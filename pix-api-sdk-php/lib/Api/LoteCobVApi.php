...
class LoteCobVApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lotecobvGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\LotesCobVConsultados|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function lotecobvGet($inicio, $fim, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['lotecobvGet'][0])
    {
        list($response) = $this->lotecobvGetWithHttpInfo($inicio, $fim, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\LotesCobVConsultados|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function lotecobvGetWithHttpInfo($inicio, $fim, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['lotecobvGet'][0])
    {
        $request = $this->lotecobvGetRequest($inicio, $fim, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\LotesCobVConsultados',
                        $request,
                        $response,
                    );
                case 403:
     ...
     */
    public function lotecobvGetAsync($inicio, $fim, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['lotecobvGet'][0])
    {
        return $this->lotecobvGetAsyncWithHttpInfo($inicio, $fim, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lotecobvGetAsyncWithHttpInfo($inicio, $fim, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['lotecobvGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\LotesCobVConsultados';
        $request = $this->lotecobvGetRequest($inicio, $fim, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
     ...
     */
    public function lotecobvGetRequest($inicio, $fim, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['lotecobvGet'][0])
    {
        ...
        if ($paginacao_pagina_atual !== null && $paginacao_pagina_atual < 0) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_pagina_atual" when calling LoteCobVApi.lotecobvGet, must be bigger than or equal to 0.');
        }
        
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina > 1000) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling LoteCobVApi.lotecobvGet, must be smaller than or equal to 1000.');
        }
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling LoteCobVApi.lotecobvGet, must be bigger than or equal to 1.');
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lotecobvIdGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\LoteCobVConsultado|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function lotecobvIdGet($id, string $contentType = self::contentTypes['lotecobvIdGet'][0])
    {
        list($response) = $this->lotecobvIdGetWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\LoteCobVConsultado|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function lotecobvIdGetWithHttpInfo($id, string $contentType = self::contentTypes['lotecobvIdGet'][0])
    {
        $request = $this->lotecobvIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\LoteCobVConsultado',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lotecobvIdGetAsync($id, string $contentType = self::contentTypes['lotecobvIdGet'][0])
    {
        return $this->lotecobvIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lotecobvIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['lotecobvIdGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\LoteCobVConsultado';
        $request = $this->lotecobvIdGetRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function lotecobvIdGetRequest($id, string $contentType = self::contentTypes['lotecobvIdGet'][0])
    {
    ...
    /**
     * Operation lotecobvIdPatch
     *
     * Utilizado para revisar cobranças específicas dentro de um lote de cobranças com vencimento.
     *
     * @param  string $id id (required)
     * @param  \OpenAPI\Client\Model\LotecobvIdPatchRequest $lotecobv_id_patch_request Dados para geração de lote de cobranças com vencimento. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lotecobvIdPatch'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function lotecobvIdPatch($id, $lotecobv_id_patch_request, string $contentType = self::contentTypes['lotecobvIdPatch'][0])
    {
        $this->lotecobvIdPatchWithHttpInfo($id, $lotecobv_id_patch_request, $contentType);
    }

    /**
     * Operation lotecobvIdPatchWithHttpInfo
     *
     * Utilizado para revisar cobranças específicas dentro de um lote de cobranças com vencimento.
     *
     * @param  string $id (required)
     ...
     */
    public function lotecobvIdPatchWithHttpInfo($id, $lotecobv_id_patch_request, string $contentType = self::contentTypes['lotecobvIdPatch'][0])
    {
        $request = $this->lotecobvIdPatchRequest($id, $lotecobv_id_patch_request, $contentType);
    ...
    /**
     * Operation lotecobvIdPatchAsync
     *
     * Utilizado para revisar cobranças específicas dentro de um lote de cobranças com vencimento.
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lotecobvIdPatchAsync($id, $lotecobv_id_patch_request, string $contentType = self::contentTypes['lotecobvIdPatch'][0])
    {
        return $this->lotecobvIdPatchAsyncWithHttpInfo($id, $lotecobv_id_patch_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation lotecobvIdPatchAsyncWithHttpInfo
     *
     * Utilizado para revisar cobranças específicas dentro de um lote de cobranças com vencimento.
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lotecobvIdPatchAsyncWithHttpInfo($id, $lotecobv_id_patch_request, string $contentType = self::contentTypes['lotecobvIdPatch'][0])
    {
        $returnType = '';
        $request = $this->lotecobvIdPatchRequest($id, $lotecobv_id_patch_request, $contentType);
    ...
    /**
     * Create request for operation 'lotecobvIdPatch'
     *
     * @param  string $id (required)
     * @param  \OpenAPI\Client\Model\LotecobvIdPatchRequest $lotecobv_id_patch_request Dados para geração de lote de cobranças com vencimento. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lotecobvIdPatch'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function lotecobvIdPatchRequest($id, $lotecobv_id_patch_request, string $contentType = self::contentTypes['lotecobvIdPatch'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling lotecobvIdPatch'
            );
        }

        // verify the required parameter 'lotecobv_id_patch_request' is set
        if ($lotecobv_id_patch_request === null || (is_array($lotecobv_id_patch_request) && count($lotecobv_id_patch_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $lotecobv_id_patch_request when calling lotecobvIdPatch'
            );
        }
        ...
        // for model (json/xml)
        if (isset($lotecobv_id_patch_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($lotecobv_id_patch_request));
            } else {
                $httpBody = $lotecobv_id_patch_request;
            }
     ...
     *
     * @param  string $id id (required)
     * @param  \OpenAPI\Client\Model\LotecobvIdPutRequest $lotecobv_id_put_request Dados para geração de lote de cobranças com vencimento. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lotecobvIdPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function lotecobvIdPut($id, $lotecobv_id_put_request, string $contentType = self::contentTypes['lotecobvIdPut'][0])
    {
        $this->lotecobvIdPutWithHttpInfo($id, $lotecobv_id_put_request, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function lotecobvIdPutWithHttpInfo($id, $lotecobv_id_put_request, string $contentType = self::contentTypes['lotecobvIdPut'][0])
    {
        $request = $this->lotecobvIdPutRequest($id, $lotecobv_id_put_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lotecobvIdPutAsync($id, $lotecobv_id_put_request, string $contentType = self::contentTypes['lotecobvIdPut'][0])
    {
        return $this->lotecobvIdPutAsyncWithHttpInfo($id, $lotecobv_id_put_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lotecobvIdPutAsyncWithHttpInfo($id, $lotecobv_id_put_request, string $contentType = self::contentTypes['lotecobvIdPut'][0])
    {
        $returnType = '';
        $request = $this->lotecobvIdPutRequest($id, $lotecobv_id_put_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function lotecobvIdPutRequest($id, $lotecobv_id_put_request, string $contentType = self::contentTypes['lotecobvIdPut'][0])
    {
        ...
        // verify the required parameter 'lotecobv_id_put_request' is set
        if ($lotecobv_id_put_request === null || (is_array($lotecobv_id_put_request) && count($lotecobv_id_put_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $lotecobv_id_put_request when calling lotecobvIdPut'
            );
        }
        ...
        // for model (json/xml)
        if (isset($lotecobv_id_put_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($lotecobv_id_put_request));
            } else {
                $httpBody = $lotecobv_id_put_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

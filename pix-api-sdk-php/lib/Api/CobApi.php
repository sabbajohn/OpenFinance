...
class CobApi
{
     ...
     * @param  bool|null $location_presente location_presente (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobsConsultadas|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobGet($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobGet'][0])
    {
        list($response) = $this->cobGetWithHttpInfo($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
        return $response;
    }
     ...
     * @param  bool|null $location_presente (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobsConsultadas|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobGetWithHttpInfo($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobGet'][0])
    {
        $request = $this->cobGetRequest($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobsConsultadas',
                        $request,
                        $response,
                    );
                case 403:
     ...
     */
    public function cobGetAsync($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobGet'][0])
    {
        return $this->cobGetAsyncWithHttpInfo($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobGetAsyncWithHttpInfo($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobsConsultadas';
        $request = $this->cobGetRequest($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
     ...
     */
    public function cobGetRequest($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobGet'][0])
    {
        ...
        if ($cpf !== null && !preg_match("/^\\d{11}$/", $cpf)) {
            throw new \InvalidArgumentException("invalid value for \"cpf\" when calling CobApi.cobGet, must conform to the pattern /^\\d{11}$/.");
        }
        
        if ($cnpj !== null && !preg_match("/^[0-9A-Z]{14}$/", $cnpj)) {
            throw new \InvalidArgumentException("invalid value for \"cnpj\" when calling CobApi.cobGet, must conform to the pattern /^[0-9A-Z]{14}$/.");
        }
        


        if ($paginacao_pagina_atual !== null && $paginacao_pagina_atual < 0) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_pagina_atual" when calling CobApi.cobGet, must be bigger than or equal to 0.');
        }
        
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina > 1000) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling CobApi.cobGet, must be smaller than or equal to 1000.');
        }
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling CobApi.cobGet, must be bigger than or equal to 1.');
        }
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $location_presente,
            'locationPresente', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     *
     * @param  \OpenAPI\Client\Model\CobSolicitada $cob_solicitada Dados para geração da cobrança imediata. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobPost($cob_solicitada, string $contentType = self::contentTypes['cobPost'][0])
    {
        list($response) = $this->cobPostWithHttpInfo($cob_solicitada, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobPostWithHttpInfo($cob_solicitada, string $contentType = self::contentTypes['cobPost'][0])
    {
        $request = $this->cobPostRequest($cob_solicitada, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobGerada',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobPostAsync($cob_solicitada, string $contentType = self::contentTypes['cobPost'][0])
    {
        return $this->cobPostAsyncWithHttpInfo($cob_solicitada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobPostAsyncWithHttpInfo($cob_solicitada, string $contentType = self::contentTypes['cobPost'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobGerada';
        $request = $this->cobPostRequest($cob_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobPostRequest($cob_solicitada, string $contentType = self::contentTypes['cobPost'][0])
    {

        // verify the required parameter 'cob_solicitada' is set
        if ($cob_solicitada === null || (is_array($cob_solicitada) && count($cob_solicitada) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cob_solicitada when calling cobPost'
            );
        }
        ...
        // for model (json/xml)
        if (isset($cob_solicitada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cob_solicitada));
            } else {
                $httpBody = $cob_solicitada;
            }
     ...
     * @param  int|null $revisao revisao (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobTxidGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobTxidGet($txid, $revisao = null, string $contentType = self::contentTypes['cobTxidGet'][0])
    {
        list($response) = $this->cobTxidGetWithHttpInfo($txid, $revisao, $contentType);
        return $response;
    }
     ...
     * @param  int|null $revisao (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobTxidGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobTxidGetWithHttpInfo($txid, $revisao = null, string $contentType = self::contentTypes['cobTxidGet'][0])
    {
        $request = $this->cobTxidGetRequest($txid, $revisao, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobCompleta',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobTxidGetAsync($txid, $revisao = null, string $contentType = self::contentTypes['cobTxidGet'][0])
    {
        return $this->cobTxidGetAsyncWithHttpInfo($txid, $revisao, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobTxidGetAsyncWithHttpInfo($txid, $revisao = null, string $contentType = self::contentTypes['cobTxidGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobCompleta';
        $request = $this->cobTxidGetRequest($txid, $revisao, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobTxidGetRequest($txid, $revisao = null, string $contentType = self::contentTypes['cobTxidGet'][0])
    {
        ...
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $txid)) {
            throw new \InvalidArgumentException("invalid value for \"txid\" when calling CobApi.cobTxidGet, must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
     ...
     *
     * @param  string $txid txid (required)
     * @param  \OpenAPI\Client\Model\CobRevisada $cob_revisada Dados para geração da cobrança. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobTxidPatch'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobTxidPatch($txid, $cob_revisada, string $contentType = self::contentTypes['cobTxidPatch'][0])
    {
        list($response) = $this->cobTxidPatchWithHttpInfo($txid, $cob_revisada, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobTxidPatchWithHttpInfo($txid, $cob_revisada, string $contentType = self::contentTypes['cobTxidPatch'][0])
    {
        $request = $this->cobTxidPatchRequest($txid, $cob_revisada, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobTxidPatchAsync($txid, $cob_revisada, string $contentType = self::contentTypes['cobTxidPatch'][0])
    {
        return $this->cobTxidPatchAsyncWithHttpInfo($txid, $cob_revisada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobTxidPatchAsyncWithHttpInfo($txid, $cob_revisada, string $contentType = self::contentTypes['cobTxidPatch'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobGerada';
        $request = $this->cobTxidPatchRequest($txid, $cob_revisada, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobTxidPatchRequest($txid, $cob_revisada, string $contentType = self::contentTypes['cobTxidPatch'][0])
    {
        ...
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $txid)) {
            throw new \InvalidArgumentException("invalid value for \"txid\" when calling CobApi.cobTxidPatch, must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
        
        // verify the required parameter 'cob_revisada' is set
        if ($cob_revisada === null || (is_array($cob_revisada) && count($cob_revisada) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cob_revisada when calling cobTxidPatch'
            );
        }
        ...
        // for model (json/xml)
        if (isset($cob_revisada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cob_revisada));
            } else {
                $httpBody = $cob_revisada;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  string $txid txid (required)
     * @param  \OpenAPI\Client\Model\CobSolicitada $cob_solicitada Dados para geração da cobrança imediata. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobTxidPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobTxidPut($txid, $cob_solicitada, string $contentType = self::contentTypes['cobTxidPut'][0])
    {
        list($response) = $this->cobTxidPutWithHttpInfo($txid, $cob_solicitada, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\CobGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobTxidPutWithHttpInfo($txid, $cob_solicitada, string $contentType = self::contentTypes['cobTxidPut'][0])
    {
        $request = $this->cobTxidPutRequest($txid, $cob_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobTxidPutAsync($txid, $cob_solicitada, string $contentType = self::contentTypes['cobTxidPut'][0])
    {
        return $this->cobTxidPutAsyncWithHttpInfo($txid, $cob_solicitada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobTxidPutAsyncWithHttpInfo($txid, $cob_solicitada, string $contentType = self::contentTypes['cobTxidPut'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobGerada';
        $request = $this->cobTxidPutRequest($txid, $cob_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobTxidPutRequest($txid, $cob_solicitada, string $contentType = self::contentTypes['cobTxidPut'][0])
    {
        ...
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $txid)) {
            throw new \InvalidArgumentException("invalid value for \"txid\" when calling CobApi.cobTxidPut, must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
        
        // verify the required parameter 'cob_solicitada' is set
        if ($cob_solicitada === null || (is_array($cob_solicitada) && count($cob_solicitada) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cob_solicitada when calling cobTxidPut'
            );
        }

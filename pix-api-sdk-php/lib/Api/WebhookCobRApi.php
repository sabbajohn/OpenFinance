...
/**
 * WebhookCobRApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class WebhookCobRApi
{
    ...
    /**
     * Operation webhookcobrDelete
     *
     * Cancelar o Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhookcobrDelete(string $contentType = self::contentTypes['webhookcobrDelete'][0])
    {
        $this->webhookcobrDeleteWithHttpInfo($contentType);
    }

    /**
     * Operation webhookcobrDeleteWithHttpInfo
     *
     * Cancelar o Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrDelete'] to see the possible values for this operation
     ...
     */
    public function webhookcobrDeleteWithHttpInfo(string $contentType = self::contentTypes['webhookcobrDelete'][0])
    {
        $request = $this->webhookcobrDeleteRequest($contentType);
    ...
    /**
     * Operation webhookcobrDeleteAsync
     *
     * Cancelar o Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrDelete'] to see the possible values for this operation
     ...
     */
    public function webhookcobrDeleteAsync(string $contentType = self::contentTypes['webhookcobrDelete'][0])
    {
        return $this->webhookcobrDeleteAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookcobrDeleteAsyncWithHttpInfo
     *
     * Cancelar o Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrDelete'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookcobrDeleteAsyncWithHttpInfo(string $contentType = self::contentTypes['webhookcobrDelete'][0])
    {
        $returnType = '';
        $request = $this->webhookcobrDeleteRequest($contentType);
    ...
    /**
     * Create request for operation 'webhookcobrDelete'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrDelete'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function webhookcobrDeleteRequest(string $contentType = self::contentTypes['webhookcobrDelete'][0])
    {


        $resourcePath = '/webhookcobr';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhookcobrGet
     *
     * Exibir informações acerca do Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WebhookCobRCompleto|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function webhookcobrGet(string $contentType = self::contentTypes['webhookcobrGet'][0])
    {
        list($response) = $this->webhookcobrGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation webhookcobrGetWithHttpInfo
     *
     * Exibir informações acerca do Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrGet'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WebhookCobRCompleto|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookcobrGetWithHttpInfo(string $contentType = self::contentTypes['webhookcobrGet'][0])
    {
        $request = $this->webhookcobrGetRequest($contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\WebhookCobRCompleto',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookcobrGetAsync(string $contentType = self::contentTypes['webhookcobrGet'][0])
    {
        return $this->webhookcobrGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookcobrGetAsyncWithHttpInfo
     *
     * Exibir informações acerca do Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookcobrGetAsyncWithHttpInfo(string $contentType = self::contentTypes['webhookcobrGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WebhookCobRCompleto';
        $request = $this->webhookcobrGetRequest($contentType);
    ...
    /**
     * Create request for operation 'webhookcobrGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookcobrGetRequest(string $contentType = self::contentTypes['webhookcobrGet'][0])
    {
    ...
    /**
     * Operation webhookcobrPut
     *
     * Configurar Webhook.
     *
     * @param  \OpenAPI\Client\Model\WebhookCobRSolicitado $webhook_cob_r_solicitado webhook_cob_r_solicitado (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhookcobrPut($webhook_cob_r_solicitado, string $contentType = self::contentTypes['webhookcobrPut'][0])
    {
        $this->webhookcobrPutWithHttpInfo($webhook_cob_r_solicitado, $contentType);
    }

    /**
     * Operation webhookcobrPutWithHttpInfo
     *
     * Configurar Webhook.
     *
     * @param  \OpenAPI\Client\Model\WebhookCobRSolicitado $webhook_cob_r_solicitado (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookcobrPutWithHttpInfo($webhook_cob_r_solicitado, string $contentType = self::contentTypes['webhookcobrPut'][0])
    {
        $request = $this->webhookcobrPutRequest($webhook_cob_r_solicitado, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookcobrPutAsync($webhook_cob_r_solicitado, string $contentType = self::contentTypes['webhookcobrPut'][0])
    {
        return $this->webhookcobrPutAsyncWithHttpInfo($webhook_cob_r_solicitado, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookcobrPutAsyncWithHttpInfo
     *
     * Configurar Webhook.
     *
     * @param  \OpenAPI\Client\Model\WebhookCobRSolicitado $webhook_cob_r_solicitado (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookcobrPutAsyncWithHttpInfo($webhook_cob_r_solicitado, string $contentType = self::contentTypes['webhookcobrPut'][0])
    {
        $returnType = '';
        $request = $this->webhookcobrPutRequest($webhook_cob_r_solicitado, $contentType);
    ...
    /**
     * Create request for operation 'webhookcobrPut'
     *
     * @param  \OpenAPI\Client\Model\WebhookCobRSolicitado $webhook_cob_r_solicitado (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookcobrPut'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookcobrPutRequest($webhook_cob_r_solicitado, string $contentType = self::contentTypes['webhookcobrPut'][0])
    {

        // verify the required parameter 'webhook_cob_r_solicitado' is set
        if ($webhook_cob_r_solicitado === null || (is_array($webhook_cob_r_solicitado) && count($webhook_cob_r_solicitado) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhook_cob_r_solicitado when calling webhookcobrPut'
            );
        }
        ...
        // for model (json/xml)
        if (isset($webhook_cob_r_solicitado)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_cob_r_solicitado));
            } else {
                $httpBody = $webhook_cob_r_solicitado;
            }

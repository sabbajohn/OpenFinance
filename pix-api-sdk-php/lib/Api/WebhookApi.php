...
class WebhookApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookChaveDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhookChaveDelete($chave, string $contentType = self::contentTypes['webhookChaveDelete'][0])
    {
        $this->webhookChaveDeleteWithHttpInfo($chave, $contentType);
    }
     ...
     */
    public function webhookChaveDeleteWithHttpInfo($chave, string $contentType = self::contentTypes['webhookChaveDelete'][0])
    {
        $request = $this->webhookChaveDeleteRequest($chave, $contentType);
     ...
     */
    public function webhookChaveDeleteAsync($chave, string $contentType = self::contentTypes['webhookChaveDelete'][0])
    {
        return $this->webhookChaveDeleteAsyncWithHttpInfo($chave, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookChaveDeleteAsyncWithHttpInfo($chave, string $contentType = self::contentTypes['webhookChaveDelete'][0])
    {
        $returnType = '';
        $request = $this->webhookChaveDeleteRequest($chave, $contentType);
     ...
     */
    public function webhookChaveDeleteRequest($chave, string $contentType = self::contentTypes['webhookChaveDelete'][0])
    {
        ...
        if (strlen($chave) > 77) {
            throw new \InvalidArgumentException('invalid length for "$chave" when calling WebhookApi.webhookChaveDelete, must be smaller than or equal to 77.');
        }
     ...
     *
     * @param  string $chave chave (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookChaveGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WebhookCompleto|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function webhookChaveGet($chave, string $contentType = self::contentTypes['webhookChaveGet'][0])
    {
        list($response) = $this->webhookChaveGetWithHttpInfo($chave, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WebhookCompleto|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookChaveGetWithHttpInfo($chave, string $contentType = self::contentTypes['webhookChaveGet'][0])
    {
        $request = $this->webhookChaveGetRequest($chave, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\WebhookCompleto',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookChaveGetAsync($chave, string $contentType = self::contentTypes['webhookChaveGet'][0])
    {
        return $this->webhookChaveGetAsyncWithHttpInfo($chave, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookChaveGetAsyncWithHttpInfo($chave, string $contentType = self::contentTypes['webhookChaveGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WebhookCompleto';
        $request = $this->webhookChaveGetRequest($chave, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookChaveGetRequest($chave, string $contentType = self::contentTypes['webhookChaveGet'][0])
    {
        ...
        if (strlen($chave) > 77) {
            throw new \InvalidArgumentException('invalid length for "$chave" when calling WebhookApi.webhookChaveGet, must be smaller than or equal to 77.');
        }
     ...
     *
     * @param  string $chave chave (required)
     * @param  \OpenAPI\Client\Model\WebhookSolicitado $webhook_solicitado webhook_solicitado (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookChavePut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhookChavePut($chave, $webhook_solicitado, string $contentType = self::contentTypes['webhookChavePut'][0])
    {
        $this->webhookChavePutWithHttpInfo($chave, $webhook_solicitado, $contentType);
    }
     ...
     *
     * @param  string $chave (required)
     * @param  \OpenAPI\Client\Model\WebhookSolicitado $webhook_solicitado (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookChavePut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookChavePutWithHttpInfo($chave, $webhook_solicitado, string $contentType = self::contentTypes['webhookChavePut'][0])
    {
        $request = $this->webhookChavePutRequest($chave, $webhook_solicitado, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookChavePutAsync($chave, $webhook_solicitado, string $contentType = self::contentTypes['webhookChavePut'][0])
    {
        return $this->webhookChavePutAsyncWithHttpInfo($chave, $webhook_solicitado, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookChavePutAsyncWithHttpInfo($chave, $webhook_solicitado, string $contentType = self::contentTypes['webhookChavePut'][0])
    {
        $returnType = '';
        $request = $this->webhookChavePutRequest($chave, $webhook_solicitado, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookChavePutRequest($chave, $webhook_solicitado, string $contentType = self::contentTypes['webhookChavePut'][0])
    {
        ...
        if (strlen($chave) > 77) {
            throw new \InvalidArgumentException('invalid length for "$chave" when calling WebhookApi.webhookChavePut, must be smaller than or equal to 77.');
        }
        
        // verify the required parameter 'webhook_solicitado' is set
        if ($webhook_solicitado === null || (is_array($webhook_solicitado) && count($webhook_solicitado) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhook_solicitado when calling webhookChavePut'
            );
        }
        ...
        // for model (json/xml)
        if (isset($webhook_solicitado)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_solicitado));
            } else {
                $httpBody = $webhook_solicitado;
            }
     ...
     *
     * @param  \DateTime|null $inicio inicio (optional)
     * @param  \DateTime|null $fim fim (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WebhooksConsultados|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function webhookGet($inicio = null, $fim = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['webhookGet'][0])
    {
        list($response) = $this->webhookGetWithHttpInfo($inicio, $fim, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
        return $response;
    }
     ...
     * Consultar webhooks cadastrados.
     *
     * @param  \DateTime|null $inicio (optional)
     * @param  \DateTime|null $fim (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WebhooksConsultados|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookGetWithHttpInfo($inicio = null, $fim = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['webhookGet'][0])
    {
        $request = $this->webhookGetRequest($inicio, $fim, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\WebhooksConsultados',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookGetAsync($inicio = null, $fim = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['webhookGet'][0])
    {
        return $this->webhookGetAsyncWithHttpInfo($inicio, $fim, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookGetAsyncWithHttpInfo($inicio = null, $fim = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['webhookGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WebhooksConsultados';
        $request = $this->webhookGetRequest($inicio, $fim, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookGetRequest($inicio = null, $fim = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['webhookGet'][0])
    {



        if ($paginacao_pagina_atual !== null && $paginacao_pagina_atual < 0) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_pagina_atual" when calling WebhookApi.webhookGet, must be bigger than or equal to 0.');
        }
        
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina > 1000) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling WebhookApi.webhookGet, must be smaller than or equal to 1000.');
        }
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling WebhookApi.webhookGet, must be bigger than or equal to 1.');
        }

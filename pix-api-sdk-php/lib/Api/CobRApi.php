...
class CobRApi
{
     ...
     * @param  string|null $id_rec id_rec (optional)
     * @param  string|null $cpf cpf (optional)
     * @param  string|null $cnpj cnpj (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobsRConsultadas|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobrGet($inicio, $fim, $id_rec = null, $cpf = null, $cnpj = null, $status = null, $convenio = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobrGet'][0])
    {
        list($response) = $this->cobrGetWithHttpInfo($inicio, $fim, $id_rec, $cpf, $cnpj, $status, $convenio, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
        return $response;
    }

    /**
     * Operation cobrGetWithHttpInfo
     *
     * Consultar lista de cobranças recorrentes.
     *
     * @param  \DateTime $inicio (required)
     * @param  \DateTime $fim (required)
     * @param  string|null $id_rec (optional)
     * @param  string|null $cpf (optional)
     * @param  string|null $cnpj (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobsRConsultadas|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobrGetWithHttpInfo($inicio, $fim, $id_rec = null, $cpf = null, $cnpj = null, $status = null, $convenio = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobrGet'][0])
    {
        $request = $this->cobrGetRequest($inicio, $fim, $id_rec, $cpf, $cnpj, $status, $convenio, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobsRConsultadas',
                        $request,
                        $response,
                    );
                case 403:
     ...
     */
    public function cobrGetAsync($inicio, $fim, $id_rec = null, $cpf = null, $cnpj = null, $status = null, $convenio = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobrGet'][0])
    {
        return $this->cobrGetAsyncWithHttpInfo($inicio, $fim, $id_rec, $cpf, $cnpj, $status, $convenio, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cobrGetAsyncWithHttpInfo
     *
     * Consultar lista de cobranças recorrentes.
     *
     * @param  \DateTime $inicio (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrGetAsyncWithHttpInfo($inicio, $fim, $id_rec = null, $cpf = null, $cnpj = null, $status = null, $convenio = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobrGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobsRConsultadas';
        $request = $this->cobrGetRequest($inicio, $fim, $id_rec, $cpf, $cnpj, $status, $convenio, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
    ...
    /**
     * Create request for operation 'cobrGet'
     *
     * @param  \DateTime $inicio (required)
     * @param  \DateTime $fim (required)
     * @param  string|null $id_rec (optional)
     ...
     */
    public function cobrGetRequest($inicio, $fim, $id_rec = null, $cpf = null, $cnpj = null, $status = null, $convenio = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobrGet'][0])
    {

        // verify the required parameter 'inicio' is set
        if ($inicio === null || (is_array($inicio) && count($inicio) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inicio when calling cobrGet'
            );
        }
        ...
        if ($fim === null || (is_array($fim) && count($fim) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fim when calling cobrGet'
            );
        }

        if ($id_rec !== null && strlen($id_rec) > 29) {
            throw new \InvalidArgumentException('invalid length for "$id_rec" when calling CobRApi.cobrGet, must be smaller than or equal to 29.');
        }
        if ($id_rec !== null && strlen($id_rec) < 29) {
            throw new \InvalidArgumentException('invalid length for "$id_rec" when calling CobRApi.cobrGet, must be bigger than or equal to 29.');
        }
        if ($id_rec !== null && !preg_match("/[a-zA-Z0-9]{29}/", $id_rec)) {
            throw new \InvalidArgumentException("invalid value for \"id_rec\" when calling CobRApi.cobrGet, must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }
        
        if ($cpf !== null && !preg_match("/^\\d{11}$/", $cpf)) {
            throw new \InvalidArgumentException("invalid value for \"cpf\" when calling CobRApi.cobrGet, must conform to the pattern /^\\d{11}$/.");
        }
        
        if ($cnpj !== null && !preg_match("/^[0-9A-Z]{14}$/", $cnpj)) {
            throw new \InvalidArgumentException("invalid value for \"cnpj\" when calling CobRApi.cobrGet, must conform to the pattern /^[0-9A-Z]{14}$/.");
        }
        

        if ($convenio !== null && strlen($convenio) > 60) {
            throw new \InvalidArgumentException('invalid length for "$convenio" when calling CobRApi.cobrGet, must be smaller than or equal to 60.');
        }
        
        if ($paginacao_pagina_atual !== null && $paginacao_pagina_atual < 0) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_pagina_atual" when calling CobRApi.cobrGet, must be bigger than or equal to 0.');
        }
        
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina > 1000) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling CobRApi.cobrGet, must be smaller than or equal to 1000.');
        }
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling CobRApi.cobrGet, must be bigger than or equal to 1.');
        }
     ...
     *
     * @param  \OpenAPI\Client\Model\CobRSolicitada $cob_r_solicitada Dados para geração da cobrança recorrente. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobRGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobrPost($cob_r_solicitada, string $contentType = self::contentTypes['cobrPost'][0])
    {
        list($response) = $this->cobrPostWithHttpInfo($cob_r_solicitada, $contentType);
        return $response;
    }

    /**
     * Operation cobrPostWithHttpInfo
     *
     * Criar cobrança recorrente.
     *
     * @param  \OpenAPI\Client\Model\CobRSolicitada $cob_r_solicitada Dados para geração da cobrança recorrente. (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobRGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobrPostWithHttpInfo($cob_r_solicitada, string $contentType = self::contentTypes['cobrPost'][0])
    {
        $request = $this->cobrPostRequest($cob_r_solicitada, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobRGerada',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrPostAsync($cob_r_solicitada, string $contentType = self::contentTypes['cobrPost'][0])
    {
        return $this->cobrPostAsyncWithHttpInfo($cob_r_solicitada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cobrPostAsyncWithHttpInfo
     *
     * Criar cobrança recorrente.
     *
     * @param  \OpenAPI\Client\Model\CobRSolicitada $cob_r_solicitada Dados para geração da cobrança recorrente. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrPostAsyncWithHttpInfo($cob_r_solicitada, string $contentType = self::contentTypes['cobrPost'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobRGerada';
        $request = $this->cobrPostRequest($cob_r_solicitada, $contentType);
    ...
    /**
     * Create request for operation 'cobrPost'
     *
     * @param  \OpenAPI\Client\Model\CobRSolicitada $cob_r_solicitada Dados para geração da cobrança recorrente. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobrPostRequest($cob_r_solicitada, string $contentType = self::contentTypes['cobrPost'][0])
    {

        // verify the required parameter 'cob_r_solicitada' is set
        if ($cob_r_solicitada === null || (is_array($cob_r_solicitada) && count($cob_r_solicitada) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cob_r_solicitada when calling cobrPost'
            );
        }
        ...
        // for model (json/xml)
        if (isset($cob_r_solicitada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cob_r_solicitada));
            } else {
                $httpBody = $cob_r_solicitada;
            }
    ...
    /**
     * Operation cobrTxidGet
     *
     * Consultar cobrança recorrente.
     *
     * @param  string $txid txid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrTxidGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobRCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobrTxidGet($txid, string $contentType = self::contentTypes['cobrTxidGet'][0])
    {
        list($response) = $this->cobrTxidGetWithHttpInfo($txid, $contentType);
        return $response;
    }

    /**
     * Operation cobrTxidGetWithHttpInfo
     *
     * Consultar cobrança recorrente.
     *
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobRCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobrTxidGetWithHttpInfo($txid, string $contentType = self::contentTypes['cobrTxidGet'][0])
    {
        $request = $this->cobrTxidGetRequest($txid, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobRCompleta',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrTxidGetAsync($txid, string $contentType = self::contentTypes['cobrTxidGet'][0])
    {
        return $this->cobrTxidGetAsyncWithHttpInfo($txid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cobrTxidGetAsyncWithHttpInfo
     *
     * Consultar cobrança recorrente.
     *
     * @param  string $txid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrTxidGetAsyncWithHttpInfo($txid, string $contentType = self::contentTypes['cobrTxidGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobRCompleta';
        $request = $this->cobrTxidGetRequest($txid, $contentType);
    ...
    /**
     * Create request for operation 'cobrTxidGet'
     *
     * @param  string $txid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrTxidGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobrTxidGetRequest($txid, string $contentType = self::contentTypes['cobrTxidGet'][0])
    {

        // verify the required parameter 'txid' is set
        if ($txid === null || (is_array($txid) && count($txid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $txid when calling cobrTxidGet'
            );
        }
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $txid)) {
            throw new \InvalidArgumentException("invalid value for \"txid\" when calling CobRApi.cobrTxidGet, must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
        

        $resourcePath = '/cobr/{txid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation cobrTxidPatch
     *
     * Revisar cobrança recorrente.
     *
     * @param  string $txid txid (required)
     * @param  \OpenAPI\Client\Model\CobRRevisada $cob_r_revisada Dados para geração da cobrança. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrTxidPatch'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobRGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobrTxidPatch($txid, $cob_r_revisada, string $contentType = self::contentTypes['cobrTxidPatch'][0])
    {
        list($response) = $this->cobrTxidPatchWithHttpInfo($txid, $cob_r_revisada, $contentType);
        return $response;
    }

    /**
     * Operation cobrTxidPatchWithHttpInfo
     *
     * Revisar cobrança recorrente.
     *
     * @param  string $txid (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobRGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobrTxidPatchWithHttpInfo($txid, $cob_r_revisada, string $contentType = self::contentTypes['cobrTxidPatch'][0])
    {
        $request = $this->cobrTxidPatchRequest($txid, $cob_r_revisada, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrTxidPatchAsync($txid, $cob_r_revisada, string $contentType = self::contentTypes['cobrTxidPatch'][0])
    {
        return $this->cobrTxidPatchAsyncWithHttpInfo($txid, $cob_r_revisada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cobrTxidPatchAsyncWithHttpInfo
     *
     * Revisar cobrança recorrente.
     *
     * @param  string $txid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrTxidPatchAsyncWithHttpInfo($txid, $cob_r_revisada, string $contentType = self::contentTypes['cobrTxidPatch'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobRGerada';
        $request = $this->cobrTxidPatchRequest($txid, $cob_r_revisada, $contentType);
    ...
    /**
     * Create request for operation 'cobrTxidPatch'
     *
     * @param  string $txid (required)
     * @param  \OpenAPI\Client\Model\CobRRevisada $cob_r_revisada Dados para geração da cobrança. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrTxidPatch'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobrTxidPatchRequest($txid, $cob_r_revisada, string $contentType = self::contentTypes['cobrTxidPatch'][0])
    {

        // verify the required parameter 'txid' is set
        if ($txid === null || (is_array($txid) && count($txid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $txid when calling cobrTxidPatch'
            );
        }
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $txid)) {
            throw new \InvalidArgumentException("invalid value for \"txid\" when calling CobRApi.cobrTxidPatch, must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
        
        // verify the required parameter 'cob_r_revisada' is set
        if ($cob_r_revisada === null || (is_array($cob_r_revisada) && count($cob_r_revisada) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cob_r_revisada when calling cobrTxidPatch'
            );
        }
        ...
        // for model (json/xml)
        if (isset($cob_r_revisada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cob_r_revisada));
            } else {
                $httpBody = $cob_r_revisada;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation cobrTxidPut
     *
     * Criar cobrança recorrente.
     *
     * @param  string $txid txid (required)
     * @param  \OpenAPI\Client\Model\CobRSolicitada $cob_r_solicitada Dados para geração da cobrança recorrente. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrTxidPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobRGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobrTxidPut($txid, $cob_r_solicitada, string $contentType = self::contentTypes['cobrTxidPut'][0])
    {
        list($response) = $this->cobrTxidPutWithHttpInfo($txid, $cob_r_solicitada, $contentType);
        return $response;
    }

    /**
     * Operation cobrTxidPutWithHttpInfo
     *
     * Criar cobrança recorrente.
     *
     * @param  string $txid (required)
     ...
     * @return array of \OpenAPI\Client\Model\CobRGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobrTxidPutWithHttpInfo($txid, $cob_r_solicitada, string $contentType = self::contentTypes['cobrTxidPut'][0])
    {
        $request = $this->cobrTxidPutRequest($txid, $cob_r_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrTxidPutAsync($txid, $cob_r_solicitada, string $contentType = self::contentTypes['cobrTxidPut'][0])
    {
        return $this->cobrTxidPutAsyncWithHttpInfo($txid, $cob_r_solicitada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cobrTxidPutAsyncWithHttpInfo
     *
     * Criar cobrança recorrente.
     *
     * @param  string $txid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrTxidPutAsyncWithHttpInfo($txid, $cob_r_solicitada, string $contentType = self::contentTypes['cobrTxidPut'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobRGerada';
        $request = $this->cobrTxidPutRequest($txid, $cob_r_solicitada, $contentType);
    ...
    /**
     * Create request for operation 'cobrTxidPut'
     *
     * @param  string $txid (required)
     * @param  \OpenAPI\Client\Model\CobRSolicitada $cob_r_solicitada Dados para geração da cobrança recorrente. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrTxidPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobrTxidPutRequest($txid, $cob_r_solicitada, string $contentType = self::contentTypes['cobrTxidPut'][0])
    {

        // verify the required parameter 'txid' is set
        if ($txid === null || (is_array($txid) && count($txid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $txid when calling cobrTxidPut'
            );
        }
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $txid)) {
            throw new \InvalidArgumentException("invalid value for \"txid\" when calling CobRApi.cobrTxidPut, must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
        
        // verify the required parameter 'cob_r_solicitada' is set
        if ($cob_r_solicitada === null || (is_array($cob_r_solicitada) && count($cob_r_solicitada) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cob_r_solicitada when calling cobrTxidPut'
            );
        }
    ...
    /**
     * Operation cobrTxidRetentativaDataPost
     *
     * Solicitar retentativa de cobrança.
     *
     * @param  string $txid txid (required)
     * @param  \DateTime $data Data prevista para liquidação da ordem de pagamento correspondente. Trata-se de uma data, no formato &#x60;YYYY-MM-DD&#x60;, segundo ISO 8601. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrTxidRetentativaDataPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPIClientModelCobRCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobrTxidRetentativaDataPost($txid, $data, string $contentType = self::contentTypes['cobrTxidRetentativaDataPost'][0])
    {
        list($response) = $this->cobrTxidRetentativaDataPostWithHttpInfo($txid, $data, $contentType);
        return $response;
    }

    /**
     * Operation cobrTxidRetentativaDataPostWithHttpInfo
     *
     * Solicitar retentativa de cobrança.
     *
     * @param  string $txid (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPIClientModelCobRCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobrTxidRetentativaDataPostWithHttpInfo($txid, $data, string $contentType = self::contentTypes['cobrTxidRetentativaDataPost'][0])
    {
        $request = $this->cobrTxidRetentativaDataPostRequest($txid, $data, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\OpenAPIClientModelCobRCompleta',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation cobrTxidRetentativaDataPostAsync
     *
     * Solicitar retentativa de cobrança.
     *
     * @param  string $txid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrTxidRetentativaDataPostAsync($txid, $data, string $contentType = self::contentTypes['cobrTxidRetentativaDataPost'][0])
    {
        return $this->cobrTxidRetentativaDataPostAsyncWithHttpInfo($txid, $data, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cobrTxidRetentativaDataPostAsyncWithHttpInfo
     *
     * Solicitar retentativa de cobrança.
     *
     * @param  string $txid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobrTxidRetentativaDataPostAsyncWithHttpInfo($txid, $data, string $contentType = self::contentTypes['cobrTxidRetentativaDataPost'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobRCompleta';
        $request = $this->cobrTxidRetentativaDataPostRequest($txid, $data, $contentType);
    ...
    /**
     * Create request for operation 'cobrTxidRetentativaDataPost'
     *
     * @param  string $txid (required)
     * @param  \DateTime $data Data prevista para liquidação da ordem de pagamento correspondente. Trata-se de uma data, no formato &#x60;YYYY-MM-DD&#x60;, segundo ISO 8601. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobrTxidRetentativaDataPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobrTxidRetentativaDataPostRequest($txid, $data, string $contentType = self::contentTypes['cobrTxidRetentativaDataPost'][0])
    {

        // verify the required parameter 'txid' is set
        if ($txid === null || (is_array($txid) && count($txid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $txid when calling cobrTxidRetentativaDataPost'
            );
        }
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $txid)) {
            throw new \InvalidArgumentException("invalid value for \"txid\" when calling CobRApi.cobrTxidRetentativaDataPost, must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
        
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling cobrTxidRetentativaDataPost'
            );
        }


        $resourcePath = '/cobr/{txid}/retentativa/{data}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($data !== null) {
            $resourcePath = str_replace(
                '{' . 'data' . '}',
                ObjectSerializer::toPathValue($data),
                $resourcePath
            );
        }

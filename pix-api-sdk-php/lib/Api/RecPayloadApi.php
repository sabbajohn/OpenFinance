...
/**
 * RecPayloadApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class RecPayloadApi
{
    ...
    /**
     * Operation recRecUrlAccessTokenGet
     *
     ...
     *
     * @param  string $rec_url_access_token rec_url_access_token (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recRecUrlAccessTokenGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RecPayload|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function recRecUrlAccessTokenGet($rec_url_access_token, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['recRecUrlAccessTokenGet'][0])
    {
        list($response) = $this->recRecUrlAccessTokenGetWithHttpInfo($rec_url_access_token, $hostIndex, $variables, $contentType);
        return $response;
    }

    /**
     * Operation recRecUrlAccessTokenGetWithHttpInfo
     *
     * Recuperar o payload JSON que representa a configuração da recorrência.
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     *    - fdqnPSPRecebedor: Endpoint base para que os usuários devedores possam acessar o payload JSON que representa a recorrência.
     *
     * @param  string $rec_url_access_token (required)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recRecUrlAccessTokenGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RecPayload|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function recRecUrlAccessTokenGetWithHttpInfo($rec_url_access_token, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['recRecUrlAccessTokenGet'][0])
    {
        $request = $this->recRecUrlAccessTokenGetRequest($rec_url_access_token, $hostIndex, $variables, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\RecPayload',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation recRecUrlAccessTokenGetAsync
     *
     * Recuperar o payload JSON que representa a configuração da recorrência.
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     */
    public function recRecUrlAccessTokenGetAsync($rec_url_access_token, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['recRecUrlAccessTokenGet'][0])
    {
        return $this->recRecUrlAccessTokenGetAsyncWithHttpInfo($rec_url_access_token, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation recRecUrlAccessTokenGetAsyncWithHttpInfo
     *
     * Recuperar o payload JSON que representa a configuração da recorrência.
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recRecUrlAccessTokenGetAsyncWithHttpInfo($rec_url_access_token, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['recRecUrlAccessTokenGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\RecPayload';
        $request = $this->recRecUrlAccessTokenGetRequest($rec_url_access_token, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'recRecUrlAccessTokenGet'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://{fdqnPSPRecebedor}/{endpointOpcional}
    ...
    *    - fdqnPSPRecebedor: Endpoint base para que os usuários devedores possam acessar o payload JSON que representa a recorrência.
     ...
     */
    public function recRecUrlAccessTokenGetRequest($rec_url_access_token, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['recRecUrlAccessTokenGet'][0])
    {

        // verify the required parameter 'rec_url_access_token' is set
        if ($rec_url_access_token === null || (is_array($rec_url_access_token) && count($rec_url_access_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $rec_url_access_token when calling recRecUrlAccessTokenGet'
            );
        }


        $resourcePath = '/rec/{recUrlAccessToken}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($rec_url_access_token !== null) {
            $resourcePath = str_replace(
                '{' . 'recUrlAccessToken' . '}',
                ObjectSerializer::toPathValue($rec_url_access_token),
                $resourcePath
            );
        }
        ...
        $hostSettings = $this->getHostSettingsForrecRecUrlAccessTokenGet();
    ...
    /**
     * Returns an array of host settings for Operation recRecUrlAccessTokenGet
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForrecRecUrlAccessTokenGet(): array
    {
        return [
            [
                "url" => "https://{fdqnPSPRecebedor}/{endpointOpcional}",

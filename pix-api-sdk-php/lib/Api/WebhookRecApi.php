...
/**
 * WebhookRecApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class WebhookRecApi
{
    ...
    /**
     * Operation webhookrecDelete
     *
     * Cancelar o Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhookrecDelete(string $contentType = self::contentTypes['webhookrecDelete'][0])
    {
        $this->webhookrecDeleteWithHttpInfo($contentType);
    }

    /**
     * Operation webhookrecDeleteWithHttpInfo
     *
     * Cancelar o Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecDelete'] to see the possible values for this operation
     ...
     */
    public function webhookrecDeleteWithHttpInfo(string $contentType = self::contentTypes['webhookrecDelete'][0])
    {
        $request = $this->webhookrecDeleteRequest($contentType);
    ...
    /**
     * Operation webhookrecDeleteAsync
     *
     * Cancelar o Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecDelete'] to see the possible values for this operation
     ...
     */
    public function webhookrecDeleteAsync(string $contentType = self::contentTypes['webhookrecDelete'][0])
    {
        return $this->webhookrecDeleteAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookrecDeleteAsyncWithHttpInfo
     *
     * Cancelar o Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecDelete'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookrecDeleteAsyncWithHttpInfo(string $contentType = self::contentTypes['webhookrecDelete'][0])
    {
        $returnType = '';
        $request = $this->webhookrecDeleteRequest($contentType);
    ...
    /**
     * Create request for operation 'webhookrecDelete'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecDelete'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function webhookrecDeleteRequest(string $contentType = self::contentTypes['webhookrecDelete'][0])
    {


        $resourcePath = '/webhookrec';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhookrecGet
     *
     * Exibir informações acerca do Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WebhookRecCompleto|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function webhookrecGet(string $contentType = self::contentTypes['webhookrecGet'][0])
    {
        list($response) = $this->webhookrecGetWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation webhookrecGetWithHttpInfo
     *
     * Exibir informações acerca do Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecGet'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WebhookRecCompleto|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookrecGetWithHttpInfo(string $contentType = self::contentTypes['webhookrecGet'][0])
    {
        $request = $this->webhookrecGetRequest($contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\WebhookRecCompleto',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookrecGetAsync(string $contentType = self::contentTypes['webhookrecGet'][0])
    {
        return $this->webhookrecGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookrecGetAsyncWithHttpInfo
     *
     * Exibir informações acerca do Webhook.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookrecGetAsyncWithHttpInfo(string $contentType = self::contentTypes['webhookrecGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WebhookRecCompleto';
        $request = $this->webhookrecGetRequest($contentType);
    ...
    /**
     * Create request for operation 'webhookrecGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookrecGetRequest(string $contentType = self::contentTypes['webhookrecGet'][0])
    {
    ...
    /**
     * Operation webhookrecPut
     *
     * Configurar Webhook.
     *
     * @param  \OpenAPI\Client\Model\WebhookRecSolicitado $webhook_rec_solicitado webhook_rec_solicitado (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhookrecPut($webhook_rec_solicitado, string $contentType = self::contentTypes['webhookrecPut'][0])
    {
        $this->webhookrecPutWithHttpInfo($webhook_rec_solicitado, $contentType);
    }

    /**
     * Operation webhookrecPutWithHttpInfo
     *
     * Configurar Webhook.
     *
     * @param  \OpenAPI\Client\Model\WebhookRecSolicitado $webhook_rec_solicitado (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookrecPutWithHttpInfo($webhook_rec_solicitado, string $contentType = self::contentTypes['webhookrecPut'][0])
    {
        $request = $this->webhookrecPutRequest($webhook_rec_solicitado, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookrecPutAsync($webhook_rec_solicitado, string $contentType = self::contentTypes['webhookrecPut'][0])
    {
        return $this->webhookrecPutAsyncWithHttpInfo($webhook_rec_solicitado, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookrecPutAsyncWithHttpInfo
     *
     * Configurar Webhook.
     *
     * @param  \OpenAPI\Client\Model\WebhookRecSolicitado $webhook_rec_solicitado (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookrecPutAsyncWithHttpInfo($webhook_rec_solicitado, string $contentType = self::contentTypes['webhookrecPut'][0])
    {
        $returnType = '';
        $request = $this->webhookrecPutRequest($webhook_rec_solicitado, $contentType);
    ...
    /**
     * Create request for operation 'webhookrecPut'
     *
     * @param  \OpenAPI\Client\Model\WebhookRecSolicitado $webhook_rec_solicitado (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookrecPut'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookrecPutRequest($webhook_rec_solicitado, string $contentType = self::contentTypes['webhookrecPut'][0])
    {

        // verify the required parameter 'webhook_rec_solicitado' is set
        if ($webhook_rec_solicitado === null || (is_array($webhook_rec_solicitado) && count($webhook_rec_solicitado) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhook_rec_solicitado when calling webhookrecPut'
            );
        }
        ...
        // for model (json/xml)
        if (isset($webhook_rec_solicitado)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_rec_solicitado));
            } else {
                $httpBody = $webhook_rec_solicitado;
            }

...
class CobVApi
{
     ...
     * @param  int|null $lote_cob_vid lote_cob_vid (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobvGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobsVConsultadas|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobvGet($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $lote_cob_vid = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobvGet'][0])
    {
        list($response) = $this->cobvGetWithHttpInfo($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $lote_cob_vid, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
        return $response;
    }
     ...
     * @param  int|null $lote_cob_vid (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobsVConsultadas|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobvGetWithHttpInfo($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $lote_cob_vid = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobvGet'][0])
    {
        $request = $this->cobvGetRequest($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $lote_cob_vid, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobsVConsultadas',
                        $request,
                        $response,
                    );
                case 403:
     ...
     */
    public function cobvGetAsync($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $lote_cob_vid = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobvGet'][0])
    {
        return $this->cobvGetAsyncWithHttpInfo($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $lote_cob_vid, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobvGetAsyncWithHttpInfo($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $lote_cob_vid = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobvGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobsVConsultadas';
        $request = $this->cobvGetRequest($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $lote_cob_vid, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
     ...
     */
    public function cobvGetRequest($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $lote_cob_vid = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['cobvGet'][0])
    {
        ...
        if ($cpf !== null && !preg_match("/^\\d{11}$/", $cpf)) {
            throw new \InvalidArgumentException("invalid value for \"cpf\" when calling CobVApi.cobvGet, must conform to the pattern /^\\d{11}$/.");
        }
        
        if ($cnpj !== null && !preg_match("/^[0-9A-Z]{14}$/", $cnpj)) {
            throw new \InvalidArgumentException("invalid value for \"cnpj\" when calling CobVApi.cobvGet, must conform to the pattern /^[0-9A-Z]{14}$/.");
        }
        ...
        if ($paginacao_pagina_atual !== null && $paginacao_pagina_atual < 0) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_pagina_atual" when calling CobVApi.cobvGet, must be bigger than or equal to 0.');
        }
        
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina > 1000) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling CobVApi.cobvGet, must be smaller than or equal to 1000.');
        }
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling CobVApi.cobvGet, must be bigger than or equal to 1.');
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobvTxidGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobVCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobvTxidGet($txid, $revisao = null, string $contentType = self::contentTypes['cobvTxidGet'][0])
    {
        list($response) = $this->cobvTxidGetWithHttpInfo($txid, $revisao, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobVCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobvTxidGetWithHttpInfo($txid, $revisao = null, string $contentType = self::contentTypes['cobvTxidGet'][0])
    {
        $request = $this->cobvTxidGetRequest($txid, $revisao, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobVCompleta',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobvTxidGetAsync($txid, $revisao = null, string $contentType = self::contentTypes['cobvTxidGet'][0])
    {
        return $this->cobvTxidGetAsyncWithHttpInfo($txid, $revisao, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobvTxidGetAsyncWithHttpInfo($txid, $revisao = null, string $contentType = self::contentTypes['cobvTxidGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobVCompleta';
        $request = $this->cobvTxidGetRequest($txid, $revisao, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobvTxidGetRequest($txid, $revisao = null, string $contentType = self::contentTypes['cobvTxidGet'][0])
    {
        ...
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $txid)) {
            throw new \InvalidArgumentException("invalid value for \"txid\" when calling CobVApi.cobvTxidGet, must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
     ...
     *
     * @param  string $txid txid (required)
     * @param  \OpenAPI\Client\Model\CobVRevisada $cob_v_revisada Dados para geração da cobrança. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobvTxidPatch'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobVGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobvTxidPatch($txid, $cob_v_revisada, string $contentType = self::contentTypes['cobvTxidPatch'][0])
    {
        list($response) = $this->cobvTxidPatchWithHttpInfo($txid, $cob_v_revisada, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobVGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobvTxidPatchWithHttpInfo($txid, $cob_v_revisada, string $contentType = self::contentTypes['cobvTxidPatch'][0])
    {
        $request = $this->cobvTxidPatchRequest($txid, $cob_v_revisada, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobVGerada',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobvTxidPatchAsync($txid, $cob_v_revisada, string $contentType = self::contentTypes['cobvTxidPatch'][0])
    {
        return $this->cobvTxidPatchAsyncWithHttpInfo($txid, $cob_v_revisada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobvTxidPatchAsyncWithHttpInfo($txid, $cob_v_revisada, string $contentType = self::contentTypes['cobvTxidPatch'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobVGerada';
        $request = $this->cobvTxidPatchRequest($txid, $cob_v_revisada, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobvTxidPatchRequest($txid, $cob_v_revisada, string $contentType = self::contentTypes['cobvTxidPatch'][0])
    {
        ...
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $txid)) {
            throw new \InvalidArgumentException("invalid value for \"txid\" when calling CobVApi.cobvTxidPatch, must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
        
        // verify the required parameter 'cob_v_revisada' is set
        if ($cob_v_revisada === null || (is_array($cob_v_revisada) && count($cob_v_revisada) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cob_v_revisada when calling cobvTxidPatch'
            );
        }
        ...
        // for model (json/xml)
        if (isset($cob_v_revisada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cob_v_revisada));
            } else {
                $httpBody = $cob_v_revisada;
            }
     ...
     *
     * @param  string $txid txid (required)
     * @param  \OpenAPI\Client\Model\CobVSolicitada $cob_v_solicitada Dados para geração da cobrança com vencimento. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobvTxidPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobVGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobvTxidPut($txid, $cob_v_solicitada, string $contentType = self::contentTypes['cobvTxidPut'][0])
    {
        list($response) = $this->cobvTxidPutWithHttpInfo($txid, $cob_v_solicitada, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\CobVGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobvTxidPutWithHttpInfo($txid, $cob_v_solicitada, string $contentType = self::contentTypes['cobvTxidPut'][0])
    {
        $request = $this->cobvTxidPutRequest($txid, $cob_v_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobvTxidPutAsync($txid, $cob_v_solicitada, string $contentType = self::contentTypes['cobvTxidPut'][0])
    {
        return $this->cobvTxidPutAsyncWithHttpInfo($txid, $cob_v_solicitada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobvTxidPutAsyncWithHttpInfo($txid, $cob_v_solicitada, string $contentType = self::contentTypes['cobvTxidPut'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobVGerada';
        $request = $this->cobvTxidPutRequest($txid, $cob_v_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cobvTxidPutRequest($txid, $cob_v_solicitada, string $contentType = self::contentTypes['cobvTxidPut'][0])
    {
        ...
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $txid)) {
            throw new \InvalidArgumentException("invalid value for \"txid\" when calling CobVApi.cobvTxidPut, must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
        
        // verify the required parameter 'cob_v_solicitada' is set
        if ($cob_v_solicitada === null || (is_array($cob_v_solicitada) && count($cob_v_solicitada) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cob_v_solicitada when calling cobvTxidPut'
            );
        }
        ...
        // for model (json/xml)
        if (isset($cob_v_solicitada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($cob_v_solicitada));
            } else {
                $httpBody = $cob_v_solicitada;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

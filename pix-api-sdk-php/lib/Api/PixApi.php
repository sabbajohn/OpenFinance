...
class PixApi
{
     ...
     * Consultar devolução.
     *
     * @param  string $e2eid e2eid (required)
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pixE2eidDevolucaoIdGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Devolucao|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function pixE2eidDevolucaoIdGet($e2eid, $id, string $contentType = self::contentTypes['pixE2eidDevolucaoIdGet'][0])
    {
        list($response) = $this->pixE2eidDevolucaoIdGetWithHttpInfo($e2eid, $id, $contentType);
        return $response;
    }
     ...
     * Consultar devolução.
     *
     * @param  string $e2eid (required)
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pixE2eidDevolucaoIdGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Devolucao|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function pixE2eidDevolucaoIdGetWithHttpInfo($e2eid, $id, string $contentType = self::contentTypes['pixE2eidDevolucaoIdGet'][0])
    {
        $request = $this->pixE2eidDevolucaoIdGetRequest($e2eid, $id, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\Devolucao',
                        $request,
                        $response,
                    );
                case 403:
     ...
     */
    public function pixE2eidDevolucaoIdGetAsync($e2eid, $id, string $contentType = self::contentTypes['pixE2eidDevolucaoIdGet'][0])
    {
        return $this->pixE2eidDevolucaoIdGetAsyncWithHttpInfo($e2eid, $id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pixE2eidDevolucaoIdGetAsyncWithHttpInfo($e2eid, $id, string $contentType = self::contentTypes['pixE2eidDevolucaoIdGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Devolucao';
        $request = $this->pixE2eidDevolucaoIdGetRequest($e2eid, $id, $contentType);
     ...
     */
    public function pixE2eidDevolucaoIdGetRequest($e2eid, $id, string $contentType = self::contentTypes['pixE2eidDevolucaoIdGet'][0])
    {
        ...
        if (strlen($e2eid) > 32) {
            throw new \InvalidArgumentException('invalid length for "$e2eid" when calling PixApi.pixE2eidDevolucaoIdGet, must be smaller than or equal to 32.');
        }
        if (strlen($e2eid) < 32) {
            throw new \InvalidArgumentException('invalid length for "$e2eid" when calling PixApi.pixE2eidDevolucaoIdGet, must be bigger than or equal to 32.');
        }
        if (!preg_match("/[a-zA-Z0-9]{32}/", $e2eid)) {
            throw new \InvalidArgumentException("invalid value for \"e2eid\" when calling PixApi.pixE2eidDevolucaoIdGet, must conform to the pattern /[a-zA-Z0-9]{32}/.");
        }
        ...
        if (!preg_match("/[a-zA-Z0-9]{1,35}/", $id)) {
            throw new \InvalidArgumentException("invalid value for \"id\" when calling PixApi.pixE2eidDevolucaoIdGet, must conform to the pattern /[a-zA-Z0-9]{1,35}/.");
        }
     ...
     * @param  string $e2eid e2eid (required)
     * @param  string $id id (required)
     * @param  \OpenAPI\Client\Model\DevolucaoSolicitada $devolucao_solicitada Dados para pedido de devolução. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pixE2eidDevolucaoIdPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Devolucao|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function pixE2eidDevolucaoIdPut($e2eid, $id, $devolucao_solicitada, string $contentType = self::contentTypes['pixE2eidDevolucaoIdPut'][0])
    {
        list($response) = $this->pixE2eidDevolucaoIdPutWithHttpInfo($e2eid, $id, $devolucao_solicitada, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Devolucao|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function pixE2eidDevolucaoIdPutWithHttpInfo($e2eid, $id, $devolucao_solicitada, string $contentType = self::contentTypes['pixE2eidDevolucaoIdPut'][0])
    {
        $request = $this->pixE2eidDevolucaoIdPutRequest($e2eid, $id, $devolucao_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pixE2eidDevolucaoIdPutAsync($e2eid, $id, $devolucao_solicitada, string $contentType = self::contentTypes['pixE2eidDevolucaoIdPut'][0])
    {
        return $this->pixE2eidDevolucaoIdPutAsyncWithHttpInfo($e2eid, $id, $devolucao_solicitada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pixE2eidDevolucaoIdPutAsyncWithHttpInfo($e2eid, $id, $devolucao_solicitada, string $contentType = self::contentTypes['pixE2eidDevolucaoIdPut'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Devolucao';
        $request = $this->pixE2eidDevolucaoIdPutRequest($e2eid, $id, $devolucao_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pixE2eidDevolucaoIdPutRequest($e2eid, $id, $devolucao_solicitada, string $contentType = self::contentTypes['pixE2eidDevolucaoIdPut'][0])
    {
        ...
        if (strlen($e2eid) > 32) {
            throw new \InvalidArgumentException('invalid length for "$e2eid" when calling PixApi.pixE2eidDevolucaoIdPut, must be smaller than or equal to 32.');
        }
        if (strlen($e2eid) < 32) {
            throw new \InvalidArgumentException('invalid length for "$e2eid" when calling PixApi.pixE2eidDevolucaoIdPut, must be bigger than or equal to 32.');
        }
        if (!preg_match("/[a-zA-Z0-9]{32}/", $e2eid)) {
            throw new \InvalidArgumentException("invalid value for \"e2eid\" when calling PixApi.pixE2eidDevolucaoIdPut, must conform to the pattern /[a-zA-Z0-9]{32}/.");
        }
        ...
        if (!preg_match("/[a-zA-Z0-9]{1,35}/", $id)) {
            throw new \InvalidArgumentException("invalid value for \"id\" when calling PixApi.pixE2eidDevolucaoIdPut, must conform to the pattern /[a-zA-Z0-9]{1,35}/.");
        }
        
        // verify the required parameter 'devolucao_solicitada' is set
        if ($devolucao_solicitada === null || (is_array($devolucao_solicitada) && count($devolucao_solicitada) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $devolucao_solicitada when calling pixE2eidDevolucaoIdPut'
            );
        }
        ...
        // for model (json/xml)
        if (isset($devolucao_solicitada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($devolucao_solicitada));
            } else {
                $httpBody = $devolucao_solicitada;
            }
     ...
     *
     * @param  string $e2eid e2eid (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pixE2eidGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Pix|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function pixE2eidGet($e2eid, string $contentType = self::contentTypes['pixE2eidGet'][0])
    {
        list($response) = $this->pixE2eidGetWithHttpInfo($e2eid, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Pix|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function pixE2eidGetWithHttpInfo($e2eid, string $contentType = self::contentTypes['pixE2eidGet'][0])
    {
        $request = $this->pixE2eidGetRequest($e2eid, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pixE2eidGetAsync($e2eid, string $contentType = self::contentTypes['pixE2eidGet'][0])
    {
        return $this->pixE2eidGetAsyncWithHttpInfo($e2eid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pixE2eidGetAsyncWithHttpInfo($e2eid, string $contentType = self::contentTypes['pixE2eidGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Pix';
        $request = $this->pixE2eidGetRequest($e2eid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pixE2eidGetRequest($e2eid, string $contentType = self::contentTypes['pixE2eidGet'][0])
    {
        ...
        if (strlen($e2eid) > 32) {
            throw new \InvalidArgumentException('invalid length for "$e2eid" when calling PixApi.pixE2eidGet, must be smaller than or equal to 32.');
        }
        if (strlen($e2eid) < 32) {
            throw new \InvalidArgumentException('invalid length for "$e2eid" when calling PixApi.pixE2eidGet, must be bigger than or equal to 32.');
        }
        if (!preg_match("/[a-zA-Z0-9]{32}/", $e2eid)) {
            throw new \InvalidArgumentException("invalid value for \"e2eid\" when calling PixApi.pixE2eidGet, must conform to the pattern /[a-zA-Z0-9]{32}/.");
        }
     ...
     * @param  string|null $txid txid (optional)
     * @param  bool|null $tx_id_presente tx_id_presente (optional)
     * @param  bool|null $devolucao_presente devolucao_presente (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pixGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PixConsultados|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function pixGet($inicio, $fim, $txid = null, $tx_id_presente = null, $devolucao_presente = null, $cpf = null, $cnpj = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['pixGet'][0])
    {
        list($response) = $this->pixGetWithHttpInfo($inicio, $fim, $txid, $tx_id_presente, $devolucao_presente, $cpf, $cnpj, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
        return $response;
    }
     ...
     * @param  string|null $txid (optional)
     * @param  bool|null $tx_id_presente (optional)
     * @param  bool|null $devolucao_presente (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PixConsultados|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function pixGetWithHttpInfo($inicio, $fim, $txid = null, $tx_id_presente = null, $devolucao_presente = null, $cpf = null, $cnpj = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['pixGet'][0])
    {
        $request = $this->pixGetRequest($inicio, $fim, $txid, $tx_id_presente, $devolucao_presente, $cpf, $cnpj, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\PixConsultados',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pixGetAsync($inicio, $fim, $txid = null, $tx_id_presente = null, $devolucao_presente = null, $cpf = null, $cnpj = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['pixGet'][0])
    {
        return $this->pixGetAsyncWithHttpInfo($inicio, $fim, $txid, $tx_id_presente, $devolucao_presente, $cpf, $cnpj, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pixGetAsyncWithHttpInfo($inicio, $fim, $txid = null, $tx_id_presente = null, $devolucao_presente = null, $cpf = null, $cnpj = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['pixGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\PixConsultados';
        $request = $this->pixGetRequest($inicio, $fim, $txid, $tx_id_presente, $devolucao_presente, $cpf, $cnpj, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pixGetRequest($inicio, $fim, $txid = null, $tx_id_presente = null, $devolucao_presente = null, $cpf = null, $cnpj = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['pixGet'][0])
    {
        ...
        if ($cpf !== null && !preg_match("/^\\d{11}$/", $cpf)) {
            throw new \InvalidArgumentException("invalid value for \"cpf\" when calling PixApi.pixGet, must conform to the pattern /^\\d{11}$/.");
        }
        
        if ($cnpj !== null && !preg_match("/^[0-9A-Z]{14}$/", $cnpj)) {
            throw new \InvalidArgumentException("invalid value for \"cnpj\" when calling PixApi.pixGet, must conform to the pattern /^[0-9A-Z]{14}$/.");
        }
        
        if ($paginacao_pagina_atual !== null && $paginacao_pagina_atual < 0) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_pagina_atual" when calling PixApi.pixGet, must be bigger than or equal to 0.');
        }
        
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina > 1000) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling PixApi.pixGet, must be smaller than or equal to 1000.');
        }
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling PixApi.pixGet, must be bigger than or equal to 1.');
        }
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $devolucao_presente,
            'devolucaoPresente', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required

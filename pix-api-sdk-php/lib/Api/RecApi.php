...
class RecApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RecsConsultadas|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function recGet($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $convenio = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['recGet'][0])
    {
        list($response) = $this->recGetWithHttpInfo($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $convenio, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
        return $response;
    }

    /**
     * Operation recGetWithHttpInfo
     *
     * Consultar lista de recorrências.
     *
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RecsConsultadas|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function recGetWithHttpInfo($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $convenio = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['recGet'][0])
    {
        $request = $this->recGetRequest($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $convenio, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\RecsConsultadas',
                        $request,
                        $response,
                    );
                case 403:
     ...
     */
    public function recGetAsync($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $convenio = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['recGet'][0])
    {
        return $this->recGetAsyncWithHttpInfo($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $convenio, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation recGetAsyncWithHttpInfo
     *
     * Consultar lista de recorrências.
     *
     * @param  \DateTime $inicio (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recGetAsyncWithHttpInfo($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $convenio = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['recGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\RecsConsultadas';
        $request = $this->recGetRequest($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $convenio, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
    ...
    /**
     * Create request for operation 'recGet'
     *
     * @param  \DateTime $inicio (required)
     * @param  \DateTime $fim (required)
     * @param  string|null $cpf (optional)
     ...
     */
    public function recGetRequest($inicio, $fim, $cpf = null, $cnpj = null, $location_presente = null, $status = null, $convenio = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['recGet'][0])
    {

        // verify the required parameter 'inicio' is set
        if ($inicio === null || (is_array($inicio) && count($inicio) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inicio when calling recGet'
            );
        }
        ...
        if ($fim === null || (is_array($fim) && count($fim) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fim when calling recGet'
            );
        }

        if ($cpf !== null && !preg_match("/^\\d{11}$/", $cpf)) {
            throw new \InvalidArgumentException("invalid value for \"cpf\" when calling RecApi.recGet, must conform to the pattern /^\\d{11}$/.");
        }
        
        if ($cnpj !== null && !preg_match("/^[0-9A-Z]{14}$/", $cnpj)) {
            throw new \InvalidArgumentException("invalid value for \"cnpj\" when calling RecApi.recGet, must conform to the pattern /^[0-9A-Z]{14}$/.");
        }
        


        if ($convenio !== null && strlen($convenio) > 60) {
            throw new \InvalidArgumentException('invalid length for "$convenio" when calling RecApi.recGet, must be smaller than or equal to 60.');
        }
        
        if ($paginacao_pagina_atual !== null && $paginacao_pagina_atual < 0) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_pagina_atual" when calling RecApi.recGet, must be bigger than or equal to 0.');
        }
        
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina > 1000) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling RecApi.recGet, must be smaller than or equal to 1000.');
        }
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling RecApi.recGet, must be bigger than or equal to 1.');
        }
    ...
    /**
     * Operation recIdRecGet
     *
     * Consultar recorrência.
     *
     * @param  string $id_rec id_rec (required)
     * @param  string|null $txid txid (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recIdRecGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RecCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function recIdRecGet($id_rec, $txid = null, string $contentType = self::contentTypes['recIdRecGet'][0])
    {
        list($response) = $this->recIdRecGetWithHttpInfo($id_rec, $txid, $contentType);
        return $response;
    }

    /**
     * Operation recIdRecGetWithHttpInfo
     *
     * Consultar recorrência.
     *
     * @param  string $id_rec (required)
     * @param  string|null $txid (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recIdRecGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RecCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function recIdRecGetWithHttpInfo($id_rec, $txid = null, string $contentType = self::contentTypes['recIdRecGet'][0])
    {
        $request = $this->recIdRecGetRequest($id_rec, $txid, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\RecCompleta',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recIdRecGetAsync($id_rec, $txid = null, string $contentType = self::contentTypes['recIdRecGet'][0])
    {
        return $this->recIdRecGetAsyncWithHttpInfo($id_rec, $txid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation recIdRecGetAsyncWithHttpInfo
     *
     * Consultar recorrência.
     *
     * @param  string $id_rec (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recIdRecGetAsyncWithHttpInfo($id_rec, $txid = null, string $contentType = self::contentTypes['recIdRecGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\RecCompleta';
        $request = $this->recIdRecGetRequest($id_rec, $txid, $contentType);
    ...
    /**
     * Create request for operation 'recIdRecGet'
     *
     * @param  string $id_rec (required)
     * @param  string|null $txid (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recIdRecGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function recIdRecGetRequest($id_rec, $txid = null, string $contentType = self::contentTypes['recIdRecGet'][0])
    {

        // verify the required parameter 'id_rec' is set
        if ($id_rec === null || (is_array($id_rec) && count($id_rec) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id_rec when calling recIdRecGet'
            );
        }



        $resourcePath = '/rec/{idRec}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($id_rec !== null) {
            $resourcePath = str_replace(
                '{' . 'idRec' . '}',
                ObjectSerializer::toPathValue($id_rec),
                $resourcePath
            );
        }
    ...
    /**
     * Operation recIdRecPatch
     *
     * Revisar recorrência.
     *
     * @param  string $id_rec id_rec (required)
     * @param  \OpenAPI\Client\Model\RecRevisada|null $rec_revisada Dados para revisão da recorrência. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recIdRecPatch'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RecGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function recIdRecPatch($id_rec, $rec_revisada = null, string $contentType = self::contentTypes['recIdRecPatch'][0])
    {
        list($response) = $this->recIdRecPatchWithHttpInfo($id_rec, $rec_revisada, $contentType);
        return $response;
    }

    /**
     * Operation recIdRecPatchWithHttpInfo
     *
     * Revisar recorrência.
     *
     * @param  string $id_rec (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RecGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function recIdRecPatchWithHttpInfo($id_rec, $rec_revisada = null, string $contentType = self::contentTypes['recIdRecPatch'][0])
    {
        $request = $this->recIdRecPatchRequest($id_rec, $rec_revisada, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\RecGerada',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recIdRecPatchAsync($id_rec, $rec_revisada = null, string $contentType = self::contentTypes['recIdRecPatch'][0])
    {
        return $this->recIdRecPatchAsyncWithHttpInfo($id_rec, $rec_revisada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation recIdRecPatchAsyncWithHttpInfo
     *
     * Revisar recorrência.
     *
     * @param  string $id_rec (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recIdRecPatchAsyncWithHttpInfo($id_rec, $rec_revisada = null, string $contentType = self::contentTypes['recIdRecPatch'][0])
    {
        $returnType = '\OpenAPI\Client\Model\RecGerada';
        $request = $this->recIdRecPatchRequest($id_rec, $rec_revisada, $contentType);
    ...
    /**
     * Create request for operation 'recIdRecPatch'
     *
     * @param  string $id_rec (required)
     * @param  \OpenAPI\Client\Model\RecRevisada|null $rec_revisada Dados para revisão da recorrência. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recIdRecPatch'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function recIdRecPatchRequest($id_rec, $rec_revisada = null, string $contentType = self::contentTypes['recIdRecPatch'][0])
    {

        // verify the required parameter 'id_rec' is set
        if ($id_rec === null || (is_array($id_rec) && count($id_rec) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id_rec when calling recIdRecPatch'
            );
        }
        ...
        // for model (json/xml)
        if (isset($rec_revisada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($rec_revisada));
            } else {
                $httpBody = $rec_revisada;
            }
     ...
     * Criar recorrência.
     *
     * @param  \OpenAPI\Client\Model\RecSolicitada|null $rec_solicitada Dados para geração da recorrência. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RecGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function recPost($rec_solicitada = null, string $contentType = self::contentTypes['recPost'][0])
    {
        list($response) = $this->recPostWithHttpInfo($rec_solicitada, $contentType);
        return $response;
    }

    /**
     * Operation recPostWithHttpInfo
     *
     * Criar recorrência.
     *
     * @param  \OpenAPI\Client\Model\RecSolicitada|null $rec_solicitada Dados para geração da recorrência. (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RecGerada|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function recPostWithHttpInfo($rec_solicitada = null, string $contentType = self::contentTypes['recPost'][0])
    {
        $request = $this->recPostRequest($rec_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recPostAsync($rec_solicitada = null, string $contentType = self::contentTypes['recPost'][0])
    {
        return $this->recPostAsyncWithHttpInfo($rec_solicitada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation recPostAsyncWithHttpInfo
     *
     * Criar recorrência.
     *
     * @param  \OpenAPI\Client\Model\RecSolicitada|null $rec_solicitada Dados para geração da recorrência. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recPostAsyncWithHttpInfo($rec_solicitada = null, string $contentType = self::contentTypes['recPost'][0])
    {
        $returnType = '\OpenAPI\Client\Model\RecGerada';
        $request = $this->recPostRequest($rec_solicitada, $contentType);
    ...
    /**
     * Create request for operation 'recPost'
     *
     * @param  \OpenAPI\Client\Model\RecSolicitada|null $rec_solicitada Dados para geração da recorrência. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['recPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function recPostRequest($rec_solicitada = null, string $contentType = self::contentTypes['recPost'][0])
    {
        ...
        // for model (json/xml)
        if (isset($rec_solicitada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($rec_solicitada));
            } else {
                $httpBody = $rec_solicitada;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

...
class CobPayloadApi
{
    ...
    /**
     * Operation cobvPixUrlAccessTokenGet
     *
     ...
     *
     * @param  string $pix_url_access_token pix_url_access_token (required)
     * @param  string|null $cod_mun Código baseado na Tabela de Códigos de Municípios do __[IBGE](https://www.ibge.gov.br/explica/codigos-dos-municipios.php)__ que apresenta a lista dos municípios brasileiros associados a um código composto de 7 dígitos, sendo os dois primeiros referentes ao código da Unidade da Federação. (optional)
     * @param  \DateTime|null $dpp Data de pagamento pretendida. Trata-se de uma data, no formato &#x60;YYYY-MM-DD&#x60;, segundo ISO 8601. (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cobvPixUrlAccessTokenGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobVPayload|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function cobvPixUrlAccessTokenGet($pix_url_access_token, $cod_mun = null, $dpp = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['cobvPixUrlAccessTokenGet'][0])
    {
        list($response) = $this->cobvPixUrlAccessTokenGetWithHttpInfo($pix_url_access_token, $cod_mun, $dpp, $hostIndex, $variables, $contentType);
        return $response;
    }

    /**
     * Operation cobvPixUrlAccessTokenGetWithHttpInfo
     *
     * Recuperar o payload JSON que representa a cobrança com vencimento.
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     *    - fdqnPSPRecebedor: Endpoint base para que os usuários devedores possam acessar o payload JSON que representa a cobrança com vencimento.
     *
     * @param  string $pix_url_access_token (required)
     * @param  string|null $cod_mun Código baseado na Tabela de Códigos de Municípios do __[IBGE](https://www.ibge.gov.br/explica/codigos-dos-municipios.php)__ que apresenta a lista dos municípios brasileiros associados a um código composto de 7 dígitos, sendo os dois primeiros referentes ao código da Unidade da Federação. (optional)
     * @param  \DateTime|null $dpp Data de pagamento pretendida. Trata-se de uma data, no formato &#x60;YYYY-MM-DD&#x60;, segundo ISO 8601. (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobVPayload|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function cobvPixUrlAccessTokenGetWithHttpInfo($pix_url_access_token, $cod_mun = null, $dpp = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['cobvPixUrlAccessTokenGet'][0])
    {
        $request = $this->cobvPixUrlAccessTokenGetRequest($pix_url_access_token, $cod_mun, $dpp, $hostIndex, $variables, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobVPayload',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation cobvPixUrlAccessTokenGetAsync
     *
     * Recuperar o payload JSON que representa a cobrança com vencimento.
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     */
    public function cobvPixUrlAccessTokenGetAsync($pix_url_access_token, $cod_mun = null, $dpp = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['cobvPixUrlAccessTokenGet'][0])
    {
        return $this->cobvPixUrlAccessTokenGetAsyncWithHttpInfo($pix_url_access_token, $cod_mun, $dpp, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cobvPixUrlAccessTokenGetAsyncWithHttpInfo
     *
     * Recuperar o payload JSON que representa a cobrança com vencimento.
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cobvPixUrlAccessTokenGetAsyncWithHttpInfo($pix_url_access_token, $cod_mun = null, $dpp = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['cobvPixUrlAccessTokenGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobVPayload';
        $request = $this->cobvPixUrlAccessTokenGetRequest($pix_url_access_token, $cod_mun, $dpp, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'cobvPixUrlAccessTokenGet'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://{fdqnPSPRecebedor}/{endpointOpcional}
    ...
    *    - fdqnPSPRecebedor: Endpoint base para que os usuários devedores possam acessar o payload JSON que representa a cobrança com vencimento.
     ...
     */
    public function cobvPixUrlAccessTokenGetRequest($pix_url_access_token, $cod_mun = null, $dpp = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['cobvPixUrlAccessTokenGet'][0])
    {

        // verify the required parameter 'pix_url_access_token' is set
        if ($pix_url_access_token === null || (is_array($pix_url_access_token) && count($pix_url_access_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pix_url_access_token when calling cobvPixUrlAccessTokenGet'
            );
        }

        if ($cod_mun !== null && !preg_match("/^\\d{7}$/", $cod_mun)) {
            throw new \InvalidArgumentException("invalid value for \"cod_mun\" when calling CobPayloadApi.cobvPixUrlAccessTokenGet, must conform to the pattern /^\\d{7}$/.");
        }
        


        $resourcePath = '/cobv/{pixUrlAccessToken}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($pix_url_access_token !== null) {
            $resourcePath = str_replace(
                '{' . 'pixUrlAccessToken' . '}',
                ObjectSerializer::toPathValue($pix_url_access_token),
                $resourcePath
            );
        }
        ...
        $hostSettings = $this->getHostSettingsForcobvPixUrlAccessTokenGet();
    ...
    /**
     * Returns an array of host settings for Operation cobvPixUrlAccessTokenGet
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForcobvPixUrlAccessTokenGet(): array
    {
        return [
            [
                "url" => "https://{fdqnPSPRecebedor}/{endpointOpcional}",
    ...
    /**
     * Operation pixUrlAccessTokenGet
     *
     ...
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pixUrlAccessTokenGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CobPayload|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function pixUrlAccessTokenGet($pix_url_access_token, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['pixUrlAccessTokenGet'][0])
    {
        list($response) = $this->pixUrlAccessTokenGetWithHttpInfo($pix_url_access_token, $hostIndex, $variables, $contentType);
        return $response;
    }

    /**
     * Operation pixUrlAccessTokenGetWithHttpInfo
     *
     * Recuperar o payload JSON que representa a cobrança imediata.
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CobPayload|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function pixUrlAccessTokenGetWithHttpInfo($pix_url_access_token, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['pixUrlAccessTokenGet'][0])
    {
        $request = $this->pixUrlAccessTokenGetRequest($pix_url_access_token, $hostIndex, $variables, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\CobPayload',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation pixUrlAccessTokenGetAsync
     *
     * Recuperar o payload JSON que representa a cobrança imediata.
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pixUrlAccessTokenGetAsync($pix_url_access_token, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['pixUrlAccessTokenGet'][0])
    {
        return $this->pixUrlAccessTokenGetAsyncWithHttpInfo($pix_url_access_token, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation pixUrlAccessTokenGetAsyncWithHttpInfo
     *
     * Recuperar o payload JSON que representa a cobrança imediata.
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pixUrlAccessTokenGetAsyncWithHttpInfo($pix_url_access_token, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['pixUrlAccessTokenGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CobPayload';
        $request = $this->pixUrlAccessTokenGetRequest($pix_url_access_token, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'pixUrlAccessTokenGet'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://{fdqnPSPRecebedor}/{endpointOpcional}
    ...
    *    - fdqnPSPRecebedor: Endpoint base para que os usuários devedores possam acessar o payload JSON que representa a cobrança imediata.
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pixUrlAccessTokenGetRequest($pix_url_access_token, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['pixUrlAccessTokenGet'][0])
    {

        // verify the required parameter 'pix_url_access_token' is set
        if ($pix_url_access_token === null || (is_array($pix_url_access_token) && count($pix_url_access_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pix_url_access_token when calling pixUrlAccessTokenGet'
            );
        }


        $resourcePath = '/{pixUrlAccessToken}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $hostSettings = $this->getHostSettingsForpixUrlAccessTokenGet();
    ...
    /**
     * Returns an array of host settings for Operation pixUrlAccessTokenGet
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForpixUrlAccessTokenGet(): array
    {
        return [
            [
                "url" => "https://{fdqnPSPRecebedor}/{endpointOpcional}",

...
class PayloadLocationApi
{
     ...
     * @param  string|null $tipo_cob tipo_cob (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PayloadLocationConsultadas|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function locGet($inicio, $fim, $tx_id_presente = null, $tipo_cob = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['locGet'][0])
    {
        list($response) = $this->locGetWithHttpInfo($inicio, $fim, $tx_id_presente, $tipo_cob, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
        return $response;
    }
     ...
     * @param  string|null $tipo_cob (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PayloadLocationConsultadas|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function locGetWithHttpInfo($inicio, $fim, $tx_id_presente = null, $tipo_cob = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['locGet'][0])
    {
        $request = $this->locGetRequest($inicio, $fim, $tx_id_presente, $tipo_cob, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\PayloadLocationConsultadas',
                        $request,
                        $response,
                    );
                case 403:
     ...
     */
    public function locGetAsync($inicio, $fim, $tx_id_presente = null, $tipo_cob = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['locGet'][0])
    {
        return $this->locGetAsyncWithHttpInfo($inicio, $fim, $tx_id_presente, $tipo_cob, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locGetAsyncWithHttpInfo($inicio, $fim, $tx_id_presente = null, $tipo_cob = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['locGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\PayloadLocationConsultadas';
        $request = $this->locGetRequest($inicio, $fim, $tx_id_presente, $tipo_cob, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $contentType);
     ...
     */
    public function locGetRequest($inicio, $fim, $tx_id_presente = null, $tipo_cob = null, $paginacao_pagina_atual = 0, $paginacao_itens_por_pagina = 100, string $contentType = self::contentTypes['locGet'][0])
    {
        ...
        if ($paginacao_pagina_atual !== null && $paginacao_pagina_atual < 0) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_pagina_atual" when calling PayloadLocationApi.locGet, must be bigger than or equal to 0.');
        }
        
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina > 1000) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling PayloadLocationApi.locGet, must be smaller than or equal to 1000.');
        }
        if ($paginacao_itens_por_pagina !== null && $paginacao_itens_por_pagina < 1) {
            throw new \InvalidArgumentException('invalid value for "$paginacao_itens_por_pagina" when calling PayloadLocationApi.locGet, must be bigger than or equal to 1.');
        }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locIdGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PayloadLocationCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function locIdGet($id, string $contentType = self::contentTypes['locIdGet'][0])
    {
        list($response) = $this->locIdGetWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PayloadLocationCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function locIdGetWithHttpInfo($id, string $contentType = self::contentTypes['locIdGet'][0])
    {
        $request = $this->locIdGetRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\PayloadLocationCompleta',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locIdGetAsync($id, string $contentType = self::contentTypes['locIdGet'][0])
    {
        return $this->locIdGetAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locIdGetAsyncWithHttpInfo($id, string $contentType = self::contentTypes['locIdGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\PayloadLocationCompleta';
        $request = $this->locIdGetRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locIdGetRequest($id, string $contentType = self::contentTypes['locIdGet'][0])
    {
     ...
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locIdTxidDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PayloadLocation|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function locIdTxidDelete($id, string $contentType = self::contentTypes['locIdTxidDelete'][0])
    {
        list($response) = $this->locIdTxidDeleteWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PayloadLocation|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function locIdTxidDeleteWithHttpInfo($id, string $contentType = self::contentTypes['locIdTxidDelete'][0])
    {
        $request = $this->locIdTxidDeleteRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\PayloadLocation',
                        $request,
                        $response,
                    );
                case 403:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locIdTxidDeleteAsync($id, string $contentType = self::contentTypes['locIdTxidDelete'][0])
    {
        return $this->locIdTxidDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locIdTxidDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['locIdTxidDelete'][0])
    {
        $returnType = '\OpenAPI\Client\Model\PayloadLocation';
        $request = $this->locIdTxidDeleteRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locIdTxidDeleteRequest($id, string $contentType = self::contentTypes['locIdTxidDelete'][0])
    {
     ...
     *
     * @param  \OpenAPI\Client\Model\PayloadLocationSolicitada $payload_location_solicitada Dados para geração da location. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PayloadLocation|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function locPost($payload_location_solicitada, string $contentType = self::contentTypes['locPost'][0])
    {
        list($response) = $this->locPostWithHttpInfo($payload_location_solicitada, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\PayloadLocation|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function locPostWithHttpInfo($payload_location_solicitada, string $contentType = self::contentTypes['locPost'][0])
    {
        $request = $this->locPostRequest($payload_location_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locPostAsync($payload_location_solicitada, string $contentType = self::contentTypes['locPost'][0])
    {
        return $this->locPostAsyncWithHttpInfo($payload_location_solicitada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locPostAsyncWithHttpInfo($payload_location_solicitada, string $contentType = self::contentTypes['locPost'][0])
    {
        $returnType = '\OpenAPI\Client\Model\PayloadLocation';
        $request = $this->locPostRequest($payload_location_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locPostRequest($payload_location_solicitada, string $contentType = self::contentTypes['locPost'][0])
    {

        // verify the required parameter 'payload_location_solicitada' is set
        if ($payload_location_solicitada === null || (is_array($payload_location_solicitada) && count($payload_location_solicitada) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payload_location_solicitada when calling locPost'
            );
        }
        ...
        // for model (json/xml)
        if (isset($payload_location_solicitada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($payload_location_solicitada));
            } else {
                $httpBody = $payload_location_solicitada;
            }

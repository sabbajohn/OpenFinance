...
class SolicRecApi
{
    ...
    /**
     * Operation solicrecIdSolicRecGet
     *
     * Consultar solicitação de confirmação de recorrência.
     *
     * @param  string $id_solic_rec id_solic_rec (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['solicrecIdSolicRecGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SolicRecCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function solicrecIdSolicRecGet($id_solic_rec, string $contentType = self::contentTypes['solicrecIdSolicRecGet'][0])
    {
        list($response) = $this->solicrecIdSolicRecGetWithHttpInfo($id_solic_rec, $contentType);
        return $response;
    }

    /**
     * Operation solicrecIdSolicRecGetWithHttpInfo
     *
     * Consultar solicitação de confirmação de recorrência.
     *
     * @param  string $id_solic_rec (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['solicrecIdSolicRecGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SolicRecCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function solicrecIdSolicRecGetWithHttpInfo($id_solic_rec, string $contentType = self::contentTypes['solicrecIdSolicRecGet'][0])
    {
        $request = $this->solicrecIdSolicRecGetRequest($id_solic_rec, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\SolicRecCompleta',
                        $request,
                        $response,
                    );
                case 403:
    ...
    /**
     * Operation solicrecIdSolicRecGetAsync
     *
     * Consultar solicitação de confirmação de recorrência.
     *
     * @param  string $id_solic_rec (required)
     ...
     */
    public function solicrecIdSolicRecGetAsync($id_solic_rec, string $contentType = self::contentTypes['solicrecIdSolicRecGet'][0])
    {
        return $this->solicrecIdSolicRecGetAsyncWithHttpInfo($id_solic_rec, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation solicrecIdSolicRecGetAsyncWithHttpInfo
     *
     * Consultar solicitação de confirmação de recorrência.
     *
     * @param  string $id_solic_rec (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solicrecIdSolicRecGetAsyncWithHttpInfo($id_solic_rec, string $contentType = self::contentTypes['solicrecIdSolicRecGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SolicRecCompleta';
        $request = $this->solicrecIdSolicRecGetRequest($id_solic_rec, $contentType);
    ...
    /**
     * Create request for operation 'solicrecIdSolicRecGet'
     *
     * @param  string $id_solic_rec (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['solicrecIdSolicRecGet'] to see the possible values for this operation
     *
     ...
     */
    public function solicrecIdSolicRecGetRequest($id_solic_rec, string $contentType = self::contentTypes['solicrecIdSolicRecGet'][0])
    {

        // verify the required parameter 'id_solic_rec' is set
        if ($id_solic_rec === null || (is_array($id_solic_rec) && count($id_solic_rec) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id_solic_rec when calling solicrecIdSolicRecGet'
            );
        }


        $resourcePath = '/solicrec/{idSolicRec}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($id_solic_rec !== null) {
            $resourcePath = str_replace(
                '{' . 'idSolicRec' . '}',
                ObjectSerializer::toPathValue($id_solic_rec),
                $resourcePath
            );
        }
    ...
    /**
     * Operation solicrecIdSolicRecPatch
     *
     * Revisar solicitação de confirmação de recorrência.
     *
     * @param  string $id_solic_rec id_solic_rec (required)
     * @param  \OpenAPI\Client\Model\SolicRecRevisada|null $solic_rec_revisada Dados para revisão da solicitação da recorrência. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['solicrecIdSolicRecPatch'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SolicRecCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function solicrecIdSolicRecPatch($id_solic_rec, $solic_rec_revisada = null, string $contentType = self::contentTypes['solicrecIdSolicRecPatch'][0])
    {
        list($response) = $this->solicrecIdSolicRecPatchWithHttpInfo($id_solic_rec, $solic_rec_revisada, $contentType);
        return $response;
    }

    /**
     * Operation solicrecIdSolicRecPatchWithHttpInfo
     *
     * Revisar solicitação de confirmação de recorrência.
     *
     * @param  string $id_solic_rec (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SolicRecCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function solicrecIdSolicRecPatchWithHttpInfo($id_solic_rec, $solic_rec_revisada = null, string $contentType = self::contentTypes['solicrecIdSolicRecPatch'][0])
    {
        $request = $this->solicrecIdSolicRecPatchRequest($id_solic_rec, $solic_rec_revisada, $contentType);
    ...
    /**
     * Operation solicrecIdSolicRecPatchAsync
     *
     * Revisar solicitação de confirmação de recorrência.
     *
     * @param  string $id_solic_rec (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solicrecIdSolicRecPatchAsync($id_solic_rec, $solic_rec_revisada = null, string $contentType = self::contentTypes['solicrecIdSolicRecPatch'][0])
    {
        return $this->solicrecIdSolicRecPatchAsyncWithHttpInfo($id_solic_rec, $solic_rec_revisada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation solicrecIdSolicRecPatchAsyncWithHttpInfo
     *
     * Revisar solicitação de confirmação de recorrência.
     *
     * @param  string $id_solic_rec (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solicrecIdSolicRecPatchAsyncWithHttpInfo($id_solic_rec, $solic_rec_revisada = null, string $contentType = self::contentTypes['solicrecIdSolicRecPatch'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SolicRecCompleta';
        $request = $this->solicrecIdSolicRecPatchRequest($id_solic_rec, $solic_rec_revisada, $contentType);
    ...
    /**
     * Create request for operation 'solicrecIdSolicRecPatch'
     *
     * @param  string $id_solic_rec (required)
     * @param  \OpenAPI\Client\Model\SolicRecRevisada|null $solic_rec_revisada Dados para revisão da solicitação da recorrência. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['solicrecIdSolicRecPatch'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function solicrecIdSolicRecPatchRequest($id_solic_rec, $solic_rec_revisada = null, string $contentType = self::contentTypes['solicrecIdSolicRecPatch'][0])
    {

        // verify the required parameter 'id_solic_rec' is set
        if ($id_solic_rec === null || (is_array($id_solic_rec) && count($id_solic_rec) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id_solic_rec when calling solicrecIdSolicRecPatch'
            );
        }
        ...
        // for model (json/xml)
        if (isset($solic_rec_revisada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($solic_rec_revisada));
            } else {
                $httpBody = $solic_rec_revisada;
            }
    ...
    /**
     * Operation solicrecPost
     *
     * Criar solicitação de confirmação de recorrência.
     *
     * @param  \OpenAPI\Client\Model\SolicRecSolicitada|null $solic_rec_solicitada Dados para geração da solicitação da recorrência. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['solicrecPost'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SolicRecCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema
     */
    public function solicrecPost($solic_rec_solicitada = null, string $contentType = self::contentTypes['solicrecPost'][0])
    {
        list($response) = $this->solicrecPostWithHttpInfo($solic_rec_solicitada, $contentType);
        return $response;
    }

    /**
     * Operation solicrecPostWithHttpInfo
     *
     * Criar solicitação de confirmação de recorrência.
     *
     * @param  \OpenAPI\Client\Model\SolicRecSolicitada|null $solic_rec_solicitada Dados para geração da solicitação da recorrência. (optional)
     ...
     * @return array of \OpenAPI\Client\Model\SolicRecCompleta|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema|\OpenAPI\Client\Model\Problema, HTTP status code, HTTP response headers (array of strings)
     */
    public function solicrecPostWithHttpInfo($solic_rec_solicitada = null, string $contentType = self::contentTypes['solicrecPost'][0])
    {
        $request = $this->solicrecPostRequest($solic_rec_solicitada, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solicrecPostAsync($solic_rec_solicitada = null, string $contentType = self::contentTypes['solicrecPost'][0])
    {
        return $this->solicrecPostAsyncWithHttpInfo($solic_rec_solicitada, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation solicrecPostAsyncWithHttpInfo
     *
     * Criar solicitação de confirmação de recorrência.
     *
     * @param  \OpenAPI\Client\Model\SolicRecSolicitada|null $solic_rec_solicitada Dados para geração da solicitação da recorrência. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solicrecPostAsyncWithHttpInfo($solic_rec_solicitada = null, string $contentType = self::contentTypes['solicrecPost'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SolicRecCompleta';
        $request = $this->solicrecPostRequest($solic_rec_solicitada, $contentType);
    ...
    /**
     * Create request for operation 'solicrecPost'
     *
     * @param  \OpenAPI\Client\Model\SolicRecSolicitada|null $solic_rec_solicitada Dados para geração da solicitação da recorrência. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['solicrecPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function solicrecPostRequest($solic_rec_solicitada = null, string $contentType = self::contentTypes['solicrecPost'][0])
    {



        $resourcePath = '/solicrec';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($solic_rec_solicitada)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($solic_rec_solicitada));
            } else {
                $httpBody = $solic_rec_solicitada;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

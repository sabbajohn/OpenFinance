...
/**
 * InfoBaseAgenciaConta Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InfoBaseAgenciaConta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InfoBaseAgenciaConta';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['agencia'] === null) {
            $invalidProperties[] = "'agencia' can't be null";
        }
        if ((mb_strlen($this->container['agencia']) > 4)) {
     ...
     * Sets agencia
     *
     * @param string $agencia Número da agência do usuário.
     *
     * @return self
     */
    public function setAgencia($agencia)
    {
        ...
        if ((mb_strlen($agencia) > 4)) {
            throw new \InvalidArgumentException('invalid length for $agencia when calling InfoBaseAgenciaConta., must be smaller than or equal to 4.');
        }
     ...
     * Sets conta
     *
     * @param string $conta Número da conta do usuário.
     *
     * @return self
     */
    public function setConta($conta)
    {
        ...
        if ((mb_strlen($conta) > 20)) {
            throw new \InvalidArgumentException('invalid length for $conta when calling InfoBaseAgenciaConta., must be smaller than or equal to 20.');
        }

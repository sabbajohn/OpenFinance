...
/**
 * WebhooksRecConsultados Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhooksRecConsultados implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhooksRecConsultados';
    ...
    protected static $openAPITypes = [
        'parametros' => '\OpenAPI\Client\Model\ParametrosConsultaWebhooks',
        'webhooksrec' => '\OpenAPIClientModelWebhookRecCompleto[]'
    ];
    ...
    {
        $this->setIfExists('parametros', $data ?? [], null);
        $this->setIfExists('webhooksrec', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['webhooksrec'] === null) {
            $invalidProperties[] = "'webhooksrec' can't be null";
        }
     ...
     * Gets parametros
     *
     * @return \OpenAPI\Client\Model\ParametrosConsultaWebhooks|null
     */
     ...
     * Sets parametros
     *
     * @param \OpenAPI\Client\Model\ParametrosConsultaWebhooks|null $parametros parametros
     *
     * @return self
     */
    public function setParametros($parametros)
    {
        if (is_null($parametros)) {
            throw new \InvalidArgumentException('non-nullable parametros cannot be null');
        }
     ...
     * Gets webhooksrec
     *
     * @return \OpenAPIClientModelWebhookRecCompleto[]
     */
    public function getWebhooksrec()
    {
        return $this->container['webhooksrec'];
    }

    /**
     * Sets webhooksrec
     *
     * @param \OpenAPIClientModelWebhookRecCompleto[] $webhooksrec webhooksrec
     *
     * @return self
     */
    public function setWebhooksrec($webhooksrec)
    {
        if (is_null($webhooksrec)) {
            throw new \InvalidArgumentException('non-nullable webhooksrec cannot be null');
        }
        $this->container['webhooksrec'] = $webhooksrec;

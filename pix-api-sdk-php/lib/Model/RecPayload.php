 ...
 */
class RecPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecPayload';
    ...
    protected static $openAPITypes = [
        ...
        'id_rec' => 'string',
        'recebedor' => '\OpenAPI\Client\Model\RecPayloadAllOfRecebedor'
    ];
    ...
    */
    ...
    public function setIdRec($id_rec)
    {
        ...
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling RecPayload., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling RecPayload., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling RecPayload., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }
     ...
     * Gets recebedor
     *
     * @return \OpenAPI\Client\Model\RecPayloadAllOfRecebedor
     */
     ...
     * Sets recebedor
     *
     * @param \OpenAPI\Client\Model\RecPayloadAllOfRecebedor $recebedor recebedor
     *
     * @return self
     */

...
/**
 * InformaEsSobreCalendRioDaRecorrNcia Class Doc Comment
 *
 * @category Class
 ...
 */
class InformaEsSobreCalendRioDaRecorrNcia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_sobre_calend_rio_da_recorr_ncia';
    ...
    */
     ...
     * Sets data_inicial
     *
     * @param \DateTime|null $data_inicial Trata-se de uma data, no formato `YYYY-MM-DD`, segundo ISO 8601. Data estimada de primeiro pagamento.
     *
     * @return self
     */

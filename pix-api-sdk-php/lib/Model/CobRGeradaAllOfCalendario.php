...
/**
 * CobRGeradaAllOfCalendario Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CobRGeradaAllOfCalendario implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobRGerada_allOf_calendario';
    ...
    */
     ...
     * Sets criacao
     *
     * @param \DateTime $criacao Trata-se de uma data, no formato `YYYY-MM-DD`, segundo ISO 8601. É a data de criação da cobrança.
     *
     * @return self
     */

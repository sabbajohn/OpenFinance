...
/**
 * CobBaseCopiaCola Class Doc Comment
 *
 * @category Class
 ...
 */
class CobBaseCopiaCola implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobBaseCopiaCola';
    ...
    */
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CobBaseCopiaCola., must be smaller than or equal to 77.');
        }
    ...
    public function setSolicitacaoPagador($solicitacao_pagador)
    {
        ...
        if ((mb_strlen($solicitacao_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $solicitacao_pagador when calling CobBaseCopiaCola., must be smaller than or equal to 140.');
        }
    ...
    public function setPixCopiaECola($pix_copia_e_cola)
    {
        ...
        if ((mb_strlen($pix_copia_e_cola) > 512)) {
            throw new \InvalidArgumentException('invalid length for $pix_copia_e_cola when calling CobBaseCopiaCola., must be smaller than or equal to 512.');
        }

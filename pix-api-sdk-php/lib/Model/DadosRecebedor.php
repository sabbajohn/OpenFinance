...
/**
 * DadosRecebedor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DadosRecebedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DadosRecebedor';
    ...
    */
     ...
     * Gets recebedor
     *
     * @return \OpenAPI\Client\Model\DadosComplementaresPessoa|null
     */
     ...
     * Sets recebedor
     *
     * @param \OpenAPI\Client\Model\DadosComplementaresPessoa|null $recebedor O objeto recebedor organiza as informações sobre o credor da cobrança.
     *
     * @return self
     */

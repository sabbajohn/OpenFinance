 ...
 */
class CalendRio2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Calend_rio_2';
    ...
    protected static array $openAPINullables = [
        'criacao' => false,
        'apresentacao' => false,
        'data_de_vencimento' => false,
        'validade_apos_vencimento' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('apresentacao', $data ?? [], null);
        $this->setIfExists('data_de_vencimento', $data ?? [], null);
        $this->setIfExists('validade_apos_vencimento', $data ?? [], 30);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['apresentacao'] === null) {
            $invalidProperties[] = "'apresentacao' can't be null";
        }
     ...
     * Sets criacao
     *
     * @param \DateTime $criacao Timestamp que indica o momento em que foi criada a cobrança. Respeita o formato definido na RFC 3339.
     *
     * @return self
     */
    ...
    {
        return $this->container['apresentacao'];
    }

    /**
     * Sets apresentacao
     *
     * @param \DateTime $apresentacao Timestamp que indica o momento em que o payload JSON que representa a cobrança foi recuperado. Ou seja, idealmente, é o momento em que o usuário realizou a captura do QR Code para verificar os dados de pagamento. Respeita o formato definido na RFC 3339.
     *
     * @return self
     */
    public function setApresentacao($apresentacao)
    {
        if (is_null($apresentacao)) {
            throw new \InvalidArgumentException('non-nullable apresentacao cannot be null');
        }
        $this->container['apresentacao'] = $apresentacao;
    ...
    {
        if (is_null($data_de_vencimento)) {
            throw new \InvalidArgumentException('non-nullable data_de_vencimento cannot be null');
        }

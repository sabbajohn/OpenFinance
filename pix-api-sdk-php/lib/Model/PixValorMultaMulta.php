...
/**
 * PixValorMultaMulta Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PixValorMultaMulta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PixValorMulta_multa';
    ...
    */
     ...
     * Sets valor
     *
     * @param string $valor Valor da multa.
     *
     * @return self
     */
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling PixValorMultaMulta., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

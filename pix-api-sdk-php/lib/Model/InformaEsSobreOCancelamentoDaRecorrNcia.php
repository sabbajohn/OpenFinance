<?php
/**
 * InformaEsSobreOCancelamentoDaRecorrNcia
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InformaEsSobreOCancelamentoDaRecorrNcia Class Doc Comment
 *
 * @category Class
 ...
 */
class InformaEsSobreOCancelamentoDaRecorrNcia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_sobre_o_cancelamento_da_recorr_ncia';
    ...
    public const SOLICITANTE_PSP_PAGADOR = 'PSP_PAGADOR';
    public const SOLICITANTE_USUARIO_PAGADOR = 'USUARIO_PAGADOR';
    public const SOLICITANTE_PSP_RECEBEDOR = 'PSP_RECEBEDOR';
    public const SOLICITANTE_USUARIO_RECEBEDOR = 'USUARIO_RECEBEDOR';
    public const CODIGO_ACCL = 'ACCL';
    public const CODIGO_CPCL = 'CPCL';
    public const CODIGO_DCSD = 'DCSD';
    public const CODIGO_ERSL = 'ERSL';
    public const CODIGO_FRUD = 'FRUD';
    public const CODIGO_PCFD = 'PCFD';
    public const CODIGO_SLCR = 'SLCR';
    public const CODIGO_SLDB = 'SLDB';
     ...
     * @return string[]
     */
    public function getSolicitanteAllowableValues()
    {
        return [
            self::SOLICITANTE_PSP_PAGADOR,
            self::SOLICITANTE_USUARIO_PAGADOR,
            self::SOLICITANTE_PSP_RECEBEDOR,
            self::SOLICITANTE_USUARIO_RECEBEDOR,
        ];
    }
     ...
     * @return string[]
     */
    public function getCodigoAllowableValues()
    {
        return [
            self::CODIGO_ACCL,
            self::CODIGO_CPCL,
    ...
    {
        $this->setIfExists('solicitante', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['solicitante'] === null) {
            $invalidProperties[] = "'solicitante' can't be null";
        }
        $allowedValues = $this->getSolicitanteAllowableValues();
        if (!is_null($this->container['solicitante']) && !in_array($this->container['solicitante'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'solicitante', must be one of '%s'",
                $this->container['solicitante'],
        ...
        $allowedValues = $this->getCodigoAllowableValues();
        if (!is_null($this->container['codigo']) && !in_array($this->container['codigo'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'codigo', must be one of '%s'",
                $this->container['codigo'],
                implode("', '", $allowedValues)
            );
        }

        if ((mb_strlen($this->container['codigo']) > 4)) {
            $invalidProperties[] = "invalid value for 'codigo', the character length must be smaller than or equal to 4.";
        }

        if ($this->container['descricao'] === null) {
            $invalidProperties[] = "'descricao' can't be null";
        }
        if ((mb_strlen($this->container['descricao']) > 400)) {
            $invalidProperties[] = "invalid value for 'descricao', the character length must be smaller than or equal to 400.";
        }
    ...
    {
        return $this->container['solicitante'];
    }

    /**
     * Sets solicitante
     *
     * @param string $solicitante solicitante
     *
     * @return self
     */
    public function setSolicitante($solicitante)
    {
        if (is_null($solicitante)) {
            throw new \InvalidArgumentException('non-nullable solicitante cannot be null');
        }
        $allowedValues = $this->getSolicitanteAllowableValues();
        if (!in_array($solicitante, $allowedValues, true)) {
        ...
        $this->container['solicitante'] = $solicitante;
     ...
     * Sets codigo
     *
     * @param string $codigo Código do cancelamento. Corresponde ao código de cancelamento presente no catálogo de mensagens.
     *
     * @return self
     */
    public function setCodigo($codigo)
    {
        ...
        $allowedValues = $this->getCodigoAllowableValues();
        if (!in_array($codigo, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'codigo', must be one of '%s'",
                    $codigo,
        ...
        if ((mb_strlen($codigo) > 4)) {
            throw new \InvalidArgumentException('invalid length for $codigo when calling InformaEsSobreOCancelamentoDaRecorrNcia., must be smaller than or equal to 4.');
        }
     ...
     * Sets descricao
     *
     * @param string $descricao Descricao do cancelamento.
     *
     * @return self
     */
    public function setDescricao($descricao)
    {
        ...
        if ((mb_strlen($descricao) > 400)) {
            throw new \InvalidArgumentException('invalid length for $descricao when calling InformaEsSobreOCancelamentoDaRecorrNcia., must be smaller than or equal to 400.');
        }

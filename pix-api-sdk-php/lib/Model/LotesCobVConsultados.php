 ...
 */
class LotesCobVConsultados implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LotesCobVConsultados';
    ...
    protected static $openAPITypes = [
        'parametros' => '\OpenAPI\Client\Model\ParametrosConsultaLote',
        'lotes' => '\OpenAPIClientModelLoteCobVConsultado[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('lotes', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets parametros
     *
     * @return \OpenAPI\Client\Model\ParametrosConsultaLote
     */
     ...
     * Sets parametros
     *
     * @param \OpenAPI\Client\Model\ParametrosConsultaLote $parametros parametros
     *
     * @return self
     */
     ...
     * Gets lotes
     *
     * @return \OpenAPIClientModelLoteCobVConsultado[]
     */
     ...
     * Sets lotes
     *
     * @param \OpenAPIClientModelLoteCobVConsultado[] $lotes lotes
     *
     * @return self
     */
    ...
    {
        if (is_null($lotes)) {
            throw new \InvalidArgumentException('non-nullable lotes cannot be null');
        }

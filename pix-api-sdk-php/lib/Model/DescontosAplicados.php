...
/**
 * DescontosAplicados Class Doc Comment
 *
 * @category Class
 ...
 */
class DescontosAplicados implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Descontos_aplicados';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['modalidade'] > 6)) {
            $invalidProperties[] = "invalid value for 'modalidade', must be smaller than or equal to 6.";
        }
    ...
    public function setModalidade($modalidade)
    {
        ...
        if (($modalidade > 6)) {
            throw new \InvalidArgumentException('invalid value for $modalidade when calling DescontosAplicados., must be smaller than or equal to 6.');
        }
        if (($modalidade < 1)) {
            throw new \InvalidArgumentException('invalid value for $modalidade when calling DescontosAplicados., must be bigger than or equal to 1.');
        }

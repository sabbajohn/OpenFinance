...
/**
 * MultaAplicada Class Doc Comment
 *
 * @category Class
 ...
 */
class MultaAplicada implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Multa_aplicada';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('valor_perc', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['modalidade'] > 2)) {
            $invalidProperties[] = "invalid value for 'modalidade', must be smaller than or equal to 2.";
        }

        if (($this->container['modalidade'] < 1)) {
            $invalidProperties[] = "invalid value for 'modalidade', must be bigger than or equal to 1.";
        }

        if ($this->container['valor_perc'] === null) {
            $invalidProperties[] = "'valor_perc' can't be null";
        }
        if (!preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['valor_perc'])) {
            $invalidProperties[] = "invalid value for 'valor_perc', must be conform to the pattern /\\d{1,10}\\.\\d{2}/.";
        }
     ...
     * Sets modalidade
     *
     * @param int $modalidade ##### Modalidade da multa, conforme tabela de domínios. <table><tr><th>Descrição</th><th>Domínio</th></tr><tr><td>Valor Fixo</td><td>1</td></tr><tr><td>Percentual</td><td>2</td></tr></table>
     *
     * @return self
     */
    public function setModalidade($modalidade)
    {
        ...
        if (($modalidade > 2)) {
            throw new \InvalidArgumentException('invalid value for $modalidade when calling MultaAplicada., must be smaller than or equal to 2.');
        }
        if (($modalidade < 1)) {
            throw new \InvalidArgumentException('invalid value for $modalidade when calling MultaAplicada., must be bigger than or equal to 1.');
        }
     ...
     * Sets valor_perc
     *
     * @param string $valor_perc Multa do documento em valor absoluto ou percentual, conforme \"valor.multa.modalidade\".
     *
     * @return self
     */
    public function setValorPerc($valor_perc)
    {
        if (is_null($valor_perc)) {
            throw new \InvalidArgumentException('non-nullable valor_perc cannot be null');
        }

        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor_perc)))) {
            throw new \InvalidArgumentException("invalid value for \$valor_perc when calling MultaAplicada., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

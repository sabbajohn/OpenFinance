...
/**
 * WebhookCobRCompleto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookCobRCompleto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookCobRCompleto';
    ...
    */
     ...
     * Sets criacao
     *
     * @param \DateTime|null $criacao Data e hora em que o webhook foi cadastrado. Respeita RFC 3339.
     *
     * @return self
     */

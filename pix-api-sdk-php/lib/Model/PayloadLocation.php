...
/**
 * PayloadLocation Class Doc Comment
 *
 * @category Class
 ...
 */
class PayloadLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayloadLocation';
    ...
    */
    ...
    public function setLocation($location)
    {
        ...
        if ((mb_strlen($location) > 77)) {
            throw new \InvalidArgumentException('invalid length for $location when calling PayloadLocation., must be smaller than or equal to 77.');
        }

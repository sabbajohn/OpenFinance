 ...
 */
class SolicRecId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SolicRecId';
    ...
    */
    ...
    public function setIdSolicRec($id_solic_rec)
    {
        ...
        if ((mb_strlen($id_solic_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_solic_rec when calling SolicRecId., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_solic_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_solic_rec when calling SolicRecId., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_solic_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_solic_rec when calling SolicRecId., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }

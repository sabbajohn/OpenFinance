...
/**
 * InformaEsDoQRComposto Class Doc Comment
 *
 * @category Class
 * @description ##### Informações relacionadas aos parâmetros &#x60;idRec&#x60; e &#x60;txid&#x60; informados na requisição. Ao consultar uma recorrência via endpoint GET &#x60;/rec/{idRec}?txid&#x3D;{txid}&#x60;, o usuário recebedor pode optar pela consulta sem  o &#x60;txid&#x60; ou por compor a requisição com um &#x60;txid&#x60; de uma cobrança imediata, ou cobrança com vencimento, de forma a obter o QR Composto para a jornada de interesse.  Os &#x60;dadosQR&#x60; retornados variam de acordo com a jornada desejada, indicada pela presença dos parâmetros de interesse, conforme a tabela abaixo: &lt;table  &gt; &lt;tr&gt;&lt;td width&#x3D;\&quot;15%\&quot;&gt;idRec&lt;/td&gt;&lt;td  width&#x3D;\&quot;15%\&quot;&gt;txid de Cob&lt;/td&gt;&lt;td  width&#x3D;\&quot;15%\&quot;&gt;txid de CobV&lt;/td&gt;&lt;td width&#x3D;\&quot;100%\&quot;&gt;Conteúdo esperado&lt;/td&gt;&lt;/tr&gt; &lt;tr&gt;&lt;td&gt;X&lt;/td&gt;&lt;td&gt;-&lt;/td&gt;&lt;td&gt;-&lt;/td&gt;&lt;td&gt;&lt;pre&gt;{ jornada: \&quot;JORNADA_2\&quot;, pixCopiaECola: \&quot;QR Composto da recorrência\&quot; }&lt;/pre&gt;&lt;/td&gt;&lt;/tr&gt; &lt;tr&gt;&lt;td&gt;X&lt;/td&gt;&lt;td&gt;X&lt;/td&gt;&lt;td&gt;-&lt;/td&gt;&lt;td&gt;&lt;pre&gt;{ jornada: \&quot;JORNADA_3\&quot;, pixCopiaECola: \&quot;QR Composto da cobrança imediata + recorrência\&quot; }&lt;/pre&gt;&lt;/td&gt;&lt;/tr&gt; &lt;tr&gt;&lt;td&gt;X&lt;/td&gt;&lt;td&gt;-&lt;/td&gt;&lt;td&gt;X&lt;/td&gt;&lt;td&gt;&lt;pre&gt;{ jornada: \&quot;JORNADA_4\&quot;, pixCopiaECola: \&quot;QR Composto da cobrança com vencimento + recorrência\&quot; }&lt;/pre&gt;&lt;/td&gt;&lt;/tr&gt; &lt;/table&gt;  Os campos &#x60;dadosQR.jornada&#x60; e &#x60;dadosQR.pixCopiaECola&#x60; só serão retornados se as respectivas locations necessárias para a construção do QR Composto estiverem preenchidas na recorrência e na eventual cobrança, a depender da jornada desejada.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InformaEsDoQRComposto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_do_QR_Composto_';
    ...
    public const JORNADA_JORNADA_2 = 'JORNADA_2';
    public const JORNADA_JORNADA_3 = 'JORNADA_3';
    public const JORNADA_JORNADA_4 = 'JORNADA_4';
     ...
     * @return string[]
     */
    public function getJornadaAllowableValues()
    {
        return [
            self::JORNADA_JORNADA_2,
            self::JORNADA_JORNADA_3,
            self::JORNADA_JORNADA_4,
        ];
    }
    ...
    {
        $this->setIfExists('jornada', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getJornadaAllowableValues();
        if (!is_null($this->container['jornada']) && !in_array($this->container['jornada'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'jornada', must be one of '%s'",
                $this->container['jornada'],
    ...
    {
        return $this->container['jornada'];
    }

    /**
     * Sets jornada
     *
     * @param string|null $jornada jornada
     *
     * @return self
     */
    ...
    {
        if (is_null($jornada)) {
            throw new \InvalidArgumentException('non-nullable jornada cannot be null');
        }
        $allowedValues = $this->getJornadaAllowableValues();
        if (!in_array($jornada, $allowedValues, true)) {
        ...
        $this->container['jornada'] = $jornada;
     ...
     *
     * @param string|null $pix_copia_e_cola Este campo retorna o valor do Pix Copia e Cola correspondente à recorrência. Trata-se da sequência de caracteres que representa o BR Code.
     *
     * @return self
     */
    public function setPixCopiaECola($pix_copia_e_cola)
    {
        ...
        if ((mb_strlen($pix_copia_e_cola) > 512)) {
            throw new \InvalidArgumentException('invalid length for $pix_copia_e_cola when calling InformaEsDoQRComposto., must be smaller than or equal to 512.');
        }

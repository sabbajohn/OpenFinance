 ...
 */
class JuroAplicado implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Juro_aplicado';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['modalidade'] > 8)) {
            $invalidProperties[] = "invalid value for 'modalidade', must be smaller than or equal to 8.";
        }
    ...
    public function setModalidade($modalidade)
    {
        ...
        if (($modalidade > 8)) {
            throw new \InvalidArgumentException('invalid value for $modalidade when calling JuroAplicado., must be smaller than or equal to 8.');
        }
        if (($modalidade < 1)) {
            throw new \InvalidArgumentException('invalid value for $modalidade when calling JuroAplicado., must be bigger than or equal to 1.');
        }
    ...
    public function setValorPerc($valor_perc)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor_perc)))) {
            throw new \InvalidArgumentException("invalid value for \$valor_perc when calling JuroAplicado., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

...
/**
 * CobRSolicitada Class Doc Comment
 *
 * @category Class
 ...
 */
class CobRSolicitada implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobRSolicitada';
    ...
    protected static $openAPITypes = [
        ...
        'calendario' => '\OpenAPI\Client\Model\InformaEsSobreCalendRioDaCobranA',
    ...
    */
    ...
    public function setInfoAdicional($info_adicional)
    {
        ...
        if ((mb_strlen($info_adicional) > 140)) {
            throw new \InvalidArgumentException('invalid length for $info_adicional when calling CobRSolicitada., must be smaller than or equal to 140.');
        }
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\InformaEsSobreCalendRioDaCobranA
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\InformaEsSobreCalendRioDaCobranA $calendario calendario
     *
     * @return self
     */
    ...
    public function setIdRec($id_rec)
    {
        ...
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling CobRSolicitada., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling CobRSolicitada., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling CobRSolicitada., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }

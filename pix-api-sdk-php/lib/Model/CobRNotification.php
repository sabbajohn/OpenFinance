...
/**
 * CobRNotification Class Doc Comment
 *
 * @category Class
 ...
 */
class CobRNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobRNotification';
    ...
    protected static $openAPITypes = [
        ...
        'id_rec' => 'string',
        'txid' => 'string',
        'pix' => '\OpenAPI\Client\Model\CobRNotificationAllOfPix[]'
    ];
    ...
    */
    ...
    public function setIdRec($id_rec)
    {
        ...
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling CobRNotification., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling CobRNotification., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling CobRNotification., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobRNotification., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
     ...
     * Gets pix
     *
     * @return \OpenAPI\Client\Model\CobRNotificationAllOfPix[]|null
     */
     ...
     * Sets pix
     *
     * @param \OpenAPI\Client\Model\CobRNotificationAllOfPix[]|null $pix pix
     *
     * @return self
     */

...
/**
 * CobRNotificationAllOfPix Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CobRNotificationAllOfPix implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobRNotification_allOf_pix';
    ...
    protected static $openAPITypes = [
        ...
        'txid' => 'string',
        'valor' => '\OpenAPI\Client\Model\ValorDoPix',
        'horario' => '\DateTime',
        'info_pagador' => 'string',
        'devolucoes' => '\OpenAPI\Client\Model\DevolucaoPixAutomatico[]'
    ];
    ...
    */
    ...
    public function setEndToEndId($end_to_end_id)
    {
        ...
        if ((mb_strlen($end_to_end_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling CobRNotificationAllOfPix., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($end_to_end_id) < 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling CobRNotificationAllOfPix., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{32}/", ObjectSerializer::toString($end_to_end_id)))) {
            throw new \InvalidArgumentException("invalid value for \$end_to_end_id when calling CobRNotificationAllOfPix., must conform to the pattern /[a-zA-Z0-9]{32}/.");
        }
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobRNotificationAllOfPix., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
     ...
     * Gets valor
     *
     * @return \OpenAPI\Client\Model\ValorDoPix
     */
     ...
     * Sets valor
     *
     * @param \OpenAPI\Client\Model\ValorDoPix $valor valor
     *
     * @return self
     */
    ...
    public function setInfoPagador($info_pagador)
    {
        ...
        if ((mb_strlen($info_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $info_pagador when calling CobRNotificationAllOfPix., must be smaller than or equal to 140.');
        }
     ...
     * Gets devolucoes
     *
     * @return \OpenAPI\Client\Model\DevolucaoPixAutomatico[]|null
     */
     ...
     * Sets devolucoes
     *
     * @param \OpenAPI\Client\Model\DevolucaoPixAutomatico[]|null $devolucoes devolucoes
     *
     * @return self
     */

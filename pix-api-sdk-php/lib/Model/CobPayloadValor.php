...
/**
 * CobPayloadValor Class Doc Comment
 *
 * @category Class
 ...
 */
class CobPayloadValor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobPayloadValor';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['original'])) {
    ...
    public function setOriginal($original)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($original)))) {
            throw new \InvalidArgumentException("invalid value for \$original when calling CobPayloadValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
    ...
    public function setModalidadeAlteracao($modalidade_alteracao)
    {
        ...
        if (($modalidade_alteracao > 1)) {
            throw new \InvalidArgumentException('invalid value for $modalidade_alteracao when calling CobPayloadValor., must be smaller than or equal to 1.');
        }
        if (($modalidade_alteracao < 0)) {
            throw new \InvalidArgumentException('invalid value for $modalidade_alteracao when calling CobPayloadValor., must be bigger than or equal to 0.');
        }

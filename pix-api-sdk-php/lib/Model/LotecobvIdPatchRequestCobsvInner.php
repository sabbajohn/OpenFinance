...
/**
 * LotecobvIdPatchRequestCobsvInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LotecobvIdPatchRequestCobsvInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_lotecobv__id__patch_request_cobsv_inner';
    ...
    protected static $openAPITypes = [
        'calendario' => '\OpenAPI\Client\Model\CobDataDeVencimento',
        'devedor' => '\OpenAPI\Client\Model\DadosDevedorDevedor',
        'loc' => '\OpenAPI\Client\Model\PayloadLocationCob',
        'status' => 'string',
    ...
    public const STATUS_REMOVIDA_PELO_USUARIO_RECEBEDOR = 'REMOVIDA_PELO_USUARIO_RECEBEDOR';
    ...
    {
        return [
            self::STATUS_REMOVIDA_PELO_USUARIO_RECEBEDOR,
        ];
    }
    ...
    */
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\CobDataDeVencimento|null
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\CobDataDeVencimento|null $calendario Os campos aninhados sob o identificador calendário organizam informações a respeito de controle de tempo da cobrança.
     *
     * @return self
     */
     ...
     * Gets devedor
     *
     * @return \OpenAPI\Client\Model\DadosDevedorDevedor|null
     */
     ...
     * Sets devedor
     *
     * @param \OpenAPI\Client\Model\DadosDevedorDevedor|null $devedor devedor
     *
     * @return self
     */
     ...
     * Gets loc
     *
     * @return \OpenAPI\Client\Model\PayloadLocationCob|null
     */
     ...
     * Sets loc
     *
     * @param \OpenAPI\Client\Model\PayloadLocationCob|null $loc loc
     *
     * @return self
     */
     ...
     * Gets valor
     *
     * @return \OpenAPI\Client\Model\CobVValor|null
     */
     ...
     * Sets valor
     *
     * @param \OpenAPI\Client\Model\CobVValor|null $valor valor
     *
     * @return self
     */
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling LotecobvIdPatchRequestCobsvInner., must be smaller than or equal to 77.');
        }
    ...
    public function setSolicitacaoPagador($solicitacao_pagador)
    {
        ...
        if ((mb_strlen($solicitacao_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $solicitacao_pagador when calling LotecobvIdPatchRequestCobsvInner., must be smaller than or equal to 140.');
        }
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling LotecobvIdPatchRequestCobsvInner., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }

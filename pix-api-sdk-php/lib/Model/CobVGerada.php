 ...
 */
class CobVGerada implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobVGerada';
    ...
    */
    ...
    public function setPixCopiaECola($pix_copia_e_cola)
    {
        ...
        if ((mb_strlen($pix_copia_e_cola) > 512)) {
            throw new \InvalidArgumentException('invalid length for $pix_copia_e_cola when calling CobVGerada., must be smaller than or equal to 512.');
        }
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CobVGerada., must be smaller than or equal to 77.');
        }
    ...
    public function setSolicitacaoPagador($solicitacao_pagador)
    {
        ...
        if ((mb_strlen($solicitacao_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $solicitacao_pagador when calling CobVGerada., must be smaller than or equal to 140.');
        }
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobVGerada., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }

...
/**
 * LoteCobVConsultadoCobsvInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LoteCobVConsultadoCobsvInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoteCobVConsultado_cobsv_inner';
    ...
    protected static $openAPITypes = [
        'txid' => 'string',
        'status' => 'string',
        'problema' => '\OpenAPI\Client\Model\Problema',
        'criacao' => '\DateTime'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('problema', $data ?? [], null);
    ...
    */
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling LoteCobVConsultadoCobsvInner., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
     ...
     * Gets problema
     *
     * @return \OpenAPI\Client\Model\Problema|null
     */
     ...
     * Sets problema
     *
     * @param \OpenAPI\Client\Model\Problema|null $problema problema
     *
     * @return self
     */
    ...
    {
        if (is_null($problema)) {
            throw new \InvalidArgumentException('non-nullable problema cannot be null');
        }
     ...
     * Sets criacao
     *
     * @param \DateTime|null $criacao Data e hora em que a cobrança foi criada. Respeita RFC 3339.
     *
     * @return self
     */

 ...
 */
class CalendRio3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Calend_rio_3';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('expiracao', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($expiracao)) {
            throw new \InvalidArgumentException('non-nullable expiracao cannot be null');
        }

...
/**
 * DescriODoObjetoDaRecorrNcia Class Doc Comment
 *
 * @category Class
 ...
 */
class DescriODoObjetoDaRecorrNcia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Descri__o_do_Objeto_da_Recorr_ncia';
    ...
    protected static $openAPITypes = [
        'objeto' => 'string',
        'devedor' => '\OpenAPI\Client\Model\DescriODoObjetoDaRecorrNciaDevedor',
        'contrato' => 'string'
    ];
    ...
    {
        $this->setIfExists('objeto', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['objeto']) && (mb_strlen($this->container['objeto']) > 35)) {
            $invalidProperties[] = "invalid value for 'objeto', the character length must be smaller than or equal to 35.";
        }

        if ($this->container['devedor'] === null) {
            $invalidProperties[] = "'devedor' can't be null";
        }
        if ($this->container['contrato'] === null) {
            $invalidProperties[] = "'contrato' can't be null";
        }
        if ((mb_strlen($this->container['contrato']) > 35)) {
            $invalidProperties[] = "invalid value for 'contrato', the character length must be smaller than or equal to 35.";
        }
    ...
    {
        return $this->container['objeto'];
    }

    /**
     * Sets objeto
     *
     * @param string|null $objeto Campo de texto livre para informações referentes ao contrato que permitam ao usuário pagador reconhecer o objeto dos pagamentos periódicos por meio do Pix Automático.
     *
     * @return self
     */
    public function setObjeto($objeto)
    {
        ...
        if ((mb_strlen($objeto) > 35)) {
            throw new \InvalidArgumentException('invalid length for $objeto when calling DescriODoObjetoDaRecorrNcia., must be smaller than or equal to 35.');
        }
     ...
     * Gets devedor
     *
     * @return \OpenAPI\Client\Model\DescriODoObjetoDaRecorrNciaDevedor
     */
     ...
     * Sets devedor
     *
     * @param \OpenAPI\Client\Model\DescriODoObjetoDaRecorrNciaDevedor $devedor devedor
     *
     * @return self
     */
     ...
     * Sets contrato
     *
     * @param string $contrato Número, identificador, ou código que representa o objeto da autorização (contrato, pedido etc.).
     *
     * @return self
     */
    public function setContrato($contrato)
    {
        ...
        if ((mb_strlen($contrato) > 35)) {
            throw new \InvalidArgumentException('invalid length for $contrato when calling DescriODoObjetoDaRecorrNcia., must be smaller than or equal to 35.');
        }

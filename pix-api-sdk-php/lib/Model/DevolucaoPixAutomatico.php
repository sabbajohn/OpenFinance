...
/**
 * DevolucaoPixAutomatico Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DevolucaoPixAutomatico implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DevolucaoPixAutomatico';
    ...
    protected static $openAPITypes = [
        ...
        'rtr_id' => 'string',
        'valor' => 'string',
        'natureza' => '\OpenAPI\Client\Model\DevolucaoNaturezaPixAutomatico',
        'descricao' => 'string',
        'horario' => '\OpenAPI\Client\Model\DevolucaoHorario',
        'status' => 'string',
        'motivo' => 'string'
    ];
    ...
    public const STATUS_NAO_REALIZADO = 'NAO_REALIZADO';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rtr_id', $data ?? [], null);
        $this->setIfExists('valor', $data ?? [], null);
        $this->setIfExists('natureza', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/[a-zA-Z0-9]{1,35}/", $this->container['id'])) {
            $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /[a-zA-Z0-9]{1,35}/.";
        }

        if ($this->container['rtr_id'] === null) {
            $invalidProperties[] = "'rtr_id' can't be null";
        }
        if ((mb_strlen($this->container['rtr_id']) > 32)) {
            $invalidProperties[] = "invalid value for 'rtr_id', the character length must be smaller than or equal to 32.";
        }

        if ((mb_strlen($this->container['rtr_id']) < 32)) {
            $invalidProperties[] = "invalid value for 'rtr_id', the character length must be bigger than or equal to 32.";
        }

        if (!preg_match("/[a-zA-Z0-9]{32}/", $this->container['rtr_id'])) {
            $invalidProperties[] = "invalid value for 'rtr_id', must be conform to the pattern /[a-zA-Z0-9]{32}/.";
        }
        ...
        if (!is_null($this->container['descricao']) && (mb_strlen($this->container['descricao']) > 140)) {
            $invalidProperties[] = "invalid value for 'descricao', the character length must be smaller than or equal to 140.";
        }
        ...
        if (!is_null($this->container['motivo']) && (mb_strlen($this->container['motivo']) > 140)) {
            $invalidProperties[] = "invalid value for 'motivo', the character length must be smaller than or equal to 140.";
        }
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{1,35}/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling DevolucaoPixAutomatico., must conform to the pattern /[a-zA-Z0-9]{1,35}/.");
        }
    ...
    {
        if (is_null($rtr_id)) {
            throw new \InvalidArgumentException('non-nullable rtr_id cannot be null');
        }
        if ((mb_strlen($rtr_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $rtr_id when calling DevolucaoPixAutomatico., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($rtr_id) < 32)) {
            throw new \InvalidArgumentException('invalid length for $rtr_id when calling DevolucaoPixAutomatico., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{32}/", ObjectSerializer::toString($rtr_id)))) {
            throw new \InvalidArgumentException("invalid value for \$rtr_id when calling DevolucaoPixAutomatico., must conform to the pattern /[a-zA-Z0-9]{32}/.");
        }
    ...
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling DevolucaoPixAutomatico., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     * Gets natureza
     *
     * @return \OpenAPI\Client\Model\DevolucaoNaturezaPixAutomatico|null
     */
     ...
     * Sets natureza
     *
     * @param \OpenAPI\Client\Model\DevolucaoNaturezaPixAutomatico|null $natureza natureza
     *
     * @return self
     */
    ...
    {
        if (is_null($natureza)) {
            throw new \InvalidArgumentException('non-nullable natureza cannot be null');
        }
     ...
     * Sets descricao
     *
     * @param string|null $descricao O campo `descricao`, opcional, determina um texto a ser apresentado ao pagador contendo informações sobre a devolução. Esse texto será preenchido, na pacs.004, pelo PSP do recebedor, no campo RemittanceInformation. O tamanho do campo na pacs.004 está limitado a 140 caracteres.
     *
     * @return self
     */
    public function setDescricao($descricao)
    {
        ...
        if ((mb_strlen($descricao) > 140)) {
            throw new \InvalidArgumentException('invalid length for $descricao when calling DevolucaoPixAutomatico., must be smaller than or equal to 140.');
        }
     ...
     * Gets horario
     *
     * @return \OpenAPI\Client\Model\DevolucaoHorario
     */
     ...
     * Sets horario
     *
     * @param \OpenAPI\Client\Model\DevolucaoHorario $horario horario
     *
     * @return self
     */
     ...
     * Sets motivo
     *
     * @param string|null $motivo # Status da Devolução  Campo opcional que pode ser utilizado pelo PSP recebedor para detalhar os motivos de a devolução ter atingido o status em questão. Pode ser utilizado, por exemplo, para detalhar o motivo de a devolução não ter sido realizada.
     *
     * @return self
     */
    public function setMotivo($motivo)
    {
        ...
        if ((mb_strlen($motivo) > 140)) {
            throw new \InvalidArgumentException('invalid length for $motivo when calling DevolucaoPixAutomatico., must be smaller than or equal to 140.');
        }

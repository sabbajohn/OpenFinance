 ...
 */
class Saque implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Saque';
    ...
    protected static array $openAPINullables = [
        ...
        'modalidade_agente' => false,
        'prestador_do_servico_de_saque' => false
    ];
    ...
    public const MODALIDADE_AGENTE_AGTEC = 'AGTEC';
    public const MODALIDADE_AGENTE_AGTOT = 'AGTOT';
    public const MODALIDADE_AGENTE_AGPSS = 'AGPSS';
     ...
     * @return string[]
     */
    public function getModalidadeAgenteAllowableValues()
    {
        return [
            self::MODALIDADE_AGENTE_AGTEC,
            self::MODALIDADE_AGENTE_AGTOT,
            self::MODALIDADE_AGENTE_AGPSS,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('modalidade_alteracao', $data ?? [], 0);
        $this->setIfExists('modalidade_agente', $data ?? [], null);
        $this->setIfExists('prestador_do_servico_de_saque', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['modalidade_alteracao']) && ($this->container['modalidade_alteracao'] > 1)) {
            $invalidProperties[] = "invalid value for 'modalidade_alteracao', must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['modalidade_alteracao']) && ($this->container['modalidade_alteracao'] < 0)) {
            $invalidProperties[] = "invalid value for 'modalidade_alteracao', must be bigger than or equal to 0.";
        }

        if ($this->container['modalidade_agente'] === null) {
            $invalidProperties[] = "'modalidade_agente' can't be null";
        }
        $allowedValues = $this->getModalidadeAgenteAllowableValues();
        if (!is_null($this->container['modalidade_agente']) && !in_array($this->container['modalidade_agente'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'modalidade_agente', must be one of '%s'",
                $this->container['modalidade_agente'],
        ...
        if (!preg_match("/^[0-9A-Z]{8}$/", $this->container['prestador_do_servico_de_saque'])) {
            $invalidProperties[] = "invalid value for 'prestador_do_servico_de_saque', must be conform to the pattern /^[0-9A-Z]{8}$/.";
        }
    ...
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling Saque., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     *
     * @param int|null $modalidade_alteracao Modalidade de alteração de valor do saque. Quando não preenchido o valor assumido é o 0 (zero).
     *
     * @return self
     */
    public function setModalidadeAlteracao($modalidade_alteracao)
    {
        if (is_null($modalidade_alteracao)) {
            throw new \InvalidArgumentException('non-nullable modalidade_alteracao cannot be null');
        }

        if (($modalidade_alteracao > 1)) {
            throw new \InvalidArgumentException('invalid value for $modalidade_alteracao when calling Saque., must be smaller than or equal to 1.');
        }
        if (($modalidade_alteracao < 0)) {
            throw new \InvalidArgumentException('invalid value for $modalidade_alteracao when calling Saque., must be bigger than or equal to 0.');
        }
    ...
    {
        if (is_null($prestador_do_servico_de_saque)) {
            throw new \InvalidArgumentException('non-nullable prestador_do_servico_de_saque cannot be null');
        }

        if ((!preg_match("/^[0-9A-Z]{8}$/", ObjectSerializer::toString($prestador_do_servico_de_saque)))) {
            throw new \InvalidArgumentException("invalid value for \$prestador_do_servico_de_saque when calling Saque., must conform to the pattern /^[0-9A-Z]{8}$/.");
        }

 ...
 */
class CobRevisada implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobRevisada';
    ...
    protected static $openAPITypes = [
        ...
        'calendario' => '\OpenAPI\Client\Model\CobExpiracao',
        'devedor' => '\OpenAPI\Client\Model\CobRevisadaAllOfDevedor',
    ...
    */
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CobRevisada., must be smaller than or equal to 77.');
        }
    ...
    public function setSolicitacaoPagador($solicitacao_pagador)
    {
        ...
        if ((mb_strlen($solicitacao_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $solicitacao_pagador when calling CobRevisada., must be smaller than or equal to 140.');
        }
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\CobExpiracao|null
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\CobExpiracao|null $calendario Os campos aninhados sob o identificador calendário organizam informações a respeito de controle de tempo da cobrança.
     *
     * @return self
     */
     ...
     * Gets devedor
     *
     * @return \OpenAPI\Client\Model\CobRevisadaAllOfDevedor|null
     */
     ...
     * Sets devedor
     *
     * @param \OpenAPI\Client\Model\CobRevisadaAllOfDevedor|null $devedor devedor
     *
     * @return self
     */
     ...
     * Gets valor
     *
     * @return \OpenAPI\Client\Model\CobValor|null
     */
     ...
     * Sets valor
     *
     * @param \OpenAPI\Client\Model\CobValor|null $valor valor
     *
     * @return self
     */

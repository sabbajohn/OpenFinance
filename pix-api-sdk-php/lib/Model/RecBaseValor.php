...
/**
 * RecBaseValor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecBaseValor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecBase_valor';
    ...
    protected static $attributeMap = [
        'valor_rec' => 'valorRec',
        'valor_minimo_recebedor' => 'valorMinimoRecebedor'
    ];
    ...
    protected static $setters = [
        'valor_rec' => 'setValorRec',
        'valor_minimo_recebedor' => 'setValorMinimoRecebedor'
    ];
    ...
    protected static $getters = [
        'valor_rec' => 'getValorRec',
        'valor_minimo_recebedor' => 'getValorMinimoRecebedor'
    ];
    ...
    {
        $this->setIfExists('valor_rec', $data ?? [], null);
        $this->setIfExists('valor_minimo_recebedor', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['valor_rec']) && !preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['valor_rec'])) {
            $invalidProperties[] = "invalid value for 'valor_rec', must be conform to the pattern /\\d{1,10}\\.\\d{2}/.";
        }

        if (!is_null($this->container['valor_minimo_recebedor']) && !preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['valor_minimo_recebedor'])) {
            $invalidProperties[] = "invalid value for 'valor_minimo_recebedor', must be conform to the pattern /\\d{1,10}\\.\\d{2}/.";
        }
    ...
    {
        return $this->container['valor_rec'];
    }

    /**
     * Sets valor_rec
     *
     * @param string|null $valor_rec Campo opcional, deve ser preenchido apenas quando o valor dos pagamentos for fixo ou não for sujeito a alteração durante a vigência da autorização.
     *
     * @return self
     */
    public function setValorRec($valor_rec)
    {
        if (is_null($valor_rec)) {
            throw new \InvalidArgumentException('non-nullable valor_rec cannot be null');
        }

        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$valor_rec when calling RecBaseValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

        $this->container['valor_rec'] = $valor_rec;

        return $this;
    }

    /**
     * Gets valor_minimo_recebedor
     *
     * @return string|null
     */
    public function getValorMinimoRecebedor()
    {
        return $this->container['valor_minimo_recebedor'];
    }

    /**
     * Sets valor_minimo_recebedor
     *
     * @param string|null $valor_minimo_recebedor Campo opcional. Valor definido pelo usuário recebedor. Se o usuário pagador atribuir um valor máximo para os pagamentos daquela autorização, ele não poderá ser inferior ao piso definido pelo usuário recebedor. Não pode ser preenchido nas autorizações de valor fixo, ou seja, com campo valor preenchido.
     *
     * @return self
     */
    public function setValorMinimoRecebedor($valor_minimo_recebedor)
    {
        if (is_null($valor_minimo_recebedor)) {
            throw new \InvalidArgumentException('non-nullable valor_minimo_recebedor cannot be null');
        }

        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor_minimo_recebedor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor_minimo_recebedor when calling RecBaseValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

        $this->container['valor_minimo_recebedor'] = $valor_minimo_recebedor;

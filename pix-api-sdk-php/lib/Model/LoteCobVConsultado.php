...
/**
 * LoteCobVConsultado Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LoteCobVConsultado implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoteCobVConsultado';
    ...
    protected static $openAPITypes = [
        ...
        'descricao' => 'string',
        'criacao' => '\DateTime',
        'cobsv' => '\OpenAPI\Client\Model\LoteCobVConsultadoCobsvInner[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cobsv', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets criacao
     *
     * @param \DateTime $criacao Timestamp que indica o momento em que foi criado o lote. Respeita o formato definido na RFC 3339.
     *
     * @return self
     */
     ...
     * Gets cobsv
     *
     * @return \OpenAPI\Client\Model\LoteCobVConsultadoCobsvInner[]
     */
     ...
     * Sets cobsv
     *
     * @param \OpenAPI\Client\Model\LoteCobVConsultadoCobsvInner[] $cobsv cobsv
     *
     * @return self
     */
    ...
    {
        if (is_null($cobsv)) {
            throw new \InvalidArgumentException('non-nullable cobsv cannot be null');
        }

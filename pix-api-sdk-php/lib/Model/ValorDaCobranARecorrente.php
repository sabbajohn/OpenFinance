...
/**
 * ValorDaCobranARecorrente Class Doc Comment
 *
 * @category Class
 ...
 */
class ValorDaCobranARecorrente implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Valor_da_cobran_a_recorrente';
    ...
    */
    ...
    public function setOriginal($original)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($original)))) {
            throw new \InvalidArgumentException("invalid value for \$original when calling ValorDaCobranARecorrente., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

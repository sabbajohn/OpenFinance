...
/**
 * LotecobvIdPutRequestCobsvInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LotecobvIdPutRequestCobsvInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_lotecobv__id__put_request_cobsv_inner';
    ...
    */
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\CobDataDeVencimento
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\CobDataDeVencimento $calendario Os campos aninhados sob o identificador calendário organizam informações a respeito de controle de tempo da cobrança.
     *
     * @return self
     */
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling LotecobvIdPutRequestCobsvInner., must be smaller than or equal to 77.');
        }
    ...
    public function setSolicitacaoPagador($solicitacao_pagador)
    {
        ...
        if ((mb_strlen($solicitacao_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $solicitacao_pagador when calling LotecobvIdPutRequestCobsvInner., must be smaller than or equal to 140.');
        }
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling LotecobvIdPutRequestCobsvInner., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }

...
/**
 * PixValorTrocoTroco Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PixValorTrocoTroco implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PixValorTroco_troco';
    ...
    */
     ...
     * Sets valor
     *
     * @param string $valor Valor do Troco Pix.
     *
     * @return self
     */
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling PixValorTrocoTroco., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
    ...
    public function setPrestadorDoServicoDeSaque($prestador_do_servico_de_saque)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{8}$/", ObjectSerializer::toString($prestador_do_servico_de_saque)))) {
            throw new \InvalidArgumentException("invalid value for \$prestador_do_servico_de_saque when calling PixValorTrocoTroco., must conform to the pattern /^[0-9A-Z]{8}$/.");
        }

...
/**
 * HistRicoDeStatusInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HistRicoDeStatusInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Hist_rico_de_Status_inner';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Status da recorrência.
     *
     * @return self
     */

...
/**
 * PessoaFisicaRecorrencia Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PessoaFisicaRecorrencia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PessoaFisicaRecorrencia';
    ...
    */
    ...
    public function setCpf($cpf)
    {
        ...
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($cpf)))) {
            throw new \InvalidArgumentException("invalid value for \$cpf when calling PessoaFisicaRecorrencia., must conform to the pattern /^\\d{11}$/.");
        }
    ...
    public function setNome($nome)
    {
        ...
        if ((mb_strlen($nome) > 140)) {
            throw new \InvalidArgumentException('invalid length for $nome when calling PessoaFisicaRecorrencia., must be smaller than or equal to 140.');
        }

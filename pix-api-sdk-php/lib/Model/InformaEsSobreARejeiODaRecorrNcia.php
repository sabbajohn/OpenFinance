<?php
/**
 * InformaEsSobreARejeiODaRecorrNcia
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InformaEsSobreARejeiODaRecorrNcia Class Doc Comment
 *
 * @category Class
 ...
 */
class InformaEsSobreARejeiODaRecorrNcia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_sobre_a_rejei__o_da_recorr_ncia';
    ...
    public const CODIGO_AP13 = 'AP13';
    public const CODIGO_AP14 = 'AP14';
    ...
    */
    ...
    public function setCodigo($codigo)
    {
        ...
        if ((mb_strlen($codigo) > 4)) {
            throw new \InvalidArgumentException('invalid length for $codigo when calling InformaEsSobreARejeiODaRecorrNcia., must be smaller than or equal to 4.');
        }
    ...
    public function setDescricao($descricao)
    {
        ...
        if ((mb_strlen($descricao) > 400)) {
            throw new \InvalidArgumentException('invalid length for $descricao when calling InformaEsSobreARejeiODaRecorrNcia., must be smaller than or equal to 400.');
        }

...
/**
 * PessoaJuridicaRecorrencia Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PessoaJuridicaRecorrencia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PessoaJuridicaRecorrencia';
    ...
    */
    ...
    public function setCnpj($cnpj)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{14}$/", ObjectSerializer::toString($cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$cnpj when calling PessoaJuridicaRecorrencia., must conform to the pattern /^[0-9A-Z]{14}$/.");
        }
    ...
    public function setNome($nome)
    {
        ...
        if ((mb_strlen($nome) > 140)) {
            throw new \InvalidArgumentException('invalid length for $nome when calling PessoaJuridicaRecorrencia., must be smaller than or equal to 140.');
        }

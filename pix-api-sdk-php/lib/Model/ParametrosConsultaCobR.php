...
/**
 * ParametrosConsultaCobR Class Doc Comment
 *
 * @category Class
 ...
 */
class ParametrosConsultaCobR implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParametrosConsultaCobR';
    ...
    protected static $openAPITypes = [
        ...
        'cnpj' => 'string',
        'status' => 'string',
        'recebedor' => '\OpenAPI\Client\Model\Recebedor',
        'paginacao' => '\OpenAPI\Client\Model\Paginacao'
    ];
    ...
    {
        $this->setIfExists('inicio', $data ?? [], null);
        $this->setIfExists('fim', $data ?? [], null);
        ...
        $this->setIfExists('paginacao', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id_rec']) && (mb_strlen($this->container['id_rec']) > 29)) {
        ...
        if (!is_null($this->container['id_rec']) && !preg_match("/[a-zA-Z0-9]{29}/", $this->container['id_rec'])) {
            $invalidProperties[] = "invalid value for 'id_rec', must be conform to the pattern /[a-zA-Z0-9]{29}/.";
        }

        if (!is_null($this->container['cpf']) && !preg_match("/^\\d{11}$/", $this->container['cpf'])) {
            $invalidProperties[] = "invalid value for 'cpf', must be conform to the pattern /^\\d{11}$/.";
        }

        if (!is_null($this->container['cnpj']) && !preg_match("/^[0-9A-Z]{14}$/", $this->container['cnpj'])) {
            $invalidProperties[] = "invalid value for 'cnpj', must be conform to the pattern /^[0-9A-Z]{14}$/.";
        }
    ...
    {
        if (is_null($inicio)) {
            throw new \InvalidArgumentException('non-nullable inicio cannot be null');
        }
    ...
    {
        if (is_null($fim)) {
            throw new \InvalidArgumentException('non-nullable fim cannot be null');
        }
    ...
    public function setIdRec($id_rec)
    {
        ...
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling ParametrosConsultaCobR., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling ParametrosConsultaCobR., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling ParametrosConsultaCobR., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }
     ...
     * Sets cpf
     *
     * @param string|null $cpf Filtro pelo CPF do devedor. Não pode ser utilizado ao mesmo tempo que o CNPJ.
     *
     * @return self
     */
    public function setCpf($cpf)
    {
        ...
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($cpf)))) {
            throw new \InvalidArgumentException("invalid value for \$cpf when calling ParametrosConsultaCobR., must conform to the pattern /^\\d{11}$/.");
        }
     ...
     * Sets cnpj
     *
     * @param string|null $cnpj Filtro pelo CNPJ do devedor. Não pode ser utilizado ao mesmo tempo que o CPF.
     *
     * @return self
     */
    public function setCnpj($cnpj)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{14}$/", ObjectSerializer::toString($cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$cnpj when calling ParametrosConsultaCobR., must conform to the pattern /^[0-9A-Z]{14}$/.");
        }
     ...
     * Sets status
     *
     * @param string|null $status Filtro pelo status das cobranças.
     *
     * @return self
     */
     ...
     * Gets recebedor
     *
     * @return \OpenAPI\Client\Model\Recebedor|null
     */
     ...
     * Sets recebedor
     *
     * @param \OpenAPI\Client\Model\Recebedor|null $recebedor recebedor
     *
     * @return self
     */
     ...
     * Gets paginacao
     *
     * @return \OpenAPI\Client\Model\Paginacao
     */
     ...
     * Sets paginacao
     *
     * @param \OpenAPI\Client\Model\Paginacao $paginacao paginacao
     *
     * @return self
     */
    public function setPaginacao($paginacao)
    {
        if (is_null($paginacao)) {
            throw new \InvalidArgumentException('non-nullable paginacao cannot be null');
        }

<?php
/**
 * DadosDevedorRecorrenciaDevedor
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * DadosDevedorRecorrenciaDevedor Class Doc Comment
 *
 * @category Class
 ...
 */
class DadosDevedorRecorrenciaDevedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DadosDevedorRecorrencia_devedor';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['logradouro']) && (mb_strlen($this->container['logradouro']) > 200)) {
            $invalidProperties[] = "invalid value for 'logradouro', the character length must be smaller than or equal to 200.";
        }

        if (!is_null($this->container['cidade']) && (mb_strlen($this->container['cidade']) > 200)) {
            $invalidProperties[] = "invalid value for 'cidade', the character length must be smaller than or equal to 200.";
        }

        if (!is_null($this->container['uf']) && (mb_strlen($this->container['uf']) > 2)) {
            $invalidProperties[] = "invalid value for 'uf', the character length must be smaller than or equal to 2.";
        }

        if (!is_null($this->container['cep']) && (mb_strlen($this->container['cep']) > 8)) {
            $invalidProperties[] = "invalid value for 'cep', the character length must be smaller than or equal to 8.";
        }
     ...
     * Sets logradouro
     *
     * @param string|null $logradouro Logradouro do usuário.
     *
     * @return self
     */
    public function setLogradouro($logradouro)
    {
        ...
        if ((mb_strlen($logradouro) > 200)) {
            throw new \InvalidArgumentException('invalid length for $logradouro when calling DadosDevedorRecorrenciaDevedor., must be smaller than or equal to 200.');
        }
     ...
     * Sets cidade
     *
     * @param string|null $cidade Cidade do usuário.
     *
     * @return self
     */
    public function setCidade($cidade)
    {
        ...
        if ((mb_strlen($cidade) > 200)) {
            throw new \InvalidArgumentException('invalid length for $cidade when calling DadosDevedorRecorrenciaDevedor., must be smaller than or equal to 200.');
        }
     ...
     * Sets uf
     *
     * @param string|null $uf UF do usuário.
     *
     * @return self
     */
    public function setUf($uf)
    {
        ...
        if ((mb_strlen($uf) > 2)) {
            throw new \InvalidArgumentException('invalid length for $uf when calling DadosDevedorRecorrenciaDevedor., must be smaller than or equal to 2.');
        }
     ...
     * Sets cep
     *
     * @param string|null $cep CEP do usuário.
     *
     * @return self
     */
    public function setCep($cep)
    {
        ...
        if ((mb_strlen($cep) > 8)) {
            throw new \InvalidArgumentException('invalid length for $cep when calling DadosDevedorRecorrenciaDevedor., must be smaller than or equal to 8.');
        }

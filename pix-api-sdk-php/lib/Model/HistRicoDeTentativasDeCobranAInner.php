...
/**
 * HistRicoDeTentativasDeCobranAInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HistRicoDeTentativasDeCobranAInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Hist_rico_de_Tentativas_de_Cobran_a_inner';
    ...
    protected static $openAPITypes = [
        ...
        'atualizacao' => '\OpenAPI\Client\Model\HistRicoDeStatusDaTentativaInner[]',
        'rejeicao' => '\OpenAPI\Client\Model\InformaEsSobreARejeiODaTentativaDaCobranA'
    ];
    ...
    protected static $setters = [
        'data_liquidacao' => 'setDataLiquidacao',
        'tipo' => 'setTipo',
        'status' => 'setStatus',
        'end_to_end_id' => 'setEndToEndId',
        'atualizacao' => 'setAtualizacao',
        'rejeicao' => 'setRejeicao'
    ];
    ...
    protected static $getters = [
        'data_liquidacao' => 'getDataLiquidacao',
        'tipo' => 'getTipo',
        'status' => 'getStatus',
        'end_to_end_id' => 'getEndToEndId',
        'atualizacao' => 'getAtualizacao',
        'rejeicao' => 'getRejeicao'
    ];
    ...
    public const TIPO_AGND = 'AGND';
    public const TIPO_NTAG = 'NTAG';
    public const TIPO_RIFL = 'RIFL';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['data_liquidacao'] === null) {
            $invalidProperties[] = "'data_liquidacao' can't be null";
        }
    ...
    /**
     * Gets data_liquidacao
     *
     * @return \DateTime
     */
    public function getDataLiquidacao()
    {
        return $this->container['data_liquidacao'];
    }

    /**
     * Sets data_liquidacao
     *
     * @param \DateTime $data_liquidacao Data da liquidação da cobrança. Trata-se de uma data, no formato `YYYY-MM-DD`, segundo ISO 8601.
     *
     * @return self
     */
    public function setDataLiquidacao($data_liquidacao)
    {
        if (is_null($data_liquidacao)) {
            throw new \InvalidArgumentException('non-nullable data_liquidacao cannot be null');
        }
        $this->container['data_liquidacao'] = $data_liquidacao;
     ...
     * Sets tipo
     *
     * @param string $tipo Tipo da tentativa da cobrança.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Status da tentativa da cobrança.
     *
     * @return self
     */
    ...
    public function setEndToEndId($end_to_end_id)
    {
        ...
        if ((mb_strlen($end_to_end_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling HistRicoDeTentativasDeCobranAInner., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($end_to_end_id) < 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling HistRicoDeTentativasDeCobranAInner., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{32}/", ObjectSerializer::toString($end_to_end_id)))) {
            throw new \InvalidArgumentException("invalid value for \$end_to_end_id when calling HistRicoDeTentativasDeCobranAInner., must conform to the pattern /[a-zA-Z0-9]{32}/.");
        }
     ...
     * Gets atualizacao
     *
     * @return \OpenAPI\Client\Model\HistRicoDeStatusDaTentativaInner[]
     */
     ...
     * Sets atualizacao
     *
     * @param \OpenAPI\Client\Model\HistRicoDeStatusDaTentativaInner[] $atualizacao Histórico das mudanças de status da tentativa de cobrança.
     *
     * @return self
     */
     ...
     * Gets rejeicao
     *
     * @return \OpenAPI\Client\Model\InformaEsSobreARejeiODaTentativaDaCobranA|null
     */
    public function getRejeicao()
    {
        return $this->container['rejeicao'];
    }

    /**
     * Sets rejeicao
     *
     * @param \OpenAPI\Client\Model\InformaEsSobreARejeiODaTentativaDaCobranA|null $rejeicao rejeicao
     *
     * @return self
     */
    ...
    {
        if (is_null($rejeicao)) {
            throw new \InvalidArgumentException('non-nullable rejeicao cannot be null');
        }
        $this->container['rejeicao'] = $rejeicao;

<?php
/**
 * HistRicoDeStatusDaTentativaInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * HistRicoDeStatusDaTentativaInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HistRicoDeStatusDaTentativaInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Hist_rico_de_Status_da_Tentativa_inner';
    ...
    */
     ...
     * Sets data
     *
     * @param \DateTime $data Data e hora do registro de status atualizado. Respeita RFC 3339.
     *
     * @return self
     */

...
/**
 * CobSolicitada Class Doc Comment
 *
 * @category Class
 ...
 */
class CobSolicitada implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobSolicitada';
    ...
    protected static $openAPITypes = [
        ...
        'devedor' => '\OpenAPI\Client\Model\CobSolicitadaAllOfDevedor',
    ...
    */
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CobSolicitada., must be smaller than or equal to 77.');
        }
    ...
    public function setSolicitacaoPagador($solicitacao_pagador)
    {
        ...
        if ((mb_strlen($solicitacao_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $solicitacao_pagador when calling CobSolicitada., must be smaller than or equal to 140.');
        }
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\CobExpiracao
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\CobExpiracao $calendario Os campos aninhados sob o identificador calendário organizam informações a respeito de controle de tempo da cobrança.
     *
     * @return self
     */
     ...
     * Gets devedor
     *
     * @return \OpenAPI\Client\Model\CobSolicitadaAllOfDevedor|null
     */
     ...
     * Sets devedor
     *
     * @param \OpenAPI\Client\Model\CobSolicitadaAllOfDevedor|null $devedor devedor
     *
     * @return self
     */

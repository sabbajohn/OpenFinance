...
/**
 * ParametrosConsultaPayloadLocationRec Class Doc Comment
 *
 * @category Class
 ...
 */
class ParametrosConsultaPayloadLocationRec implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParametrosConsultaPayloadLocationRec';
    ...
    protected static $setters = [
        'inicio' => 'setInicio',
        'fim' => 'setFim',
        'id_rec_presente' => 'setIdRecPresente',
    ...
    protected static $getters = [
        'inicio' => 'getInicio',
        'fim' => 'getFim',
        'id_rec_presente' => 'getIdRecPresente',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('id_rec_presente', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets id_rec_presente
     *
     * @return bool|null
     */
    public function getIdRecPresente()
    {
        return $this->container['id_rec_presente'];
    }

    /**
     * Sets id_rec_presente
     *
     * @param bool|null $id_rec_presente Filtro pela existência de id da recorrência.
     *
     * @return self
     */
    public function setIdRecPresente($id_rec_presente)
    {
        if (is_null($id_rec_presente)) {
            throw new \InvalidArgumentException('non-nullable id_rec_presente cannot be null');
        }
        $this->container['id_rec_presente'] = $id_rec_presente;

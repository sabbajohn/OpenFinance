...
/**
 * RecCompletaAllOfSolicitacao Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecCompletaAllOfSolicitacao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecCompleta_allOf_solicitacao';
    ...
    */
    ...
    public function setIdSolicRec($id_solic_rec)
    {
        ...
        if ((mb_strlen($id_solic_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_solic_rec when calling RecCompletaAllOfSolicitacao., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_solic_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_solic_rec when calling RecCompletaAllOfSolicitacao., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_solic_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_solic_rec when calling RecCompletaAllOfSolicitacao., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }
    ...
    public function setIdRec($id_rec)
    {
        ...
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling RecCompletaAllOfSolicitacao., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling RecCompletaAllOfSolicitacao., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling RecCompletaAllOfSolicitacao., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }

...
/**
 * ListaDeDescontosInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListaDeDescontosInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Lista_de_Descontos_inner';
    ...
    */
    ...
    public function setValorPerc($valor_perc)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor_perc)))) {
            throw new \InvalidArgumentException("invalid value for \$valor_perc when calling ListaDeDescontosInner., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

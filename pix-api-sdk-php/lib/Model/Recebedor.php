 ...
 */
class Recebedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Recebedor';
    ...
    */
    ...
    public function setConvenio($convenio)
    {
        ...
        if ((mb_strlen($convenio) > 60)) {
            throw new \InvalidArgumentException('invalid length for $convenio when calling Recebedor., must be smaller than or equal to 60.');
        }

...
/**
 * WebhookChavePostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookChavePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_webhook__chave__post_request';
    ...
    */
     ...
     * Gets pix
     *
     * @return \OpenAPI\Client\Model\Pix[]|null
     */
     ...
     * Sets pix
     *
     * @param \OpenAPI\Client\Model\Pix[]|null $pix pix
     *
     * @return self
     */

...
/**
 * PixValorDescontoDesconto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PixValorDescontoDesconto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PixValorDesconto_desconto';
    ...
    */
     ...
     * Sets valor
     *
     * @param string $valor Valor do desconto.
     *
     * @return self
     */
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling PixValorDescontoDesconto., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

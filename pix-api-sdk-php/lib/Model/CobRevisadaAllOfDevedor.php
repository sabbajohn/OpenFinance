...
/**
 * CobRevisadaAllOfDevedor Class Doc Comment
 *
 * @category Class
 ...
 */
class CobRevisadaAllOfDevedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobRevisada_allOf_devedor';
    ...
    */
    ...
    public function setCpf($cpf)
    {
        ...
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($cpf)))) {
            throw new \InvalidArgumentException("invalid value for \$cpf when calling CobRevisadaAllOfDevedor., must conform to the pattern /^\\d{11}$/.");
        }
    ...
    public function setNome($nome)
    {
        ...
        if ((mb_strlen($nome) > 200)) {
            throw new \InvalidArgumentException('invalid length for $nome when calling CobRevisadaAllOfDevedor., must be smaller than or equal to 200.');
        }
    ...
    public function setCnpj($cnpj)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{14}$/", ObjectSerializer::toString($cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$cnpj when calling CobRevisadaAllOfDevedor., must conform to the pattern /^[0-9A-Z]{14}$/.");
        }

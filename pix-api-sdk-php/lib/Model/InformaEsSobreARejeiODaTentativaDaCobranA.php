<?php
/**
 * InformaEsSobreARejeiODaTentativaDaCobranA
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InformaEsSobreARejeiODaTentativaDaCobranA Class Doc Comment
 *
 * @category Class
 ...
 */
class InformaEsSobreARejeiODaTentativaDaCobranA implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_sobre_a_rejei__o_da_tentativa_da_cobran_a';
    ...
    public const CODIGO_AB10 = 'AB10';
    public const CODIGO_AC05 = 'AC05';
    public const CODIGO_AC06 = 'AC06';
    public const CODIGO_AM02 = 'AM02';
    public const CODIGO_AM09 = 'AM09';
    public const CODIGO_DENC = 'DENC';
    public const CODIGO_DS27 = 'DS27';
    public const CODIGO_DTED = 'DTED';
    public const CODIGO_DTNT = 'DTNT';
    public const CODIGO_FBRD = 'FBRD';
    public const CODIGO_IRNT = 'IRNT';
    public const CODIGO_MIDI = 'MIDI';
    public const CODIGO_MSUC = 'MSUC';
    public const CODIGO_NIEC = 'NIEC';
    public const CODIGO_NIPA = 'NIPA';
    public const CODIGO_NITX = 'NITX';
    public const CODIGO_QUNT = 'QUNT';
    public const CODIGO_RC09 = 'RC09';
    public const CODIGO_UDEI = 'UDEI';
    ...
    */
     ...
     * Sets codigo
     *
     * @param string $codigo Código da rejeição da tentativa. Corresponde ao código de rejeição presente no catálogo de mensagens. Os códigos de rejeição da tentativa `AC05`,`AM09`,`DENC`,`DS27`,`DTED`,`MIDI`,`MSUC`,`NITX`,`RC09` e `DTED` causam a rejeição da cobrança recorrente correspondente.
     *
     * @return self
     */
    public function setCodigo($codigo)
    {
        ...
        if ((mb_strlen($codigo) > 4)) {
            throw new \InvalidArgumentException('invalid length for $codigo when calling InformaEsSobreARejeiODaTentativaDaCobranA., must be smaller than or equal to 4.');
        }
     ...
     * Sets descricao
     *
     * @param string $descricao Descricao da causa da rejeição
     *
     * @return self
     */
    public function setDescricao($descricao)
    {
        ...
        if ((mb_strlen($descricao) > 400)) {
            throw new \InvalidArgumentException('invalid length for $descricao when calling InformaEsSobreARejeiODaTentativaDaCobranA., must be smaller than or equal to 400.');
        }

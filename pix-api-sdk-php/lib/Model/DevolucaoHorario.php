 ...
 */
class DevolucaoHorario implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Devolucao_horario';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('liquidacao', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets solicitacao
     *
     * @param \DateTime|null $solicitacao Horário no qual a devolução foi solicitada no PSP.
     *
     * @return self
     */
     ...
     * Sets liquidacao
     *
     * @param \DateTime|null $liquidacao Horário no qual a devolução foi liquidada no PSP.
     *
     * @return self
     */
    public function setLiquidacao($liquidacao)
    {
        if (is_null($liquidacao)) {
            throw new \InvalidArgumentException('non-nullable liquidacao cannot be null');
        }

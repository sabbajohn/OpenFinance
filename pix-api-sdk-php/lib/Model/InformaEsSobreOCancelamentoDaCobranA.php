<?php
/**
 * InformaEsSobreOCancelamentoDaCobranA
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InformaEsSobreOCancelamentoDaCobranA Class Doc Comment
 *
 * @category Class
 ...
 */
class InformaEsSobreOCancelamentoDaCobranA implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_sobre_o_cancelamento_da_cobran_a';
    ...
    public const CODIGO_ACCT = 'ACCT';
    public const CODIGO_BLCK = 'BLCK';
    public const CODIGO_CCLD = 'CCLD';
    public const CODIGO_FAIL = 'FAIL';
    public const CODIGO_OTHR = 'OTHR';
    public const CODIGO_SLBD = 'SLBD';
    ...
    */
    ...
    public function setCodigo($codigo)
    {
        ...
        if ((mb_strlen($codigo) > 4)) {
            throw new \InvalidArgumentException('invalid length for $codigo when calling InformaEsSobreOCancelamentoDaCobranA., must be smaller than or equal to 4.');
        }
     ...
     * Sets descricao
     *
     * @param string $descricao Descricao da causa do cancelamento
     *
     * @return self
     */
    public function setDescricao($descricao)
    {
        ...
        if ((mb_strlen($descricao) > 400)) {
            throw new \InvalidArgumentException('invalid length for $descricao when calling InformaEsSobreOCancelamentoDaCobranA., must be smaller than or equal to 400.');
        }

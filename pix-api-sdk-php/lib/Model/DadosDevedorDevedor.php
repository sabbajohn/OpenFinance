...
/**
 * DadosDevedorDevedor Class Doc Comment
 *
 * @category Class
 ...
 */
class DadosDevedorDevedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DadosDevedor_devedor';
    ...
    */
    ...
    public function setLogradouro($logradouro)
    {
        ...
        if ((mb_strlen($logradouro) > 200)) {
            throw new \InvalidArgumentException('invalid length for $logradouro when calling DadosDevedorDevedor., must be smaller than or equal to 200.');
        }
    ...
    public function setCidade($cidade)
    {
        ...
        if ((mb_strlen($cidade) > 200)) {
            throw new \InvalidArgumentException('invalid length for $cidade when calling DadosDevedorDevedor., must be smaller than or equal to 200.');
        }
    ...
    public function setUf($uf)
    {
        ...
        if ((mb_strlen($uf) > 2)) {
            throw new \InvalidArgumentException('invalid length for $uf when calling DadosDevedorDevedor., must be smaller than or equal to 2.');
        }
    ...
    public function setCep($cep)
    {
        ...
        if ((mb_strlen($cep) > 8)) {
            throw new \InvalidArgumentException('invalid length for $cep when calling DadosDevedorDevedor., must be smaller than or equal to 8.');
        }

<?php
/**
 * DescriODoObjetoDaRecorrNciaDevedor
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * DescriODoObjetoDaRecorrNciaDevedor Class Doc Comment
 *
 * @category Class
 ...
 */
class DescriODoObjetoDaRecorrNciaDevedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Descri__o_do_Objeto_da_Recorr_ncia_devedor';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^\\d{11}$/", $this->container['cpf'])) {
        ...
        if ((mb_strlen($this->container['nome']) > 140)) {
            $invalidProperties[] = "invalid value for 'nome', the character length must be smaller than or equal to 140.";
        }
    ...
    public function setCpf($cpf)
    {
        ...
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($cpf)))) {
            throw new \InvalidArgumentException("invalid value for \$cpf when calling DescriODoObjetoDaRecorrNciaDevedor., must conform to the pattern /^\\d{11}$/.");
        }
    ...
    public function setNome($nome)
    {
        ...
        if ((mb_strlen($nome) > 140)) {
            throw new \InvalidArgumentException('invalid length for $nome when calling DescriODoObjetoDaRecorrNciaDevedor., must be smaller than or equal to 140.');
        }
    ...
    public function setCnpj($cnpj)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{14}$/", ObjectSerializer::toString($cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$cnpj when calling DescriODoObjetoDaRecorrNciaDevedor., must conform to the pattern /^[0-9A-Z]{14}$/.");
        }

 ...
 */
class CobRBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobRBase';
    ...
    */
    ...
    public function setInfoAdicional($info_adicional)
    {
        ...
        if ((mb_strlen($info_adicional) > 140)) {
            throw new \InvalidArgumentException('invalid length for $info_adicional when calling CobRBase., must be smaller than or equal to 140.');
        }
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\InformaEsSobreCalendRioDaCobranA|null
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\InformaEsSobreCalendRioDaCobranA|null $calendario calendario
     *
     * @return self
     */
     ...
     * Gets valor
     *
     * @return \OpenAPI\Client\Model\ValorDaCobranARecorrente|null
     */
     ...
     * Sets valor
     *
     * @param \OpenAPI\Client\Model\ValorDaCobranARecorrente|null $valor valor
     *
     * @return self
     */
     ...
     * Gets recebedor
     *
     * @return \OpenAPI\Client\Model\DadosBancariosRecebedor|null
     */
     ...
     * Sets recebedor
     *
     * @param \OpenAPI\Client\Model\DadosBancariosRecebedor|null $recebedor O objeto recebedor organiza as informações sobre o recebedor da cobrança.
     *
     * @return self
     */

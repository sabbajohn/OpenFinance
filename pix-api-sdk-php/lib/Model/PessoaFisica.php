...
/**
 * PessoaFisica Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PessoaFisica implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PessoaFisica';
    ...
    */
    ...
    public function setCpf($cpf)
    {
        ...
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($cpf)))) {
            throw new \InvalidArgumentException("invalid value for \$cpf when calling PessoaFisica., must conform to the pattern /^\\d{11}$/.");
        }
    ...
    public function setNome($nome)
    {
        ...
        if ((mb_strlen($nome) > 200)) {
            throw new \InvalidArgumentException('invalid length for $nome when calling PessoaFisica., must be smaller than or equal to 200.');
        }

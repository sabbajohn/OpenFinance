...
/**
 * RecPayloadAllOfRecebedor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecPayloadAllOfRecebedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecPayload_allOf_recebedor';
    ...
    */
     ...
     *
     * @param string $ispb_participante ISPB do usuário recebedor.
     *
     * @return self
     */
    public function setIspbParticipante($ispb_participante)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{8}$/", ObjectSerializer::toString($ispb_participante)))) {
            throw new \InvalidArgumentException("invalid value for \$ispb_participante when calling RecPayloadAllOfRecebedor., must conform to the pattern /^[0-9A-Z]{8}$/.");
        }

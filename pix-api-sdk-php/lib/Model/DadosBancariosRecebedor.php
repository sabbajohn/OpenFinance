...
/**
 * DadosBancariosRecebedor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DadosBancariosRecebedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DadosBancariosRecebedor';
    ...
    public const TIPO_CONTA_CORRENTE = 'CORRENTE';
    public const TIPO_CONTA_POUPANCA = 'POUPANCA';
    public const TIPO_CONTA_PAGAMENTO = 'PAGAMENTO';
     ...
     * @return string[]
     */
    public function getTipoContaAllowableValues()
    {
        return [
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tipo_conta', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tipo_conta'] === null) {
            $invalidProperties[] = "'tipo_conta' can't be null";
        }
        $allowedValues = $this->getTipoContaAllowableValues();
        if (!is_null($this->container['tipo_conta']) && !in_array($this->container['tipo_conta'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'tipo_conta', must be one of '%s'",
                $this->container['tipo_conta'],
     ...
     * Sets conta
     *
     * @param string $conta Número da conta do usuário recebedor.
     *
     * @return self
     */
    public function setConta($conta)
    {
        ...
        if ((mb_strlen($conta) > 20)) {
            throw new \InvalidArgumentException('invalid length for $conta when calling DadosBancariosRecebedor., must be smaller than or equal to 20.');
        }
    ...
    {
        return $this->container['tipo_conta'];
    }

    /**
     * Sets tipo_conta
     *
     * @param string $tipo_conta Tipo da conta do usuário recebedor.
     *
     * @return self
     */
    public function setTipoConta($tipo_conta)
    {
        if (is_null($tipo_conta)) {
            throw new \InvalidArgumentException('non-nullable tipo_conta cannot be null');
        }
        $allowedValues = $this->getTipoContaAllowableValues();
        if (!in_array($tipo_conta, $allowedValues, true)) {
        ...
        $this->container['tipo_conta'] = $tipo_conta;
     ...
     * Sets agencia
     *
     * @param string|null $agencia Número da agência do usuário recebedor.
     *
     * @return self
     */
    public function setAgencia($agencia)
    {
        ...
        if ((mb_strlen($agencia) > 4)) {
            throw new \InvalidArgumentException('invalid length for $agencia when calling DadosBancariosRecebedor., must be smaller than or equal to 4.');
        }

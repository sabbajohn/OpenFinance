 ...
 */
class CobCompleta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobCompleta';
    ...
    protected static $openAPITypes = [
        'calendario' => '\OpenAPI\Client\Model\CalendRio',
        'txid' => 'string',
        'revisao' => 'int',
        'devedor' => '\OpenAPI\Client\Model\CobGeradaAllOfDevedor',
        'loc' => '\OpenAPI\Client\Model\PayloadLocation',
        'location' => 'string',
        'status' => '\OpenAPI\Client\Model\CobrancaStatus',
        'valor' => '\OpenAPI\Client\Model\CobValor',
        'pix_copia_e_cola' => 'string',
        'chave' => 'string',
        'solicitacao_pagador' => 'string',
        'info_adicionais' => '\OpenAPI\Client\Model\InformaEsAdicionaisInner[]',
        'pix' => '\OpenAPI\Client\Model\CobCompletaAllOfPix[]'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'status' => false,
        'valor' => false,
        'pix_copia_e_cola' => false,
        'chave' => false,
        'solicitacao_pagador' => false,
        'info_adicionais' => false,
        'pix' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('revisao', $data ?? [], null);
        $this->setIfExists('devedor', $data ?? [], null);
        $this->setIfExists('loc', $data ?? [], null);
        $this->setIfExists('location', $data ?? [], null);
        $this->setIfExists('status', $data ?? [], null);
        $this->setIfExists('valor', $data ?? [], null);
        $this->setIfExists('pix_copia_e_cola', $data ?? [], null);
        $this->setIfExists('chave', $data ?? [], null);
        $this->setIfExists('solicitacao_pagador', $data ?? [], null);
        $this->setIfExists('info_adicionais', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['location']) && (mb_strlen($this->container['location']) > 77)) {
            $invalidProperties[] = "invalid value for 'location', the character length must be smaller than or equal to 77.";
        }
        ...
        if (!is_null($this->container['pix_copia_e_cola']) && (mb_strlen($this->container['pix_copia_e_cola']) > 512)) {
            $invalidProperties[] = "invalid value for 'pix_copia_e_cola', the character length must be smaller than or equal to 512.";
        }

        if ($this->container['chave'] === null) {
            $invalidProperties[] = "'chave' can't be null";
        }
        if ((mb_strlen($this->container['chave']) > 77)) {
            $invalidProperties[] = "invalid value for 'chave', the character length must be smaller than or equal to 77.";
        }

        if (!is_null($this->container['solicitacao_pagador']) && (mb_strlen($this->container['solicitacao_pagador']) > 140)) {
            $invalidProperties[] = "invalid value for 'solicitacao_pagador', the character length must be smaller than or equal to 140.";
        }
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\CalendRio
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\CalendRio $calendario calendario
     *
     * @return self
     */
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobCompleta., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
    ...
    {
        if (is_null($revisao)) {
            throw new \InvalidArgumentException('non-nullable revisao cannot be null');
        }
     ...
     * Gets devedor
     *
     * @return \OpenAPI\Client\Model\CobGeradaAllOfDevedor|null
     */
     ...
     * Sets devedor
     *
     * @param \OpenAPI\Client\Model\CobGeradaAllOfDevedor|null $devedor devedor
     *
     * @return self
     */
     ...
     * Gets loc
     *
     * @return \OpenAPI\Client\Model\PayloadLocation|null
     */
     ...
     * Sets loc
     *
     * @param \OpenAPI\Client\Model\PayloadLocation|null $loc loc
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string|null $location Localização do Payload a ser informada na criação da cobrança.
     *
     * @return self
     */
    public function setLocation($location)
    {
        ...
        if ((mb_strlen($location) > 77)) {
            throw new \InvalidArgumentException('invalid length for $location when calling CobCompleta., must be smaller than or equal to 77.');
        }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\CobrancaStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\CobrancaStatus $status status
     *
     * @return self
     */
     ...
     * Gets valor
     *
     * @return \OpenAPI\Client\Model\CobValor
     */
     ...
     * Sets valor
     *
     * @param \OpenAPI\Client\Model\CobValor $valor valor
     *
     * @return self
     */
     ...
     *
     * @param string|null $pix_copia_e_cola Este campo retorna o valor do Pix Copia e Cola correspondente à cobrança. Trata-se da sequência de caracteres que representa o BR Code.
     *
     * @return self
     */
    public function setPixCopiaECola($pix_copia_e_cola)
    {
        if (is_null($pix_copia_e_cola)) {
            throw new \InvalidArgumentException('non-nullable pix_copia_e_cola cannot be null');
        }
        if ((mb_strlen($pix_copia_e_cola) > 512)) {
            throw new \InvalidArgumentException('invalid length for $pix_copia_e_cola when calling CobCompleta., must be smaller than or equal to 512.');
        }
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CobCompleta., must be smaller than or equal to 77.');
        }
     ...
     *
     * @param string|null $solicitacao_pagador O campo solicitacaoPagador, opcional, determina um texto a ser apresentado ao pagador para que ele possa digitar uma informação correlata, em formato livre, a ser enviada ao recebedor. Esse texto será preenchido, na pacs.008, pelo PSP do pagador, no campo RemittanceInformation <RmtInf>. O tamanho do campo <RmtInf> na pacs.008 está limitado a 140 caracteres.
     *
     * @return self
     */
    public function setSolicitacaoPagador($solicitacao_pagador)
    {
        if (is_null($solicitacao_pagador)) {
            throw new \InvalidArgumentException('non-nullable solicitacao_pagador cannot be null');
        }
        if ((mb_strlen($solicitacao_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $solicitacao_pagador when calling CobCompleta., must be smaller than or equal to 140.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\InformaEsAdicionaisInner[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InformaEsAdicionaisInner[]|null $info_adicionais Cada respectiva informação adicional contida na lista (nome e valor) deve ser apresentada ao pagador.
     *
     * @return self
     */
    public function setInfoAdicionais($info_adicionais)
    {
        if (is_null($info_adicionais)) {
            throw new \InvalidArgumentException('non-nullable info_adicionais cannot be null');
        }
     ...
     * Gets pix
     *
     * @return \OpenAPI\Client\Model\CobCompletaAllOfPix[]|null
     */
     ...
     * Sets pix
     *
     * @param \OpenAPI\Client\Model\CobCompletaAllOfPix[]|null $pix pix
     *
     * @return self
     */

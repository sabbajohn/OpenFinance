...
/**
 * PayloadLocationRecCompleta Class Doc Comment
 *
 * @category Class
 ...
 */
class PayloadLocationRecCompleta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayloadLocationRecCompleta';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('criacao', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['location']) > 77)) {
     ...
     * Sets id
     *
     * @param int $id Identificador da location a ser informada na criação de uma recorrência .
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param string $location Localização do Payload a ser informada na criação da recorrência.
     *
     * @return self
     */
    public function setLocation($location)
    {
        ...
        if ((mb_strlen($location) > 77)) {
            throw new \InvalidArgumentException('invalid length for $location when calling PayloadLocationRecCompleta., must be smaller than or equal to 77.');
        }
    ...
    {
        if (is_null($criacao)) {
            throw new \InvalidArgumentException('non-nullable criacao cannot be null');
        }
    ...
    public function setIdRec($id_rec)
    {
        ...
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling PayloadLocationRecCompleta., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling PayloadLocationRecCompleta., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling PayloadLocationRecCompleta., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }

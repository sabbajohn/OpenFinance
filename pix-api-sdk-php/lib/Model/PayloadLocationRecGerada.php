...
/**
 * PayloadLocationRecGerada Class Doc Comment
 *
 * @category Class
 ...
 */
class PayloadLocationRecGerada implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayloadLocationRecGerada';
    ...
    */
    ...
    public function setLocation($location)
    {
        ...
        if ((mb_strlen($location) > 77)) {
            throw new \InvalidArgumentException('invalid length for $location when calling PayloadLocationRecGerada., must be smaller than or equal to 77.');
        }

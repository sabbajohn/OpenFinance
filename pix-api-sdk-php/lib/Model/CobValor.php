 ...
 */
class CobValor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobValor';
    ...
    protected static $openAPITypes = [
        ...
        'retirada' => '\OpenAPI\Client\Model\InformaEsDeRetirada'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('modalidade_alteracao', $data ?? [], null);
    ...
    */
    ...
    public function setOriginal($original)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($original)))) {
            throw new \InvalidArgumentException("invalid value for \$original when calling CobValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
    ...
    public function setModalidadeAlteracao($modalidade_alteracao)
    {
        ...
        if (($modalidade_alteracao > 1)) {
            throw new \InvalidArgumentException('invalid value for $modalidade_alteracao when calling CobValor., must be smaller than or equal to 1.');
        }
        if (($modalidade_alteracao < 0)) {
            throw new \InvalidArgumentException('invalid value for $modalidade_alteracao when calling CobValor., must be bigger than or equal to 0.');
        }
     ...
     * Gets retirada
     *
     * @return \OpenAPI\Client\Model\InformaEsDeRetirada|null
     */
     ...
     * Sets retirada
     *
     * @param \OpenAPI\Client\Model\InformaEsDeRetirada|null $retirada retirada
     *
     * @return self
     */

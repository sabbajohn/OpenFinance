...
/**
 * DadosRecebedorRecebedorOneOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DadosRecebedorRecebedorOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DadosRecebedor_recebedor_oneOf';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9A-Z]{14}$/", $this->container['cnpj'])) {
        ...
        if ((mb_strlen($this->container['nome']) > 200)) {
            $invalidProperties[] = "invalid value for 'nome', the character length must be smaller than or equal to 200.";
        }

        if (!is_null($this->container['nome_fantasia']) && (mb_strlen($this->container['nome_fantasia']) > 200)) {
            $invalidProperties[] = "invalid value for 'nome_fantasia', the character length must be smaller than or equal to 200.";
        }
    ...
    public function setCnpj($cnpj)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{14}$/", ObjectSerializer::toString($cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$cnpj when calling DadosRecebedorRecebedorOneOf., must conform to the pattern /^[0-9A-Z]{14}$/.");
        }
    ...
    public function setNome($nome)
    {
        ...
        if ((mb_strlen($nome) > 200)) {
            throw new \InvalidArgumentException('invalid length for $nome when calling DadosRecebedorRecebedorOneOf., must be smaller than or equal to 200.');
        }
     ...
     * Sets nome_fantasia
     *
     * @param string|null $nome_fantasia Nome fantasia.
     *
     * @return self
     */
    public function setNomeFantasia($nome_fantasia)
    {
        ...
        if ((mb_strlen($nome_fantasia) > 200)) {
            throw new \InvalidArgumentException('invalid length for $nome_fantasia when calling DadosRecebedorRecebedorOneOf., must be smaller than or equal to 200.');
        }

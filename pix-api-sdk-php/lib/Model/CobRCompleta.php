...
/**
 * CobRCompleta Class Doc Comment
 *
 * @category Class
 ...
 */
class CobRCompleta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobRCompleta';
    ...
    protected static $openAPITypes = [
        ...
        'calendario' => '\OpenAPI\Client\Model\CobRGeradaAllOfCalendario',
        'valor' => '\OpenAPI\Client\Model\ValorDaCobranARecorrente',
        'ajuste_dia_util' => 'bool',
        'recebedor' => '\OpenAPI\Client\Model\DadosBancariosRecebedor',
        'status' => 'string',
        'politica_retentativa' => 'string',
        'devedor' => '\OpenAPI\Client\Model\DadosDevedorRecorrenciaDevedor',
        'atualizacao' => '\OpenAPI\Client\Model\HistRicoDeStatusInner1[]',
        'encerramento' => '\OpenAPI\Client\Model\DetalhamentoDoEncerramentoDaCobranA',
        'tentativas' => '\OpenAPI\Client\Model\HistRicoDeTentativasDeCobranAInner[]',
        'id_rec' => 'string',
        'txid' => 'string',
        'pix' => '\OpenAPI\Client\Model\CobRCompletaAllOfPix[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'calendario' => null,
        'valor' => null,
        'ajuste_dia_util' => null,
        'recebedor' => null,
        'status' => null,
        'politica_retentativa' => null,
        'devedor' => null,
        'atualizacao' => null,
        'encerramento' => null,
        'tentativas' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'calendario' => false,
        'valor' => false,
        'ajuste_dia_util' => false,
        'recebedor' => false,
        'status' => false,
        'politica_retentativa' => false,
        'devedor' => false,
        'atualizacao' => false,
        'encerramento' => false,
        'tentativas' => false,
    ...
    protected static $setters = [
        'info_adicional' => 'setInfoAdicional',
        'calendario' => 'setCalendario',
        'valor' => 'setValor',
        'ajuste_dia_util' => 'setAjusteDiaUtil',
        'recebedor' => 'setRecebedor',
        'status' => 'setStatus',
        'politica_retentativa' => 'setPoliticaRetentativa',
        'devedor' => 'setDevedor',
        'atualizacao' => 'setAtualizacao',
        'encerramento' => 'setEncerramento',
    ...
    protected static $getters = [
        'info_adicional' => 'getInfoAdicional',
        'calendario' => 'getCalendario',
        'valor' => 'getValor',
        'ajuste_dia_util' => 'getAjusteDiaUtil',
        'recebedor' => 'getRecebedor',
        'status' => 'getStatus',
        'politica_retentativa' => 'getPoliticaRetentativa',
        'devedor' => 'getDevedor',
    ...
    public const POLITICA_RETENTATIVA_NAO_PERMITE = 'NAO_PERMITE';
    public const POLITICA_RETENTATIVA_PERMITE_3_R_7_D = 'PERMITE_3R_7D';
     ...
     * @return string[]
     */
    public function getPoliticaRetentativaAllowableValues()
    {
        return [
            self::POLITICA_RETENTATIVA_NAO_PERMITE,
            self::POLITICA_RETENTATIVA_PERMITE_3_R_7_D,
        ];
    }
    ...
    {
        $this->setIfExists('info_adicional', $data ?? [], null);
        $this->setIfExists('calendario', $data ?? [], null);
        $this->setIfExists('valor', $data ?? [], null);
        $this->setIfExists('ajuste_dia_util', $data ?? [], true);
        $this->setIfExists('recebedor', $data ?? [], null);
        $this->setIfExists('status', $data ?? [], null);
        $this->setIfExists('politica_retentativa', $data ?? [], null);
        $this->setIfExists('devedor', $data ?? [], null);
        $this->setIfExists('atualizacao', $data ?? [], null);
        $this->setIfExists('encerramento', $data ?? [], null);
        $this->setIfExists('tentativas', $data ?? [], null);
        $this->setIfExists('id_rec', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['info_adicional']) && (mb_strlen($this->container['info_adicional']) > 140)) {
            $invalidProperties[] = "invalid value for 'info_adicional', the character length must be smaller than or equal to 140.";
        }
        ...
        if ($this->container['ajuste_dia_util'] === null) {
            $invalidProperties[] = "'ajuste_dia_util' can't be null";
        }
        ...
        if ($this->container['politica_retentativa'] === null) {
            $invalidProperties[] = "'politica_retentativa' can't be null";
        }
        $allowedValues = $this->getPoliticaRetentativaAllowableValues();
        if (!is_null($this->container['politica_retentativa']) && !in_array($this->container['politica_retentativa'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'politica_retentativa', must be one of '%s'",
                $this->container['politica_retentativa'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['atualizacao'] === null) {
            $invalidProperties[] = "'atualizacao' can't be null";
        }
        if ($this->container['id_rec'] === null) {
            $invalidProperties[] = "'id_rec' can't be null";
        }
        if ((mb_strlen($this->container['id_rec']) > 29)) {
            $invalidProperties[] = "invalid value for 'id_rec', the character length must be smaller than or equal to 29.";
        }

        if ((mb_strlen($this->container['id_rec']) < 29)) {
            $invalidProperties[] = "invalid value for 'id_rec', the character length must be bigger than or equal to 29.";
        }

        if (!preg_match("/[a-zA-Z0-9]{29}/", $this->container['id_rec'])) {
            $invalidProperties[] = "invalid value for 'id_rec', must be conform to the pattern /[a-zA-Z0-9]{29}/.";
        }

        if ($this->container['txid'] === null) {
            $invalidProperties[] = "'txid' can't be null";
        }
        if (!preg_match("/[a-zA-Z0-9]{26,35}/", $this->container['txid'])) {
            $invalidProperties[] = "invalid value for 'txid', must be conform to the pattern /[a-zA-Z0-9]{26,35}/.";
        }
    ...
    {
        return $this->container['info_adicional'];
    }

    /**
     * Sets info_adicional
     *
     * @param string|null $info_adicional Informações adicionais da fatura.
     *
     * @return self
     */
    public function setInfoAdicional($info_adicional)
    {
        if (is_null($info_adicional)) {
            throw new \InvalidArgumentException('non-nullable info_adicional cannot be null');
        }
        if ((mb_strlen($info_adicional) > 140)) {
            throw new \InvalidArgumentException('invalid length for $info_adicional when calling CobRCompleta., must be smaller than or equal to 140.');
        }

        $this->container['info_adicional'] = $info_adicional;
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\CobRGeradaAllOfCalendario
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\CobRGeradaAllOfCalendario $calendario calendario
     *
     * @return self
     */
    public function setCalendario($calendario)
    {
        if (is_null($calendario)) {
            throw new \InvalidArgumentException('non-nullable calendario cannot be null');
        }
     ...
     * Gets valor
     *
     * @return \OpenAPI\Client\Model\ValorDaCobranARecorrente
     */
     ...
     * Sets valor
     *
     * @param \OpenAPI\Client\Model\ValorDaCobranARecorrente $valor valor
     *
     * @return self
     */
    ...
    /**
     * Gets ajuste_dia_util
     *
     * @return bool
     */
    public function getAjusteDiaUtil()
    {
        return $this->container['ajuste_dia_util'];
    }

    /**
     * Sets ajuste_dia_util
     *
     * @param bool $ajuste_dia_util Campo de ativação do ajuste da data prevista para liquidação para próximo dia útil caso o vencimento corrente seja um dia não útil. O PSP Recebedor deverá considerar os feriados locais com base no código município do usuário pagador.
     *
     * @return self
     */
    public function setAjusteDiaUtil($ajuste_dia_util)
    {
        if (is_null($ajuste_dia_util)) {
            throw new \InvalidArgumentException('non-nullable ajuste_dia_util cannot be null');
        }
        $this->container['ajuste_dia_util'] = $ajuste_dia_util;
     ...
     * Gets recebedor
     *
     * @return \OpenAPI\Client\Model\DadosBancariosRecebedor
     */
     ...
     * Sets recebedor
     *
     * @param \OpenAPI\Client\Model\DadosBancariosRecebedor $recebedor O objeto recebedor organiza as informações sobre o recebedor da cobrança.
     *
     * @return self
     */
    public function setRecebedor($recebedor)
    {
        if (is_null($recebedor)) {
            throw new \InvalidArgumentException('non-nullable recebedor cannot be null');
        }
    ...
    /**
     * Gets politica_retentativa
     *
     * @return string
     */
    public function getPoliticaRetentativa()
    {
        return $this->container['politica_retentativa'];
    }

    /**
     * Sets politica_retentativa
     *
     * @param string $politica_retentativa politica_retentativa
     *
     * @return self
     */
    public function setPoliticaRetentativa($politica_retentativa)
    {
        if (is_null($politica_retentativa)) {
            throw new \InvalidArgumentException('non-nullable politica_retentativa cannot be null');
        }
        $allowedValues = $this->getPoliticaRetentativaAllowableValues();
        if (!in_array($politica_retentativa, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'politica_retentativa', must be one of '%s'",
        ...
        $this->container['politica_retentativa'] = $politica_retentativa;
     ...
     * Gets devedor
     *
     * @return \OpenAPI\Client\Model\DadosDevedorRecorrenciaDevedor|null
     */
     ...
     * Sets devedor
     *
     * @param \OpenAPI\Client\Model\DadosDevedorRecorrenciaDevedor|null $devedor devedor
     *
     * @return self
     */
    ...
    {
        if (is_null($devedor)) {
            throw new \InvalidArgumentException('non-nullable devedor cannot be null');
        }
     ...
     * Gets atualizacao
     *
     * @return \OpenAPI\Client\Model\HistRicoDeStatusInner1[]
     */
    public function getAtualizacao()
    {
        return $this->container['atualizacao'];
    }

    /**
     * Sets atualizacao
     *
     * @param \OpenAPI\Client\Model\HistRicoDeStatusInner1[] $atualizacao Histórico das mudanças de status das cobranças recorrentes.
     *
     * @return self
     */
    public function setAtualizacao($atualizacao)
    {
        if (is_null($atualizacao)) {
            throw new \InvalidArgumentException('non-nullable atualizacao cannot be null');
        }
        $this->container['atualizacao'] = $atualizacao;
     ...
     * Gets encerramento
     *
     * @return \OpenAPI\Client\Model\DetalhamentoDoEncerramentoDaCobranA|null
     */
    public function getEncerramento()
    {
        return $this->container['encerramento'];
    }

    /**
     * Sets encerramento
     *
     * @param \OpenAPI\Client\Model\DetalhamentoDoEncerramentoDaCobranA|null $encerramento encerramento
     *
     * @return self
     */
    public function setEncerramento($encerramento)
    {
        if (is_null($encerramento)) {
            throw new \InvalidArgumentException('non-nullable encerramento cannot be null');
        }
        $this->container['encerramento'] = $encerramento;
     ...
     * Gets tentativas
     *
     * @return \OpenAPI\Client\Model\HistRicoDeTentativasDeCobranAInner[]|null
     */
    public function getTentativas()
    {
        return $this->container['tentativas'];
    }

    /**
     * Sets tentativas
     *
     * @param \OpenAPI\Client\Model\HistRicoDeTentativasDeCobranAInner[]|null $tentativas Histórico de Tentativas de Cobrança
     *
     * @return self
     */
    public function setTentativas($tentativas)
    {
        if (is_null($tentativas)) {
            throw new \InvalidArgumentException('non-nullable tentativas cannot be null');
        }
        $this->container['tentativas'] = $tentativas;
    ...
    {
        if (is_null($id_rec)) {
            throw new \InvalidArgumentException('non-nullable id_rec cannot be null');
        }
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling CobRCompleta., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling CobRCompleta., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling CobRCompleta., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }

        $this->container['id_rec'] = $id_rec;
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobRCompleta., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
     ...
     * Gets pix
     *
     * @return \OpenAPI\Client\Model\CobRCompletaAllOfPix[]|null
     */
     ...
     * Sets pix
     *
     * @param \OpenAPI\Client\Model\CobRCompletaAllOfPix[]|null $pix pix
     *
     * @return self
     */

...
/**
 * AbatimentoAplicado Class Doc Comment
 *
 * @category Class
 ...
 */
class AbatimentoAplicado implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Abatimento_aplicado';
    ...
    */
     ...
     * Sets modalidade
     *
     * @param int $modalidade ##### Modalidade de abatimentos, conforme tabela de domínios. <table><tr><th>Descrição</th><th>Domínio</th></tr><tr><td>Valor Fixo</td><td>1</td></tr><tr><td>Percentual</td><td>2</td></tr></table>
     *
     * @return self
     */
    public function setModalidade($modalidade)
    {
        ...
        if (($modalidade > 2)) {
            throw new \InvalidArgumentException('invalid value for $modalidade when calling AbatimentoAplicado., must be smaller than or equal to 2.');
        }
        if (($modalidade < 1)) {
            throw new \InvalidArgumentException('invalid value for $modalidade when calling AbatimentoAplicado., must be bigger than or equal to 1.');
        }
    ...
    public function setValorPerc($valor_perc)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor_perc)))) {
            throw new \InvalidArgumentException("invalid value for \$valor_perc when calling AbatimentoAplicado., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

...
/**
 * CobVCompleta Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CobVCompleta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobVCompleta';
    ...
    protected static $openAPITypes = [
        'calendario' => '\OpenAPI\Client\Model\CalendRio1',
        'txid' => 'string',
        'revisao' => 'int',
        'devedor' => '\OpenAPI\Client\Model\DadosDevedorDevedor',
        'recebedor' => '\OpenAPI\Client\Model\DadosComplementaresPessoa',
        'loc' => '\OpenAPI\Client\Model\PayloadLocation',
        'status' => '\OpenAPI\Client\Model\CobrancaStatus',
        'valor' => '\OpenAPI\Client\Model\CobVValor',
        'pix_copia_e_cola' => 'string',
        'chave' => 'string',
        'solicitacao_pagador' => 'string',
        'info_adicionais' => '\OpenAPI\Client\Model\InformaEsAdicionaisInner[]',
        'pix' => '\OpenAPI\Client\Model\CobVCompletaAllOfPix[]'
    ];
    ...
    */
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\CalendRio1
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\CalendRio1 $calendario calendario
     *
     * @return self
     */
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobVCompleta., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
     ...
     * Gets devedor
     *
     * @return \OpenAPI\Client\Model\DadosDevedorDevedor
     */
     ...
     * Sets devedor
     *
     * @param \OpenAPI\Client\Model\DadosDevedorDevedor $devedor devedor
     *
     * @return self
     */
     ...
     * Gets recebedor
     *
     * @return \OpenAPI\Client\Model\DadosComplementaresPessoa
     */
     ...
     * Sets recebedor
     *
     * @param \OpenAPI\Client\Model\DadosComplementaresPessoa $recebedor O objeto recebedor organiza as informações sobre o credor da cobrança.
     *
     * @return self
     */
     ...
     * Gets valor
     *
     * @return \OpenAPI\Client\Model\CobVValor
     */
     ...
     * Sets valor
     *
     * @param \OpenAPI\Client\Model\CobVValor $valor valor
     *
     * @return self
     */
    ...
    public function setPixCopiaECola($pix_copia_e_cola)
    {
        ...
        if ((mb_strlen($pix_copia_e_cola) > 512)) {
            throw new \InvalidArgumentException('invalid length for $pix_copia_e_cola when calling CobVCompleta., must be smaller than or equal to 512.');
        }
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CobVCompleta., must be smaller than or equal to 77.');
        }
    ...
    public function setSolicitacaoPagador($solicitacao_pagador)
    {
        ...
        if ((mb_strlen($solicitacao_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $solicitacao_pagador when calling CobVCompleta., must be smaller than or equal to 140.');
        }
     ...
     * Gets pix
     *
     * @return \OpenAPI\Client\Model\CobVCompletaAllOfPix[]|null
     */
     ...
     * Sets pix
     *
     * @param \OpenAPI\Client\Model\CobVCompletaAllOfPix[]|null $pix pix
     *
     * @return self
     */

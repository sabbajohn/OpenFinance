...
/**
 * DadosRelacionadosConfirmaODaAtivaODaRecorrNcia Class Doc Comment
 *
 * @category Class
 ...
 */
class DadosRelacionadosConfirmaODaAtivaODaRecorrNcia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dados_relacionados___confirma__o_da_ativa__o_da_recorr_ncia_';
    ...
    protected static $openAPITypes = [
        'tipo_jornada' => 'string',
        'dados_jornada' => '\OpenAPI\Client\Model\CobranAImediataVinculadaJornada3'
    ];
    ...
    public const TIPO_JORNADA_JORNADA_1 = 'JORNADA_1';
    public const TIPO_JORNADA_JORNADA_2 = 'JORNADA_2';
    public const TIPO_JORNADA_JORNADA_3 = 'JORNADA_3';
    public const TIPO_JORNADA_JORNADA_4 = 'JORNADA_4';
    public const TIPO_JORNADA_AGUARDANDO_DEFINICAO = 'AGUARDANDO_DEFINICAO';
    ...
    {
        return [
            self::TIPO_JORNADA_JORNADA_1,
            self::TIPO_JORNADA_JORNADA_2,
            self::TIPO_JORNADA_JORNADA_3,
            self::TIPO_JORNADA_JORNADA_4,
            self::TIPO_JORNADA_AGUARDANDO_DEFINICAO,
        ];
    }
    ...
    {
        $this->setIfExists('tipo_jornada', $data ?? [], null);
        $this->setIfExists('dados_jornada', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tipo_jornada'] === null) {
            $invalidProperties[] = "'tipo_jornada' can't be null";
        }
        ...
        if (!is_null($this->container['tipo_jornada']) && !in_array($this->container['tipo_jornada'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'tipo_jornada', must be one of '%s'",
                $this->container['tipo_jornada'],
     ...
     * Gets dados_jornada
     *
     * @return \OpenAPI\Client\Model\CobranAImediataVinculadaJornada3|null
     */
    public function getDadosJornada()
    {
        return $this->container['dados_jornada'];
    }

    /**
     * Sets dados_jornada
     *
     * @param \OpenAPI\Client\Model\CobranAImediataVinculadaJornada3|null $dados_jornada dados_jornada
     *
     * @return self
     */
    public function setDadosJornada($dados_jornada)
    {
        if (is_null($dados_jornada)) {
            throw new \InvalidArgumentException('non-nullable dados_jornada cannot be null');
        }
        $this->container['dados_jornada'] = $dados_jornada;

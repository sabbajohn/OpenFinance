 ...
 */
class Devolucao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Devolucao';
    ...
    protected static $openAPITypes = [
        ...
        'rtr_id' => 'string',
        'valor' => 'string',
        'natureza' => '\OpenAPI\Client\Model\DevolucaoNatureza',
        'descricao' => 'string',
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{1,35}/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling Devolucao., must conform to the pattern /[a-zA-Z0-9]{1,35}/.");
        }
    ...
    public function setRtrId($rtr_id)
    {
        ...
        if ((mb_strlen($rtr_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $rtr_id when calling Devolucao., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($rtr_id) < 32)) {
            throw new \InvalidArgumentException('invalid length for $rtr_id when calling Devolucao., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{32}/", ObjectSerializer::toString($rtr_id)))) {
            throw new \InvalidArgumentException("invalid value for \$rtr_id when calling Devolucao., must conform to the pattern /[a-zA-Z0-9]{32}/.");
        }
    ...
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling Devolucao., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     * Gets natureza
     *
     * @return \OpenAPI\Client\Model\DevolucaoNatureza|null
     */
     ...
     * Sets natureza
     *
     * @param \OpenAPI\Client\Model\DevolucaoNatureza|null $natureza natureza
     *
     * @return self
     */
    ...
    public function setDescricao($descricao)
    {
        ...
        if ((mb_strlen($descricao) > 140)) {
            throw new \InvalidArgumentException('invalid length for $descricao when calling Devolucao., must be smaller than or equal to 140.');
        }
    ...
    public function setMotivo($motivo)
    {
        ...
        if ((mb_strlen($motivo) > 140)) {
            throw new \InvalidArgumentException('invalid length for $motivo when calling Devolucao., must be smaller than or equal to 140.');
        }

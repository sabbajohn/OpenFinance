...
/**
 * RecSolicitadaAllOfRecebedor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecSolicitadaAllOfRecebedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecSolicitada_allOf_recebedor';
    ...
    */
    ...
    public function setConvenio($convenio)
    {
        ...
        if ((mb_strlen($convenio) > 60)) {
            throw new \InvalidArgumentException('invalid length for $convenio when calling RecSolicitadaAllOfRecebedor., must be smaller than or equal to 60.');
        }

 ...
 */
class CobRGerada implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobRGerada';
    ...
    protected static $openAPITypes = [
        ...
        'recebedor' => '\OpenAPI\Client\Model\PessoaJuridicaRecorrencia',
        'status' => 'string',
    ...
    */
    ...
    public function setInfoAdicional($info_adicional)
    {
        ...
        if ((mb_strlen($info_adicional) > 140)) {
            throw new \InvalidArgumentException('invalid length for $info_adicional when calling CobRGerada., must be smaller than or equal to 140.');
        }
     ...
     * Gets recebedor
     *
     * @return \OpenAPI\Client\Model\PessoaJuridicaRecorrencia
     */
     ...
     * Sets recebedor
     *
     * @param \OpenAPI\Client\Model\PessoaJuridicaRecorrencia $recebedor recebedor
     *
     * @return self
     */
    ...
    public function setIdRec($id_rec)
    {
        ...
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling CobRGerada., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling CobRGerada., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling CobRGerada., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobRGerada., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }

...
/**
 * RecsConsultadas Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecsConsultadas implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecsConsultadas';
    ...
    protected static $openAPITypes = [
        'parametros' => '\OpenAPI\Client\Model\ParametrosConsultaRec',
        'recs' => '\OpenAPIClientModelRecCompletaPesquisada[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('recs', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recs'] === null) {
            $invalidProperties[] = "'recs' can't be null";
        }
     ...
     * Gets parametros
     *
     * @return \OpenAPI\Client\Model\ParametrosConsultaRec
     */
     ...
     * Sets parametros
     *
     * @param \OpenAPI\Client\Model\ParametrosConsultaRec $parametros parametros
     *
     * @return self
     */
     ...
     * Gets recs
     *
     * @return \OpenAPIClientModelRecCompletaPesquisada[]
     */
    public function getRecs()
    {
        return $this->container['recs'];
    }

    /**
     * Sets recs
     *
     * @param \OpenAPIClientModelRecCompletaPesquisada[] $recs recs
     *
     * @return self
     */
    ...
    {
        if (is_null($recs)) {
            throw new \InvalidArgumentException('non-nullable recs cannot be null');
        }
        $this->container['recs'] = $recs;

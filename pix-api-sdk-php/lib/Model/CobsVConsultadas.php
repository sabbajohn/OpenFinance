...
/**
 * CobsVConsultadas Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CobsVConsultadas implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobsVConsultadas';
    ...
    protected static $openAPITypes = [
        'parametros' => '\OpenAPI\Client\Model\ParametrosConsultaCob',
        'cobs' => '\OpenAPIClientModelCobVCompleta[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cobs', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets parametros
     *
     * @return \OpenAPI\Client\Model\ParametrosConsultaCob
     */
     ...
     * Sets parametros
     *
     * @param \OpenAPI\Client\Model\ParametrosConsultaCob $parametros parametros
     *
     * @return self
     */
     ...
     * Gets cobs
     *
     * @return \OpenAPIClientModelCobVCompleta[]
     */
     ...
     * Sets cobs
     *
     * @param \OpenAPIClientModelCobVCompleta[] $cobs cobs
     *
     * @return self
     */
    ...
    {
        if (is_null($cobs)) {
            throw new \InvalidArgumentException('non-nullable cobs cannot be null');
        }

...
/**
 * LoteCobVGerado Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LoteCobVGerado implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoteCobVGerado';
    ...
    protected static $openAPITypes = [
        ...
        'descricao' => 'string',
        'criacao' => '\DateTime',
        'cobsv' => '\OpenAPI\Client\Model\CobVGerada[]'
    ];
    ...
    */
     ...
     * Gets cobsv
     *
     * @return \OpenAPI\Client\Model\CobVGerada[]
     */
     ...
     * Sets cobsv
     *
     * @param \OpenAPI\Client\Model\CobVGerada[] $cobsv cobsv
     *
     * @return self
     */

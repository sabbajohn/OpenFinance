...
/**
 * DadosBancarios Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DadosBancarios implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DadosBancarios';
    ...
    protected static $attributeMap = [
        'conta' => 'conta',
        'ispb_participante' => 'ispbParticipante',
        'agencia' => 'agencia'
    ];
    ...
    protected static $setters = [
        'conta' => 'setConta',
        'ispb_participante' => 'setIspbParticipante',
        'agencia' => 'setAgencia'
    ];
    ...
    protected static $getters = [
        'conta' => 'getConta',
        'ispb_participante' => 'getIspbParticipante',
        'agencia' => 'getAgencia'
    ];
    ...
    {
        $this->setIfExists('conta', $data ?? [], null);
        $this->setIfExists('ispb_participante', $data ?? [], null);
        $this->setIfExists('agencia', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['conta'] === null) {
            $invalidProperties[] = "'conta' can't be null";
        }
        if ((mb_strlen($this->container['conta']) > 20)) {
            $invalidProperties[] = "invalid value for 'conta', the character length must be smaller than or equal to 20.";
        }

        if ($this->container['ispb_participante'] === null) {
            $invalidProperties[] = "'ispb_participante' can't be null";
        }
        if (!preg_match("/^[0-9A-Z]{8}$/", $this->container['ispb_participante'])) {
            $invalidProperties[] = "invalid value for 'ispb_participante', must be conform to the pattern /^[0-9A-Z]{8}$/.";
        }

        if (!is_null($this->container['agencia']) && (mb_strlen($this->container['agencia']) > 4)) {
            $invalidProperties[] = "invalid value for 'agencia', the character length must be smaller than or equal to 4.";
        }
    ...
    {
        return $this->container['conta'];
    }

    /**
     * Sets conta
     *
     * @param string $conta Número da conta do usuário pagador.
     *
     * @return self
     */
    ...
    {
        if (is_null($conta)) {
            throw new \InvalidArgumentException('non-nullable conta cannot be null');
        }
        if ((mb_strlen($conta) > 20)) {
            throw new \InvalidArgumentException('invalid length for $conta when calling DadosBancarios., must be smaller than or equal to 20.');
        }

        $this->container['conta'] = $conta;

        return $this;
    }

    /**
     * Gets ispb_participante
     *
     * @return string
     */
    public function getIspbParticipante()
    {
        return $this->container['ispb_participante'];
    }

    /**
     * Sets ispb_participante
     *
     * @param string $ispb_participante ISPB do usuário pagador.
     *
     * @return self
     */
    public function setIspbParticipante($ispb_participante)
    {
        if (is_null($ispb_participante)) {
            throw new \InvalidArgumentException('non-nullable ispb_participante cannot be null');
        }

        if ((!preg_match("/^[0-9A-Z]{8}$/", ObjectSerializer::toString($ispb_participante)))) {
            throw new \InvalidArgumentException("invalid value for \$ispb_participante when calling DadosBancarios., must conform to the pattern /^[0-9A-Z]{8}$/.");
        }

        $this->container['ispb_participante'] = $ispb_participante;
     ...
     * Sets agencia
     *
     * @param string|null $agencia Número da agência do usuário pagador.
     *
     * @return self
     */
    ...
    {
        if (is_null($agencia)) {
            throw new \InvalidArgumentException('non-nullable agencia cannot be null');
        }
        if ((mb_strlen($agencia) > 4)) {
            throw new \InvalidArgumentException('invalid length for $agencia when calling DadosBancarios., must be smaller than or equal to 4.');
        }

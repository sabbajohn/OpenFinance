 ...
 */
class PayloadLocationCompleta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayloadLocationCompleta';
    ...
    public const TIPO_COB_COB = 'cob';
    public const TIPO_COB_COBV = 'cobv';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tipo_cob', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tipo_cob']) && !in_array($this->container['tipo_cob'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'tipo_cob', must be one of '%s'",
                $this->container['tipo_cob'],
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling PayloadLocationCompleta., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
    ...
    public function setLocation($location)
    {
        ...
        if ((mb_strlen($location) > 77)) {
            throw new \InvalidArgumentException('invalid length for $location when calling PayloadLocationCompleta., must be smaller than or equal to 77.');
        }
    ...
    {
        if (is_null($tipo_cob)) {
            throw new \InvalidArgumentException('non-nullable tipo_cob cannot be null');
        }
        $allowedValues = $this->getTipoCobAllowableValues();

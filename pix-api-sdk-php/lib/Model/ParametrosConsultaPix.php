...
/**
 * ParametrosConsultaPix Class Doc Comment
 *
 * @category Class
 ...
 */
class ParametrosConsultaPix implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParametrosConsultaPix';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tx_id_presente', $data ?? [], null);
        $this->setIfExists('devolucao_presente', $data ?? [], null);
    ...
    */
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling ParametrosConsultaPix., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
     ...
     * Sets tx_id_presente
     *
     * @param bool|null $tx_id_presente Filtro pela existência de txid.
     *
     * @return self
     */
    public function setTxIdPresente($tx_id_presente)
    {
        if (is_null($tx_id_presente)) {
            throw new \InvalidArgumentException('non-nullable tx_id_presente cannot be null');
        }
     ...
     *
     * @param bool|null $devolucao_presente Filtro pela existência de devolução.
     *
     * @return self
     */
    public function setDevolucaoPresente($devolucao_presente)
    {
        if (is_null($devolucao_presente)) {
            throw new \InvalidArgumentException('non-nullable devolucao_presente cannot be null');
        }
    ...
    public function setCpf($cpf)
    {
        ...
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($cpf)))) {
            throw new \InvalidArgumentException("invalid value for \$cpf when calling ParametrosConsultaPix., must conform to the pattern /^\\d{11}$/.");
        }
    ...
    public function setCnpj($cnpj)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{14}$/", ObjectSerializer::toString($cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$cnpj when calling ParametrosConsultaPix., must conform to the pattern /^[0-9A-Z]{14}$/.");
        }

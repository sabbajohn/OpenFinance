...
/**
 * DadosPagadorRecPagador Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DadosPagadorRecPagador implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DadosPagadorRec_pagador';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cod_mun', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ispb_participante']) && !preg_match("/^[0-9A-Z]{8}$/", $this->container['ispb_participante'])) {
            $invalidProperties[] = "invalid value for 'ispb_participante', must be conform to the pattern /^[0-9A-Z]{8}$/.";
        }

        if (!is_null($this->container['cod_mun']) && !preg_match("/^\\d{7}$/", $this->container['cod_mun'])) {
            $invalidProperties[] = "invalid value for 'cod_mun', must be conform to the pattern /^\\d{7}$/.";
        }
     ...
     *
     * @param string|null $ispb_participante ISPB do PSP pagador.
     *
     * @return self
     */
    public function setIspbParticipante($ispb_participante)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{8}$/", ObjectSerializer::toString($ispb_participante)))) {
            throw new \InvalidArgumentException("invalid value for \$ispb_participante when calling DadosPagadorRecPagador., must conform to the pattern /^[0-9A-Z]{8}$/.");
        }
     ...
     * @return self
     */
    public function setCodMun($cod_mun)
    {
        if (is_null($cod_mun)) {
            throw new \InvalidArgumentException('non-nullable cod_mun cannot be null');
        }

        if ((!preg_match("/^\\d{7}$/", ObjectSerializer::toString($cod_mun)))) {
            throw new \InvalidArgumentException("invalid value for \$cod_mun when calling DadosPagadorRecPagador., must conform to the pattern /^\\d{7}$/.");
        }

        $this->container['cod_mun'] = $cod_mun;

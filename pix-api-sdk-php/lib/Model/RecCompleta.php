 ...
 */
class RecCompleta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecCompleta';
    ...
    protected static $openAPITypes = [
        'vinculo' => '\OpenAPI\Client\Model\DescriODoObjetoDaRecorrNcia',
        'calendario' => '\OpenAPI\Client\Model\InformaEsSobreCalendRioDaRecorrNcia1',
        'valor' => '\OpenAPI\Client\Model\RecBaseValor',
        'pagador' => '\OpenAPI\Client\Model\DadosPagadorRecPagador',
        'status' => 'string',
        'politica_retentativa' => 'string',
        'atualizacao' => '\OpenAPI\Client\Model\HistRicoDeStatusInner[]',
        'encerramento' => '\OpenAPI\Client\Model\DetalhamentoDoEncerramentoDaRecorrNcia',
        'ativacao' => '\OpenAPI\Client\Model\DadosRelacionadosConfirmaODaAtivaODaRecorrNcia',
        'id_rec' => 'string',
        'recebedor' => '\OpenAPI\Client\Model\RecCompletaAllOfRecebedor',
        'loc' => '\OpenAPI\Client\Model\PayloadLocationRecCompleta',
        'solicitacao' => '\OpenAPI\Client\Model\RecCompletaAllOfSolicitacao[]',
        'dados_qr' => '\OpenAPI\Client\Model\InformaEsDoQRComposto'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ativacao', $data ?? [], null);
        $this->setIfExists('id_rec', $data ?? [], null);
        $this->setIfExists('recebedor', $data ?? [], null);
        $this->setIfExists('loc', $data ?? [], null);
        $this->setIfExists('solicitacao', $data ?? [], null);
        $this->setIfExists('dados_qr', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vinculo'] === null) {
            $invalidProperties[] = "'vinculo' can't be null";
        }
     ...
     * Gets vinculo
     *
     * @return \OpenAPI\Client\Model\DescriODoObjetoDaRecorrNcia
     */
    public function getVinculo()
    {
        return $this->container['vinculo'];
    }

    /**
     * Sets vinculo
     *
     * @param \OpenAPI\Client\Model\DescriODoObjetoDaRecorrNcia $vinculo vinculo
     *
     * @return self
     */
    ...
    {
        if (is_null($vinculo)) {
            throw new \InvalidArgumentException('non-nullable vinculo cannot be null');
        }
        $this->container['vinculo'] = $vinculo;
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\InformaEsSobreCalendRioDaRecorrNcia1
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\InformaEsSobreCalendRioDaRecorrNcia1 $calendario calendario
     *
     * @return self
     */
     ...
     * Gets valor
     *
     * @return \OpenAPI\Client\Model\RecBaseValor|null
     */
     ...
     * Sets valor
     *
     * @param \OpenAPI\Client\Model\RecBaseValor|null $valor valor
     *
     * @return self
     */
     ...
     * Gets pagador
     *
     * @return \OpenAPI\Client\Model\DadosPagadorRecPagador|null
     */
     ...
     * Sets pagador
     *
     * @param \OpenAPI\Client\Model\DadosPagadorRecPagador|null $pagador pagador
     *
     * @return self
     */
    ...
    {
        if (is_null($pagador)) {
            throw new \InvalidArgumentException('non-nullable pagador cannot be null');
        }
     ...
     * Gets atualizacao
     *
     * @return \OpenAPI\Client\Model\HistRicoDeStatusInner[]
     */
     ...
     * Sets atualizacao
     *
     * @param \OpenAPI\Client\Model\HistRicoDeStatusInner[] $atualizacao Histórico das mudanças de status da recorrência.
     *
     * @return self
     */
     ...
     * Gets encerramento
     *
     * @return \OpenAPI\Client\Model\DetalhamentoDoEncerramentoDaRecorrNcia|null
     */
     ...
     * Sets encerramento
     *
     * @param \OpenAPI\Client\Model\DetalhamentoDoEncerramentoDaRecorrNcia|null $encerramento encerramento
     *
     * @return self
     */
     ...
     * Gets ativacao
     *
     * @return \OpenAPI\Client\Model\DadosRelacionadosConfirmaODaAtivaODaRecorrNcia|null
     */
    public function getAtivacao()
    {
        return $this->container['ativacao'];
    }

    /**
     * Sets ativacao
     *
     * @param \OpenAPI\Client\Model\DadosRelacionadosConfirmaODaAtivaODaRecorrNcia|null $ativacao ativacao
     *
     * @return self
     */
    ...
    {
        if (is_null($ativacao)) {
            throw new \InvalidArgumentException('non-nullable ativacao cannot be null');
        }
        $this->container['ativacao'] = $ativacao;
    ...
    public function setIdRec($id_rec)
    {
        ...
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling RecCompleta., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling RecCompleta., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling RecCompleta., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }
     ...
     * Gets recebedor
     *
     * @return \OpenAPI\Client\Model\RecCompletaAllOfRecebedor
     */
     ...
     * Sets recebedor
     *
     * @param \OpenAPI\Client\Model\RecCompletaAllOfRecebedor $recebedor recebedor
     *
     * @return self
     */
     ...
     * Gets loc
     *
     * @return \OpenAPI\Client\Model\PayloadLocationRecCompleta|null
     */
     ...
     * Sets loc
     *
     * @param \OpenAPI\Client\Model\PayloadLocationRecCompleta|null $loc loc
     *
     * @return self
     */
     ...
     * Gets solicitacao
     *
     * @return \OpenAPI\Client\Model\RecCompletaAllOfSolicitacao[]|null
     */
     ...
     * Sets solicitacao
     *
     * @param \OpenAPI\Client\Model\RecCompletaAllOfSolicitacao[]|null $solicitacao Solicitações vinculadas
     *
     * @return self
     */
    public function setSolicitacao($solicitacao)
    {
        if (is_null($solicitacao)) {
            throw new \InvalidArgumentException('non-nullable solicitacao cannot be null');
        }
     ...
     * Gets dados_qr
     *
     * @return \OpenAPI\Client\Model\InformaEsDoQRComposto|null
     */
    public function getDadosQr()
    {
        return $this->container['dados_qr'];
    }

    /**
     * Sets dados_qr
     *
     * @param \OpenAPI\Client\Model\InformaEsDoQRComposto|null $dados_qr dados_qr
     *
     * @return self
     */
    public function setDadosQr($dados_qr)
    {
        if (is_null($dados_qr)) {
            throw new \InvalidArgumentException('non-nullable dados_qr cannot be null');
        }
        $this->container['dados_qr'] = $dados_qr;

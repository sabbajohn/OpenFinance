 ...
 */
class Troco implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Troco';
    ...
    */
    ...
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling Troco., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     *
     * @param int|null $modalidade_alteracao Modalidade de alteração de valor do troco. Quando não preenchido o valor assumido é o 0 (zero).
     *
     * @return self
     */
    public function setModalidadeAlteracao($modalidade_alteracao)
    {
        ...
        if (($modalidade_alteracao > 1)) {
            throw new \InvalidArgumentException('invalid value for $modalidade_alteracao when calling Troco., must be smaller than or equal to 1.');
        }
        if (($modalidade_alteracao < 0)) {
            throw new \InvalidArgumentException('invalid value for $modalidade_alteracao when calling Troco., must be bigger than or equal to 0.');
        }
    ...
    public function setPrestadorDoServicoDeSaque($prestador_do_servico_de_saque)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{8}$/", ObjectSerializer::toString($prestador_do_servico_de_saque)))) {
            throw new \InvalidArgumentException("invalid value for \$prestador_do_servico_de_saque when calling Troco., must conform to the pattern /^[0-9A-Z]{8}$/.");
        }

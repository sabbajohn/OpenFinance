<?php
/**
 * RecCompletaPesquisadaAllOfRecebedor
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RecCompletaPesquisadaAllOfRecebedor Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecCompletaPesquisadaAllOfRecebedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecCompletaPesquisada_allOf_recebedor';
    ...
    {
        $this->setIfExists('convenio', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['convenio']) && (mb_strlen($this->container['convenio']) > 60)) {
            $invalidProperties[] = "invalid value for 'convenio', the character length must be smaller than or equal to 60.";
        }
     ...
     * Sets convenio
     *
     * @param string|null $convenio Convênio entre usuário e participante recebedor.
     *
     * @return self
     */
    ...
    {
        if (is_null($convenio)) {
            throw new \InvalidArgumentException('non-nullable convenio cannot be null');
        }
        if ((mb_strlen($convenio) > 60)) {
            throw new \InvalidArgumentException('invalid length for $convenio when calling RecCompletaPesquisadaAllOfRecebedor., must be smaller than or equal to 60.');
        }

...
/**
 * PixValorJurosJuros Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PixValorJurosJuros implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PixValorJuros_juros';
    ...
    */
     ...
     * Sets valor
     *
     * @param string $valor Valor dos juros.
     *
     * @return self
     */
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling PixValorJurosJuros., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

...
/**
 * CobVPayloadValor Class Doc Comment
 *
 * @category Class
 ...
 */
class CobVPayloadValor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobVPayloadValor';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('multa', $data ?? [], null);
        $this->setIfExists('juros', $data ?? [], null);
        $this->setIfExists('abatimento', $data ?? [], null);
        $this->setIfExists('desconto', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['original']) && !preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['original'])) {
            $invalidProperties[] = "invalid value for 'original', must be conform to the pattern /\\d{1,10}\\.\\d{2}/.";
        }

        if (!is_null($this->container['multa']) && !preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['multa'])) {
            $invalidProperties[] = "invalid value for 'multa', must be conform to the pattern /\\d{1,10}\\.\\d{2}/.";
        }

        if (!is_null($this->container['juros']) && !preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['juros'])) {
            $invalidProperties[] = "invalid value for 'juros', must be conform to the pattern /\\d{1,10}\\.\\d{2}/.";
        }

        if (!is_null($this->container['abatimento']) && !preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['abatimento'])) {
            $invalidProperties[] = "invalid value for 'abatimento', must be conform to the pattern /\\d{1,10}\\.\\d{2}/.";
        }

        if (!is_null($this->container['desconto']) && !preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['desconto'])) {
            $invalidProperties[] = "invalid value for 'desconto', must be conform to the pattern /\\d{1,10}\\.\\d{2}/.";
        }

        if ($this->container['final'] === null) {
            $invalidProperties[] = "'final' can't be null";
        }
        if (!preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['final'])) {
            $invalidProperties[] = "invalid value for 'final', must be conform to the pattern /\\d{1,10}\\.\\d{2}/.";
        }
     ...
     * Sets original
     *
     * @param string|null $original Valor original da cobrança.
     *
     * @return self
     */
    public function setOriginal($original)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($original)))) {
            throw new \InvalidArgumentException("invalid value for \$original when calling CobVPayloadValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     * Sets multa
     *
     * @param string|null $multa Multa aplicada à cobrança
     *
     * @return self
     */
    ...
    {
        if (is_null($multa)) {
            throw new \InvalidArgumentException('non-nullable multa cannot be null');
        }

        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($multa)))) {
            throw new \InvalidArgumentException("invalid value for \$multa when calling CobVPayloadValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     * Sets juros
     *
     * @param string|null $juros Juro aplicado à cobrança
     *
     * @return self
     */
    ...
    {
        if (is_null($juros)) {
            throw new \InvalidArgumentException('non-nullable juros cannot be null');
        }

        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($juros)))) {
            throw new \InvalidArgumentException("invalid value for \$juros when calling CobVPayloadValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     * Sets abatimento
     *
     * @param string|null $abatimento Abatimento aplicado à cobrança
     *
     * @return self
     */
    public function setAbatimento($abatimento)
    {
        if (is_null($abatimento)) {
            throw new \InvalidArgumentException('non-nullable abatimento cannot be null');
        }

        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($abatimento)))) {
            throw new \InvalidArgumentException("invalid value for \$abatimento when calling CobVPayloadValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     * Sets desconto
     *
     * @param string|null $desconto Descontos aplicados à cobrança
     *
     * @return self
     */
    ...
    {
        if (is_null($desconto)) {
            throw new \InvalidArgumentException('non-nullable desconto cannot be null');
        }

        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($desconto)))) {
            throw new \InvalidArgumentException("invalid value for \$desconto when calling CobVPayloadValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     * Sets final
     *
     * @param string $final Valor final da cobrança.
     *
     * @return self
     */
    public function setFinal($final)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($final)))) {
            throw new \InvalidArgumentException("invalid value for \$final when calling CobVPayloadValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

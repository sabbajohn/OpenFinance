...
/**
 * PixValorOriginalOriginal Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PixValorOriginalOriginal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PixValorOriginal_original';
    ...
    */
     ...
     * Sets valor
     *
     * @param string $valor Valor original do Pix.
     *
     * @return self
     */
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling PixValorOriginalOriginal., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

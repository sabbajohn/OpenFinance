...
/**
 * DevolucaoSolicitada Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DevolucaoSolicitada implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DevolucaoSolicitada';
    ...
    protected static $openAPITypes = [
        'valor' => 'string',
        'natureza' => '\OpenAPI\Client\Model\DevolucaoSolicitadaNatureza',
        'descricao' => 'string'
    ];
    ...
    */
     ...
     * Sets valor
     *
     * @param string $valor Valor solicitado para devolução. A soma dos valores de todas as devolucões não podem ultrapassar o valor total do Pix.
     *
     * @return self
     */
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling DevolucaoSolicitada., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     * Gets natureza
     *
     * @return \OpenAPI\Client\Model\DevolucaoSolicitadaNatureza|null
     */
     ...
     * Sets natureza
     *
     * @param \OpenAPI\Client\Model\DevolucaoSolicitadaNatureza|null $natureza natureza
     *
     * @return self
     */
    ...
    public function setDescricao($descricao)
    {
        ...
        if ((mb_strlen($descricao) > 140)) {
            throw new \InvalidArgumentException('invalid length for $descricao when calling DevolucaoSolicitada., must be smaller than or equal to 140.');
        }

 ...
 */
class PessoaFSica implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pessoa_F_sica';
    ...
    */
    ...
    public function setNome($nome)
    {
        ...
        if ((mb_strlen($nome) > 140)) {
            throw new \InvalidArgumentException('invalid length for $nome when calling PessoaFSica., must be smaller than or equal to 140.');
        }

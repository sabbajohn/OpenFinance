...
/**
 * CobsRConsultadas Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CobsRConsultadas implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobsRConsultadas';
    ...
    protected static $openAPITypes = [
        'parametros' => '\OpenAPI\Client\Model\ParametrosConsultaCobR',
        'cobsr' => '\OpenAPIClientModelCobRCompleta[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cobsr', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cobsr'] === null) {
            $invalidProperties[] = "'cobsr' can't be null";
        }
     ...
     * Gets parametros
     *
     * @return \OpenAPI\Client\Model\ParametrosConsultaCobR
     */
     ...
     * Sets parametros
     *
     * @param \OpenAPI\Client\Model\ParametrosConsultaCobR $parametros parametros
     *
     * @return self
     */
     ...
     * Gets cobsr
     *
     * @return \OpenAPIClientModelCobRCompleta[]
     */
    public function getCobsr()
    {
        return $this->container['cobsr'];
    }

    /**
     * Sets cobsr
     *
     * @param \OpenAPIClientModelCobRCompleta[] $cobsr cobsr
     *
     * @return self
     */
    public function setCobsr($cobsr)
    {
        if (is_null($cobsr)) {
            throw new \InvalidArgumentException('non-nullable cobsr cannot be null');
        }
        $this->container['cobsr'] = $cobsr;

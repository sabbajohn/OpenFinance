 ...
 */
class CobVPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobVPayload';
    ...
    protected static $openAPITypes = [
        ...
        'calendario' => '\OpenAPI\Client\Model\CalendRio2',
        'devedor' => '\OpenAPI\Client\Model\CobVPayloadAllOfDevedor',
        'txid' => 'string',
        'revisao' => 'int',
        'status' => '\OpenAPI\Client\Model\CobrancaStatus',
        'valor' => '\OpenAPI\Client\Model\CobVPayloadValor'
    ];
    ...
    */
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CobVPayload., must be smaller than or equal to 77.');
        }
    ...
    public function setSolicitacaoPagador($solicitacao_pagador)
    {
        ...
        if ((mb_strlen($solicitacao_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $solicitacao_pagador when calling CobVPayload., must be smaller than or equal to 140.');
        }
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\CalendRio2
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\CalendRio2 $calendario calendario
     *
     * @return self
     */
     ...
     * Gets devedor
     *
     * @return \OpenAPI\Client\Model\CobVPayloadAllOfDevedor
     */
     ...
     * Sets devedor
     *
     * @param \OpenAPI\Client\Model\CobVPayloadAllOfDevedor $devedor devedor
     *
     * @return self
     */
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobVPayload., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
     ...
     * Gets valor
     *
     * @return \OpenAPI\Client\Model\CobVPayloadValor
     */
     ...
     * Sets valor
     *
     * @param \OpenAPI\Client\Model\CobVPayloadValor $valor valor
     *
     * @return self
     */

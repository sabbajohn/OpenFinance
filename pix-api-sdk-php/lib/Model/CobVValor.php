 ...
 */
class CobVValor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobVValor';
    ...
    protected static $openAPITypes = [
        'original' => 'string',
        'multa' => '\OpenAPI\Client\Model\MultaAplicada',
        'juros' => '\OpenAPI\Client\Model\JuroAplicado',
        'abatimento' => '\OpenAPI\Client\Model\AbatimentoAplicado',
        'desconto' => '\OpenAPI\Client\Model\DescontosAplicados'
    ];
    ...
    */
    ...
    public function setOriginal($original)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($original)))) {
            throw new \InvalidArgumentException("invalid value for \$original when calling CobVValor., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     * Gets multa
     *
     * @return \OpenAPI\Client\Model\MultaAplicada|null
     */
     ...
     * Sets multa
     *
     * @param \OpenAPI\Client\Model\MultaAplicada|null $multa multa
     *
     * @return self
     */
     ...
     * Gets juros
     *
     * @return \OpenAPI\Client\Model\JuroAplicado|null
     */
     ...
     * Sets juros
     *
     * @param \OpenAPI\Client\Model\JuroAplicado|null $juros juros
     *
     * @return self
     */
     ...
     * Gets abatimento
     *
     * @return \OpenAPI\Client\Model\AbatimentoAplicado|null
     */
     ...
     * Sets abatimento
     *
     * @param \OpenAPI\Client\Model\AbatimentoAplicado|null $abatimento abatimento
     *
     * @return self
     */
     ...
     * Gets desconto
     *
     * @return \OpenAPI\Client\Model\DescontosAplicados|null
     */
     ...
     * Sets desconto
     *
     * @param \OpenAPI\Client\Model\DescontosAplicados|null $desconto desconto
     *
     * @return self
     */

...
/**
 * CobranAImediataVinculadaJornada3 Class Doc Comment
 *
 * @category Class
 ...
 */
class CobranAImediataVinculadaJornada3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cobran_a_imediata_vinculada___Jornada_3';
    ...
    */
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobranAImediataVinculadaJornada3., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }

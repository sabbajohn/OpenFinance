 ...
 */
class CobPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobPayload';
    ...
    protected static $openAPITypes = [
        ...
        'calendario' => '\OpenAPI\Client\Model\CalendRio3',
        'txid' => 'string',
        'revisao' => 'int',
        'devedor' => '\OpenAPI\Client\Model\CobPayloadAllOfDevedor',
        'status' => '\OpenAPI\Client\Model\CobrancaStatus',
        'valor' => '\OpenAPI\Client\Model\CobPayloadValor'
    ];
    ...
    */
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CobPayload., must be smaller than or equal to 77.');
        }
    ...
    public function setSolicitacaoPagador($solicitacao_pagador)
    {
        ...
        if ((mb_strlen($solicitacao_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $solicitacao_pagador when calling CobPayload., must be smaller than or equal to 140.');
        }
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\CalendRio3
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\CalendRio3 $calendario calendario
     *
     * @return self
     */
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobPayload., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
     ...
     * Gets devedor
     *
     * @return \OpenAPI\Client\Model\CobPayloadAllOfDevedor|null
     */
     ...
     * Sets devedor
     *
     * @param \OpenAPI\Client\Model\CobPayloadAllOfDevedor|null $devedor devedor
     *
     * @return self
     */
     ...
     * Gets valor
     *
     * @return \OpenAPI\Client\Model\CobPayloadValor
     */
     ...
     * Sets valor
     *
     * @param \OpenAPI\Client\Model\CobPayloadValor $valor valor
     *
     * @return self
     */

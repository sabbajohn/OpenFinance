...
/**
 * DadosComplementaresPessoa Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DadosComplementaresPessoa implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DadosComplementaresPessoa';
    ...
    */
    ...
    public function setLogradouro($logradouro)
    {
        ...
        if ((mb_strlen($logradouro) > 200)) {
            throw new \InvalidArgumentException('invalid length for $logradouro when calling DadosComplementaresPessoa., must be smaller than or equal to 200.');
        }
    ...
    public function setCidade($cidade)
    {
        ...
        if ((mb_strlen($cidade) > 200)) {
            throw new \InvalidArgumentException('invalid length for $cidade when calling DadosComplementaresPessoa., must be smaller than or equal to 200.');
        }
    ...
    public function setUf($uf)
    {
        ...
        if ((mb_strlen($uf) > 2)) {
            throw new \InvalidArgumentException('invalid length for $uf when calling DadosComplementaresPessoa., must be smaller than or equal to 2.');
        }
    ...
    public function setCep($cep)
    {
        ...
        if ((mb_strlen($cep) > 8)) {
            throw new \InvalidArgumentException('invalid length for $cep when calling DadosComplementaresPessoa., must be smaller than or equal to 8.');
        }

...
/**
 * PixAutomatico Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PixAutomatico implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PixAutomatico';
    ...
    */
    ...
    public function setEndToEndId($end_to_end_id)
    {
        ...
        if ((mb_strlen($end_to_end_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling PixAutomatico., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($end_to_end_id) < 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling PixAutomatico., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{32}/", ObjectSerializer::toString($end_to_end_id)))) {
            throw new \InvalidArgumentException("invalid value for \$end_to_end_id when calling PixAutomatico., must conform to the pattern /[a-zA-Z0-9]{32}/.");
        }
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling PixAutomatico., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
    ...
    public function setInfoPagador($info_pagador)
    {
        ...
        if ((mb_strlen($info_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $info_pagador when calling PixAutomatico., must be smaller than or equal to 140.');
        }

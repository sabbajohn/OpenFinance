...
/**
 * CobCompletaAllOfPix Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CobCompletaAllOfPix implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobCompleta_allOf_pix';
    ...
    */
    ...
    public function setEndToEndId($end_to_end_id)
    {
        ...
        if ((mb_strlen($end_to_end_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling CobCompletaAllOfPix., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($end_to_end_id) < 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling CobCompletaAllOfPix., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{32}/", ObjectSerializer::toString($end_to_end_id)))) {
            throw new \InvalidArgumentException("invalid value for \$end_to_end_id when calling CobCompletaAllOfPix., must conform to the pattern /[a-zA-Z0-9]{32}/.");
        }
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobCompletaAllOfPix., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
    ...
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling CobCompletaAllOfPix., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
    ...
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CobCompletaAllOfPix., must be smaller than or equal to 77.');
        }
    ...
    public function setInfoPagador($info_pagador)
    {
        ...
        if ((mb_strlen($info_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $info_pagador when calling CobCompletaAllOfPix., must be smaller than or equal to 140.');
        }

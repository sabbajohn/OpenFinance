...
/**
 * PessoaJurDica Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PessoaJurDica implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pessoa_Jur_dica';
    ...
    */
    ...
    public function setNome($nome)
    {
        ...
        if ((mb_strlen($nome) > 140)) {
            throw new \InvalidArgumentException('invalid length for $nome when calling PessoaJurDica., must be smaller than or equal to 140.');
        }

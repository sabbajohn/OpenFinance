...
/**
 * InformaEsSobreCalendRioDaCobranA Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class InformaEsSobreCalendRioDaCobranA implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_sobre_calend_rio_da_cobran_a';
    ...
    */
     ...
     *
     * @param \DateTime $data_de_vencimento Trata-se de uma data, no formato `YYYY-MM-DD`, segundo ISO 8601. É a data de vencimento da cobrança.
     *
     * @return self
     */

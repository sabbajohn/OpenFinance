...
/**
 * InformaEsAdicionaisInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InformaEsAdicionaisInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_adicionais_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['nome']) > 50)) {
            $invalidProperties[] = "invalid value for 'nome', the character length must be smaller than or equal to 50.";
        }

        if ($this->container['valor'] === null) {
            $invalidProperties[] = "'valor' can't be null";
        }
        if ((mb_strlen($this->container['valor']) > 200)) {
            $invalidProperties[] = "invalid value for 'valor', the character length must be smaller than or equal to 200.";
        }
    ...
    public function setNome($nome)
    {
        ...
        if ((mb_strlen($nome) > 50)) {
            throw new \InvalidArgumentException('invalid length for $nome when calling InformaEsAdicionaisInner., must be smaller than or equal to 50.');
        }
     ...
     * Sets valor
     *
     * @param string $valor Dados do campo.
     *
     * @return self
     */
    public function setValor($valor)
    {
        ...
        if ((mb_strlen($valor) > 200)) {
            throw new \InvalidArgumentException('invalid length for $valor when calling InformaEsAdicionaisInner., must be smaller than or equal to 200.');
        }

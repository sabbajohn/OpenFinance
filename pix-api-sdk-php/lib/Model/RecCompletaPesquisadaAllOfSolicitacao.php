<?php
/**
 * RecCompletaPesquisadaAllOfSolicitacao
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RecCompletaPesquisadaAllOfSolicitacao Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecCompletaPesquisadaAllOfSolicitacao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecCompletaPesquisada_allOf_solicitacao';
    ...
    protected static $openAPITypes = [
        'id_solic_rec' => 'string',
        'id_rec' => 'string',
        'calendario' => '\OpenAPI\Client\Model\InformaEsDeCalendRioDaSolicitaODaRecorrNcia',
        'destinatario' => '\OpenAPI\Client\Model\DadosBancarios',
        'status' => 'string',
        'atualizacao' => '\OpenAPI\Client\Model\HistRicoDeStatusDaSolicitaODeRecorrNciaInner[]',
        'rec_payload' => '\OpenAPI\Client\Model\RecPayload'
    ];
    ...
    protected static $attributeMap = [
        'id_solic_rec' => 'idSolicRec',
        'id_rec' => 'idRec',
        'calendario' => 'calendario',
        'destinatario' => 'destinatario',
        'status' => 'status',
        'atualizacao' => 'atualizacao',
        'rec_payload' => 'recPayload'
    ];
    ...
    {
        $this->setIfExists('id_solic_rec', $data ?? [], null);
        ...
        $this->setIfExists('rec_payload', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['id_solic_rec'] === null) {
            $invalidProperties[] = "'id_solic_rec' can't be null";
        }
        if ((mb_strlen($this->container['id_solic_rec']) > 29)) {
            $invalidProperties[] = "invalid value for 'id_solic_rec', the character length must be smaller than or equal to 29.";
        }

        if ((mb_strlen($this->container['id_solic_rec']) < 29)) {
            $invalidProperties[] = "invalid value for 'id_solic_rec', the character length must be bigger than or equal to 29.";
        }

        if (!preg_match("/[a-zA-Z0-9]{29}/", $this->container['id_solic_rec'])) {
            $invalidProperties[] = "invalid value for 'id_solic_rec', must be conform to the pattern /[a-zA-Z0-9]{29}/.";
        }
     ...
     * @return string
     */
    public function getIdSolicRec()
    {
        return $this->container['id_solic_rec'];
    }

    /**
     * Sets id_solic_rec
     *
     * @param string $id_solic_rec # Identificador da Solicitação da Recorrência  Regra de formação: - SCxxxxxxxxyyyyMMddkkkkkkkkkkk (29 caracteres; “case sensitive”, isso é, diferencia letras maiúsculas e minúsculas), sendo:   - SC - fixo (2 caracteres);   - xxxxxxxx – ISPB do agente que envia a mensagem pain.009 de solicitação de confirmação da recorrência (8 caracteres alfanuméricos [A-Z|0-9]);   - yyyyMMdd – data (8 caracteres) de criação da mensagem pain.009 de solicitação de confirmação da recorrência;   - kkkkkkkkkkk – sequencial criado pelo agente que gerou a mensagem de solicitação de confirmação da recorrência (11 caracteres alfanuméricos [a-z|A-Z|0-9]). Deve ser único dentro de cada “yyyyMMdd”.
     *
     * @return self
     */
    public function setIdSolicRec($id_solic_rec)
    {
        if (is_null($id_solic_rec)) {
            throw new \InvalidArgumentException('non-nullable id_solic_rec cannot be null');
        }
        if ((mb_strlen($id_solic_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_solic_rec when calling RecCompletaPesquisadaAllOfSolicitacao., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_solic_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_solic_rec when calling RecCompletaPesquisadaAllOfSolicitacao., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_solic_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_solic_rec when calling RecCompletaPesquisadaAllOfSolicitacao., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }

        $this->container['id_solic_rec'] = $id_solic_rec;
    ...
    public function setIdRec($id_rec)
    {
        ...
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling RecCompletaPesquisadaAllOfSolicitacao., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling RecCompletaPesquisadaAllOfSolicitacao., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling RecCompletaPesquisadaAllOfSolicitacao., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }
     ...
     * Gets calendario
     *
     * @return \OpenAPI\Client\Model\InformaEsDeCalendRioDaSolicitaODaRecorrNcia
     */
     ...
     * Sets calendario
     *
     * @param \OpenAPI\Client\Model\InformaEsDeCalendRioDaSolicitaODaRecorrNcia $calendario calendario
     *
     * @return self
     */
     ...
     * Gets destinatario
     *
     * @return \OpenAPI\Client\Model\DadosBancarios
     */
     ...
     * Sets destinatario
     *
     * @param \OpenAPI\Client\Model\DadosBancarios $destinatario destinatario
     *
     * @return self
     */
     ...
     * Gets atualizacao
     *
     * @return \OpenAPI\Client\Model\HistRicoDeStatusDaSolicitaODeRecorrNciaInner[]
     */
     ...
     * Sets atualizacao
     *
     * @param \OpenAPI\Client\Model\HistRicoDeStatusDaSolicitaODeRecorrNciaInner[] $atualizacao 
     *
     * @return self
     */
     ...
     * Gets rec_payload
     *
     * @return \OpenAPI\Client\Model\RecPayload|null
     */
    public function getRecPayload()
    {
        return $this->container['rec_payload'];
    }

    /**
     * Sets rec_payload
     *
     * @param \OpenAPI\Client\Model\RecPayload|null $rec_payload rec_payload
     *
     * @return self
     */
    public function setRecPayload($rec_payload)
    {
        if (is_null($rec_payload)) {
            throw new \InvalidArgumentException('non-nullable rec_payload cannot be null');
        }
        $this->container['rec_payload'] = $rec_payload;

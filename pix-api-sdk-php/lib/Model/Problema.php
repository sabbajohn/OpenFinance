 ...
 */
class Problema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Problema';
    ...
    protected static $openAPITypes = [
        ...
        'violacoes' => '\OpenAPI\Client\Model\Violacao[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('violacoes', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets detail
     *
     * @param string|null $detail Descrição completa do problema.
     *
     * @return self
     */
     ...
     * Sets correlation_id
     *
     * @param string|null $correlation_id Identificador de correlação do problema para fins de suporte
     *
     * @return self
     */
     ...
     * Gets violacoes
     *
     * @return \OpenAPI\Client\Model\Violacao[]|null
     */
     ...
     * Sets violacoes
     *
     * @param \OpenAPI\Client\Model\Violacao[]|null $violacoes violacoes
     *
     * @return self
     */
    public function setViolacoes($violacoes)
    {
        if (is_null($violacoes)) {
            throw new \InvalidArgumentException('non-nullable violacoes cannot be null');
        }

...
class InformaEsSobreOValorDoPix implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_sobre_o_valor_do_Pix';
    ...
    protected static $openAPITypes = [
        'original' => '\OpenAPI\Client\Model\PixValorOriginalOriginal',
        'saque' => '\OpenAPI\Client\Model\PixValorSaqueSaque',
        'troco' => '\OpenAPI\Client\Model\PixValorTrocoTroco',
        'juros' => '\OpenAPI\Client\Model\PixValorJurosJuros',
        'multa' => '\OpenAPI\Client\Model\PixValorMultaMulta',
        'abatimento' => '\OpenAPI\Client\Model\PixValorAbatimentoAbatimento',
        'desconto' => '\OpenAPI\Client\Model\PixValorDescontoDesconto'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('saque', $data ?? [], null);
        $this->setIfExists('troco', $data ?? [], null);
    ...
    */
     ...
     * Gets original
     *
     * @return \OpenAPI\Client\Model\PixValorOriginalOriginal|null
     */
     ...
     * Sets original
     *
     * @param \OpenAPI\Client\Model\PixValorOriginalOriginal|null $original original
     *
     * @return self
     */
     ...
     * Gets saque
     *
     * @return \OpenAPI\Client\Model\PixValorSaqueSaque|null
     */
     ...
     * Sets saque
     *
     * @param \OpenAPI\Client\Model\PixValorSaqueSaque|null $saque saque
     *
     * @return self
     */
    ...
    {
        if (is_null($saque)) {
            throw new \InvalidArgumentException('non-nullable saque cannot be null');
        }
     ...
     * Gets troco
     *
     * @return \OpenAPI\Client\Model\PixValorTrocoTroco|null
     */
     ...
     * Sets troco
     *
     * @param \OpenAPI\Client\Model\PixValorTrocoTroco|null $troco troco
     *
     * @return self
     */
    ...
    {
        if (is_null($troco)) {
            throw new \InvalidArgumentException('non-nullable troco cannot be null');
        }
     ...
     * Gets juros
     *
     * @return \OpenAPI\Client\Model\PixValorJurosJuros|null
     */
     ...
     * Sets juros
     *
     * @param \OpenAPI\Client\Model\PixValorJurosJuros|null $juros juros
     *
     * @return self
     */
     ...
     * Gets multa
     *
     * @return \OpenAPI\Client\Model\PixValorMultaMulta|null
     */
     ...
     * Sets multa
     *
     * @param \OpenAPI\Client\Model\PixValorMultaMulta|null $multa multa
     *
     * @return self
     */
     ...
     * Gets abatimento
     *
     * @return \OpenAPI\Client\Model\PixValorAbatimentoAbatimento|null
     */
     ...
     * Sets abatimento
     *
     * @param \OpenAPI\Client\Model\PixValorAbatimentoAbatimento|null $abatimento abatimento
     *
     * @return self
     */
     ...
     * Gets desconto
     *
     * @return \OpenAPI\Client\Model\PixValorDescontoDesconto|null
     */
     ...
     * Sets desconto
     *
     * @param \OpenAPI\Client\Model\PixValorDescontoDesconto|null $desconto desconto
     *
     * @return self
     */

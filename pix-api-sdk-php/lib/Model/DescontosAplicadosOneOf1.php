...
/**
 * DescontosAplicadosOneOf1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DescontosAplicadosOneOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Descontos_aplicados_oneOf_1';
    ...
    */
    ...
    public function setValorPerc($valor_perc)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor_perc)))) {
            throw new \InvalidArgumentException("invalid value for \$valor_perc when calling DescontosAplicadosOneOf1., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }

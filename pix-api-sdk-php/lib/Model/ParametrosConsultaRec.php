...
/**
 * ParametrosConsultaRec Class Doc Comment
 *
 * @category Class
 ...
 */
class ParametrosConsultaRec implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParametrosConsultaRec';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('location_presente', $data ?? [], null);
    ...
    */
    ...
    public function setCpf($cpf)
    {
        ...
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($cpf)))) {
            throw new \InvalidArgumentException("invalid value for \$cpf when calling ParametrosConsultaRec., must conform to the pattern /^\\d{11}$/.");
        }
    ...
    public function setCnpj($cnpj)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{14}$/", ObjectSerializer::toString($cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$cnpj when calling ParametrosConsultaRec., must conform to the pattern /^[0-9A-Z]{14}$/.");
        }
     ...
     *
     * @param bool|null $location_presente Filtro pela existência de location vinculada.
     *
     * @return self
     */
    public function setLocationPresente($location_presente)
    {
        if (is_null($location_presente)) {
            throw new \InvalidArgumentException('non-nullable location_presente cannot be null');
        }
     ...
     * Sets status
     *
     * @param string|null $status Filtro pelo status das recorrências.
     *
     * @return self
     */

...
/**
 * InformaEsDeCalendRioDaSolicitaODaRecorrNcia Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InformaEsDeCalendRioDaSolicitaODaRecorrNcia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_de_Calend_rio_da_Solicita__o_da_Recorr_ncia';
    ...
    protected static $openAPITypes = [
        'data_expiracao_solicitacao' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        'data_expiracao_solicitacao' => 'date-time'
    ];
    ...
    protected static array $openAPINullables = [
        'data_expiracao_solicitacao' => false
    ];
    ...
    protected static $attributeMap = [
        'data_expiracao_solicitacao' => 'dataExpiracaoSolicitacao'
    ];
    ...
    protected static $setters = [
        'data_expiracao_solicitacao' => 'setDataExpiracaoSolicitacao'
    ];
    ...
    protected static $getters = [
        'data_expiracao_solicitacao' => 'getDataExpiracaoSolicitacao'
    ];
    ...
    {
        $this->setIfExists('data_expiracao_solicitacao', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['data_expiracao_solicitacao'] === null) {
            $invalidProperties[] = "'data_expiracao_solicitacao' can't be null";
        }
    ...
    /**
     * Gets data_expiracao_solicitacao
     *
     * @return \DateTime
     */
    public function getDataExpiracaoSolicitacao()
    {
        return $this->container['data_expiracao_solicitacao'];
    }

    /**
     * Sets data_expiracao_solicitacao
     *
     * @param \DateTime $data_expiracao_solicitacao Data da expiração da solicitação enviada ao usuário pagador. Respeita RFC 3339.
     *
     * @return self
     */
    public function setDataExpiracaoSolicitacao($data_expiracao_solicitacao)
    {
        if (is_null($data_expiracao_solicitacao)) {
            throw new \InvalidArgumentException('non-nullable data_expiracao_solicitacao cannot be null');
        }
        $this->container['data_expiracao_solicitacao'] = $data_expiracao_solicitacao;

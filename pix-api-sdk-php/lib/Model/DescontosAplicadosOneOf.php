...
/**
 * DescontosAplicadosOneOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DescontosAplicadosOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Descontos_aplicados_oneOf';
    ...
    protected static $openAPITypes = [
        'desconto_data_fixa' => '\OpenAPI\Client\Model\ListaDeDescontosInner[]'
    ];
    ...
    {
        $this->setIfExists('desconto_data_fixa', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['desconto_data_fixa']) && (count($this->container['desconto_data_fixa']) > 3)) {
            $invalidProperties[] = "invalid value for 'desconto_data_fixa', number of items must be less than or equal to 3.";
        }

        if (!is_null($this->container['desconto_data_fixa']) && (count($this->container['desconto_data_fixa']) < 1)) {
            $invalidProperties[] = "invalid value for 'desconto_data_fixa', number of items must be greater than or equal to 1.";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\ListaDeDescontosInner[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ListaDeDescontosInner[]|null $desconto_data_fixa Descontos absolutos aplicados à cobrança.
     *
     * @return self
     */
    public function setDescontoDataFixa($desconto_data_fixa)
    {
        if (is_null($desconto_data_fixa)) {
            throw new \InvalidArgumentException('non-nullable desconto_data_fixa cannot be null');
        }

        if ((count($desconto_data_fixa) > 3)) {
            throw new \InvalidArgumentException('invalid value for $desconto_data_fixa when calling DescontosAplicadosOneOf., number of items must be less than or equal to 3.');
        }
        if ((count($desconto_data_fixa) < 1)) {
            throw new \InvalidArgumentException('invalid length for $desconto_data_fixa when calling DescontosAplicadosOneOf., number of items must be greater than or equal to 1.');
        }

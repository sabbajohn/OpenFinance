<?php
/**
 * RecRevisadaAllOfVinculoDevedor
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RecRevisadaAllOfVinculoDevedor Class Doc Comment
 *
 * @category Class
 ...
 */
class RecRevisadaAllOfVinculoDevedor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecRevisada_allOf_vinculo_devedor';
    ...
    */
    ...
    public function setNome($nome)
    {
        ...
        if ((mb_strlen($nome) > 140)) {
            throw new \InvalidArgumentException('invalid length for $nome when calling RecRevisadaAllOfVinculoDevedor., must be smaller than or equal to 140.');
        }

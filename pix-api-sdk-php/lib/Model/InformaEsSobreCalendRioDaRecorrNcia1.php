...
/**
 * InformaEsSobreCalendRioDaRecorrNcia1 Class Doc Comment
 *
 * @category Class
 ...
 */
class InformaEsSobreCalendRioDaRecorrNcia1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_sobre_calend_rio_da_recorr_ncia_1';
    ...
    protected static $setters = [
        'data_inicial' => 'setDataInicial',
        'data_final' => 'setDataFinal',
    ...
    protected static $getters = [
        'data_inicial' => 'getDataInicial',
        'data_final' => 'getDataFinal',
     ...
     * @return string[]
     */
    public function getPeriodicidadeAllowableValues()
    {
        return [
    ...
    {
        $this->setIfExists('data_inicial', $data ?? [], null);
        $this->setIfExists('data_final', $data ?? [], null);
        $this->setIfExists('periodicidade', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['data_inicial'] === null) {
            $invalidProperties[] = "'data_inicial' can't be null";
        }
        if ($this->container['periodicidade'] === null) {
            $invalidProperties[] = "'periodicidade' can't be null";
        }
        $allowedValues = $this->getPeriodicidadeAllowableValues();
        if (!is_null($this->container['periodicidade']) && !in_array($this->container['periodicidade'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'periodicidade', must be one of '%s'",
                $this->container['periodicidade'],
    ...
    {
        return $this->container['data_inicial'];
    }

    /**
     * Sets data_inicial
     *
     * @param \DateTime $data_inicial Trata-se de uma data, no formato `YYYY-MM-DD`, segundo ISO 8601. Data estimada de primeiro pagamento.
     *
     * @return self
     */
    public function setDataInicial($data_inicial)
    {
        if (is_null($data_inicial)) {
            throw new \InvalidArgumentException('non-nullable data_inicial cannot be null');
        }
        $this->container['data_inicial'] = $data_inicial;
    ...
    public function setDataFinal($data_final)
    {
        if (is_null($data_final)) {
            throw new \InvalidArgumentException('non-nullable data_final cannot be null');
        }
        $this->container['data_final'] = $data_final;
    ...
    {
        return $this->container['periodicidade'];
    }

    /**
     * Sets periodicidade
     *
     * @param string $periodicidade periodicidade
     *
     * @return self
     */
    public function setPeriodicidade($periodicidade)
    {
        if (is_null($periodicidade)) {
            throw new \InvalidArgumentException('non-nullable periodicidade cannot be null');
        }
        $allowedValues = $this->getPeriodicidadeAllowableValues();
        if (!in_array($periodicidade, $allowedValues, true)) {
        ...
        $this->container['periodicidade'] = $periodicidade;

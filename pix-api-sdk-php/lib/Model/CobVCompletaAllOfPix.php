...
/**
 * CobVCompletaAllOfPix Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CobVCompletaAllOfPix implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CobVCompleta_allOf_pix';
    ...
    protected static $openAPITypes = [
        ...
        'txid' => 'string',
        'valor' => 'string',
        'componentes_valor' => '\OpenAPI\Client\Model\InformaEsSobreOValorDoPix',
        'chave' => 'string',
        'horario' => '\DateTime',
        'info_pagador' => 'string',
        'devolucoes' => '\OpenAPI\Client\Model\Devolucao[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('componentes_valor', $data ?? [], null);
        $this->setIfExists('chave', $data ?? [], null);
        $this->setIfExists('horario', $data ?? [], null);
        $this->setIfExists('info_pagador', $data ?? [], null);
        $this->setIfExists('devolucoes', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/[a-zA-Z0-9]{32}/", $this->container['end_to_end_id'])) {
            $invalidProperties[] = "invalid value for 'end_to_end_id', must be conform to the pattern /[a-zA-Z0-9]{32}/.";
        }

        if (!is_null($this->container['txid']) && !preg_match("/[a-zA-Z0-9]{26,35}/", $this->container['txid'])) {
        ...
        if (!preg_match("/\\d{1,10}\\.\\d{2}/", $this->container['valor'])) {
            $invalidProperties[] = "invalid value for 'valor', must be conform to the pattern /\\d{1,10}\\.\\d{2}/.";
        }

        if (!is_null($this->container['chave']) && (mb_strlen($this->container['chave']) > 77)) {
        ...
        if (!is_null($this->container['info_pagador']) && (mb_strlen($this->container['info_pagador']) > 140)) {
            $invalidProperties[] = "invalid value for 'info_pagador', the character length must be smaller than or equal to 140.";
        }
     ...
     * Sets end_to_end_id
     *
     * @param string $end_to_end_id EndToEndIdentification que transita na PACS002, PACS004 e PACS008
     *
     * @return self
     */
    public function setEndToEndId($end_to_end_id)
    {
        ...
        if ((mb_strlen($end_to_end_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling CobVCompletaAllOfPix., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($end_to_end_id) < 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling CobVCompletaAllOfPix., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{32}/", ObjectSerializer::toString($end_to_end_id)))) {
            throw new \InvalidArgumentException("invalid value for \$end_to_end_id when calling CobVCompletaAllOfPix., must conform to the pattern /[a-zA-Z0-9]{32}/.");
        }
    ...
    public function setTxid($txid)
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9]{26,35}/", ObjectSerializer::toString($txid)))) {
            throw new \InvalidArgumentException("invalid value for \$txid when calling CobVCompletaAllOfPix., must conform to the pattern /[a-zA-Z0-9]{26,35}/.");
        }
    ...
    public function setValor($valor)
    {
        ...
        if ((!preg_match("/\\d{1,10}\\.\\d{2}/", ObjectSerializer::toString($valor)))) {
            throw new \InvalidArgumentException("invalid value for \$valor when calling CobVCompletaAllOfPix., must conform to the pattern /\\d{1,10}\\.\\d{2}/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\InformaEsSobreOValorDoPix|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InformaEsSobreOValorDoPix|null $componentes_valor componentes_valor
     *
     * @return self
     */
    public function setComponentesValor($componentes_valor)
    {
        if (is_null($componentes_valor)) {
            throw new \InvalidArgumentException('non-nullable componentes_valor cannot be null');
        }
     ...
     * Sets chave
     *
     * @param string|null $chave # Formato do campo chave  * Campo chave do recebedor conforme atribuído na respectiva PACS008. * Os tipos de chave podem ser: telefone, e-mail, cpf/cnpj ou EVP. * O formato das chaves pode ser encontrado na seção \"Formatação das chaves do DICT no BR Code\" do [Manual de Padrões para iniciação do Pix](https://www.bcb.gov.br/estabilidadefinanceira/pix).
     *
     * @return self
     */
    public function setChave($chave)
    {
        ...
        if ((mb_strlen($chave) > 77)) {
            throw new \InvalidArgumentException('invalid length for $chave when calling CobVCompletaAllOfPix., must be smaller than or equal to 77.');
        }
    ...
    {
        if (is_null($horario)) {
            throw new \InvalidArgumentException('non-nullable horario cannot be null');
        }
     ...
     * Sets info_pagador
     *
     * @param string|null $info_pagador info_pagador
     *
     * @return self
     */
    public function setInfoPagador($info_pagador)
    {
        if (is_null($info_pagador)) {
            throw new \InvalidArgumentException('non-nullable info_pagador cannot be null');
        }
        if ((mb_strlen($info_pagador) > 140)) {
            throw new \InvalidArgumentException('invalid length for $info_pagador when calling CobVCompletaAllOfPix., must be smaller than or equal to 140.');
        }
     ...
     * Gets devolucoes
     *
     * @return \OpenAPI\Client\Model\Devolucao[]|null
     */
     ...
     * Sets devolucoes
     *
     * @param \OpenAPI\Client\Model\Devolucao[]|null $devolucoes devolucoes
     *
     * @return self
     */
    public function setDevolucoes($devolucoes)
    {
        if (is_null($devolucoes)) {
            throw new \InvalidArgumentException('non-nullable devolucoes cannot be null');
        }

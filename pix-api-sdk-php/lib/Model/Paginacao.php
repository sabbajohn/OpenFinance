 ...
 */
class Paginacao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Paginacao';
    ...
    protected static array $openAPINullables = [
        'pagina_atual' => false,
        'itens_por_pagina' => false,
        'quantidade_de_paginas' => false,
        'quantidade_total_de_itens' => false
    ];
    ...
    {
        $this->setIfExists('pagina_atual', $data ?? [], null);
        $this->setIfExists('itens_por_pagina', $data ?? [], null);
        $this->setIfExists('quantidade_de_paginas', $data ?? [], null);
        $this->setIfExists('quantidade_total_de_itens', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['pagina_atual'] < 0)) {
            $invalidProperties[] = "invalid value for 'pagina_atual', must be bigger than or equal to 0.";
        }

        if ($this->container['itens_por_pagina'] === null) {
            $invalidProperties[] = "'itens_por_pagina' can't be null";
        }
        if (($this->container['itens_por_pagina'] < 1)) {
            $invalidProperties[] = "invalid value for 'itens_por_pagina', must be bigger than or equal to 1.";
        }

        if ($this->container['quantidade_de_paginas'] === null) {
            $invalidProperties[] = "'quantidade_de_paginas' can't be null";
        }
        if (($this->container['quantidade_de_paginas'] < 1)) {
            $invalidProperties[] = "invalid value for 'quantidade_de_paginas', must be bigger than or equal to 1.";
        }

        if ($this->container['quantidade_total_de_itens'] === null) {
            $invalidProperties[] = "'quantidade_total_de_itens' can't be null";
        }
        if (($this->container['quantidade_total_de_itens'] < 0)) {
            $invalidProperties[] = "invalid value for 'quantidade_total_de_itens', must be bigger than or equal to 0.";
        }
    ...
    {
        if (is_null($pagina_atual)) {
            throw new \InvalidArgumentException('non-nullable pagina_atual cannot be null');
        }

        if (($pagina_atual < 0)) {
            throw new \InvalidArgumentException('invalid value for $pagina_atual when calling Paginacao., must be bigger than or equal to 0.');
        }
    ...
    {
        if (is_null($itens_por_pagina)) {
            throw new \InvalidArgumentException('non-nullable itens_por_pagina cannot be null');
        }

        if (($itens_por_pagina < 1)) {
            throw new \InvalidArgumentException('invalid value for $itens_por_pagina when calling Paginacao., must be bigger than or equal to 1.');
        }
    ...
    {
        if (is_null($quantidade_de_paginas)) {
            throw new \InvalidArgumentException('non-nullable quantidade_de_paginas cannot be null');
        }

        if (($quantidade_de_paginas < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantidade_de_paginas when calling Paginacao., must be bigger than or equal to 1.');
        }
    ...
    {
        if (is_null($quantidade_total_de_itens)) {
            throw new \InvalidArgumentException('non-nullable quantidade_total_de_itens cannot be null');
        }

        if (($quantidade_total_de_itens < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantidade_total_de_itens when calling Paginacao., must be bigger than or equal to 0.');
        }

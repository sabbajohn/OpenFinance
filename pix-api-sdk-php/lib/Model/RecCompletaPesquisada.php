...
/**
 * RecCompletaPesquisada Class Doc Comment
 *
 * @category Class
 ...
 */
class RecCompletaPesquisada implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecCompletaPesquisada';
    ...
    protected static $openAPITypes = [
        ...
        'id_rec' => 'string',
        'recebedor' => '\OpenAPI\Client\Model\RecCompletaPesquisadaAllOfRecebedor',
        'loc' => '\OpenAPI\Client\Model\PayloadLocationRecCompleta',
        'solicitacao' => '\OpenAPI\Client\Model\RecCompletaPesquisadaAllOfSolicitacao[]'
    ];
    ...
    */
    ...
    public function setIdRec($id_rec)
    {
        ...
        if ((mb_strlen($id_rec) > 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling RecCompletaPesquisada., must be smaller than or equal to 29.');
        }
        if ((mb_strlen($id_rec) < 29)) {
            throw new \InvalidArgumentException('invalid length for $id_rec when calling RecCompletaPesquisada., must be bigger than or equal to 29.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{29}/", ObjectSerializer::toString($id_rec)))) {
            throw new \InvalidArgumentException("invalid value for \$id_rec when calling RecCompletaPesquisada., must conform to the pattern /[a-zA-Z0-9]{29}/.");
        }
     ...
     * Gets recebedor
     *
     * @return \OpenAPI\Client\Model\RecCompletaPesquisadaAllOfRecebedor
     */
     ...
     * Sets recebedor
     *
     * @param \OpenAPI\Client\Model\RecCompletaPesquisadaAllOfRecebedor $recebedor recebedor
     *
     * @return self
     */
     ...
     * Gets solicitacao
     *
     * @return \OpenAPI\Client\Model\RecCompletaPesquisadaAllOfSolicitacao[]|null
     */
     ...
     * Sets solicitacao
     *
     * @param \OpenAPI\Client\Model\RecCompletaPesquisadaAllOfSolicitacao[]|null $solicitacao Solicitações vinculadas
     *
     * @return self
     */

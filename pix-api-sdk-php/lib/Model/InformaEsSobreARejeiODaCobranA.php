<?php
/**
 * InformaEsSobreARejeiODaCobranA
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InformaEsSobreARejeiODaCobranA Class Doc Comment
 *
 * @category Class
 ...
 */
class InformaEsSobreARejeiODaCobranA implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Informa__es_sobre_a_rejei__o_da_cobran_a';
    ...
    */
     ...
     * Sets codigo
     *
     * @param string $codigo Código da rejeição. Corresponde ao código de rejeição presente no catálogo de mensagens.
     *
     * @return self
     */
    public function setCodigo($codigo)
    {
        ...
        if ((mb_strlen($codigo) > 4)) {
            throw new \InvalidArgumentException('invalid length for $codigo when calling InformaEsSobreARejeiODaCobranA., must be smaller than or equal to 4.');
        }
    ...
    public function setDescricao($descricao)
    {
        ...
        if ((mb_strlen($descricao) > 400)) {
            throw new \InvalidArgumentException('invalid length for $descricao when calling InformaEsSobreARejeiODaCobranA., must be smaller than or equal to 400.');
        }

...
**calendario** | [**\OpenAPI\Client\Model\CobExpiracao**](CobExpiracao.md) | Os campos aninhados sob o identificador calendário organizam informações a respeito de controle de tempo da cobrança. | [optional]
**devedor** | [**\OpenAPI\Client\Model\CobRevisadaAllOfDevedor**](CobRevisadaAllOfDevedor.md) |  | [optional]
**loc** | [**\OpenAPI\Client\Model\PayloadLocationCob**](PayloadLocationCob.md) |  | [optional]
**status** | **string** |  | [optional]
**valor** | [**\OpenAPI\Client\Model\CobValor**](CobValor.md) |  | [optional]

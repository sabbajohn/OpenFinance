...
**calendario** | [**\OpenAPI\Client\Model\CobExpiracao**](CobExpiracao.md) | Os campos aninhados sob o identificador calendário organizam informações a respeito de controle de tempo da cobrança. |
**devedor** | [**\OpenAPI\Client\Model\CobSolicitadaAllOfDevedor**](CobSolicitadaAllOfDevedor.md) |  | [optional]

...
------------ | ------------- | ------------- | -------------
**calendario** | [**\OpenAPI\Client\Model\CalendRio1**](CalendRio1.md) |  |
...
**recebedor** | [**\OpenAPI\Client\Model\DadosComplementaresPessoa**](\OpenAPI\Client\Model\DadosComplementaresPessoa.md) | O objeto recebedor organiza as informações sobre o credor da cobrança. |
...
**pix** | [**\OpenAPI\Client\Model\CobVCompletaAllOfPix[]**](CobVCompletaAllOfPix.md) |  | [optional]

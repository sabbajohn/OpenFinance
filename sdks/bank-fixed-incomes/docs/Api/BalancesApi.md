...
| ------------- | ------------- | ------------- |
| [**banktFixedIncomesGetInvestmentsInvestmentIdBalances()**](BalancesApi.md#banktFixedIncomesGetInvestmentsInvestmentIdBalances) | **GET** /investments/{investmentId}/balances | Obtém a posição da operação de Renda Fixa Bancária identificada por investmentId. |


## `banktFixedIncomesGetInvestmentsInvestmentIdBalances()`

```php
banktFixedIncomesGetInvestmentsInvestmentIdBalances($investment_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent): \OpenAPI\Client\Model\ResponseBankFixedIncomesBalances
```
...
[**\OpenAPI\Client\Model\ResponseBankFixedIncomesBalances**](../Model/ResponseBankFixedIncomesBalances.md)

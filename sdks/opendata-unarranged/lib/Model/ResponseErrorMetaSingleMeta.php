...
/**
 * ResponseErrorMetaSingleMeta Class Doc Comment
 *
 * @category Class
 ...
 */
class ResponseErrorMetaSingleMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseErrorMetaSingle_meta';
    ...
    */
    ...
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling ResponseErrorMetaSingleMeta., must be smaller than or equal to 20.');
        }

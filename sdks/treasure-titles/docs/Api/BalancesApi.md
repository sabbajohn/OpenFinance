...
| ------------- | ------------- | ------------- |
| [**treasureTitlesGetInvestmentsInvestmentIdBalances()**](BalancesApi.md#treasureTitlesGetInvestmentsInvestmentIdBalances) | **GET** /investments/{investmentId}/balances | Obtém a posição da operação de Títulos do Tesouro Direto identificada por investmentId. |


## `treasureTitlesGetInvestmentsInvestmentIdBalances()`

```php
treasureTitlesGetInvestmentsInvestmentIdBalances($investment_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent): \OpenAPI\Client\Model\ResponseTreasureTitlesBalances
```
...
[**\OpenAPI\Client\Model\ResponseTreasureTitlesBalances**](../Model/ResponseTreasureTitlesBalances.md)

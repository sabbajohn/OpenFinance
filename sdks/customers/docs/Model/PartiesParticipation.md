...
**shareholding** | **float** | Percentual de participação societária (informar com 6 casas decimais). O Sócio só deve ser informado se sua participação societária for igual ou superior a 25%. p.ex: 0.250000 (Este valor  representa 25%. O valor &#39;1 &#39;representa 100%).  [Restrição]: Campo obrigatório caso o type for igual a SOCIO e este tiver participação societária maior que 25%. | [optional]
**document_type** | [**\OpenAPI\Client\Model\EnumPartiesParticipationDocumentType**](EnumPartiesParticipationDocumentType.md) |  |
**document_number** | **string** | Número do documento informado. Campo Texto Livre para preencher número e dígito do documento se houver |
**document_additional_info** | **string** | Campo livre, de preenchimento obrigatório quando o documento informado tiver informações complementares relevantes para a sua identificação | [optional]
**document_country** | **string** | País de emissão do documento. Código do pais de acordo com o código alpha3 do ISO-3166. | [optional]
**document_expiration_date** | **\DateTime** | Data de validade do documento informado, conforme especificação RFC-3339. | [optional]
**document_issue_date** | **\DateTime** | Data de emissão do documento, conforme especificação RFC-3339. | [optional]

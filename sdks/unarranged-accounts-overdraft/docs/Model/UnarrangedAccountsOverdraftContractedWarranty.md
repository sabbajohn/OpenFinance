...
**warranty_type** | [**\OpenAPI\Client\Model\EnumWarrantyType**](EnumWarrantyType.md) |  |
**warranty_sub_type** | [**\OpenAPI\Client\Model\EnumWarrantySubType**](EnumWarrantySubType.md) |  |
**warranty_amount** | **string** | Valor original da garantia. Expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.  [Restrição] Para casos em que warrantyType for igual a \&quot;GARANTIA_FIDEJUSSORIA\&quot; o valor da garantia corresponde a uma porcentagem do total garantido.  Dessa forma, os casos de garantia fidejussória para os quais não é possível determinar um valor monetário para a garantia devem ser preenchidos com 0.00. |

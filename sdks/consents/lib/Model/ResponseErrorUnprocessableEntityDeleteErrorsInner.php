...
/**
 * ResponseErrorUnprocessableEntityDeleteErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseErrorUnprocessableEntityDeleteErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseErrorUnprocessableEntityDelete_errors_inner';
    ...
    public const CODE_CONSENTIMENTO_EM_STATUS_REJEITADO = 'CONSENTIMENTO_EM_STATUS_REJEITADO';
    ...
    {
        return [
            self::CODE_CONSENTIMENTO_EM_STATUS_REJEITADO,
        ];
    }
    ...
    */
     ...
     * Sets code
     *
     * @param string $code - CONSENTIMENTO_EM_STATUS_REJEITADO
     *
     * @return self
     */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ResponseErrorUnprocessableEntityDeleteErrorsInner., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling ResponseErrorUnprocessableEntityDeleteErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ResponseErrorUnprocessableEntityDeleteErrorsInner., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling ResponseErrorUnprocessableEntityDeleteErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }

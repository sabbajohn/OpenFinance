...
/**
 * ResponseConsentReadExtensions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseConsentReadExtensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseConsentReadExtensions';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ResponseConsentReadExtensionsDataInner[]',
        'links' => '\OpenAPI\Client\Model\Links',
        'meta' => '\OpenAPI\Client\Model\MetaExtensions'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ResponseConsentReadExtensionsDataInner[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ResponseConsentReadExtensionsDataInner[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseConsentReadExtensions., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\MetaExtensions|null
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\MetaExtensions|null $meta meta
     *
     * @return self
     */

...
/**
 * ResponseErrorUnprocessableEntityDelete Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseErrorUnprocessableEntityDelete implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseErrorUnprocessableEntityDelete';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\ResponseErrorUnprocessableEntityDeleteErrorsInner[]',
        'meta' => '\OpenAPI\Client\Model\MetaError'
    ];
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\ResponseErrorUnprocessableEntityDeleteErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\ResponseErrorUnprocessableEntityDeleteErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 13)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling ResponseErrorUnprocessableEntityDelete., number of items must be less than or equal to 13.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling ResponseErrorUnprocessableEntityDelete., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\MetaError|null
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\MetaError|null $meta meta
     *
     * @return self
     */

...
All URIs are relative to https://api.banco.com.br/open-banking/loans/v2, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**loansGetContracts()**](LoansApi.md#loansGetContracts) | **GET** /contracts | Conjunto de informações  de contratos de empréstimo mantidos pelo cliente na instituição transmissora e para os quais ele tenha fornecido consentimento |
| [**loansGetContractsContractId()**](LoansApi.md#loansGetContractsContractId) | **GET** /contracts/{contractId} | Obtém os dados do contrato de empréstimo identificado por contractId |
| [**loansGetContractsContractIdPayments()**](LoansApi.md#loansGetContractsContractIdPayments) | **GET** /contracts/{contractId}/payments | Obtém os dados de pagamentos do contrato de empréstimo identificado por contractId |
| [**loansGetContractsContractIdScheduledInstalments()**](LoansApi.md#loansGetContractsContractIdScheduledInstalments) | **GET** /contracts/{contractId}/scheduled-instalments | Obtém os dados do cronograma de parcelas do contrato de empréstimo identificado por contractId |
| [**loansGetContractsContractIdWarranties()**](LoansApi.md#loansGetContractsContractIdWarranties) | **GET** /contracts/{contractId}/warranties | Obtém a lista de garantias vinculadas ao contrato de empréstimo identificado por contractId |


## `loansGetContracts()`

```php
loansGetContracts($authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent, $page, $page_size, $pagination_key): \OpenAPI\Client\Model\ResponseLoansContractList
```
...
[**\OpenAPI\Client\Model\ResponseLoansContractList**](../Model/ResponseLoansContractList.md)
...
## `loansGetContractsContractId()`

```php
loansGetContractsContractId($contract_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent): \OpenAPI\Client\Model\ResponseLoansContract
```
...
try {
    $result = $apiInstance->loansGetContractsContractId($contract_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LoansApi->loansGetContractsContractId: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\ResponseLoansContract**](../Model/ResponseLoansContract.md)
...
## `loansGetContractsContractIdPayments()`

```php
loansGetContractsContractIdPayments($contract_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent): \OpenAPI\Client\Model\ResponseLoansPayments
```
...
try {
    $result = $apiInstance->loansGetContractsContractIdPayments($contract_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LoansApi->loansGetContractsContractIdPayments: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\ResponseLoansPayments**](../Model/ResponseLoansPayments.md)
...
## `loansGetContractsContractIdScheduledInstalments()`

```php
loansGetContractsContractIdScheduledInstalments($contract_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent): \OpenAPI\Client\Model\ResponseLoansInstalments
```
...
try {
    $result = $apiInstance->loansGetContractsContractIdScheduledInstalments($contract_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LoansApi->loansGetContractsContractIdScheduledInstalments: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\ResponseLoansInstalments**](../Model/ResponseLoansInstalments.md)
...
## `loansGetContractsContractIdWarranties()`

```php
loansGetContractsContractIdWarranties($contract_id, $authorization, $x_fapi_interaction_id, $page, $page_size, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent, $pagination_key): \OpenAPI\Client\Model\ResponseLoansWarranties
```
...
try {
    $result = $apiInstance->loansGetContractsContractIdWarranties($contract_id, $authorization, $x_fapi_interaction_id, $page, $page_size, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent, $pagination_key);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LoansApi->loansGetContractsContractIdWarranties: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\ResponseLoansWarranties**](../Model/ResponseLoansWarranties.md)

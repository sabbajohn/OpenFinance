...
- Para permitir a segunda janela de liquidação para os pagamentos já agendados no detentor, os consentimentos de Pix Automático (\"automatic\" selecionado no oneOf \"/data/recurringConfiguration/\"), precisam obrigatoriamente ter o horário de expiração do consentimento definido para 23:59:59h (UTC).
...
4. **Validações na criação do pagamento - Síncrono (_POST /pix/recurring-payments_)**  
  4.1 **Casos de erro relacionados às permissões de segurança para acesso à API (ex. certificado, access_token, jwt, assinatura)**  
    ...
    &ensp;4.1.5 Detalhe tentativa inválida: Valida se os parâmetros informados condizem com a tentativa original de pagamento (DETALHE_TENTATIVA_INVALIDO).  
  4.2 **Casos de erro sintáticos e semânticos, previstos com retorno HTTP Code 422 - Unprocessable Entity (detalhamento adicional na documentação técnica da API):**  
    ...
    &ensp;4.2.2 Semânticos  
      ...
      &emsp;4.2.2.2 Limites da transação: Valida se o valor ultrapassa o limite estabelecido [na instituição (conta ou canal)/no arranjo] para permitir a realização de transações pelo cliente (VALOR_ACIMA_LIMITE);  
      &emsp;4.2.2.3 Valor informado: Valida se valor enviado é válido para o consentimento associado ao pagamento (VALOR_INVALIDO);  
      &emsp;4.2.2.4 Status Consentimento: Valida se o consentimento encontra-se em um dos estados finais “CONSUMED”, “REVOKED” ou “REJECTED\" (CONSENTIMENTO_INVALIDO);   
...
6. **Demais validações executadas durante o processamento assíncrono do pagamento pela detentora, poderão ser consultados pela iniciadora através dos endpoints _GET /pix/recurring-payments/{recurringPaymentId}_ e _GET /pix/recurring-payments_ previstos com retorno HTTP Code 200 - OK com status RJCT (Rejected) e rejectionReason conforme abaixo (detalhamento adicional na documentação técnica da API):**  
  6.1 **Demais validações durante o processamento assíncrono:**  
    ...
    &ensp;6.1.2 - Limites da transação: Valida se o valor ultrapassa o limite estabelecido [na instituição (conta ou canal)/no arranjo] para permitir a realização de transações pelo cliente (VALOR_ACIMA_LIMITE);  
    ...
    &ensp;6.1.12 - Status Consentimento: Valida se o consentimento encontra-se em um dos estados finais “CONSUMED”, “REVOKED” ou “REJECTED\" (CONSENTIMENTO_INVALIDO);  
...
All URIs are relative to *https://api.banco.com.br/open-banking/automatic-payments/v2*

Class | Method | HTTP request | Description
------------ | ------------- | ------------- | -------------
*RecurringConsentsApi* | [**automaticPaymentsGetRecurringConsentsConsentId**](docs/Api/RecurringConsentsApi.md#automaticpaymentsgetrecurringconsentsconsentid) | **GET** /recurring-consents/{recurringConsentId} | Busca informações de um consentimento.
*RecurringConsentsApi* | [**automaticPaymentsPatchRecurringConsentsConsentId**](docs/Api/RecurringConsentsApi.md#automaticpaymentspatchrecurringconsentsconsentid) | **PATCH** /recurring-consents/{recurringConsentId} | Rejeita, revoga ou edita um consentimento.
*RecurringConsentsApi* | [**automaticPaymentsPostRecurringConsents**](docs/Api/RecurringConsentsApi.md#automaticpaymentspostrecurringconsents) | **POST** /recurring-consents | Cria um consentimento para transações de pagamentos.
*RecurringPaymentsApi* | [**automaticPaymentsGetPixRecurringPayments**](docs/Api/RecurringPaymentsApi.md#automaticpaymentsgetpixrecurringpayments) | **GET** /pix/recurring-payments | Busca informações de transações de pagamentos associadas a um consentimento.
*RecurringPaymentsApi* | [**automaticPaymentsGetPixRecurringPaymentsPaymentId**](docs/Api/RecurringPaymentsApi.md#automaticpaymentsgetpixrecurringpaymentspaymentid) | **GET** /pix/recurring-payments/{recurringPaymentId} | Busca informações de uma transação de pagamento.
*RecurringPaymentsApi* | [**automaticPaymentsPatchPixRecurringPaymentsPaymentId**](docs/Api/RecurringPaymentsApi.md#automaticpaymentspatchpixrecurringpaymentspaymentid) | **PATCH** /pix/recurring-payments/{recurringPaymentId} | Cancelamento de solicitação de pagamento automático.
*RecurringPaymentsApi* | [**automaticPaymentsPostPixRecurringPayments**](docs/Api/RecurringPaymentsApi.md#automaticpaymentspostpixrecurringpayments) | **POST** /pix/recurring-payments | Cria uma transação de pagamento.

## Models

- [422ResponseErrorCreatePixRecurringPaymentErrorsInner](docs/Model/422ResponseErrorCreatePixRecurringPaymentErrorsInner.md)
- [422ResponseErrorCreateRecurringPaymentsPaymentIdErrorsInner](docs/Model/422ResponseErrorCreateRecurringPaymentsPaymentIdErrorsInner.md)
- [422ResponseErrorRecurringConsentsErrorsInner](docs/Model/422ResponseErrorRecurringConsentsErrorsInner.md)
- [Automatic](docs/Model/Automatic.md)
- [AutomaticAutomatic](docs/Model/AutomaticAutomatic.md)
- [AutomaticRequest](docs/Model/AutomaticRequest.md)
- [AutomaticRequestAutomatic](docs/Model/AutomaticRequestAutomatic.md)
- [BusinessEntity](docs/Model/BusinessEntity.md)
- [BusinessEntityDocument](docs/Model/BusinessEntityDocument.md)
- [ConsentEdition](docs/Model/ConsentEdition.md)
- [ConsentEditionBusinessEntity](docs/Model/ConsentEditionBusinessEntity.md)
- [ConsentEditionCreditorsInner](docs/Model/ConsentEditionCreditorsInner.md)
- [ConsentEditionLoggedUser](docs/Model/ConsentEditionLoggedUser.md)
- [ConsentEditionLoggedUserDocument](docs/Model/ConsentEditionLoggedUserDocument.md)
- [ConsentEditionRecurringConfiguration](docs/Model/ConsentEditionRecurringConfiguration.md)
- [ConsentEditionRecurringConfigurationAutomatic](docs/Model/ConsentEditionRecurringConfigurationAutomatic.md)
- [ConsentRejection](docs/Model/ConsentRejection.md)
- [ConsentRejectionReason](docs/Model/ConsentRejectionReason.md)
- [ConsentRejectionRejection](docs/Model/ConsentRejectionRejection.md)
- [ConsentRevocation](docs/Model/ConsentRevocation.md)
- [ConsentRevocationRevocation](docs/Model/ConsentRevocationRevocation.md)
- [ConsentRevokedReason](docs/Model/ConsentRevokedReason.md)
- [ContractDebtor](docs/Model/ContractDebtor.md)
- [ContractDebtorDocument](docs/Model/ContractDebtorDocument.md)
- [CreateRecurringConsent](docs/Model/CreateRecurringConsent.md)
- [CreateRecurringConsentData](docs/Model/CreateRecurringConsentData.md)
- [CreateRecurringConsentDataDebtorAccount](docs/Model/CreateRecurringConsentDataDebtorAccount.md)
- [CreateRecurringConsentDataRecurringConfiguration](docs/Model/CreateRecurringConsentDataRecurringConfiguration.md)
- [CreateRecurringPixPayment](docs/Model/CreateRecurringPixPayment.md)
- [CreateRecurringPixPaymentData](docs/Model/CreateRecurringPixPaymentData.md)
- [CreateRecurringPixPaymentDataCreditorAccount](docs/Model/CreateRecurringPixPaymentDataCreditorAccount.md)
- [CreateRecurringPixPaymentDataDocument](docs/Model/CreateRecurringPixPaymentDataDocument.md)
- [CreditorAccount](docs/Model/CreditorAccount.md)
- [CreditorAccountConsent](docs/Model/CreditorAccountConsent.md)
- [CreditorsInner](docs/Model/CreditorsInner.md)
- [Day](docs/Model/Day.md)
- [DebtorAccount](docs/Model/DebtorAccount.md)
- [EnumAccountTypeConsents](docs/Model/EnumAccountTypeConsents.md)
- [EnumAccountTypePayments](docs/Model/EnumAccountTypePayments.md)
...
- [EnumRejectionReasonCode](docs/Model/EnumRejectionReasonCode.md)
- [EnumRejectionReasonCodeGet](docs/Model/EnumRejectionReasonCodeGet.md)
- [FirstPayment](docs/Model/FirstPayment.md)
...
- [Model422ResponseErrorCreatePixRecurringPayment](docs/Model/Model422ResponseErrorCreatePixRecurringPayment.md)
- [Model422ResponseErrorCreateRecurringPaymentsPaymentId](docs/Model/Model422ResponseErrorCreateRecurringPaymentsPaymentId.md)
- [Model422ResponseErrorRecurringConsents](docs/Model/Model422ResponseErrorRecurringConsents.md)
- [Month](docs/Model/Month.md)
...
- [PatchRecurringConsent](docs/Model/PatchRecurringConsent.md)
- [PatchRecurringConsentData](docs/Model/PatchRecurringConsentData.md)
- [PaymentPix](docs/Model/PaymentPix.md)
- [PeriodicLimits](docs/Model/PeriodicLimits.md)
- [PixPaymentCancellation](docs/Model/PixPaymentCancellation.md)
- [PixPaymentCancellationCancelledBy](docs/Model/PixPaymentCancellationCancelledBy.md)
- [PixPaymentCancellationCancelledByDocument](docs/Model/PixPaymentCancellationCancelledByDocument.md)
- [RecurringConfiguration](docs/Model/RecurringConfiguration.md)
- [Rejection](docs/Model/Rejection.md)
- [RejectionReason](docs/Model/RejectionReason.md)
- [RejectionReasonGet](docs/Model/RejectionReasonGet.md)
- [ResponseError](docs/Model/ResponseError.md)
- [ResponseErrorCreateConsent](docs/Model/ResponseErrorCreateConsent.md)
- [ResponseErrorCreateConsentErrorsInner](docs/Model/ResponseErrorCreateConsentErrorsInner.md)
- [ResponseErrorErrorsInner](docs/Model/ResponseErrorErrorsInner.md)
- [ResponseErrorMeta](docs/Model/ResponseErrorMeta.md)
- [ResponsePostRecurringConsent](docs/Model/ResponsePostRecurringConsent.md)
- [ResponsePostRecurringConsentData](docs/Model/ResponsePostRecurringConsentData.md)
- [ResponsePostRecurringConsentDataDebtorAccount](docs/Model/ResponsePostRecurringConsentDataDebtorAccount.md)
- [ResponsePostRecurringConsentDataRevocation](docs/Model/ResponsePostRecurringConsentDataRevocation.md)
- [ResponsePostRecurringConsentDataRevocationReason](docs/Model/ResponsePostRecurringConsentDataRevocationReason.md)
- [ResponseRecurringConsent](docs/Model/ResponseRecurringConsent.md)
- [ResponseRecurringConsentData](docs/Model/ResponseRecurringConsentData.md)
- [ResponseRecurringConsentDataDebtorAccount](docs/Model/ResponseRecurringConsentDataDebtorAccount.md)
- [ResponseRecurringConsentPatch](docs/Model/ResponseRecurringConsentPatch.md)
- [ResponseRecurringConsentPatchData](docs/Model/ResponseRecurringConsentPatchData.md)
- [ResponseRecurringConsentPatchDataDebtorAccount](docs/Model/ResponseRecurringConsentPatchDataDebtorAccount.md)
- [ResponseRecurringConsentPatchDataRejection](docs/Model/ResponseRecurringConsentPatchDataRejection.md)
- [ResponseRecurringPaymentsDataPatch](docs/Model/ResponseRecurringPaymentsDataPatch.md)
- [ResponseRecurringPaymentsDataRead](docs/Model/ResponseRecurringPaymentsDataRead.md)
- [ResponseRecurringPaymentsIdPatch](docs/Model/ResponseRecurringPaymentsIdPatch.md)
- [ResponseRecurringPaymentsIdPost](docs/Model/ResponseRecurringPaymentsIdPost.md)
- [ResponseRecurringPaymentsIdRead](docs/Model/ResponseRecurringPaymentsIdRead.md)
- [ResponseRecurringPaymentsPostData](docs/Model/ResponseRecurringPaymentsPostData.md)
- [ResponseRecurringPixDataInner](docs/Model/ResponseRecurringPixDataInner.md)
- [ResponseRecurringPixDataInnerDocument](docs/Model/ResponseRecurringPixDataInnerDocument.md)
- [ResponseRecurringPixPayment](docs/Model/ResponseRecurringPixPayment.md)
- [RiskSignalsConsentEdition](docs/Model/RiskSignalsConsentEdition.md)
- [RiskSignalsConsentEditionGeolocation](docs/Model/RiskSignalsConsentEditionGeolocation.md)
- [RiskSignalsConsentEditionIntegrity](docs/Model/RiskSignalsConsentEditionIntegrity.md)
- [RiskSignalsConsentEditionScreenDimensions](docs/Model/RiskSignalsConsentEditionScreenDimensions.md)
- [RiskSignalsConsents](docs/Model/RiskSignalsConsents.md)
- [RiskSignalsPayments](docs/Model/RiskSignalsPayments.md)
- [RiskSignalsPaymentsAutomatic](docs/Model/RiskSignalsPaymentsAutomatic.md)
- [RiskSignalsPaymentsManual](docs/Model/RiskSignalsPaymentsManual.md)
- [RiskSignalsPaymentsManualGeolocation](docs/Model/RiskSignalsPaymentsManualGeolocation.md)
- [RiskSignalsPaymentsManualIntegrity](docs/Model/RiskSignalsPaymentsManualIntegrity.md)
- [RiskSignalsPaymentsManualScreenDimensions](docs/Model/RiskSignalsPaymentsManualScreenDimensions.md)
- [Sweeping](docs/Model/Sweeping.md)
- [SweepingRequest](docs/Model/SweepingRequest.md)
- [SweepingRequestSweeping](docs/Model/SweepingRequestSweeping.md)
- [SweepingSweeping](docs/Model/SweepingSweeping.md)
- [Vrp](docs/Model/Vrp.md)
- [VrpVrp](docs/Model/VrpVrp.md)
- [VrpVrpGlobalLimits](docs/Model/VrpVrpGlobalLimits.md)
- [VrpVrpPeriodicLimits](docs/Model/VrpVrpPeriodicLimits.md)

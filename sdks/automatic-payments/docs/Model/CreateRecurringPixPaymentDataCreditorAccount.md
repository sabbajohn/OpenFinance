...
**number** | **string** | Deve ser preenchido com o número da conta transacional do usuário recebedor, com dígito verificador (se este existir), se houver valor alfanumérico, este deve ser convertido para 0. |
**account_type** | [**\OpenAPI\Client\Model\EnumAccountTypePayments**](EnumAccountTypePayments.md) |  |

 ...
 */
class ResponseError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\ResponseErrorErrorsInner[]',
        'meta' => '\OpenAPI\Client\Model\ResponseErrorMeta'
    ];
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\ResponseErrorErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\ResponseErrorErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 13)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling ResponseError., number of items must be less than or equal to 13.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling ResponseError., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\ResponseErrorMeta|null
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\ResponseErrorMeta|null $meta meta
     *
     * @return self
     */

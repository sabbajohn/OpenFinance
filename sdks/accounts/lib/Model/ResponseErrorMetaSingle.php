...
/**
 * ResponseErrorMetaSingle Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseErrorMetaSingle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseErrorMetaSingle';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\ResponseErrorMetaSingleErrorsInner[]',
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\ResponseErrorMetaSingleErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\ResponseErrorMetaSingleErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 13)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling ResponseErrorMetaSingle., number of items must be less than or equal to 13.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling ResponseErrorMetaSingle., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\MetaOnlyRequestDateTime|null
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\MetaOnlyRequestDateTime|null $meta meta
     *
     * @return self
     */

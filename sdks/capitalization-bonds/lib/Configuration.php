...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.banco.com.br/open-banking/opendata-capitalization/v2';
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.banco.com.br/open-banking/opendata-capitalization/v2",
                "description" => "Servidor de Produção",
            ],
            [
                "url" => "https://apih.banco.com.br/open-banking/opendata-capitalization/v2",

...
/**
 * ResponseErrorWithAbleAdditionalProperties Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseErrorWithAbleAdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseErrorWithAbleAdditionalProperties';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\ResponseErrorWithAbleAdditionalPropertiesErrorsInner[]',
        'meta' => '\OpenAPI\Client\Model\POSTResponseCreditPortabilityPaymentMeta'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['errors']) > 13)) {
            $invalidProperties[] = "invalid value for 'errors', number of items must be less than or equal to 13.";
        }

        if ((count($this->container['errors']) < 0)) {
            $invalidProperties[] = "invalid value for 'errors', number of items must be greater than or equal to 0.";
        }
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\ResponseErrorWithAbleAdditionalPropertiesErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\ResponseErrorWithAbleAdditionalPropertiesErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 13)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling ResponseErrorWithAbleAdditionalProperties., number of items must be less than or equal to 13.');
        }
        if ((count($errors) < 0)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling ResponseErrorWithAbleAdditionalProperties., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\POSTResponseCreditPortabilityPaymentMeta|null
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\POSTResponseCreditPortabilityPaymentMeta|null $meta meta
     *
     * @return self
     */

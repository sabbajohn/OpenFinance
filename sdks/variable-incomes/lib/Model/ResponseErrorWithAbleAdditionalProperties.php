...
class ResponseErrorWithAbleAdditionalProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'meta' => '\OpenAPI\Client\Model\MetaWithAbleAdditionalProperties'
    ];
    ...
    */
    ...
    public function setErrors($errors)
    {
        ...
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling ResponseErrorWithAbleAdditionalProperties., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\MetaWithAbleAdditionalProperties|null
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\MetaWithAbleAdditionalProperties|null $meta meta
     *
     * @return self
     */

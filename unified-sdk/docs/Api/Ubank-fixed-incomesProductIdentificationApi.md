...
| ------------- | ------------- | ------------- |
| [**banktFixedIncomesGetInvestmentsInvestmentId()**](ProductIdentificationApi.md#banktFixedIncomesGetInvestmentsInvestmentId) | **GET** /investments/{investmentId} | Obtém os dados da operação de Renda Fixa Bancária identificada por investmentId. |


## `banktFixedIncomesGetInvestmentsInvestmentId()`

```php
banktFixedIncomesGetInvestmentsInvestmentId($investment_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent): \OpenAPI\Client\Model\ResponseBankFixedIncomesProductIdentification
```
...
try {
    $result = $apiInstance->banktFixedIncomesGetInvestmentsInvestmentId($investment_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ProductIdentificationApi->banktFixedIncomesGetInvestmentsInvestmentId: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\ResponseBankFixedIncomesProductIdentification**](../Model/ResponseBankFixedIncomesProductIdentification.md)

...
| ------------- | ------------- | ------------- |
| [**creditPortabilityGetAccountData()**](AccountDataApi.md#creditPortabilityGetAccountData) | **GET** /portabilities/{portabilityId}/account-data | Obtém os dados necessários para realização do pagamento da operação via TED. |


## `creditPortabilityGetAccountData()`

```php
creditPortabilityGetAccountData($portability_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent): \OpenAPI\Client\Model\ResponseAccountData
```
...
[**\OpenAPI\Client\Model\ResponseAccountData**](../Model/ResponseAccountData.md)

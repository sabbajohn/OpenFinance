...
| ------------- | ------------- | ------------- |
| [**variableIncomesGetInvestmentsInvestmentId()**](ProductIdentificationApi.md#variableIncomesGetInvestmentsInvestmentId) | **GET** /investments/{investmentId} | Obtém os dados da operação de Renda Variável identificada por investmentId. |


## `variableIncomesGetInvestmentsInvestmentId()`

```php
variableIncomesGetInvestmentsInvestmentId($investment_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent): \OpenAPI\Client\Model\ResponseVariableIncomesProductIdentification
```
...
try {
    $result = $apiInstance->variableIncomesGetInvestmentsInvestmentId($investment_id, $authorization, $x_fapi_interaction_id, $x_fapi_auth_date, $x_fapi_customer_ip_address, $x_customer_user_agent);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ProductIdentificationApi->variableIncomesGetInvestmentsInvestmentId: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\ResponseVariableIncomesProductIdentification**](../Model/ResponseVariableIncomesProductIdentification.md)

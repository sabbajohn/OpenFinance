...
**address** | **string** | Corresponde ao endereço residencial do cliente. |
**additional_info** | **string** | Alguns logradouros ainda necessitam ser especificados por meio de complemento. | [optional]
**district_name** | **string** | Bairro é uma comunidade ou região localizada em uma cidade ou município de acordo com as suas subdivisões geográficas. [Restrição] De preenchimento obrigatório, se houver. | [optional]
...
**country_code** | **string** | Código do país de acordo com o código alpha3 do ISO-3166. | [optional]

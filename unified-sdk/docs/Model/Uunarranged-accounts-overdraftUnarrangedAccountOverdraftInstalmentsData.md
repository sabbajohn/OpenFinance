...
------------ | ------------- | ------------- | -------------
**type_number_of_instalments** | [**\OpenAPI\Client\Model\EnumTypeNumberOfInstalments**](EnumTypeNumberOfInstalments.md) |  |
...
**balloon_payments** | [**\OpenAPI\Client\Model\UnarrangedAccountOverdraftBalloonPayment[]**](UnarrangedAccountOverdraftBalloonPayment.md) | Lista que traz as datas de vencimento e valor das parcelas não regulares do contrato da modalidade de crédito consultada | [optional]

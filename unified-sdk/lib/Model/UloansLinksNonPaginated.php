...
/**
 * LinksNonPaginated Class Doc Comment
 *
 * @category Class
 ...
 */
class UloansLinksNonPaginated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinksNonPaginated';
    ...
    */
    ...
    public function setSelf($self)
    {
        ...
        if ((mb_strlen($self) > 4048)) {
            throw new \InvalidArgumentException('invalid length for $self when calling LinksNonPaginated., must be smaller than or equal to 4048.');
        }

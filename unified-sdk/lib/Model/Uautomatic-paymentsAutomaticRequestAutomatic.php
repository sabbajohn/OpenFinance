...
/**
 * AutomaticRequestAutomatic Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsAutomaticRequestAutomatic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutomaticRequest_automatic';
    ...
    */
    ...
    public function setContractId($contract_id)
    {
        ...
        if ((mb_strlen($contract_id) > 35)) {
            throw new \InvalidArgumentException('invalid length for $contract_id when calling AutomaticRequestAutomatic., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($contract_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contract_id when calling AutomaticRequestAutomatic., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]{1,35}$/", ObjectSerializer::toString($contract_id)))) {
            throw new \InvalidArgumentException("invalid value for \$contract_id when calling AutomaticRequestAutomatic., must conform to the pattern /^[a-zA-Z0-9]{1,35}$/.");
        }
    ...
    public function setFixedAmount($fixed_amount)
    {
        ...
        if ((mb_strlen($fixed_amount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $fixed_amount when calling AutomaticRequestAutomatic., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($fixed_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $fixed_amount when calling AutomaticRequestAutomatic., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($fixed_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$fixed_amount when calling AutomaticRequestAutomatic., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }
    ...
    public function setMaximumVariableAmount($maximum_variable_amount)
    {
        ...
        if ((mb_strlen($maximum_variable_amount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $maximum_variable_amount when calling AutomaticRequestAutomatic., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($maximum_variable_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $maximum_variable_amount when calling AutomaticRequestAutomatic., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($maximum_variable_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$maximum_variable_amount when calling AutomaticRequestAutomatic., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }
    ...
    public function setMinimumVariableAmount($minimum_variable_amount)
    {
        ...
        if ((mb_strlen($minimum_variable_amount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $minimum_variable_amount when calling AutomaticRequestAutomatic., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($minimum_variable_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $minimum_variable_amount when calling AutomaticRequestAutomatic., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($minimum_variable_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$minimum_variable_amount when calling AutomaticRequestAutomatic., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }
    ...
    public function setReferenceStartDate($reference_start_date)
    {
        ...
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($reference_start_date)))) {
            throw new \InvalidArgumentException("invalid value for \$reference_start_date when calling AutomaticRequestAutomatic., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }

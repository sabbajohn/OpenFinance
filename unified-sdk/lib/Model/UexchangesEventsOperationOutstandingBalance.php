...
/**
 * EventsOperationOutstandingBalance Class Doc Comment
 *
 * @category Class
 ...
 */
class UexchangesEventsOperationOutstandingBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Events_operationOutstandingBalance';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 20)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling EventsOperationOutstandingBalance., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^\\d{1,17}\\.\\d{2}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling EventsOperationOutstandingBalance., must conform to the pattern /^\\d{1,17}\\.\\d{2}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling EventsOperationOutstandingBalance., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling EventsOperationOutstandingBalance., must conform to the pattern /^[A-Z]{3}$/.");
        }

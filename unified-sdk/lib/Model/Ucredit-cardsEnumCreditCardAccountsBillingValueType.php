...
/**
 * EnumCreditCardAccountsBillingValueType Class Doc Comment
 *
 * @category Class
 * @description Traz os tipos dos valores relativos aos pagamentos da fatura da conta de pagamento pós-paga: (Vide Enum)  - Valor de pagamento da fatura com parcelamento  - Valor pagamento da fatura realizado  - Outro Valor pago na fatura   VALOR_PAGAMENTO_FATURA_PARCELADO: Quando o pagamento corresponde ao fato gerador para abertura do plano de parcelamento da fatura   VALOR_PAGAMENTO_FATURA_REALIZADO: Quando o pagamento corresponde ao valor total da fatura   OUTRO_VALOR_PAGO_FATURA: Demais casos
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Ucredit-cardsEnumCreditCardAccountsBillingValueType
{
    /**
     * Possible values of this enum
     */
    public const VALOR_PAGAMENTO_FATURA_PARCELADO = 'VALOR_PAGAMENTO_FATURA_PARCELADO';

    public const VALOR_PAGAMENTO_FATURA_REALIZADO = 'VALOR_PAGAMENTO_FATURA_REALIZADO';

    public const OUTRO_VALOR_PAGO_FATURA = 'OUTRO_VALOR_PAGO_FATURA';
    ...
    {
        return [
            self::VALOR_PAGAMENTO_FATURA_PARCELADO,
            self::VALOR_PAGAMENTO_FATURA_REALIZADO,
            self::OUTRO_VALOR_PAGO_FATURA
        ];
    }
}

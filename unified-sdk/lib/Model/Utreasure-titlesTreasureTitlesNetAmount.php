...
/**
 * TreasureTitlesNetAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class Utreasure-titlesTreasureTitlesNetAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TreasureTitlesNetAmount';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 20)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling TreasureTitlesNetAmount., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling TreasureTitlesNetAmount., must conform to the pattern /^\\d{1,15}\\.\\d{2,4}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling TreasureTitlesNetAmount., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling TreasureTitlesNetAmount., must conform to the pattern /^[A-Z]{3}$/.");
        }

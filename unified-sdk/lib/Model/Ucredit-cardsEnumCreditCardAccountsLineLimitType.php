...
/**
 * EnumCreditCardAccountsLineLimitType Class Doc Comment
 *
 * @category Class
 * @description Indicador do tipo de limite  LIMITE_CREDITO_TOTAL: Limite de crédito total aplicado a conta cartão.  LIMITE_CREDITO_MODALIDADE_OPERACAO: Limite de crédito por modalidade desse conta cartão (observar lineName e listar os aplicáveis da instituição).
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Ucredit-cardsEnumCreditCardAccountsLineLimitType
{
    /**
     * Possible values of this enum
     */
    public const LIMITE_CREDITO_TOTAL = 'LIMITE_CREDITO_TOTAL';

    public const LIMITE_CREDITO_MODALIDADE_OPERACAO = 'LIMITE_CREDITO_MODALIDADE_OPERACAO';
    ...
    {
        return [
            self::LIMITE_CREDITO_TOTAL,
            self::LIMITE_CREDITO_MODALIDADE_OPERACAO
        ];
    }
}

...
/**
 * ResponsePortabilitiesByPortabilityIdDataProposedContract Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucredit-portabilityResponsePortabilitiesByPortabilityIdDataProposedContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePortabilitiesByPortabilityId_data_proposedContract';
    ...
    protected static $openAPITypes = [
        ...
        'contracted_finance_charges' => '\OpenAPI\Client\Model\ResponsePortabilitiesByPortabilityIdDataProposedContractContractedFinanceChargesInner[]',
    ...
    */
    ...
    public function setCet($cet)
    {
        ...
        if ((mb_strlen($cet) > 13)) {
            throw new \InvalidArgumentException('invalid length for $cet when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($cet) < 8)) {
            throw new \InvalidArgumentException('invalid length for $cet when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d{1,6}\\.\\d{6}$/", ObjectSerializer::toString($cet)))) {
            throw new \InvalidArgumentException("invalid value for \$cet when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., must conform to the pattern /^\\d{1,6}\\.\\d{6}$/.");
        }
    ...
    public function setAmortizationScheduledAdditionalInfo($amortization_scheduled_additional_info)
    {
        ...
        if ((mb_strlen($amortization_scheduled_additional_info) > 200)) {
            throw new \InvalidArgumentException('invalid length for $amortization_scheduled_additional_info when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., must be smaller than or equal to 200.');
        }
        if ((!preg_match("/^[^\\s](?:.*[^\\s])?$/", ObjectSerializer::toString($amortization_scheduled_additional_info)))) {
            throw new \InvalidArgumentException("invalid value for \$amortization_scheduled_additional_info when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., must conform to the pattern /^[^\\s](?:.*[^\\s])?$/.");
        }
    ...
    public function setInterestRates($interest_rates)
    {
        ...
        if ((count($interest_rates) < 0)) {
            throw new \InvalidArgumentException('invalid length for $interest_rates when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., number of items must be greater than or equal to 0.');
        }
    ...
    public function setContractedFees($contracted_fees)
    {
        ...
        if ((count($contracted_fees) < 0)) {
            throw new \InvalidArgumentException('invalid length for $contracted_fees when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., number of items must be greater than or equal to 0.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\ResponsePortabilitiesByPortabilityIdDataProposedContractContractedFinanceChargesInner[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ResponsePortabilitiesByPortabilityIdDataProposedContractContractedFinanceChargesInner[] $contracted_finance_charges Lista que traz os encargos pactuados no contrato
     *
     * @return self
     */
    public function setContractedFinanceCharges($contracted_finance_charges)
    {
        ...
        if ((count($contracted_finance_charges) < 0)) {
            throw new \InvalidArgumentException('invalid length for $contracted_finance_charges when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., number of items must be greater than or equal to 0.');
        }
     ...
     *
     * @param string $instalment_periodicity Informação relativa à periodicidade regular das parcelas. (Vide Enum) sem periodicidade regular, diario, semanal, quinzenal, mensal, bimestral, trimestral, semestral, anual.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\RequestCreditPortabilityDataProposedContractInstallmentAmount|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RequestCreditPortabilityDataProposedContractInstallmentAmount|null $installment_amount installment_amount
     *
     * @return self
     */
     ...
     * Sets due_date
     *
     * @param string $due_date Prazo (data de vencimento final) da operação. Especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339)
     *
     * @return self
     */
    public function setDueDate($due_date)
    {
        ...
        if ((mb_strlen($due_date) > 20)) {
            throw new \InvalidArgumentException('invalid length for $due_date when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($due_date) < 20)) {
            throw new \InvalidArgumentException('invalid length for $due_date when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($due_date)))) {
            throw new \InvalidArgumentException("invalid value for \$due_date when calling ResponsePortabilitiesByPortabilityIdDataProposedContract., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

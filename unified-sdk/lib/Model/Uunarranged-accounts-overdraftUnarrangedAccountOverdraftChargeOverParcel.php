...
/**
 * UnarrangedAccountOverdraftChargeOverParcel Class Doc Comment
 *
 * @category Class
 ...
 */
class Uunarranged-accounts-overdraftUnarrangedAccountOverdraftChargeOverParcel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnarrangedAccountOverdraftChargeOverParcel';
    ...
    protected static $openAPITypes = [
        'charge_type' => '\OpenAPI\Client\Model\ChargeType',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['charge_amount']) > 21)) {
            $invalidProperties[] = "invalid value for 'charge_amount', the character length must be smaller than or equal to 21.";
        }

        if ((mb_strlen($this->container['charge_amount']) < 4)) {
            $invalidProperties[] = "invalid value for 'charge_amount', the character length must be bigger than or equal to 4.";
        }

        if (!preg_match("/^-?\\d{1,15}\\.\\d{2,4}$/", $this->container['charge_amount'])) {
            $invalidProperties[] = "invalid value for 'charge_amount', must be conform to the pattern /^-?\\d{1,15}\\.\\d{2,4}$/.";
        }
     ...
     * Gets charge_type
     *
     * @return \OpenAPI\Client\Model\ChargeType
     */
     ...
     * Sets charge_type
     *
     * @param \OpenAPI\Client\Model\ChargeType $charge_type charge_type
     *
     * @return self
     */
     ...
     *
     * @param string|null $charge_additional_info Campo livre para preenchimento das informações adicionais referente ao encargo. [Restrição] Obrigatório quando chargeType for igual 'OUTROS'.
     *
     * @return self
     */
    public function setChargeAdditionalInfo($charge_additional_info)
    {
        ...
        if ((mb_strlen($charge_additional_info) > 140)) {
            throw new \InvalidArgumentException('invalid length for $charge_additional_info when calling UnarrangedAccountOverdraftChargeOverParcel., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($charge_additional_info)))) {
            throw new \InvalidArgumentException("invalid value for \$charge_additional_info when calling UnarrangedAccountOverdraftChargeOverParcel., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
     ...
     * Sets charge_amount
     *
     * @param string $charge_amount Valor do pagamento do encargo pago fora da parcela. Expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.
     *
     * @return self
     */
    public function setChargeAmount($charge_amount)
    {
        ...
        if ((mb_strlen($charge_amount) > 21)) {
            throw new \InvalidArgumentException('invalid length for $charge_amount when calling UnarrangedAccountOverdraftChargeOverParcel., must be smaller than or equal to 21.');
        }
        if ((mb_strlen($charge_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $charge_amount when calling UnarrangedAccountOverdraftChargeOverParcel., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^-?\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($charge_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$charge_amount when calling UnarrangedAccountOverdraftChargeOverParcel., must conform to the pattern /^-?\\d{1,15}\\.\\d{2,4}$/.");
        }

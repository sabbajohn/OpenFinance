...
/**
 * LinksAccountId Class Doc Comment
 *
 * @category Class
 ...
 */
class UaccountsLinksAccountId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinksAccountId';
    ...
    */
    ...
    public function setSelf($self)
    {
        ...
        if ((mb_strlen($self) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $self when calling LinksAccountId., must be smaller than or equal to 2000.');
        }
    ...
    public function setFirst($first)
    {
        ...
        if ((mb_strlen($first) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $first when calling LinksAccountId., must be smaller than or equal to 2000.');
        }
    ...
    public function setPrev($prev)
    {
        ...
        if ((mb_strlen($prev) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $prev when calling LinksAccountId., must be smaller than or equal to 2000.');
        }
    ...
    public function setNext($next)
    {
        ...
        if ((mb_strlen($next) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $next when calling LinksAccountId., must be smaller than or equal to 2000.');
        }
    ...
    public function setLast($last)
    {
        ...
        if ((mb_strlen($last) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $last when calling LinksAccountId., must be smaller than or equal to 2000.');
        }

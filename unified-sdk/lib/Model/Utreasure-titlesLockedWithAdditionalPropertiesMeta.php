<?php
/**
 * LockedWithAdditionalPropertiesMeta
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * LockedWithAdditionalPropertiesMeta Class Doc Comment
 *
 * @category Class
 ...
 */
class Utreasure-titlesLockedWithAdditionalPropertiesMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LockedWithAdditionalProperties_meta';
    ...
    */
    ...
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling LockedWithAdditionalPropertiesMeta., must be smaller than or equal to 20.');
        }

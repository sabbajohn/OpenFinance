...
/**
 * CreatePixPayment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpaymentsCreatePixPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePixPayment';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\CreatePixPaymentDataInner[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\CreatePixPaymentDataInner[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\CreatePixPaymentDataInner[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling CreatePixPayment., number of items must be greater than or equal to 1.');
        }

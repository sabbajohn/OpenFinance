...
/**
 * ResponseFundsTransactionsDataTransactionExitFee Class Doc Comment
 *
 * @category Class
 * @description Valor da taxa de saída considerado na movimentação.  [Restrição] Campo de preenchimento obrigatório pelas participantes quando o campo &#39;type&#39; for preenchido com o valor &#39;SAIDA&#39;.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UfundsResponseFundsTransactionsDataTransactionExitFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseFundsTransactionsData_transactionExitFee';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 20)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling ResponseFundsTransactionsDataTransactionExitFee., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling ResponseFundsTransactionsDataTransactionExitFee., must conform to the pattern /^\\d{1,15}\\.\\d{2,4}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ResponseFundsTransactionsDataTransactionExitFee., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling ResponseFundsTransactionsDataTransactionExitFee., must conform to the pattern /^[A-Z]{3}$/.");
        }

...
/**
 * OpenDataMetaOperationId Class Doc Comment
 *
 * @category Class
 ...
 */
class UexchangesOpenDataMetaOperationId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpenDataMetaOperationId';
    ...
    */
    ...
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling OpenDataMetaOperationId., must be smaller than or equal to 20.');
        }

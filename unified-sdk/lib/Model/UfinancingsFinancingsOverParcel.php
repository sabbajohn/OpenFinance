...
/**
 * FinancingsOverParcel Class Doc Comment
 *
 * @category Class
 ...
 */
class UfinancingsFinancingsOverParcel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancingsOverParcel';
    ...
    protected static $openAPITypes = [
        'fees' => '\OpenAPI\Client\Model\FinancingsFeeOverParcel[]',
        'charges' => '\OpenAPI\Client\Model\FinancingsChargeOverParcel[]'
    ];
    ...
    */
     ...
     * Gets fees
     *
     * @return \OpenAPI\Client\Model\FinancingsFeeOverParcel[]
     */
     ...
     * Sets fees
     *
     * @param \OpenAPI\Client\Model\FinancingsFeeOverParcel[] $fees Lista das tarifas que foram pagas fora da parcela, só para pagamento avulso.
     *
     * @return self
     */
    public function setFees($fees)
    {
        ...
        if ((count($fees) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fees when calling FinancingsOverParcel., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets charges
     *
     * @return \OpenAPI\Client\Model\FinancingsChargeOverParcel[]
     */
     ...
     * Sets charges
     *
     * @param \OpenAPI\Client\Model\FinancingsChargeOverParcel[] $charges Lista dos encargos que foram pagos fora da parcela.
     *
     * @return self
     */
    public function setCharges($charges)
    {
        ...
        if ((count($charges) < 0)) {
            throw new \InvalidArgumentException('invalid length for $charges when calling FinancingsOverParcel., number of items must be greater than or equal to 0.');
        }

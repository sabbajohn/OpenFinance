...
/**
 * LoggedUserExtensions Class Doc Comment
 *
 * @category Class
 * @description Usuário (pessoa natural) que encontra-se logado na instituição receptora e que iniciará o processo de consentimento para compartilhamento de dados.   Deve ser armazenado como novo usuário logado responsável pela renovação do consentimento atual.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UconsentsLoggedUserExtensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoggedUserExtensions';
    ...
    protected static $openAPITypes = [
        'document' => '\OpenAPI\Client\Model\LoggedUserDocumentExtensions'
    ];
    ...
    */
     ...
     * Gets document
     *
     * @return \OpenAPI\Client\Model\LoggedUserDocumentExtensions
     */
     ...
     * Sets document
     *
     * @param \OpenAPI\Client\Model\LoggedUserDocumentExtensions $document document
     *
     * @return self
     */

...
/**
 * OKResponseProductList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UexchangesOKResponseProductList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OKResponseProductList';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ProductList[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ProductList[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ProductList[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling OKResponseProductList., number of items must be greater than or equal to 0.');
        }

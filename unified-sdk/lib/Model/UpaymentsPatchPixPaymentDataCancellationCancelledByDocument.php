...
/**
 * PatchPixPaymentDataCancellationCancelledByDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class UpaymentsPatchPixPaymentDataCancellationCancelledByDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchPixPaymentData_cancellation_cancelledBy_document';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['identification']) > 11)) {
            $invalidProperties[] = "invalid value for 'identification', the character length must be smaller than or equal to 11.";
        }

        if (!preg_match("/^\\d{11}$/", $this->container['identification'])) {
            $invalidProperties[] = "invalid value for 'identification', must be conform to the pattern /^\\d{11}$/.";
        }

        if ($this->container['rel'] === null) {
            $invalidProperties[] = "'rel' can't be null";
        }
        if ((mb_strlen($this->container['rel']) > 3)) {
            $invalidProperties[] = "invalid value for 'rel', the character length must be smaller than or equal to 3.";
        }

        if (!preg_match("/^[A-Z]{3}$/", $this->container['rel'])) {
            $invalidProperties[] = "invalid value for 'rel', must be conform to the pattern /^[A-Z]{3}$/.";
        }
     ...
     * Sets identification
     *
     * @param string $identification Número do documento do usuário pagador responsável pelo cancelamento do pagamento.
     *
     * @return self
     */
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 11)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling PatchPixPaymentDataCancellationCancelledByDocument., must be smaller than or equal to 11.');
        }
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling PatchPixPaymentDataCancellationCancelledByDocument., must conform to the pattern /^\\d{11}$/.");
        }
     ...
     * Sets rel
     *
     * @param string $rel Tipo do documento do usuário pagador responsável pelo cancelamento do pagamento.
     *
     * @return self
     */
    public function setRel($rel)
    {
        ...
        if ((mb_strlen($rel) > 3)) {
            throw new \InvalidArgumentException('invalid length for $rel when calling PatchPixPaymentDataCancellationCancelledByDocument., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($rel)))) {
            throw new \InvalidArgumentException("invalid value for \$rel when calling PatchPixPaymentDataCancellationCancelledByDocument., must conform to the pattern /^[A-Z]{3}$/.");
        }

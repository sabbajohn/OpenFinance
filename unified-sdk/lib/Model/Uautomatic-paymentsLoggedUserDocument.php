...
/**
 * LoggedUserDocument Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-paymentsLoggedUserDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoggedUser_document';
    ...
    */
    ...
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 11)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling LoggedUserDocument., must be smaller than or equal to 11.');
        }
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling LoggedUserDocument., must conform to the pattern /^\\d{11}$/.");
        }
    ...
    public function setRel($rel)
    {
        ...
        if ((mb_strlen($rel) > 3)) {
            throw new \InvalidArgumentException('invalid length for $rel when calling LoggedUserDocument., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($rel)))) {
            throw new \InvalidArgumentException("invalid value for \$rel when calling LoggedUserDocument., must conform to the pattern /^[A-Z]{3}$/.");
        }

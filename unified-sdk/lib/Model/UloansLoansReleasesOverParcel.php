...
/**
 * LoansReleasesOverParcel Class Doc Comment
 *
 * @category Class
 ...
 */
class UloansLoansReleasesOverParcel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoansReleases_overParcel';
    ...
    protected static $openAPITypes = [
        'fees' => '\OpenAPI\Client\Model\LoansFeeOverParcel[]',
        'charges' => '\OpenAPI\Client\Model\LoansChargeOverParcel[]'
    ];
    ...
    */
     ...
     * Gets fees
     *
     * @return \OpenAPI\Client\Model\LoansFeeOverParcel[]
     */
     ...
     * Sets fees
     *
     * @param \OpenAPI\Client\Model\LoansFeeOverParcel[] $fees Lista das tarifas que foram pagas fora da parcela, só para pagamento avulso.
     *
     * @return self
     */
    public function setFees($fees)
    {
        ...
        if ((count($fees) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fees when calling LoansReleasesOverParcel., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets charges
     *
     * @return \OpenAPI\Client\Model\LoansChargeOverParcel[]
     */
     ...
     * Sets charges
     *
     * @param \OpenAPI\Client\Model\LoansChargeOverParcel[] $charges Lista dos encargos que foram pagos fora da parcela.
     *
     * @return self
     */
    public function setCharges($charges)
    {
        ...
        if ((count($charges) < 0)) {
            throw new \InvalidArgumentException('invalid length for $charges when calling LoansReleasesOverParcel., number of items must be greater than or equal to 0.');
        }

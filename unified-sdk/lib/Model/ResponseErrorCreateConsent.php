...
/**
 * ResponseErrorCreateConsent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseErrorCreateConsent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseErrorCreateConsent';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\ResponseErrorCreateConsentErrorsInner[]',
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\ResponseErrorCreateConsentErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\ResponseErrorCreateConsentErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 3)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling ResponseErrorCreateConsent., number of items must be less than or equal to 3.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling ResponseErrorCreateConsent., number of items must be greater than or equal to 1.');
        }

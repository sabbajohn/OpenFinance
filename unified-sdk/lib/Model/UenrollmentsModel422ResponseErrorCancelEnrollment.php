...
/**
 * Model422ResponseErrorCancelEnrollment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UenrollmentsModel422ResponseErrorCancelEnrollment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '422ResponseErrorCancelEnrollment';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\Model422ResponseErrorCancelEnrollmentErrorsInner[]',
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\Model422ResponseErrorCancelEnrollmentErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\Model422ResponseErrorCancelEnrollmentErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling Model422ResponseErrorCancelEnrollment., number of items must be greater than or equal to 1.');
        }

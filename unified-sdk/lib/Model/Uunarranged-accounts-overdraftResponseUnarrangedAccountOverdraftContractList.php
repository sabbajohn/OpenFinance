...
/**
 * ResponseUnarrangedAccountOverdraftContractList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uunarranged-accounts-overdraftResponseUnarrangedAccountOverdraftContractList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseUnarrangedAccountOverdraftContractList';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\UnarrangedAccountOverdraftContractListData[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\UnarrangedAccountOverdraftContractListData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\UnarrangedAccountOverdraftContractListData[] $data Conjunto de informações de contratos de adiantamento a depositantes mantidos pelo cliente na instituição transmissora e para os quais ele tenha fornecido consentimento
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseUnarrangedAccountOverdraftContractList., number of items must be greater than or equal to 0.');
        }

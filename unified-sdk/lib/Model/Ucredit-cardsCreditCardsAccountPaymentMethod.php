...
/**
 * CreditCardsAccountPaymentMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucredit-cardsCreditCardsAccountPaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditCardsAccountPaymentMethod';
    ...
    protected static $setters = [
        ...
        'is_multiple_credit_card' => 'setIsMultipleCreditCard'
    ];
    ...
    protected static $getters = [
        ...
        'is_multiple_credit_card' => 'getIsMultipleCreditCard'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_multiple_credit_card', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_multiple_credit_card'] === null) {
            $invalidProperties[] = "'is_multiple_credit_card' can't be null";
        }
     ...
     *
     * @param string $identification_number Número de identificação do cartão: corresponde aos 4 últimos dígitos do cartão para pessoa natural, ou então, preencher com um identificador para pessoa jurídica, com as características definidas para os IDs no Open Finance.
     *
     * @return self
     */
    public function setIdentificationNumber($identification_number)
    {
        ...
        if ((mb_strlen($identification_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $identification_number when calling CreditCardsAccountPaymentMethod., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($identification_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identification_number when calling CreditCardsAccountPaymentMethod., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9][a-zA-Z0-9-]{0,99}$/", ObjectSerializer::toString($identification_number)))) {
            throw new \InvalidArgumentException("invalid value for \$identification_number when calling CreditCardsAccountPaymentMethod., must conform to the pattern /^[a-zA-Z0-9][a-zA-Z0-9-]{0,99}$/.");
        }
    ...
    /**
     * Gets is_multiple_credit_card
     *
     * @return bool
     */
    public function getIsMultipleCreditCard()
    {
        return $this->container['is_multiple_credit_card'];
    }

    /**
     * Sets is_multiple_credit_card
     *
     * @param bool $is_multiple_credit_card Indica se o Cartão de crédito associado à conta pagamento pós-paga é múltiplo ou não. Cartões denominados múltiplos possuem tanto a função crédito quanto a função débito, devendo o proprietário do cartão, no momento de sua utilização, informar se o pagamento é na função crédito (que leva a um pagamento futuro, por meio de uma fatura do cartão de crédito) ou na função débito.
     *
     * @return self
     */
    public function setIsMultipleCreditCard($is_multiple_credit_card)
    {
        if (is_null($is_multiple_credit_card)) {
            throw new \InvalidArgumentException('non-nullable is_multiple_credit_card cannot be null');
        }
        $this->container['is_multiple_credit_card'] = $is_multiple_credit_card;

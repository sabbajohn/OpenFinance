<?php
/**
 * ConsentEditionLoggedUserDocument
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ConsentEditionLoggedUserDocument Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-paymentsConsentEditionLoggedUserDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsentEdition_loggedUser_document';
    ...
    */
     ...
     * Sets identification
     *
     * @param string $identification Número do documento de identificação oficial do usuário logado na instituição iniciadora.
     *
     * @return self
     */
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 11)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling ConsentEditionLoggedUserDocument., must be smaller than or equal to 11.');
        }
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling ConsentEditionLoggedUserDocument., must conform to the pattern /^\\d{11}$/.");
        }
     ...
     * Sets rel
     *
     * @param string $rel Tipo do documento de identificação oficial do usuário logado na instituição iniciadora.
     *
     * @return self
     */

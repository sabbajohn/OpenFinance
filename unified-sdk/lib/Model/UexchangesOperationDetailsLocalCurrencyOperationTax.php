...
/**
 * OperationDetailsLocalCurrencyOperationTax Class Doc Comment
 *
 * @category Class
 ...
 */
class UexchangesOperationDetailsLocalCurrencyOperationTax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OperationDetails_localCurrencyOperationTax';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['amount']) > 31)) {
            $invalidProperties[] = "invalid value for 'amount', the character length must be smaller than or equal to 31.";
        }

        if (!preg_match("/^\\d{1,15}\\.\\d{1,15}$/", $this->container['amount'])) {
            $invalidProperties[] = "invalid value for 'amount', must be conform to the pattern /^\\d{1,15}\\.\\d{1,15}$/.";
        }
    ...
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 31)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling OperationDetailsLocalCurrencyOperationTax., must be smaller than or equal to 31.');
        }
        if ((!preg_match("/^\\d{1,15}\\.\\d{1,15}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling OperationDetailsLocalCurrencyOperationTax., must conform to the pattern /^\\d{1,15}\\.\\d{1,15}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling OperationDetailsLocalCurrencyOperationTax., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling OperationDetailsLocalCurrencyOperationTax., must conform to the pattern /^[A-Z]{3}$/.");
        }

...
/**
 * CreateRecurringPixPaymentDataDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsCreateRecurringPixPaymentDataDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRecurringPixPaymentData_document';
    ...
    */
    ...
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 14)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling CreateRecurringPixPaymentDataDocument., must be smaller than or equal to 14.');
        }
        if ((mb_strlen($identification) < 11)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling CreateRecurringPixPaymentDataDocument., must be bigger than or equal to 11.');
        }
        if ((!preg_match("/^(?:\\d{11}|\\d{14})$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling CreateRecurringPixPaymentDataDocument., must conform to the pattern /^(?:\\d{11}|\\d{14})$/.");
        }

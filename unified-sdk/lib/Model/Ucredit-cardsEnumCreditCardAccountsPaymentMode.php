...
/**
 * EnumCreditCardAccountsPaymentMode Class Doc Comment
 *
 * @category Class
 * @description Traz as formas de efetivação do pagamento realizado: (Vide Enum) - Débito em conta corrente - Boleto bancário - Averbação em folha - PIX
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Ucredit-cardsEnumCreditCardAccountsPaymentMode
{
    /**
    ...
    public const AVERBACAO_FOLHA = 'AVERBACAO_FOLHA';

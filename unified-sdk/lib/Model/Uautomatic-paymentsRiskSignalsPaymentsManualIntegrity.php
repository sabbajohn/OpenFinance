<?php
/**
 * RiskSignalsPaymentsManualIntegrity
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RiskSignalsPaymentsManualIntegrity Class Doc Comment
 *
 * @category Class
 * @description Informa a integridade do dispositivo e app.   No Android, conforme documentação Play API Integrity - [Android](https://developer.android.com/google/play/integrity/overview?hl&#x3D;pt-br).   No iOS, conforme documentação App Attest [iOS](https://developer.apple.com/documentation/devicecheck/establishing_your_app_s_integrity)
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsRiskSignalsPaymentsManualIntegrity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RiskSignalsPayments_manual_integrity';
    ...
    protected static $openAPIFormats = [
        'app_recognition_verdict' => null,
        'device_recognition_verdict' => null
    ];
    ...
    protected static array $openAPINullables = [
        'app_recognition_verdict' => false,
        'device_recognition_verdict' => false
    ];
    ...
    protected static $setters = [
        'app_recognition_verdict' => 'setAppRecognitionVerdict',
        'device_recognition_verdict' => 'setDeviceRecognitionVerdict'
    ];
    ...
    protected static $getters = [
        'app_recognition_verdict' => 'getAppRecognitionVerdict',
        'device_recognition_verdict' => 'getDeviceRecognitionVerdict'
    ];
    ...
    {
        $this->setIfExists('app_recognition_verdict', $data ?? [], null);
        $this->setIfExists('device_recognition_verdict', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets app_recognition_verdict
     *
     * @return string|null
     */
    public function getAppRecognitionVerdict()
    {
        return $this->container['app_recognition_verdict'];
    }

    /**
     * Sets app_recognition_verdict
     *
     * @param string|null $app_recognition_verdict Informa a integridade do app
     *
     * @return self
     */
    public function setAppRecognitionVerdict($app_recognition_verdict)
    {
        if (is_null($app_recognition_verdict)) {
            throw new \InvalidArgumentException('non-nullable app_recognition_verdict cannot be null');
        }
        $this->container['app_recognition_verdict'] = $app_recognition_verdict;

        return $this;
    }

    /**
     * Gets device_recognition_verdict
     *
     * @return string|null
     */
    public function getDeviceRecognitionVerdict()
    {
        return $this->container['device_recognition_verdict'];
    }

    /**
     * Sets device_recognition_verdict
     *
     * @param string|null $device_recognition_verdict Informa a integridade do dispositivo
     *
     * @return self
     */
    public function setDeviceRecognitionVerdict($device_recognition_verdict)
    {
        if (is_null($device_recognition_verdict)) {
            throw new \InvalidArgumentException('non-nullable device_recognition_verdict cannot be null');
        }
        $this->container['device_recognition_verdict'] = $device_recognition_verdict;

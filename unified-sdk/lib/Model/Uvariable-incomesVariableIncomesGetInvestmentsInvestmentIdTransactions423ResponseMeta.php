...
/**
 * VariableIncomesGetInvestmentsInvestmentIdTransactions423ResponseMeta Class Doc Comment
 *
 * @category Class
 ...
 */
class Uvariable-incomesVariableIncomesGetInvestmentsInvestmentIdTransactions423ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'variableIncomesGetInvestmentsInvestmentIdTransactions_423_response_meta';
    ...
    */
    ...
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling VariableIncomesGetInvestmentsInvestmentIdTransactions423ResponseMeta., must be smaller than or equal to 20.');
        }

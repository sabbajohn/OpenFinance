...
/**
 * ResponseConsentReadDataJourney Class Doc Comment
 *
 * @category Class
 * @description Informações adicionais sobre o contexto de Jornada Otimizada. [RESTRIÇÃO] Objeto de envio obrigatório quando o usuário manifestar consentimento para compartilhamento de saldo  através da Jornada Otimizada.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UconsentsResponseConsentReadDataJourney implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseConsentRead_data_journey';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['link_id']) && (mb_strlen($this->container['link_id']) > 256)) {
            $invalidProperties[] = "invalid value for 'link_id', the character length must be smaller than or equal to 256.";
        }

        if (!is_null($this->container['link_id']) && !preg_match("/^urn:[a-zA-Z0-9][a-zA-Z0-9-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/", $this->container['link_id'])) {
            $invalidProperties[] = "invalid value for 'link_id', must be conform to the pattern /^urn:[a-zA-Z0-9][a-zA-Z0-9-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/.";
        }
     ...
     * Sets link_id
     *
     * @param string|null $link_id Identificador do consentimento de pagamento/vínculo ao qual este consentimento está vinculado. [RESTRIÇÃO] Esse campo será preenchido caso o consentimento tenha sido autorizado ou rejeitado por ação do cliente.
     *
     * @return self
     */
    public function setLinkId($link_id)
    {
        ...
        if ((mb_strlen($link_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $link_id when calling ResponseConsentReadDataJourney., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^urn:[a-zA-Z0-9][a-zA-Z0-9-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/", ObjectSerializer::toString($link_id)))) {
            throw new \InvalidArgumentException("invalid value for \$link_id when calling ResponseConsentReadDataJourney., must conform to the pattern /^urn:[a-zA-Z0-9][a-zA-Z0-9-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/.");
        }

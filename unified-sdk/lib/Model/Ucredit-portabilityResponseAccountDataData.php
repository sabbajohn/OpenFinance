...
/**
 * ResponseAccountDataData Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucredit-portabilityResponseAccountDataData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseAccountData_data';
    ...
    protected static $openAPITypes = [
        'str_code' => '\OpenAPI\Client\Model\ResponseAccountDataDataStrCode'
    ];
    ...
    {
        $this->setIfExists('str_code', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['str_code'] === null) {
            $invalidProperties[] = "'str_code' can't be null";
        }
     ...
     * Gets str_code
     *
     * @return \OpenAPI\Client\Model\ResponseAccountDataDataStrCode
     */
    public function getStrCode()
    {
        return $this->container['str_code'];
    }

    /**
     * Sets str_code
     *
     * @param \OpenAPI\Client\Model\ResponseAccountDataDataStrCode $str_code str_code
     *
     * @return self
     */
    public function setStrCode($str_code)
    {
        if (is_null($str_code)) {
            throw new \InvalidArgumentException('non-nullable str_code cannot be null');
        }
        $this->container['str_code'] = $str_code;

<?php
/**
 * RequestCreditPortabilityDataInstitutionCreditor
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RequestCreditPortabilityDataInstitutionCreditor Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucredit-portabilityRequestCreditPortabilityDataInstitutionCreditor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestCreditPortability_data_institution_creditor';
    ...
    */
    ...
    public function setCompanyName($company_name)
    {
        ...
        if ((mb_strlen($company_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling RequestCreditPortabilityDataInstitutionCreditor., must be smaller than or equal to 80.');
        }
        if ((!preg_match("/^[^\\s](?:.*[^\\s])?$/", ObjectSerializer::toString($company_name)))) {
            throw new \InvalidArgumentException("invalid value for \$company_name when calling RequestCreditPortabilityDataInstitutionCreditor., must conform to the pattern /^[^\\s](?:.*[^\\s])?$/.");
        }
    ...
    public function setCompanyCnpj($company_cnpj)
    {
        ...
        if ((mb_strlen($company_cnpj) > 14)) {
            throw new \InvalidArgumentException('invalid length for $company_cnpj when calling RequestCreditPortabilityDataInstitutionCreditor., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^[0-9A-Z]{12}[0-9]{2}$/", ObjectSerializer::toString($company_cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$company_cnpj when calling RequestCreditPortabilityDataInstitutionCreditor., must conform to the pattern /^[0-9A-Z]{12}[0-9]{2}$/.");
        }

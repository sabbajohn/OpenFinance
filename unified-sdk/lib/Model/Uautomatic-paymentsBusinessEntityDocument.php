 ...
 */
class Uautomatic-paymentsBusinessEntityDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessEntity_document';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^\\d{14}$/", $this->container['identification'])) {
            $invalidProperties[] = "invalid value for 'identification', must be conform to the pattern /^\\d{14}$/.";
        }
    ...
    public function setIdentification($identification)
    {
        ...
        if ((!preg_match("/^\\d{14}$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling BusinessEntityDocument., must conform to the pattern /^\\d{14}$/.");
        }

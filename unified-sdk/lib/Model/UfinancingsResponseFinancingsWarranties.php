...
/**
 * ResponseFinancingsWarranties Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UfinancingsResponseFinancingsWarranties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseFinancingsWarranties';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\FinancingsWarranties[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\FinancingsWarranties[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\FinancingsWarranties[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseFinancingsWarranties., number of items must be greater than or equal to 0.');
        }

<?php
/**
 * ResponsePortabilitiesByPortabilityIdDataRejection
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponsePortabilitiesByPortabilityIdDataRejection Class Doc Comment
 *
 * @category Class
 * @description Objeto contendo detalhes do cancelamento do pedido de portabilidade de crédito junto a Instituição Credora.  [RESTRIÇÃO] Campo de preenchimento obrigatório quando &#x60;status&#x60; for igual a &#x60;REJECTED&#x60; ou &#x60;CANCELLED&#x60;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Ucredit-portabilityResponsePortabilitiesByPortabilityIdDataRejection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePortabilitiesByPortabilityId_data_rejection';
    ...
    protected static $openAPITypes = [
        'rejected_by' => 'string',
        'reason' => '\OpenAPI\Client\Model\ResponsePortabilitiesByPortabilityIdDataRejectionReason'
    ];
    ...
    public const REJECTED_BY_PROPONENTE = 'PROPONENTE';
    public const REJECTED_BY_USUARIO = 'USUARIO';
    public const REJECTED_BY_CREDORA = 'CREDORA';
    ...
    {
        return [
            self::REJECTED_BY_PROPONENTE,
            self::REJECTED_BY_USUARIO,
            self::REJECTED_BY_CREDORA,
        ];
    }
    ...
    */
     ...
     * Gets reason
     *
     * @return \OpenAPI\Client\Model\ResponsePortabilitiesByPortabilityIdDataRejectionReason
     */
     ...
     * Sets reason
     *
     * @param \OpenAPI\Client\Model\ResponsePortabilitiesByPortabilityIdDataRejectionReason $reason reason
     *
     * @return self
     */

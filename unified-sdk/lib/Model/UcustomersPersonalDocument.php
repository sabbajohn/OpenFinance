...
/**
 * PersonalDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class UcustomersPersonalDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonalDocument';
    ...
    protected static $openAPITypes = [
        'cpf_number' => 'string',
        'passport' => '\OpenAPI\Client\Model\PersonalPassport'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cpf_number']) && (mb_strlen($this->container['cpf_number']) > 11)) {
            $invalidProperties[] = "invalid value for 'cpf_number', the character length must be smaller than or equal to 11.";
        }

        if (!is_null($this->container['cpf_number']) && !preg_match("/^\\d{11}$/", $this->container['cpf_number'])) {
    ...
    public function setCpfNumber($cpf_number)
    {
        ...
        if ((mb_strlen($cpf_number) > 11)) {
            throw new \InvalidArgumentException('invalid length for $cpf_number when calling PersonalDocument., must be smaller than or equal to 11.');
        }
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($cpf_number)))) {
            throw new \InvalidArgumentException("invalid value for \$cpf_number when calling PersonalDocument., must conform to the pattern /^\\d{11}$/.");
        }
     ...
     * Gets passport
     *
     * @return \OpenAPI\Client\Model\PersonalPassport|null
     */
     ...
     * Sets passport
     *
     * @param \OpenAPI\Client\Model\PersonalPassport|null $passport passport
     *
     * @return self
     */

<?php
/**
 * ResponseRecurringConsentDataDebtorAccount
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponseRecurringConsentDataDebtorAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsResponseRecurringConsentDataDebtorAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRecurringConsent_data_debtorAccount';
    ...
    protected static $openAPITypes = [
        ...
        'issuer' => 'string',
        'number' => 'string',
        'account_type' => '\OpenAPI\Client\Model\EnumAccountTypeConsents',
    ...
    */
    ...
    public function setIspb($ispb)
    {
        ...
        if ((mb_strlen($ispb) > 8)) {
            throw new \InvalidArgumentException('invalid length for $ispb when calling ResponseRecurringConsentDataDebtorAccount., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ispb) < 8)) {
            throw new \InvalidArgumentException('invalid length for $ispb when calling ResponseRecurringConsentDataDebtorAccount., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^[0-9]{8}$/", ObjectSerializer::toString($ispb)))) {
            throw new \InvalidArgumentException("invalid value for \$ispb when calling ResponseRecurringConsentDataDebtorAccount., must conform to the pattern /^[0-9]{8}$/.");
        }
    ...
    public function setIssuer($issuer)
    {
        ...
        if ((mb_strlen($issuer) > 4)) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling ResponseRecurringConsentDataDebtorAccount., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($issuer) < 1)) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling ResponseRecurringConsentDataDebtorAccount., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9]{1,4}$/", ObjectSerializer::toString($issuer)))) {
            throw new \InvalidArgumentException("invalid value for \$issuer when calling ResponseRecurringConsentDataDebtorAccount., must conform to the pattern /^[0-9]{1,4}$/.");
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $number when calling ResponseRecurringConsentDataDebtorAccount., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling ResponseRecurringConsentDataDebtorAccount., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9]{1,20}$/", ObjectSerializer::toString($number)))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling ResponseRecurringConsentDataDebtorAccount., must conform to the pattern /^[0-9]{1,20}$/.");
        }
     ...
     * Gets account_type
     *
     * @return \OpenAPI\Client\Model\EnumAccountTypeConsents
     */
     ...
     * Sets account_type
     *
     * @param \OpenAPI\Client\Model\EnumAccountTypeConsents $account_type account_type
     *
     * @return self
     */
    ...
    public function setIbgeTownCode($ibge_town_code)
    {
        ...
        if ((mb_strlen($ibge_town_code) > 7)) {
            throw new \InvalidArgumentException('invalid length for $ibge_town_code when calling ResponseRecurringConsentDataDebtorAccount., must be smaller than or equal to 7.');
        }
        if ((mb_strlen($ibge_town_code) < 7)) {
            throw new \InvalidArgumentException('invalid length for $ibge_town_code when calling ResponseRecurringConsentDataDebtorAccount., must be bigger than or equal to 7.');
        }
        if ((!preg_match("/^\\d{7}$/", ObjectSerializer::toString($ibge_town_code)))) {
            throw new \InvalidArgumentException("invalid value for \$ibge_town_code when calling ResponseRecurringConsentDataDebtorAccount., must conform to the pattern /^\\d{7}$/.");
        }

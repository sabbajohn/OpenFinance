<?php
/**
 * CreateRecurringPixPaymentDataCreditorAccount
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateRecurringPixPaymentDataCreditorAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsCreateRecurringPixPaymentDataCreditorAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRecurringPixPaymentData_creditorAccount';
    ...
    protected static $openAPITypes = [
        ...
        'issuer' => 'string',
        'number' => 'string',
        'account_type' => '\OpenAPI\Client\Model\EnumAccountTypePayments'
    ];
    ...
    */
    ...
    public function setIspb($ispb)
    {
        ...
        if ((mb_strlen($ispb) > 8)) {
            throw new \InvalidArgumentException('invalid length for $ispb when calling CreateRecurringPixPaymentDataCreditorAccount., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ispb) < 8)) {
            throw new \InvalidArgumentException('invalid length for $ispb when calling CreateRecurringPixPaymentDataCreditorAccount., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^[0-9]{8}$/", ObjectSerializer::toString($ispb)))) {
            throw new \InvalidArgumentException("invalid value for \$ispb when calling CreateRecurringPixPaymentDataCreditorAccount., must conform to the pattern /^[0-9]{8}$/.");
        }
    ...
    public function setIssuer($issuer)
    {
        ...
        if ((mb_strlen($issuer) > 4)) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling CreateRecurringPixPaymentDataCreditorAccount., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($issuer) < 1)) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling CreateRecurringPixPaymentDataCreditorAccount., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9]{1,4}$/", ObjectSerializer::toString($issuer)))) {
            throw new \InvalidArgumentException("invalid value for \$issuer when calling CreateRecurringPixPaymentDataCreditorAccount., must conform to the pattern /^[0-9]{1,4}$/.");
        }
     ...
     * Sets number
     *
     * @param string $number Deve ser preenchido com o número da conta transacional do usuário recebedor, com dígito verificador (se este existir), se houver valor alfanumérico, este deve ser convertido para 0.
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $number when calling CreateRecurringPixPaymentDataCreditorAccount., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling CreateRecurringPixPaymentDataCreditorAccount., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9]{1,20}$/", ObjectSerializer::toString($number)))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling CreateRecurringPixPaymentDataCreditorAccount., must conform to the pattern /^[0-9]{1,20}$/.");
        }
     ...
     * Gets account_type
     *
     * @return \OpenAPI\Client\Model\EnumAccountTypePayments
     */
     ...
     * Sets account_type
     *
     * @param \OpenAPI\Client\Model\EnumAccountTypePayments $account_type account_type
     *
     * @return self
     */

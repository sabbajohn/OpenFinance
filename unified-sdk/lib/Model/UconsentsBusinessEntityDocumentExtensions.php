...
/**
 * BusinessEntityDocumentExtensions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UconsentsBusinessEntityDocumentExtensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessEntityDocumentExtensions';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['identification']) > 14)) {
            $invalidProperties[] = "invalid value for 'identification', the character length must be smaller than or equal to 14.";
        }

        if (!preg_match("/^[0-9A-Z]{12}[0-9]{2}$/", $this->container['identification'])) {
            $invalidProperties[] = "invalid value for 'identification', must be conform to the pattern /^[0-9A-Z]{12}[0-9]{2}$/.";
        }

        if ($this->container['rel'] === null) {
            $invalidProperties[] = "'rel' can't be null";
        }
        if ((mb_strlen($this->container['rel']) > 4)) {
            $invalidProperties[] = "invalid value for 'rel', the character length must be smaller than or equal to 4.";
        }

        if (!preg_match("/^[A-Z]{4}$/", $this->container['rel'])) {
            $invalidProperties[] = "invalid value for 'rel', must be conform to the pattern /^[A-Z]{4}$/.";
        }
     ...
     * Sets identification
     *
     * @param string $identification Número do documento de identificação oficial do titular pessoa jurídica.
     *
     * @return self
     */
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 14)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling BusinessEntityDocumentExtensions., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^[0-9A-Z]{12}[0-9]{2}$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling BusinessEntityDocumentExtensions., must conform to the pattern /^[0-9A-Z]{12}[0-9]{2}$/.");
        }
     ...
     * Sets rel
     *
     * @param string $rel Tipo do documento de identificação oficial do titular pessoa jurídica.
     *
     * @return self
     */
    public function setRel($rel)
    {
        ...
        if ((mb_strlen($rel) > 4)) {
            throw new \InvalidArgumentException('invalid length for $rel when calling BusinessEntityDocumentExtensions., must be smaller than or equal to 4.');
        }
        if ((!preg_match("/^[A-Z]{4}$/", ObjectSerializer::toString($rel)))) {
            throw new \InvalidArgumentException("invalid value for \$rel when calling BusinessEntityDocumentExtensions., must conform to the pattern /^[A-Z]{4}$/.");
        }

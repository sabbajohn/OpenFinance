<?php
/**
 * RequestCreditPortabilityDataProposedContractContractedFinanceChargesInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RequestCreditPortabilityDataProposedContractContractedFinanceChargesInner Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucredit-portabilityRequestCreditPortabilityDataProposedContractContractedFinanceChargesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestCreditPortability_data_proposedContract_contractedFinanceCharges_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['charge_rate'] === null) {
            $invalidProperties[] = "'charge_rate' can't be null";
        }
        if ((mb_strlen($this->container['charge_rate']) > 8)) {
        ...
        if (!preg_match("/^\\d{1}\\.\\d{6}$/", $this->container['charge_rate'])) {
    ...
    public function setChargeAdditionalInfo($charge_additional_info)
    {
        ...
        if ((mb_strlen($charge_additional_info) > 140)) {
            throw new \InvalidArgumentException('invalid length for $charge_additional_info when calling RequestCreditPortabilityDataProposedContractContractedFinanceChargesInner., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/^[^\\s](?:.*[^\\s])?$/", ObjectSerializer::toString($charge_additional_info)))) {
            throw new \InvalidArgumentException("invalid value for \$charge_additional_info when calling RequestCreditPortabilityDataProposedContractContractedFinanceChargesInner., must conform to the pattern /^[^\\s](?:.*[^\\s])?$/.");
        }
     ...
     * Sets charge_rate
     *
     * @param float $charge_rate Representa o valor do encargo em percentual pactuado no contrato.  O preenchimento deve respeitar as 6 casas decimais, mesmo que venham preenchidas com zeros(representação de porcentagem p.ex: 0.150000. Este valor representa 15%. O valor 1 representa 100%).
     *
     * @return self
     */
    public function setChargeRate($charge_rate)
    {
        ...
        if ((mb_strlen($charge_rate) > 8)) {
            throw new \InvalidArgumentException('invalid length for $charge_rate when calling RequestCreditPortabilityDataProposedContractContractedFinanceChargesInner., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($charge_rate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $charge_rate when calling RequestCreditPortabilityDataProposedContractContractedFinanceChargesInner., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d{1}\\.\\d{6}$/", ObjectSerializer::toString($charge_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$charge_rate when calling RequestCreditPortabilityDataProposedContractContractedFinanceChargesInner., must conform to the pattern /^\\d{1}\\.\\d{6}$/.");
        }

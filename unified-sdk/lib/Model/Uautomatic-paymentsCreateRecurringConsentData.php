...
/**
 * CreateRecurringConsentData Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsCreateRecurringConsentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRecurringConsent_data';
    ...
    protected static $openAPITypes = [
        ...
        'debtor_account' => '\OpenAPI\Client\Model\CreateRecurringConsentDataDebtorAccount',
        'recurring_configuration' => '\OpenAPI\Client\Model\CreateRecurringConsentDataRecurringConfiguration'
    ];
    ...
    */
    ...
    public function setCreditors($creditors)
    {
        ...
        if ((count($creditors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $creditors when calling CreateRecurringConsentData., number of items must be greater than or equal to 1.');
        }
    ...
    public function setExpirationDateTime($expiration_date_time)
    {
        ...
        if ((mb_strlen($expiration_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date_time when calling CreateRecurringConsentData., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($expiration_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$expiration_date_time when calling CreateRecurringConsentData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
    ...
    public function setAdditionalInformation($additional_information)
    {
        ...
        if ((mb_strlen($additional_information) > 140)) {
            throw new \InvalidArgumentException('invalid length for $additional_information when calling CreateRecurringConsentData., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($additional_information)))) {
            throw new \InvalidArgumentException("invalid value for \$additional_information when calling CreateRecurringConsentData., must conform to the pattern /[\\w\\W\\s]*/.");
        }
     ...
     * Gets debtor_account
     *
     * @return \OpenAPI\Client\Model\CreateRecurringConsentDataDebtorAccount|null
     */
     ...
     * Sets debtor_account
     *
     * @param \OpenAPI\Client\Model\CreateRecurringConsentDataDebtorAccount|null $debtor_account debtor_account
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\CreateRecurringConsentDataRecurringConfiguration
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CreateRecurringConsentDataRecurringConfiguration $recurring_configuration recurring_configuration
     *
     * @return self
     */

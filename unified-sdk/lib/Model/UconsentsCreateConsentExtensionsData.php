...
/**
 * CreateConsentExtensionsData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UconsentsCreateConsentExtensionsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateConsentExtensions_data';
    ...
    protected static $openAPITypes = [
        ...
        'business_entity' => '\OpenAPI\Client\Model\BusinessEntityExtensions'
    ];
    ...
    */
    ...
    public function setExpirationDateTime($expiration_date_time)
    {
        ...
        if ((mb_strlen($expiration_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date_time when calling CreateConsentExtensionsData., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/(^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$)/", ObjectSerializer::toString($expiration_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$expiration_date_time when calling CreateConsentExtensionsData., must conform to the pattern /(^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$)/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\BusinessEntityExtensions|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BusinessEntityExtensions|null $business_entity business_entity
     *
     * @return self
     */

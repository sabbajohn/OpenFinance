<?php
/**
 * CreateRecurringConsentDataRecurringConfiguration
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateRecurringConsentDataRecurringConfiguration Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsCreateRecurringConsentDataRecurringConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRecurringConsent_data_recurringConfiguration';
    ...
    protected static $openAPITypes = [
        'automatic' => '\OpenAPI\Client\Model\AutomaticRequestAutomatic',
        'sweeping' => '\OpenAPI\Client\Model\SweepingRequestSweeping',
        'vrp' => '\OpenAPI\Client\Model\VrpVrp'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sweeping', $data ?? [], null);
        $this->setIfExists('vrp', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sweeping'] === null) {
            $invalidProperties[] = "'sweeping' can't be null";
        }
        if ($this->container['vrp'] === null) {
            $invalidProperties[] = "'vrp' can't be null";
        }
     ...
     * Gets automatic
     *
     * @return \OpenAPI\Client\Model\AutomaticRequestAutomatic
     */
     ...
     * Sets automatic
     *
     * @param \OpenAPI\Client\Model\AutomaticRequestAutomatic $automatic automatic
     *
     * @return self
     */
     ...
     * Gets sweeping
     *
     * @return \OpenAPI\Client\Model\SweepingRequestSweeping
     */
    public function getSweeping()
    {
        return $this->container['sweeping'];
    }

    /**
     * Sets sweeping
     *
     * @param \OpenAPI\Client\Model\SweepingRequestSweeping $sweeping sweeping
     *
     * @return self
     */
    public function setSweeping($sweeping)
    {
        if (is_null($sweeping)) {
            throw new \InvalidArgumentException('non-nullable sweeping cannot be null');
        }
        $this->container['sweeping'] = $sweeping;
     ...
     * Gets vrp
     *
     * @return \OpenAPI\Client\Model\VrpVrp
     */
    public function getVrp()
    {
        return $this->container['vrp'];
    }

    /**
     * Sets vrp
     *
     * @param \OpenAPI\Client\Model\VrpVrp $vrp vrp
     *
     * @return self
     */
    public function setVrp($vrp)
    {
        if (is_null($vrp)) {
            throw new \InvalidArgumentException('non-nullable vrp cannot be null');
        }
        $this->container['vrp'] = $vrp;

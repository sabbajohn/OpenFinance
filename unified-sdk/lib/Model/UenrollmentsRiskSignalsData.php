...
/**
 * RiskSignalsData Class Doc Comment
 *
 * @category Class
 ...
 */
class UenrollmentsRiskSignalsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RiskSignals_data';
    ...
    protected static $openAPITypes = [
        ...
        'language' => 'string',
        'screen_dimensions' => '\OpenAPI\Client\Model\RiskSignalsDataScreenDimensions',
        'account_tenure' => '\DateTime',
        'geolocation' => '\OpenAPI\Client\Model\RiskSignalsDataGeolocation',
        ...
        'integrity' => '\OpenAPI\Client\Model\RiskSignalsDataIntegrity'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\RiskSignalsDataScreenDimensions
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RiskSignalsDataScreenDimensions $screen_dimensions screen_dimensions
     *
     * @return self
     */
    ...
    public function setAccountTenure($account_tenure)
    {
        ...
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($account_tenure)))) {
            throw new \InvalidArgumentException("invalid value for \$account_tenure when calling RiskSignalsData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
     ...
     * Gets geolocation
     *
     * @return \OpenAPI\Client\Model\RiskSignalsDataGeolocation|null
     */
     ...
     * Sets geolocation
     *
     * @param \OpenAPI\Client\Model\RiskSignalsDataGeolocation|null $geolocation geolocation
     *
     * @return self
     */
     ...
     * Gets integrity
     *
     * @return \OpenAPI\Client\Model\RiskSignalsDataIntegrity|null
     */
     ...
     * Sets integrity
     *
     * @param \OpenAPI\Client\Model\RiskSignalsDataIntegrity|null $integrity integrity
     *
     * @return self
     */

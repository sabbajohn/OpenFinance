<?php
/**
 * Model422ResponseErrorCreatePixRecurringPayment
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * Model422ResponseErrorCreatePixRecurringPayment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-paymentsModel422ResponseErrorCreatePixRecurringPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '422ResponseErrorCreatePixRecurringPayment';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\Model422ResponseErrorCreatePixRecurringPaymentErrorsInner[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['errors']) > 9)) {
            $invalidProperties[] = "invalid value for 'errors', number of items must be less than or equal to 9.";
        }
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\Model422ResponseErrorCreatePixRecurringPaymentErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\Model422ResponseErrorCreatePixRecurringPaymentErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 9)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling Model422ResponseErrorCreatePixRecurringPayment., number of items must be less than or equal to 9.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling Model422ResponseErrorCreatePixRecurringPayment., number of items must be greater than or equal to 1.');
        }

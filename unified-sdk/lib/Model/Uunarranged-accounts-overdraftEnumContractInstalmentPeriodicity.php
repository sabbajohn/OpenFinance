...
/**
 * EnumContractInstalmentPeriodicity Class Doc Comment
 *
 * @category Class
 * @description \&quot;Informação relativa à periodicidade regular das parcelas. (Vide Enum) sem periodicidade regular, semanal, quinzenal, mensal, bimestral, trimestral, semestral, anual\&quot;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Uunarranged-accounts-overdraftEnumContractInstalmentPeriodicity
{
    /**
     * Possible values of this enum
     */
    public const SEM_PERIODICIDADE_REGULAR = 'SEM_PERIODICIDADE_REGULAR';
    ...
    {
        return [
            self::SEM_PERIODICIDADE_REGULAR,
            self::SEMANAL,
            self::QUINZENAL,
            self::MENSAL,
            self::BIMESTRAL,

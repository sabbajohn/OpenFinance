<?php
/**
 * ResponsePostRecurringConsentDataRevocationReason
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponsePostRecurringConsentDataRevocationReason Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsResponsePostRecurringConsentDataRevocationReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePostRecurringConsent_data_revocation_reason';
    ...
    public const CODE_REVOGADO_USUARIO = 'REVOGADO_USUARIO';
    public const CODE_REVOGADO_RECEBEDOR = 'REVOGADO_RECEBEDOR';
    ...
    public function getCodeAllowableValues()
    {
        return [
            ...
            self::CODE_REVOGADO_USUARIO,
            self::CODE_REVOGADO_RECEBEDOR,
        ];
    }
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Código indicador do motivo da revogação
     *
     * @return self
     */
     ...
     * Sets detail
     *
     * @param string $detail Detalhe sobre o motivo de revogação indicado no campo `/data/revocation/reason/code`. - NAO_INFORMADO: Não informada pela detentora de conta; - REVOGADO_USUARIO: O usuário pagador revogou a recorrência do consentimento; - REVOGADO_RECEBEDOR: O usuário recebedor revogou a recorrência do consentimento.
     *
     * @return self
     */
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ResponsePostRecurringConsentDataRevocationReason., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling ResponsePostRecurringConsentDataRevocationReason., must conform to the pattern /[\\w\\W\\s]*/.");
        }

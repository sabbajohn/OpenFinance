<?php
/**
 * InvoiceFinancingsReleasesOverParcel
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InvoiceFinancingsReleasesOverParcel Class Doc Comment
 *
 * @category Class
 ...
 */
class Uinvoice-financingsInvoiceFinancingsReleasesOverParcel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceFinancingsReleases_overParcel';
    ...
    protected static $openAPITypes = [
        'fees' => '\OpenAPI\Client\Model\InvoiceFinancingsFeeOverParcel[]',
        'charges' => '\OpenAPI\Client\Model\InvoiceFinancingsChargeOverParcel[]'
    ];
    ...
    */
     ...
     * Gets fees
     *
     * @return \OpenAPI\Client\Model\InvoiceFinancingsFeeOverParcel[]
     */
     ...
     * Sets fees
     *
     * @param \OpenAPI\Client\Model\InvoiceFinancingsFeeOverParcel[] $fees Lista das tarifas que foram pagas fora da parcela, só para pagamento avulso.
     *
     * @return self
     */
    public function setFees($fees)
    {
        ...
        if ((count($fees) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fees when calling InvoiceFinancingsReleasesOverParcel., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets charges
     *
     * @return \OpenAPI\Client\Model\InvoiceFinancingsChargeOverParcel[]
     */
     ...
     * Sets charges
     *
     * @param \OpenAPI\Client\Model\InvoiceFinancingsChargeOverParcel[] $charges Lista dos encargos que foram pagos fora da parcela.
     *
     * @return self
     */
    public function setCharges($charges)
    {
        ...
        if ((count($charges) < 0)) {
            throw new \InvalidArgumentException('invalid length for $charges when calling InvoiceFinancingsReleasesOverParcel., number of items must be greater than or equal to 0.');
        }

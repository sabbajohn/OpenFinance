...
/**
 * EnumCreditCardAccountsOtherCreditType Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class Ucredit-cardsEnumCreditCardAccountsOtherCreditType
{
    /**
     * Possible values of this enum
     */
    public const CREDITO_ROTATIVO = 'CREDITO_ROTATIVO';

    public const PARCELAMENTO_FATURA = 'PARCELAMENTO_FATURA';
    ...
    {
        return [
            self::CREDITO_ROTATIVO,
            self::PARCELAMENTO_FATURA,
            self::EMPRESTIMO,
            self::OUTROS
        ];
    }

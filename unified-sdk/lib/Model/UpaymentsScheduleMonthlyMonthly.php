...
/**
 * ScheduleMonthlyMonthly Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpaymentsScheduleMonthlyMonthly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduleMonthly_monthly';
    ...
    */
     ...
     * Sets day_of_month
     *
     * @param int $day_of_month Define o dia do mês planejado para a ocorrência das liquidações.
     *
     * @return self
     */
    public function setDayOfMonth($day_of_month)
    {
        ...
        if (($day_of_month > 31)) {
            throw new \InvalidArgumentException('invalid value for $day_of_month when calling ScheduleMonthlyMonthly., must be smaller than or equal to 31.');
        }
        if (($day_of_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $day_of_month when calling ScheduleMonthlyMonthly., must be bigger than or equal to 1.');
        }
    ...
    public function setStartDate($start_date)
    {
        ...
        if ((mb_strlen($start_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $start_date when calling ScheduleMonthlyMonthly., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($start_date)))) {
            throw new \InvalidArgumentException("invalid value for \$start_date when calling ScheduleMonthlyMonthly., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 24)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ScheduleMonthlyMonthly., must be smaller than or equal to 24.');
        }
        if (($quantity < 2)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ScheduleMonthlyMonthly., must be bigger than or equal to 2.');
        }

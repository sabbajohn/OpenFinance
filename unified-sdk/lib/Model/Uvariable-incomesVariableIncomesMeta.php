...
/**
 * VariableIncomesMeta Class Doc Comment
 *
 * @category Class
 ...
 */
class Uvariable-incomesVariableIncomesMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariableIncomesMeta';
    ...
    */
    ...
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling VariableIncomesMeta., must be smaller than or equal to 20.');
        }

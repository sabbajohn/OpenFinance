...
/**
 * ResponseLoansContractList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UloansResponseLoansContractList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseLoansContractList';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\LoansListContract[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\LoansListContract[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\LoansListContract[] $data Conjunto de informações de contratos de empréstimo mantidos pelo cliente na instituição transmissora e para os quais ele tenha fornecido consentimento
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseLoansContractList., number of items must be greater than or equal to 0.');
        }

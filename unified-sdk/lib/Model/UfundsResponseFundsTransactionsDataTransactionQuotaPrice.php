...
/**
 * ResponseFundsTransactionsDataTransactionQuotaPrice Class Doc Comment
 *
 * @category Class
 ...
 */
class UfundsResponseFundsTransactionsDataTransactionQuotaPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseFundsTransactionsData_transactionQuotaPrice';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['amount']) > 25)) {
            $invalidProperties[] = "invalid value for 'amount', the character length must be smaller than or equal to 25.";
        }
    ...
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 25)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling ResponseFundsTransactionsDataTransactionQuotaPrice., must be smaller than or equal to 25.');
        }
        if ((!preg_match("/^-?\\d{1,15}\\.\\d{2,8}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling ResponseFundsTransactionsDataTransactionQuotaPrice., must conform to the pattern /^-?\\d{1,15}\\.\\d{2,8}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ResponseFundsTransactionsDataTransactionQuotaPrice., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling ResponseFundsTransactionsDataTransactionQuotaPrice., must conform to the pattern /^[A-Z]{3}$/.");
        }

<?php
/**
 * ResponsePortabilitiesByPortabilityIdDataInstitution
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponsePortabilitiesByPortabilityIdDataInstitution Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucredit-portabilityResponsePortabilitiesByPortabilityIdDataInstitution implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePortabilitiesByPortabilityId_data_institution';
    ...
    protected static $openAPITypes = [
        'creditor' => '\OpenAPI\Client\Model\ResponsePortabilitiesByPortabilityIdDataInstitutionCreditor',
        'proposing' => '\OpenAPI\Client\Model\RequestCreditPortabilityDataInstitutionProposing'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('proposing', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['proposing'] === null) {
            $invalidProperties[] = "'proposing' can't be null";
        }
     ...
     * Gets creditor
     *
     * @return \OpenAPI\Client\Model\ResponsePortabilitiesByPortabilityIdDataInstitutionCreditor
     */
     ...
     * Sets creditor
     *
     * @param \OpenAPI\Client\Model\ResponsePortabilitiesByPortabilityIdDataInstitutionCreditor $creditor creditor
     *
     * @return self
     */
     ...
     * Gets proposing
     *
     * @return \OpenAPI\Client\Model\RequestCreditPortabilityDataInstitutionProposing
     */
    public function getProposing()
    {
        return $this->container['proposing'];
    }

    /**
     * Sets proposing
     *
     * @param \OpenAPI\Client\Model\RequestCreditPortabilityDataInstitutionProposing $proposing proposing
     *
     * @return self
     */
    public function setProposing($proposing)
    {
        if (is_null($proposing)) {
            throw new \InvalidArgumentException('non-nullable proposing cannot be null');
        }
        $this->container['proposing'] = $proposing;

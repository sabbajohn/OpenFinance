...
/**
 * SweepingRequestSweeping Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsSweepingRequestSweeping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SweepingRequest_sweeping';
    ...
    protected static $openAPITypes = [
        'total_allowed_amount' => 'string',
        'transaction_limit' => 'string',
        'periodic_limits' => '\OpenAPI\Client\Model\PeriodicLimits',
    ...
    protected static array $openAPINullables = [
        'total_allowed_amount' => false,
        'transaction_limit' => false,
        'periodic_limits' => false,
    ...
    protected static $setters = [
        'total_allowed_amount' => 'setTotalAllowedAmount',
        'transaction_limit' => 'setTransactionLimit',
        'periodic_limits' => 'setPeriodicLimits',
    ...
    protected static $getters = [
        'total_allowed_amount' => 'getTotalAllowedAmount',
        'transaction_limit' => 'getTransactionLimit',
        'periodic_limits' => 'getPeriodicLimits',
    ...
    {
        $this->setIfExists('total_allowed_amount', $data ?? [], null);
        $this->setIfExists('transaction_limit', $data ?? [], null);
        $this->setIfExists('periodic_limits', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['total_allowed_amount']) && (mb_strlen($this->container['total_allowed_amount']) > 19)) {
            $invalidProperties[] = "invalid value for 'total_allowed_amount', the character length must be smaller than or equal to 19.";
        }

        if (!is_null($this->container['total_allowed_amount']) && (mb_strlen($this->container['total_allowed_amount']) < 4)) {
            $invalidProperties[] = "invalid value for 'total_allowed_amount', the character length must be bigger than or equal to 4.";
        }

        if (!is_null($this->container['total_allowed_amount']) && !preg_match("/^((\\d{1,16}\\.\\d{2}))$/", $this->container['total_allowed_amount'])) {
            $invalidProperties[] = "invalid value for 'total_allowed_amount', must be conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.";
        }

        if (!is_null($this->container['transaction_limit']) && (mb_strlen($this->container['transaction_limit']) > 19)) {
            $invalidProperties[] = "invalid value for 'transaction_limit', the character length must be smaller than or equal to 19.";
        }

        if (!is_null($this->container['transaction_limit']) && (mb_strlen($this->container['transaction_limit']) < 4)) {
            $invalidProperties[] = "invalid value for 'transaction_limit', the character length must be bigger than or equal to 4.";
        }

        if (!is_null($this->container['transaction_limit']) && !preg_match("/^((\\d{1,16}\\.\\d{2}))$/", $this->container['transaction_limit'])) {
            $invalidProperties[] = "invalid value for 'transaction_limit', must be conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.";
        }

        if (!is_null($this->container['start_date_time']) && !preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", $this->container['start_date_time'])) {
            $invalidProperties[] = "invalid value for 'start_date_time', must be conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.";
        }
    ...
    /**
     * Gets total_allowed_amount
     *
     * @return string|null
     */
    public function getTotalAllowedAmount()
    {
        return $this->container['total_allowed_amount'];
    }

    /**
     * Sets total_allowed_amount
     *
     * @param string|null $total_allowed_amount Valor máximo a ser atingido pelo somatório de todas as transações que utilizam o consentimento autorizado pelo cliente. Caso o valor seja superado, a detentora de conta deve negar a transação solicitada pela iniciadora.
     *
     * @return self
     */
    public function setTotalAllowedAmount($total_allowed_amount)
    {
        if (is_null($total_allowed_amount)) {
            throw new \InvalidArgumentException('non-nullable total_allowed_amount cannot be null');
        }
        if ((mb_strlen($total_allowed_amount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $total_allowed_amount when calling SweepingRequestSweeping., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($total_allowed_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $total_allowed_amount when calling SweepingRequestSweeping., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($total_allowed_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$total_allowed_amount when calling SweepingRequestSweeping., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }

        $this->container['total_allowed_amount'] = $total_allowed_amount;
     ...
     *
     * @param string|null $transaction_limit Valor máximo para cada transação de pagamento associada a esse consentimento. Caso valor do pagamento seja maior que esse limite, a detentora de contas deve rejeitar a transação de pagamento.
     *
     * @return self
     */
    public function setTransactionLimit($transaction_limit)
    {
        ...
        if ((mb_strlen($transaction_limit) > 19)) {
            throw new \InvalidArgumentException('invalid length for $transaction_limit when calling SweepingRequestSweeping., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($transaction_limit) < 4)) {
            throw new \InvalidArgumentException('invalid length for $transaction_limit when calling SweepingRequestSweeping., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($transaction_limit)))) {
            throw new \InvalidArgumentException("invalid value for \$transaction_limit when calling SweepingRequestSweeping., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }
    ...
    /**
     * Gets periodic_limits
     *
     * @return \OpenAPI\Client\Model\PeriodicLimits|null
     */
    public function getPeriodicLimits()
    {
        return $this->container['periodic_limits'];
    }

    /**
     * Sets periodic_limits
     *
     * @param \OpenAPI\Client\Model\PeriodicLimits|null $periodic_limits periodic_limits
     *
     * @return self
     */
    public function setPeriodicLimits($periodic_limits)
    {
        if (is_null($periodic_limits)) {
            throw new \InvalidArgumentException('non-nullable periodic_limits cannot be null');
        }
        $this->container['periodic_limits'] = $periodic_limits;
     ...
     *
     * @param \DateTime|null $start_date_time Description: Data e hora em que o consentimento deve passar a ser válido.  Uma string com data e hora conforme especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339), sempre com a utilização de timezone UTC(UTC time format).  [Restrição] Caso esse campo não seja enviado pelo iniciador na requisição, o detentor deve preencher esse campo com o mesmo valor atribuído ao campo /data/creationDateTime.
     *
     * @return self
     */
    public function setStartDateTime($start_date_time)
    {
        ...
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($start_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$start_date_time when calling SweepingRequestSweeping., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

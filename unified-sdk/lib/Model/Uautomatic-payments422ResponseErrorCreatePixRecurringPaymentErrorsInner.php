...
/**
 * 422ResponseErrorCreatePixRecurringPaymentErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-payments422ResponseErrorCreatePixRecurringPaymentErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_422ResponseErrorCreatePixRecurringPayment_errors_inner';
    ...
    public const CODE_SALDO_INSUFICIENTE = 'SALDO_INSUFICIENTE';
    public const CODE_VALOR_ACIMA_LIMITE = 'VALOR_ACIMA_LIMITE';
    public const CODE_VALOR_INVALIDO = 'VALOR_INVALIDO';
    public const CODE_LIMITE_PERIODO_VALOR_EXCEDIDO = 'LIMITE_PERIODO_VALOR_EXCEDIDO';
    public const CODE_LIMITE_PERIODO_QUANTIDADE_EXCEDIDO = 'LIMITE_PERIODO_QUANTIDADE_EXCEDIDO';
    public const CODE_CONSENTIMENTO_INVALIDO = 'CONSENTIMENTO_INVALIDO';
    public const CODE_CONSENTIMENTO_PENDENTE_AUTORIZACAO = 'CONSENTIMENTO_PENDENTE_AUTORIZACAO';
    public const CODE_PARAMETRO_NAO_INFORMADO = 'PARAMETRO_NAO_INFORMADO';
    public const CODE_PARAMETRO_INVALIDO = 'PARAMETRO_INVALIDO';
    public const CODE_NAO_INFORMADO = 'NAO_INFORMADO';
    public const CODE_PAGAMENTO_DIVERGENTE_CONSENTIMENTO = 'PAGAMENTO_DIVERGENTE_CONSENTIMENTO';
    public const CODE_DETALHE_PAGAMENTO_INVALIDO = 'DETALHE_PAGAMENTO_INVALIDO';
    public const CODE_PAGAMENTO_RECUSADO_DETENTORA = 'PAGAMENTO_RECUSADO_DETENTORA';
    public const CODE_PAGAMENTO_RECUSADO_SPI = 'PAGAMENTO_RECUSADO_SPI';
    public const CODE_ERRO_IDEMPOTENCIA = 'ERRO_IDEMPOTENCIA';
    public const CODE_LIMITE_VALOR_TOTAL_CONSENTIMENTO_EXCEDIDO = 'LIMITE_VALOR_TOTAL_CONSENTIMENTO_EXCEDIDO';
    public const CODE_LIMITE_VALOR_TRANSACAO_CONSENTIMENTO_EXCEDIDO = 'LIMITE_VALOR_TRANSACAO_CONSENTIMENTO_EXCEDIDO';
    public const CODE_LIMITE_TENTATIVAS_EXCEDIDO = 'LIMITE_TENTATIVAS_EXCEDIDO';
    public const CODE_FORA_PRAZO_PERMITIDO = 'FORA_PRAZO_PERMITIDO';
    public const CODE_DETALHE_TENTATIVA_INVALIDO = 'DETALHE_TENTATIVA_INVALIDO';
    ...
    {
        return [
            self::CODE_SALDO_INSUFICIENTE,
            self::CODE_VALOR_ACIMA_LIMITE,
            self::CODE_VALOR_INVALIDO,
            self::CODE_LIMITE_PERIODO_VALOR_EXCEDIDO,
            self::CODE_LIMITE_PERIODO_QUANTIDADE_EXCEDIDO,
            self::CODE_CONSENTIMENTO_INVALIDO,
            self::CODE_CONSENTIMENTO_PENDENTE_AUTORIZACAO,
            self::CODE_PARAMETRO_NAO_INFORMADO,
            self::CODE_PARAMETRO_INVALIDO,
            self::CODE_NAO_INFORMADO,
            self::CODE_PAGAMENTO_DIVERGENTE_CONSENTIMENTO,
            self::CODE_DETALHE_PAGAMENTO_INVALIDO,
            self::CODE_PAGAMENTO_RECUSADO_DETENTORA,
            self::CODE_PAGAMENTO_RECUSADO_SPI,
            self::CODE_ERRO_IDEMPOTENCIA,
            self::CODE_LIMITE_VALOR_TOTAL_CONSENTIMENTO_EXCEDIDO,
            self::CODE_LIMITE_VALOR_TRANSACAO_CONSENTIMENTO_EXCEDIDO,
            self::CODE_LIMITE_TENTATIVAS_EXCEDIDO,
            self::CODE_FORA_PRAZO_PERMITIDO,
            self::CODE_DETALHE_TENTATIVA_INVALIDO,
        ];
    }
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling 422ResponseErrorCreatePixRecurringPaymentErrorsInner., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling 422ResponseErrorCreatePixRecurringPaymentErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling 422ResponseErrorCreatePixRecurringPaymentErrorsInner., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling 422ResponseErrorCreatePixRecurringPaymentErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }

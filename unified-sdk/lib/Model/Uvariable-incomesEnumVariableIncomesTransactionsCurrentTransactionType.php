...
/**
 * EnumVariableIncomesTransactionsCurrentTransactionType Class Doc Comment
 *
 * @category Class
 * @description O campo deve classificar a movimentação em um dos tipos descritos: compra, venda, dividendos, JCP, aluguéis, transferência de custódia, transferência de titularidade e outros.  O transmissor deve classificar as movimentações disponíveis associando-a a um dos itens do Enum listado neste campo.  A opção OUTROS só deve ser utilizada para os casos em que de fato a movimentação compartilhada não possa ser classificada como um dos itens deste Enum.  A expressão “aluguéis” deverá ser utilizada apenas para informar os juros/remuneração pagos/recebidos pelo cliente dos contratos de ações alugadas, seguindo o mesmo entendimento de ENTRADA/SAÍDA da expressão “dividendos”.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Uvariable-incomesEnumVariableIncomesTransactionsCurrentTransactionType
{
    /**
    ...
    public const DIVIDENDOS = 'DIVIDENDOS';

    public const JCP = 'JCP';

    public const ALUGUEIS = 'ALUGUEIS';

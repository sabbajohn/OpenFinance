...
/**
 * ResponseFinancingsContractList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UfinancingsResponseFinancingsContractList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseFinancingsContractList';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\FinancingsListContract[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\FinancingsListContract[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\FinancingsListContract[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseFinancingsContractList., number of items must be greater than or equal to 0.');
        }

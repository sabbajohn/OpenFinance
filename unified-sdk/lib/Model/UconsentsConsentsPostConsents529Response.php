...
/**
 * ConsentsPostConsents529Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UconsentsConsentsPostConsents529Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'consentsPostConsents_529_response';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\ConsentsPostConsents529ResponseErrorsInner[]',
        'meta' => '\OpenAPI\Client\Model\ConsentsPostConsents529ResponseMeta'
    ];
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\ConsentsPostConsents529ResponseErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\ConsentsPostConsents529ResponseErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 13)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling ConsentsPostConsents529Response., number of items must be less than or equal to 13.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling ConsentsPostConsents529Response., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\ConsentsPostConsents529ResponseMeta|null
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\ConsentsPostConsents529ResponseMeta|null $meta meta
     *
     * @return self
     */

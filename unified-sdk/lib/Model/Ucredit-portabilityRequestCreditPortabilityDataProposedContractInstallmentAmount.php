<?php
/**
 * RequestCreditPortabilityDataProposedContractInstallmentAmount
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RequestCreditPortabilityDataProposedContractInstallmentAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucredit-portabilityRequestCreditPortabilityDataProposedContractInstallmentAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestCreditPortability_data_proposedContract_installmentAmount';
    ...
    */
     ...
     * Sets amount
     *
     * @param float $amount Valor da parcela regular da operação após portabilidade. Expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 20)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling RequestCreditPortabilityDataProposedContractInstallmentAmount., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling RequestCreditPortabilityDataProposedContractInstallmentAmount., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling RequestCreditPortabilityDataProposedContractInstallmentAmount., must conform to the pattern /^\\d{1,15}\\.\\d{2,4}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling RequestCreditPortabilityDataProposedContractInstallmentAmount., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling RequestCreditPortabilityDataProposedContractInstallmentAmount., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^(\\w{3}){1}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling RequestCreditPortabilityDataProposedContractInstallmentAmount., must conform to the pattern /^(\\w{3}){1}$/.");
        }

...
/**
 * ResponseBusinessCustomersIdentification Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UcustomersResponseBusinessCustomersIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseBusinessCustomersIdentification';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\BusinessIdentificationData[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\BusinessIdentificationData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\BusinessIdentificationData[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseBusinessCustomersIdentification., number of items must be greater than or equal to 1.');
        }

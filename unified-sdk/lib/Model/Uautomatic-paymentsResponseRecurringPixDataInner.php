...
/**
 * ResponseRecurringPixDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-paymentsResponseRecurringPixDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRecurringPixData_inner';
    ...
    protected static $openAPITypes = [
        ...
        'rejection_reason' => '\OpenAPI\Client\Model\RejectionReasonGet',
        'payment' => '\OpenAPI\Client\Model\PaymentPix',
        'remittance_information' => 'string',
        'transaction_identification' => 'string',
        'document' => '\OpenAPI\Client\Model\ResponseRecurringPixDataInnerDocument',
    ...
    */
    ...
    public function setRecurringPaymentId($recurring_payment_id)
    {
        ...
        if ((mb_strlen($recurring_payment_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $recurring_payment_id when calling ResponseRecurringPixDataInner., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($recurring_payment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $recurring_payment_id when calling ResponseRecurringPixDataInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9][a-zA-Z0-9\\-]{0,99}$/", ObjectSerializer::toString($recurring_payment_id)))) {
            throw new \InvalidArgumentException("invalid value for \$recurring_payment_id when calling ResponseRecurringPixDataInner., must conform to the pattern /^[a-zA-Z0-9][a-zA-Z0-9\\-]{0,99}$/.");
        }
    ...
    public function setRecurringConsentId($recurring_consent_id)
    {
        ...
        if ((mb_strlen($recurring_consent_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $recurring_consent_id when calling ResponseRecurringPixDataInner., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/", ObjectSerializer::toString($recurring_consent_id)))) {
            throw new \InvalidArgumentException("invalid value for \$recurring_consent_id when calling ResponseRecurringPixDataInner., must conform to the pattern /^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/.");
        }
    ...
    public function setEndToEndId($end_to_end_id)
    {
        ...
        if ((mb_strlen($end_to_end_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling ResponseRecurringPixDataInner., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($end_to_end_id) < 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling ResponseRecurringPixDataInner., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/^([E])([0-9]{8})([0-9]{4})(0[1-9]|1[0-2])(0[1-9]|[1-2][0-9]|3[0-1])(2[0-3]|[01][0-9])([0-5][0-9])([a-zA-Z0-9]{11})$/", ObjectSerializer::toString($end_to_end_id)))) {
            throw new \InvalidArgumentException("invalid value for \$end_to_end_id when calling ResponseRecurringPixDataInner., must conform to the pattern /^([E])([0-9]{8})([0-9]{4})(0[1-9]|1[0-2])(0[1-9]|[1-2][0-9]|3[0-1])(2[0-3]|[01][0-9])([0-5][0-9])([a-zA-Z0-9]{11})$/.");
        }
    ...
    public function setDate($date)
    {
        ...
        if ((mb_strlen($date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $date when calling ResponseRecurringPixDataInner., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($date)))) {
            throw new \InvalidArgumentException("invalid value for \$date when calling ResponseRecurringPixDataInner., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
    ...
    public function setCreationDateTime($creation_date_time)
    {
        ...
        if ((mb_strlen($creation_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $creation_date_time when calling ResponseRecurringPixDataInner., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($creation_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$creation_date_time when calling ResponseRecurringPixDataInner., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
    ...
    public function setStatusUpdateDateTime($status_update_date_time)
    {
        ...
        if ((mb_strlen($status_update_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status_update_date_time when calling ResponseRecurringPixDataInner., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($status_update_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$status_update_date_time when calling ResponseRecurringPixDataInner., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\RejectionReasonGet|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RejectionReasonGet|null $rejection_reason rejection_reason
     *
     * @return self
     */
    ...
    public function setRemittanceInformation($remittance_information)
    {
        ...
        if ((mb_strlen($remittance_information) > 140)) {
            throw new \InvalidArgumentException('invalid length for $remittance_information when calling ResponseRecurringPixDataInner., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($remittance_information)))) {
            throw new \InvalidArgumentException("invalid value for \$remittance_information when calling ResponseRecurringPixDataInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }
    ...
    public function setTransactionIdentification($transaction_identification)
    {
        ...
        if ((mb_strlen($transaction_identification) > 35)) {
            throw new \InvalidArgumentException('invalid length for $transaction_identification when calling ResponseRecurringPixDataInner., must be smaller than or equal to 35.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]{1,35}$/", ObjectSerializer::toString($transaction_identification)))) {
            throw new \InvalidArgumentException("invalid value for \$transaction_identification when calling ResponseRecurringPixDataInner., must conform to the pattern /^[a-zA-Z0-9]{1,35}$/.");
        }
     ...
     * Gets document
     *
     * @return \OpenAPI\Client\Model\ResponseRecurringPixDataInnerDocument
     */
     ...
     * Sets document
     *
     * @param \OpenAPI\Client\Model\ResponseRecurringPixDataInnerDocument $document document
     *
     * @return self
     */
    ...
    public function setOriginalRecurringPaymentId($original_recurring_payment_id)
    {
        ...
        if ((mb_strlen($original_recurring_payment_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $original_recurring_payment_id when calling ResponseRecurringPixDataInner., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($original_recurring_payment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $original_recurring_payment_id when calling ResponseRecurringPixDataInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9][a-zA-Z0-9\\-]{0,99}$/", ObjectSerializer::toString($original_recurring_payment_id)))) {
            throw new \InvalidArgumentException("invalid value for \$original_recurring_payment_id when calling ResponseRecurringPixDataInner., must conform to the pattern /^[a-zA-Z0-9][a-zA-Z0-9\\-]{0,99}$/.");
        }
    ...
    public function setPaymentReference($payment_reference)
    {
        ...
        if ((mb_strlen($payment_reference) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_reference when calling ResponseRecurringPixDataInner., must be smaller than or equal to 10.');
        }

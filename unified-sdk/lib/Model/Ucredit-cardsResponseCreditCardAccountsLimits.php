...
/**
 * ResponseCreditCardAccountsLimits Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Ucredit-cardsResponseCreditCardAccountsLimits implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCreditCardAccountsLimits';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\CreditCardAccountsLimitsData[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\CreditCardAccountsLimitsData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\CreditCardAccountsLimitsData[] $data [Restrição] A lista vazia deve ser interpretada como a ausência da informação.  Cenário de limite com valor zerado, deve ter um registro explícito informando o valor como zero.  Cenário de \"cartão sem limite\", isto é, cartões em que o uso do limite é ilimitado, deve ser informado em um registro explícito com isLimitFlexible como true.
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseCreditCardAccountsLimits., number of items must be greater than or equal to 0.');
        }

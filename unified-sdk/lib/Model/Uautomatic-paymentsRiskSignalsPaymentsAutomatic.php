...
/**
 * RiskSignalsPaymentsAutomatic Class Doc Comment
 *
 * @category Class
 * @description Representa a coleta de sinais de risco sem a presença do usuário  [Restrição] Obrigatório de ser enviado quando a transação não ocorrer na presença do usuário
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsRiskSignalsPaymentsAutomatic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RiskSignalsPayments_automatic';
    ...
    protected static $openAPITypes = [
        ...
        'pix_key_registration_date_time' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        'last_login_date_time' => 'date-time',
        'pix_key_registration_date_time' => 'date-time'
    ];
    ...
    protected static array $openAPINullables = [
        'last_login_date_time' => false,
        'pix_key_registration_date_time' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'pix_key_registration_date_time' => 'pixKeyRegistrationDateTime'
    ];
    ...
    protected static $setters = [
        'last_login_date_time' => 'setLastLoginDateTime',
        'pix_key_registration_date_time' => 'setPixKeyRegistrationDateTime'
    ];
    ...
    protected static $getters = [
        'last_login_date_time' => 'getLastLoginDateTime',
        'pix_key_registration_date_time' => 'getPixKeyRegistrationDateTime'
    ];
    ...
    {
        $this->setIfExists('last_login_date_time', $data ?? [], null);
        $this->setIfExists('pix_key_registration_date_time', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['last_login_date_time'] === null) {
            $invalidProperties[] = "'last_login_date_time' can't be null";
        }
        if (!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", $this->container['last_login_date_time'])) {
            $invalidProperties[] = "invalid value for 'last_login_date_time', must be conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.";
        }

        if (!is_null($this->container['pix_key_registration_date_time']) && !preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", $this->container['pix_key_registration_date_time'])) {
            $invalidProperties[] = "invalid value for 'pix_key_registration_date_time', must be conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.";
        }
    ...
    /**
     * Gets last_login_date_time
     *
     * @return \DateTime
     */
    public function getLastLoginDateTime()
    {
        return $this->container['last_login_date_time'];
    }

    /**
     * Sets last_login_date_time
     *
     * @param \DateTime $last_login_date_time Caso o usuário pagador tenha acesso ao ambiente da iniciadora de pagamentos, utilizar data e hora da última interação do cliente com seu aplicativo/sistema.  Para casos onde a iniciadora de pagamentos presta serviços a um terceiro, deve-se enviar o horário que o pagador logou na aplicação do terceiro.
     *
     * @return self
     */
    public function setLastLoginDateTime($last_login_date_time)
    {
        if (is_null($last_login_date_time)) {
            throw new \InvalidArgumentException('non-nullable last_login_date_time cannot be null');
        }

        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($last_login_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$last_login_date_time when calling RiskSignalsPaymentsAutomatic., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

        $this->container['last_login_date_time'] = $last_login_date_time;

        return $this;
    }

    /**
     * Gets pix_key_registration_date_time
     *
     * @return \DateTime|null
     */
    public function getPixKeyRegistrationDateTime()
    {
        return $this->container['pix_key_registration_date_time'];
    }

    /**
     * Sets pix_key_registration_date_time
     *
     * @param \DateTime|null $pix_key_registration_date_time Data e hora de cadastro da chave Pix do recebedor na iniciadora  [Restrição] Campo obrigatório a ser enviado, caso o valor do campo `/data/localInstrument` seja igual a `DICT` ou `INIC`.
     *
     * @return self
     */
    public function setPixKeyRegistrationDateTime($pix_key_registration_date_time)
    {
        if (is_null($pix_key_registration_date_time)) {
            throw new \InvalidArgumentException('non-nullable pix_key_registration_date_time cannot be null');
        }

        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($pix_key_registration_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$pix_key_registration_date_time when calling RiskSignalsPaymentsAutomatic., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

        $this->container['pix_key_registration_date_time'] = $pix_key_registration_date_time;

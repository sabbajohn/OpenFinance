...
/**
 * BusinessFinancingFee Class Doc Comment
 *
 * @category Class
 ...
 */
class Uproducts-servicesBusinessFinancingFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessFinancingFee';
    ...
    */
     ...
     * Gets services
     *
     * @return \OpenAPI\Client\Model\FinancingService[]
     */
     ...
     * Sets services
     *
     * @param \OpenAPI\Client\Model\FinancingService[] $services services
     *
     * @return self
     */
    public function setServices($services)
    {
        ...
        if ((count($services) < 1)) {
            throw new \InvalidArgumentException('invalid length for $services when calling BusinessFinancingFee., number of items must be greater than or equal to 1.');
        }

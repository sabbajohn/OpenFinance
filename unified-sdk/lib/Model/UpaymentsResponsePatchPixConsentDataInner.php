<?php
/**
 * ResponsePatchPixConsentDataInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponsePatchPixConsentDataInner Class Doc Comment
 *
 * @category Class
 ...
 */
class UpaymentsResponsePatchPixConsentDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePatchPixConsent_data_inner';
    ...
    */
    ...
    public function setPaymentId($payment_id)
    {
        ...
        if ((mb_strlen($payment_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling ResponsePatchPixConsentDataInner., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($payment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling ResponsePatchPixConsentDataInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9][a-zA-Z0-9\\-]{0,99}$/", ObjectSerializer::toString($payment_id)))) {
            throw new \InvalidArgumentException("invalid value for \$payment_id when calling ResponsePatchPixConsentDataInner., must conform to the pattern /^[a-zA-Z0-9][a-zA-Z0-9\\-]{0,99}$/.");
        }
    ...
    public function setStatusUpdateDateTime($status_update_date_time)
    {
        ...
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($status_update_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$status_update_date_time when calling ResponsePatchPixConsentDataInner., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

...
/**
 * EnumCreditCardAccountNetwork Class Doc Comment
 *
 * @category Class
 * @description Categoria de Bandeiras de Cartões de Crédito (Instituidor do arranjo de pagamento). Bandeira é a detentora de todos os direitos e deveres da utilização da marca estampada no cartão, inclusive as bandeiras pertencentes aos emissores.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Ucredit-cardsEnumCreditCardAccountNetwork
{
    /**
    ...
    public const BANDEIRA_PROPRIA = 'BANDEIRA_PROPRIA';

...
/**
 * ResponseInvoiceFinancingsWarranties Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uinvoice-financingsResponseInvoiceFinancingsWarranties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseInvoiceFinancingsWarranties';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\InvoiceFinancingsContractedWarranty[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\InvoiceFinancingsContractedWarranty[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\InvoiceFinancingsContractedWarranty[] $data Conjunto de informações referentes às garantias que avalizam a operação de direitos creditórios descontados contratada
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseInvoiceFinancingsWarranties., number of items must be greater than or equal to 0.');
        }

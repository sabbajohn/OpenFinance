<?php
/**
 * UnarrangedAccountOverdraftReleasesOverParcel
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * UnarrangedAccountOverdraftReleasesOverParcel Class Doc Comment
 *
 * @category Class
 * @description Objeto das tarifas e encargos que foram pagos fora da parcela.  [Restrição] Informação deve ser enviada caso ela exista.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uunarranged-accounts-overdraftUnarrangedAccountOverdraftReleasesOverParcel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnarrangedAccountOverdraftReleases_overParcel';
    ...
    protected static $openAPITypes = [
        'fees' => '\OpenAPI\Client\Model\UnarrangedAccountOverdraftFeeOverParcel[]',
        'charges' => '\OpenAPI\Client\Model\UnarrangedAccountOverdraftChargeOverParcel[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['fees']) < 0)) {
            $invalidProperties[] = "invalid value for 'fees', number of items must be greater than or equal to 0.";
        }

        if ($this->container['charges'] === null) {
            $invalidProperties[] = "'charges' can't be null";
        }
        if ((count($this->container['charges']) < 0)) {
            $invalidProperties[] = "invalid value for 'charges', number of items must be greater than or equal to 0.";
        }
     ...
     * Gets fees
     *
     * @return \OpenAPI\Client\Model\UnarrangedAccountOverdraftFeeOverParcel[]
     */
     ...
     * Sets fees
     *
     * @param \OpenAPI\Client\Model\UnarrangedAccountOverdraftFeeOverParcel[] $fees Lista das tarifas que foram pagas fora da parcela, só para pagamento avulso.
     *
     * @return self
     */
    public function setFees($fees)
    {
        ...
        if ((count($fees) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fees when calling UnarrangedAccountOverdraftReleasesOverParcel., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets charges
     *
     * @return \OpenAPI\Client\Model\UnarrangedAccountOverdraftChargeOverParcel[]
     */
     ...
     * Sets charges
     *
     * @param \OpenAPI\Client\Model\UnarrangedAccountOverdraftChargeOverParcel[] $charges Lista dos encargos que foram pagos fora da parcela.
     *
     * @return self
     */
    public function setCharges($charges)
    {
        ...
        if ((count($charges) < 0)) {
            throw new \InvalidArgumentException('invalid length for $charges when calling UnarrangedAccountOverdraftReleasesOverParcel., number of items must be greater than or equal to 0.');
        }

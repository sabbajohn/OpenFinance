 ...
 */
class UcustomersBusinessAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCompeCode($compe_code)
    {
        ...
        if ((mb_strlen($compe_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $compe_code when calling BusinessAccount., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^\\d{3}$/", ObjectSerializer::toString($compe_code)))) {
            throw new \InvalidArgumentException("invalid value for \$compe_code when calling BusinessAccount., must conform to the pattern /^\\d{3}$/.");
        }
    ...
    public function setBranchCode($branch_code)
    {
        ...
        if ((mb_strlen($branch_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $branch_code when calling BusinessAccount., must be smaller than or equal to 4.');
        }
        if ((!preg_match("/^\\d{4}$/", ObjectSerializer::toString($branch_code)))) {
            throw new \InvalidArgumentException("invalid value for \$branch_code when calling BusinessAccount., must conform to the pattern /^\\d{4}$/.");
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $number when calling BusinessAccount., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^\\d{8,20}$/", ObjectSerializer::toString($number)))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling BusinessAccount., must conform to the pattern /^\\d{8,20}$/.");
        }
    ...
    public function setCheckDigit($check_digit)
    {
        ...
        if ((mb_strlen($check_digit) > 1)) {
            throw new \InvalidArgumentException('invalid length for $check_digit when calling BusinessAccount., must be smaller than or equal to 1.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($check_digit)))) {
            throw new \InvalidArgumentException("invalid value for \$check_digit when calling BusinessAccount., must conform to the pattern /[\\w\\W\\s]*/.");
        }

...
/**
 * ConsentRejectionRejection Class Doc Comment
 *
 * @category Class
 * @description Objeto contendo as informações de rejeição dos consentimentos.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsConsentRejectionRejection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsentRejection_rejection';
    ...
    */
     ...
     * Sets rejected_by
     *
     * @param string $rejected_by Ator responsável pela solicitação rejeição
     *
     * @return self
     */
     ...
     * Gets reason
     *
     * @return \OpenAPI\Client\Model\ConsentRejectionReason
     */
     ...
     * Sets reason
     *
     * @param \OpenAPI\Client\Model\ConsentRejectionReason $reason reason
     *
     * @return self
     */

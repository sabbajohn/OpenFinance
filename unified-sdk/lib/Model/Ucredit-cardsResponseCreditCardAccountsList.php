...
/**
 * ResponseCreditCardAccountsList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Ucredit-cardsResponseCreditCardAccountsList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCreditCardAccountsList';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\CreditCardAccountsData[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\CreditCardAccountsData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\CreditCardAccountsData[] $data Conjunto de informações de conta de pagamento pós-paga
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseCreditCardAccountsList., number of items must be greater than or equal to 0.');
        }

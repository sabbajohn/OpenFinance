...
/**
 * FinancingsBalloonPayment Class Doc Comment
 *
 * @category Class
 ...
 */
class UfinancingsFinancingsBalloonPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancingsBalloonPayment';
    ...
    protected static $openAPITypes = [
        'due_date' => '\DateTime',
        'amount' => '\OpenAPI\Client\Model\FinancingsBalloonPaymentAmount'
    ];
    ...
    */
    ...
    public function setDueDate($due_date)
    {
        ...
        if ((mb_strlen($due_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $due_date when calling FinancingsBalloonPayment., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($due_date)))) {
            throw new \InvalidArgumentException("invalid value for \$due_date when calling FinancingsBalloonPayment., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
     ...
     * Gets amount
     *
     * @return \OpenAPI\Client\Model\FinancingsBalloonPaymentAmount
     */
     ...
     * Sets amount
     *
     * @param \OpenAPI\Client\Model\FinancingsBalloonPaymentAmount $amount amount
     *
     * @return self
     */

<?php
/**
 * CreateRecurringConsentDataDebtorAccount
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateRecurringConsentDataDebtorAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsCreateRecurringConsentDataDebtorAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRecurringConsent_data_debtorAccount';
    ...
    */
    ...
    public function setIspb($ispb)
    {
        ...
        if ((mb_strlen($ispb) > 8)) {
            throw new \InvalidArgumentException('invalid length for $ispb when calling CreateRecurringConsentDataDebtorAccount., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($ispb) < 8)) {
            throw new \InvalidArgumentException('invalid length for $ispb when calling CreateRecurringConsentDataDebtorAccount., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^[0-9]{8}$/", ObjectSerializer::toString($ispb)))) {
            throw new \InvalidArgumentException("invalid value for \$ispb when calling CreateRecurringConsentDataDebtorAccount., must conform to the pattern /^[0-9]{8}$/.");
        }
    ...
    public function setIssuer($issuer)
    {
        ...
        if ((mb_strlen($issuer) > 4)) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling CreateRecurringConsentDataDebtorAccount., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($issuer) < 1)) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling CreateRecurringConsentDataDebtorAccount., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9]{1,4}$/", ObjectSerializer::toString($issuer)))) {
            throw new \InvalidArgumentException("invalid value for \$issuer when calling CreateRecurringConsentDataDebtorAccount., must conform to the pattern /^[0-9]{1,4}$/.");
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $number when calling CreateRecurringConsentDataDebtorAccount., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling CreateRecurringConsentDataDebtorAccount., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9]{1,20}$/", ObjectSerializer::toString($number)))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling CreateRecurringConsentDataDebtorAccount., must conform to the pattern /^[0-9]{1,20}$/.");
        }

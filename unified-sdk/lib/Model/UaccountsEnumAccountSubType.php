...
/**
 * EnumAccountSubType Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class UaccountsEnumAccountSubType
{
    /**
    ...
    public const CONJUNTA_SIMPLES = 'CONJUNTA_SIMPLES';

    public const CONJUNTA_SOLIDARIA = 'CONJUNTA_SOLIDARIA';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::INDIVIDUAL,
            self::CONJUNTA_SIMPLES,
            self::CONJUNTA_SOLIDARIA
        ];
    }
}

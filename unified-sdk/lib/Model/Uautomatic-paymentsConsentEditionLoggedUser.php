...
/**
 * ConsentEditionLoggedUser Class Doc Comment
 *
 * @category Class
 * @description Usuário (pessoa natural) que encontra-se logado na instituição Iniciadora de Pagamento.  [Restrição] Objeto de envio obrigatório para a edição dos parâmetros do consentimento, exceto para o caso de edição exclusiva do campo “/data/creditors/name”.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsConsentEditionLoggedUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsentEdition_loggedUser';
    ...
    protected static $openAPITypes = [
        'document' => '\OpenAPI\Client\Model\ConsentEditionLoggedUserDocument'
    ];
    ...
    */
     ...
     * Gets document
     *
     * @return \OpenAPI\Client\Model\ConsentEditionLoggedUserDocument
     */
     ...
     * Sets document
     *
     * @param \OpenAPI\Client\Model\ConsentEditionLoggedUserDocument $document document
     *
     * @return self
     */

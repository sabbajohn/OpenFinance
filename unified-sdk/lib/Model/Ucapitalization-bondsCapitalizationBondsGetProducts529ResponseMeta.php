...
/**
 * CapitalizationBondsGetProducts529ResponseMeta Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucapitalization-bondsCapitalizationBondsGetProducts529ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'capitalizationBondsGetProducts_529_response_meta';
    ...
    */
    ...
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling CapitalizationBondsGetProducts529ResponseMeta., must be smaller than or equal to 20.');
        }

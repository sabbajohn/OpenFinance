...
/**
 * GetPersonalAcquiringServices529ResponseMeta Class Doc Comment
 *
 * @category Class
 ...
 */
class Uacquiring-servicesGetPersonalAcquiringServices529ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getPersonalAcquiringServices_529_response_meta';
    ...
    */
    ...
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling GetPersonalAcquiringServices529ResponseMeta., must be smaller than or equal to 20.');
        }

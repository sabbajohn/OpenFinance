...
/**
 * InvoiceFinancingsContractInterestRate Class Doc Comment
 *
 * @category Class
 ...
 */
class Uinvoice-financingsInvoiceFinancingsContractInterestRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceFinancingsContractInterestRate';
    ...
    protected static $openAPITypes = [
        ...
        'calculation' => '\OpenAPI\Client\Model\EnumContractCalculation',
    ...
    */
     ...
     * Gets calculation
     *
     * @return \OpenAPI\Client\Model\EnumContractCalculation
     */
     ...
     * Sets calculation
     *
     * @param \OpenAPI\Client\Model\EnumContractCalculation $calculation calculation
     *
     * @return self
     */
    ...
    public function setReferentialRateIndexerAdditionalInfo($referential_rate_indexer_additional_info)
    {
        ...
        if ((mb_strlen($referential_rate_indexer_additional_info) > 140)) {
            throw new \InvalidArgumentException('invalid length for $referential_rate_indexer_additional_info when calling InvoiceFinancingsContractInterestRate., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($referential_rate_indexer_additional_info)))) {
            throw new \InvalidArgumentException("invalid value for \$referential_rate_indexer_additional_info when calling InvoiceFinancingsContractInterestRate., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
    ...
    public function setPreFixedRate($pre_fixed_rate)
    {
        ...
        if ((mb_strlen($pre_fixed_rate) > 9)) {
            throw new \InvalidArgumentException('invalid length for $pre_fixed_rate when calling InvoiceFinancingsContractInterestRate., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($pre_fixed_rate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $pre_fixed_rate when calling InvoiceFinancingsContractInterestRate., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d{1,2}\\.\\d{6}$/", ObjectSerializer::toString($pre_fixed_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$pre_fixed_rate when calling InvoiceFinancingsContractInterestRate., must conform to the pattern /^\\d{1,2}\\.\\d{6}$/.");
        }
    ...
    public function setPostFixedRate($post_fixed_rate)
    {
        ...
        if ((mb_strlen($post_fixed_rate) > 9)) {
            throw new \InvalidArgumentException('invalid length for $post_fixed_rate when calling InvoiceFinancingsContractInterestRate., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($post_fixed_rate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $post_fixed_rate when calling InvoiceFinancingsContractInterestRate., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d{1,2}\\.\\d{6}$/", ObjectSerializer::toString($post_fixed_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$post_fixed_rate when calling InvoiceFinancingsContractInterestRate., must conform to the pattern /^\\d{1,2}\\.\\d{6}$/.");
        }
    ...
    public function setAdditionalInfo($additional_info)
    {
        ...
        if ((mb_strlen($additional_info) > 1200)) {
            throw new \InvalidArgumentException('invalid length for $additional_info when calling InvoiceFinancingsContractInterestRate., must be smaller than or equal to 1200.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($additional_info)))) {
            throw new \InvalidArgumentException("invalid value for \$additional_info when calling InvoiceFinancingsContractInterestRate., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }

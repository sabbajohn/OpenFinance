...
/**
 * CreditCardAccountsBillsFinanceCharge Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Ucredit-cardsCreditCardAccountsBillsFinanceCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditCardAccountsBillsFinanceCharge';
    ...
    protected static $openAPITypes = [
        'type' => '\OpenAPI\Client\Model\EnumCreditCardAccountsFinanceChargeType',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['additional_info']) && (mb_strlen($this->container['additional_info']) > 140)) {
            $invalidProperties[] = "invalid value for 'additional_info', the character length must be smaller than or equal to 140.";
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\EnumCreditCardAccountsFinanceChargeType
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\EnumCreditCardAccountsFinanceChargeType $type type
     *
     * @return self
     */
     ...
     *
     * @param string|null $additional_info Campo livre, de preenchimento obrigatório se selecionado tipo de encargo 'OUTROS'
     *
     * @return self
     */
    public function setAdditionalInfo($additional_info)
    {
        ...
        if ((mb_strlen($additional_info) > 140)) {
            throw new \InvalidArgumentException('invalid length for $additional_info when calling CreditCardAccountsBillsFinanceCharge., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($additional_info)))) {
            throw new \InvalidArgumentException("invalid value for \$additional_info when calling CreditCardAccountsBillsFinanceCharge., must conform to the pattern /[\\w\\W\\s]*/.");
        }
     ...
     * Sets amount
     *
     * @param float $amount Valor cobrado pelo encargo. Expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 20)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling CreditCardAccountsBillsFinanceCharge., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling CreditCardAccountsBillsFinanceCharge., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling CreditCardAccountsBillsFinanceCharge., must conform to the pattern /^\\d{1,15}\\.\\d{2,4}$/.");
        }
     ...
     * Sets currency
     *
     * @param string $currency Moeda referente ao valor cobrado pelo encargo, segundo modelo ISO-4217. p.ex. 'BRL'  Todos os saldos informados estão representados com a moeda vigente do Brasil.
     *
     * @return self
     */
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreditCardAccountsBillsFinanceCharge., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^(\\w{3}){1}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling CreditCardAccountsBillsFinanceCharge., must conform to the pattern /^(\\w{3}){1}$/.");
        }

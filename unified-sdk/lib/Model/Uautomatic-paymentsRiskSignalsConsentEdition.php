...
/**
 * RiskSignalsConsentEdition Class Doc Comment
 *
 * @category Class
 * @description Sinais de risco para iniciação de pagamentos automáticos  [Restrição] Deve ser enviado quando o consentimento for para o produto Pix Automático (O objeto \&quot;/data/recurringConfiguration/automatic\&quot; usado no oneOf).  Só estará presente após a primeira edição do consentimento de longa duração.  Objeto de envio obrigatório para a edição dos parâmetros do consentimento, exceto para o caso de edição exclusiva do campo “/data/creditors/name”.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsRiskSignalsConsentEdition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RiskSignalsConsentEdition';
    ...
    protected static $openAPITypes = [
        ...
        'language' => 'string',
        'screen_dimensions' => '\OpenAPI\Client\Model\RiskSignalsConsentEditionScreenDimensions',
        'account_tenure' => '\DateTime',
        'geolocation' => '\OpenAPI\Client\Model\RiskSignalsConsentEditionGeolocation',
        ...
        'integrity' => '\OpenAPI\Client\Model\RiskSignalsConsentEditionIntegrity'
    ];
    ...
    */
     ...
     * Sets device_id
     *
     * @param string $device_id ID único do dispositivo gerado pela plataforma.  [Android] Informação obtida através do [link](https://developer.android.com/reference/android/provider/Settings.Secure#ANDROID_ID).  [iOS] Informação obtida através do [link](https://developer.apple.com/documentation/uikit/uidevice/1620059-identifierforvendor/).
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_rooted_device Indica se o dispositivo atualmente está com permissão de “root”.  [Restrição] Campos de envio obrigatório quando o sistema operacional utilizado pelo usuário for Android ou iOS.
     *
     * @return self
     */
     ...
     *
     * @param int|null $elapsed_time_since_boot Indica por quanto tempo (em milissegundos) o dispositivo está ligado.  [Android] Informação obtida através do [link](https://developer.android.com/reference/android/os/SystemClock#elapsedRealtime%28%29).  [iOS] Informação obtida através do [link](https://developer.apple.com/documentation/kernel/kern/).  [Restrição] Campos de envio obrigatório quando o sistema operacional utilizado pelo for Android ou iOS.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\RiskSignalsConsentEditionScreenDimensions
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RiskSignalsConsentEditionScreenDimensions $screen_dimensions screen_dimensions
     *
     * @return self
     */
    ...
    public function setAccountTenure($account_tenure)
    {
        ...
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($account_tenure)))) {
            throw new \InvalidArgumentException("invalid value for \$account_tenure when calling RiskSignalsConsentEdition., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
     ...
     * Gets geolocation
     *
     * @return \OpenAPI\Client\Model\RiskSignalsConsentEditionGeolocation|null
     */
     ...
     * Sets geolocation
     *
     * @param \OpenAPI\Client\Model\RiskSignalsConsentEditionGeolocation|null $geolocation geolocation
     *
     * @return self
     */
     ...
     * Gets integrity
     *
     * @return \OpenAPI\Client\Model\RiskSignalsConsentEditionIntegrity|null
     */
     ...
     * Sets integrity
     *
     * @param \OpenAPI\Client\Model\RiskSignalsConsentEditionIntegrity|null $integrity integrity
     *
     * @return self
     */

...
/**
 * ResponseVariableIncomesTransactions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uvariable-incomesResponseVariableIncomesTransactions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseVariableIncomesTransactions';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ResponseVariableIncomesTransactionsData[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ResponseVariableIncomesTransactionsData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ResponseVariableIncomesTransactionsData[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseVariableIncomesTransactions., number of items must be greater than or equal to 0.');
        }

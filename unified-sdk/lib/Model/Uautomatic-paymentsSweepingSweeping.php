...
/**
 * SweepingSweeping Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsSweepingSweeping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sweeping_sweeping';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", $this->container['start_date_time'])) {
    ...
    public function setTotalAllowedAmount($total_allowed_amount)
    {
        ...
        if ((mb_strlen($total_allowed_amount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $total_allowed_amount when calling SweepingSweeping., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($total_allowed_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $total_allowed_amount when calling SweepingSweeping., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($total_allowed_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$total_allowed_amount when calling SweepingSweeping., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }
    ...
    public function setTransactionLimit($transaction_limit)
    {
        ...
        if ((mb_strlen($transaction_limit) > 19)) {
            throw new \InvalidArgumentException('invalid length for $transaction_limit when calling SweepingSweeping., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($transaction_limit) < 4)) {
            throw new \InvalidArgumentException('invalid length for $transaction_limit when calling SweepingSweeping., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($transaction_limit)))) {
            throw new \InvalidArgumentException("invalid value for \$transaction_limit when calling SweepingSweeping., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }
     ...
     *
     * @param \DateTime $start_date_time Description: Data e hora em que o consentimento deve passar a ser válido.  Uma string com data e hora conforme especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339), sempre com a utilização de timezone UTC(UTC time format).  [Restrição] Caso esse campo não seja enviado pelo iniciador na requisição, o detentor deve preencher esse campo com o mesmo valor atribuído ao campo /data/creationDateTime.
     *
     * @return self
     */
    public function setStartDateTime($start_date_time)
    {
        ...
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($start_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$start_date_time when calling SweepingSweeping., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

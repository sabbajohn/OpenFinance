...
/**
 * Model422ResponseErrorCreateConsent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpaymentsModel422ResponseErrorCreateConsent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '422ResponseErrorCreateConsent';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\Model422ResponseErrorCreateConsentErrorsInner[]',
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\Model422ResponseErrorCreateConsentErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\Model422ResponseErrorCreateConsentErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 3)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling Model422ResponseErrorCreateConsent., number of items must be less than or equal to 3.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling Model422ResponseErrorCreateConsent., number of items must be greater than or equal to 1.');
        }

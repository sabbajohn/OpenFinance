 ...
 *
 * @category Class
 * @description \&quot;Tipo da modalidade de crédito contratada, conforme circular 4.015 e descrição do DOC3040 do SCR). (Vide Enum) Adiantamento a depositantes, Direitos creditórios descontados Empréstimos,  Financiamentos, Financiamentos rurais  e Financiamentos imobiliários\&quot;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Uunarranged-accounts-overdraftProductType
{
    /**
     * Possible values of this enum
     */
    public const ADIANTAMENTO_A_DEPOSITANTES = 'ADIANTAMENTO_A_DEPOSITANTES';
    ...
    {
        return [
            self::ADIANTAMENTO_A_DEPOSITANTES
        ];
    }
}

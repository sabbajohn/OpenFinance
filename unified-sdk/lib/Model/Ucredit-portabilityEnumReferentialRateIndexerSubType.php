...
/**
 * EnumReferentialRateIndexerSubType Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class Ucredit-portabilityEnumReferentialRateIndexerSubType
{
    /**
     * Possible values of this enum
     */
    public const SEM_SUB_TIPO_INDEXADOR = 'SEM_SUB_TIPO_INDEXADOR';

    public const PRE_FIXADO = 'PRE_FIXADO';

    public const TR_TBF = 'TR_TBF';

    public const TJLP = 'TJLP';

    public const LIBOR = 'LIBOR';
    ...
    public const IPCC = 'IPCC';

    public const OUTROS_INDICES_PRECO = 'OUTROS_INDICES_PRECO';

    public const TCR_PRE = 'TCR_PRE';

    public const TCR_POS = 'TCR_POS';

    public const TRFC_PRE = 'TRFC_PRE';

    public const TRFC_POS = 'TRFC_POS';

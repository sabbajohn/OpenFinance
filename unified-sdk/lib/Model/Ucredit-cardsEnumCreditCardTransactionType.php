...
/**
 * EnumCreditCardTransactionType Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class Ucredit-cardsEnumCreditCardTransactionType
{
    /**
    ...
    public const TARIFA = 'TARIFA';

    public const OPERACOES_CREDITO_CONTRATADAS_CARTAO = 'OPERACOES_CREDITO_CONTRATADAS_CARTAO';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::PAGAMENTO,
            self::TARIFA,
            self::OPERACOES_CREDITO_CONTRATADAS_CARTAO,
            self::ESTORNO,
            self::CASHBACK,
            self::OUTROS
        ];

...
/**
 * FinancingsFinanceCharge Class Doc Comment
 *
 * @category Class
 ...
 */
class UfinancingsFinancingsFinanceCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancingsFinanceCharge';
    ...
    */
    ...
    public function setChargeAdditionalInfo($charge_additional_info)
    {
        ...
        if ((mb_strlen($charge_additional_info) > 50)) {
            throw new \InvalidArgumentException('invalid length for $charge_additional_info when calling FinancingsFinanceCharge., must be smaller than or equal to 50.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($charge_additional_info)))) {
            throw new \InvalidArgumentException("invalid value for \$charge_additional_info when calling FinancingsFinanceCharge., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
    ...
    public function setChargeRate($charge_rate)
    {
        ...
        if ((mb_strlen($charge_rate) > 8)) {
            throw new \InvalidArgumentException('invalid length for $charge_rate when calling FinancingsFinanceCharge., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($charge_rate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $charge_rate when calling FinancingsFinanceCharge., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d{1}\\.\\d{6}$/", ObjectSerializer::toString($charge_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$charge_rate when calling FinancingsFinanceCharge., must conform to the pattern /^\\d{1}\\.\\d{6}$/.");
        }

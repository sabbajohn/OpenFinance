...
/**
 * OKResponseEvents Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UexchangesOKResponseEvents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OKResponseEvents';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\Events[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\Events[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Events[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling OKResponseEvents., number of items must be greater than or equal to 0.');
        }

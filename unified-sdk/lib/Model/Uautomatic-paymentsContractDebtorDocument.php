...
/**
 * ContractDebtorDocument Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-paymentsContractDebtorDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContractDebtor_document';
    ...
    */
     ...
     * Sets identification
     *
     * @param string $identification Número do documento de identificação oficial do cliente devedor do contrato.
     *
     * @return self
     */
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 14)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling ContractDebtorDocument., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^(?:\\d{11}|\\d{14})$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling ContractDebtorDocument., must conform to the pattern /^(?:\\d{11}|\\d{14})$/.");
        }
     ...
     * Sets rel
     *
     * @param string $rel Tipo do documento de identificação oficial do cliente devedor do contrato.
     *
     * @return self
     */

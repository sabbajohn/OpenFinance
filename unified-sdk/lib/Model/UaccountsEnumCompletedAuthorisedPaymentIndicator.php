...
/**
 * EnumCompletedAuthorisedPaymentIndicator Class Doc Comment
 *
 * @category Class
 * @description Indicador da transação:    - Transação efetivada: a transação atinge esse status quando o &#x60;transactionId&#x60; torna-se imutável;   - Lançamento futuro: a transação será efetivada em momento futuro, ou seja, o &#x60;transactionId&#x60; pode mudar;   - Transação processando: a transação está em processamento, ou seja, o &#x60;transactionId&#x60; pode mudar.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class UaccountsEnumCompletedAuthorisedPaymentIndicator
{
    /**
     * Possible values of this enum
     */
    public const TRANSACAO_EFETIVADA = 'TRANSACAO_EFETIVADA';

    public const LANCAMENTO_FUTURO = 'LANCAMENTO_FUTURO';

    public const TRANSACAO_PROCESSANDO = 'TRANSACAO_PROCESSANDO';
    ...
    {
        return [
            self::TRANSACAO_EFETIVADA,
            self::LANCAMENTO_FUTURO,
            self::TRANSACAO_PROCESSANDO
        ];
    }
}

...
/**
 * EnumCreditCardAccountsFinanceChargeType Class Doc Comment
 *
 * @category Class
 * @description Traz a denominação dos Encargos que incidem na fatura da conta de pagamento pós-paga. (Vide Enum) - Juros remuneratórios por atraso no pagamento da fatura - Multa por atraso no pagamento da fatura - Juros de mora por atraso no pagamento da fatura - IOF - Outros
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Ucredit-cardsEnumCreditCardAccountsFinanceChargeType
{
    /**
     * Possible values of this enum
     */
    public const JUROS_REMUNERATORIOS_ATRASO_PAGAMENTO_FATURA = 'JUROS_REMUNERATORIOS_ATRASO_PAGAMENTO_FATURA';

    public const MULTA_ATRASO_PAGAMENTO_FATURA = 'MULTA_ATRASO_PAGAMENTO_FATURA';

    public const JUROS_MORA_ATRASO_PAGAMENTO_FATURA = 'JUROS_MORA_ATRASO_PAGAMENTO_FATURA';
    ...
    {
        return [
            self::JUROS_REMUNERATORIOS_ATRASO_PAGAMENTO_FATURA,
            self::MULTA_ATRASO_PAGAMENTO_FATURA,
            self::JUROS_MORA_ATRASO_PAGAMENTO_FATURA,
            self::IOF,
            self::OUTROS
        ];
    }

...
/**
 * ResponseTreasureTitlesListProductData Class Doc Comment
 *
 * @category Class
 ...
 */
class Utreasure-titlesResponseTreasureTitlesListProductData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseTreasureTitlesListProductData';
    ...
    */
    ...
    public function setBrandName($brand_name)
    {
        ...
        if ((mb_strlen($brand_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $brand_name when calling ResponseTreasureTitlesListProductData., must be smaller than or equal to 80.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($brand_name)))) {
            throw new \InvalidArgumentException("invalid value for \$brand_name when calling ResponseTreasureTitlesListProductData., must conform to the pattern /[\\w\\W\\s]*/.");
        }
    ...
    public function setCompanyCnpj($company_cnpj)
    {
        ...
        if ((mb_strlen($company_cnpj) > 14)) {
            throw new \InvalidArgumentException('invalid length for $company_cnpj when calling ResponseTreasureTitlesListProductData., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^\\d{14}$/", ObjectSerializer::toString($company_cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$company_cnpj when calling ResponseTreasureTitlesListProductData., must conform to the pattern /^\\d{14}$/.");
        }
    ...
    public function setInvestmentId($investment_id)
    {
        ...
        if ((mb_strlen($investment_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $investment_id when calling ResponseTreasureTitlesListProductData., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[a-zA-Z0-9][a-zA-Z0-9-]{0,99}$/", ObjectSerializer::toString($investment_id)))) {
            throw new \InvalidArgumentException("invalid value for \$investment_id when calling ResponseTreasureTitlesListProductData., must conform to the pattern /^[a-zA-Z0-9][a-zA-Z0-9-]{0,99}$/.");
        }

...
/**
 * ResponseErrorCreateConsentErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseErrorCreateConsentErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseErrorCreateConsent_errors_inner';
    ...
    public const CODE_DATA_PAGAMENTO_INVALIDA = 'DATA_PAGAMENTO_INVALIDA';
    ...
    public const CODE_FUNCIONALIDADE_NAO_HABILITADA = 'FUNCIONALIDADE_NAO_HABILITADA';
    ...
    {
        return [
            self::CODE_DATA_PAGAMENTO_INVALIDA,
            ...
            self::CODE_FUNCIONALIDADE_NAO_HABILITADA,
        ];
    }
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Códigos de erros previstos na criação de consentimento para a iniciação de pagamentos:    - DATA_PAGAMENTO_INVALIDA - DETALHE_PAGAMENTO_INVALIDO - PARAMETRO_NAO_INFORMADO - PARAMETRO_INVALIDO - ERRO_IDEMPOTENCIA - NAO_INFORMADO - FUNCIONALIDADE_NAO_HABILITADA
     *
     * @return self
     */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ResponseErrorCreateConsentErrorsInner., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling ResponseErrorCreateConsentErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ResponseErrorCreateConsentErrorsInner., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling ResponseErrorCreateConsentErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }

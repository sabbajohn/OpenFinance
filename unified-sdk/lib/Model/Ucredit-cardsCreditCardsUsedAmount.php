...
/**
 * CreditCardsUsedAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucredit-cardsCreditCardsUsedAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditCardsUsedAmount';
    ...
    */
     ...
     * Sets amount
     *
     * @param float $amount Valor utilizado do limite informado expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 21)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling CreditCardsUsedAmount., must be smaller than or equal to 21.');
        }
        if ((mb_strlen($amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling CreditCardsUsedAmount., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^-?\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling CreditCardsUsedAmount., must conform to the pattern /^-?\\d{1,15}\\.\\d{2,4}$/.");
        }
     ...
     * Sets currency
     *
     * @param string $currency Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os saldos informados estão representados com a moeda vigente do Brasil.
     *
     * @return self
     */
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreditCardsUsedAmount., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling CreditCardsUsedAmount., must conform to the pattern /^[A-Z]{3}$/.");
        }

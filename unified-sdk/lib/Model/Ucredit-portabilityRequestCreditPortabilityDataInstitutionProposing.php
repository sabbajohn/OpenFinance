<?php
/**
 * RequestCreditPortabilityDataInstitutionProposing
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RequestCreditPortabilityDataInstitutionProposing Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucredit-portabilityRequestCreditPortabilityDataInstitutionProposing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestCreditPortability_data_institution_proposing';
    ...
    protected static $openAPITypes = [
        'company_name' => 'string',
        'company_cnpj' => 'string',
        'contact' => '\OpenAPI\Client\Model\RequestCreditPortabilityDataInstitutionProposingContactInner[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['contact']) && (count($this->container['contact']) < 1)) {
            $invalidProperties[] = "invalid value for 'contact', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets company_name
     *
     * @param string $company_name Nome da Instituição Proponente
     *
     * @return self
     */
    public function setCompanyName($company_name)
    {
        ...
        if ((mb_strlen($company_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling RequestCreditPortabilityDataInstitutionProposing., must be smaller than or equal to 80.');
        }
        if ((!preg_match("/^[^\\s](?:.*[^\\s])?$/", ObjectSerializer::toString($company_name)))) {
            throw new \InvalidArgumentException("invalid value for \$company_name when calling RequestCreditPortabilityDataInstitutionProposing., must conform to the pattern /^[^\\s](?:.*[^\\s])?$/.");
        }
    ...
    public function setCompanyCnpj($company_cnpj)
    {
        ...
        if ((mb_strlen($company_cnpj) > 14)) {
            throw new \InvalidArgumentException('invalid length for $company_cnpj when calling RequestCreditPortabilityDataInstitutionProposing., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^[0-9A-Z]{12}[0-9]{2}$/", ObjectSerializer::toString($company_cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$company_cnpj when calling RequestCreditPortabilityDataInstitutionProposing., must conform to the pattern /^[0-9A-Z]{12}[0-9]{2}$/.");
        }
     ...
     * Gets contact
     *
     * @return \OpenAPI\Client\Model\RequestCreditPortabilityDataInstitutionProposingContactInner[]|null
     */
     ...
     * Sets contact
     *
     * @param \OpenAPI\Client\Model\RequestCreditPortabilityDataInstitutionProposingContactInner[]|null $contact contact
     *
     * @return self
     */
    public function setContact($contact)
    {
        ...
        if ((count($contact) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contact when calling RequestCreditPortabilityDataInstitutionProposing., number of items must be greater than or equal to 1.');
        }

<?php
/**
 * VariableIncomesGetInvestments423Response
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * VariableIncomesGetInvestments423Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uvariable-incomesVariableIncomesGetInvestments423Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'variableIncomesGetInvestments_423_response';
    ...
    protected static $openAPITypes = [
        ...
        'meta' => '\OpenAPI\Client\Model\VariableIncomesGetInvestments423ResponseMeta'
    ];
    ...
    */
    ...
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 13)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling VariableIncomesGetInvestments423Response., number of items must be less than or equal to 13.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling VariableIncomesGetInvestments423Response., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\VariableIncomesGetInvestments423ResponseMeta|null
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\VariableIncomesGetInvestments423ResponseMeta|null $meta meta
     *
     * @return self
     */

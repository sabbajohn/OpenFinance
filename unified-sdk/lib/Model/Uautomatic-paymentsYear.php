 ...
 *
 * @category Class
 * @description Configurar limite transacional anual determinado pelo usuário pagador.  [Restrição] Caso enviado o objeto, ao menos um dos campos (&#x60;quantityLimit&#x60; ou &#x60;transactionLimit&#x60;) devem ser preenchidos
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsYear implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets quantity_limit
     *
     * @param int|null $quantity_limit Quantidade limite de transações permitidas para ocorrer durante um ano.
     *
     * @return self
     */
    public function setQuantityLimit($quantity_limit)
    {
        ...
        if (($quantity_limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity_limit when calling Year., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $transaction_limit Valor máximo a ser transacionado por um ano, a partir da data definida no campo `/data/startDateTime`.
     *
     * @return self
     */
    public function setTransactionLimit($transaction_limit)
    {
        ...
        if ((mb_strlen($transaction_limit) > 19)) {
            throw new \InvalidArgumentException('invalid length for $transaction_limit when calling Year., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($transaction_limit) < 4)) {
            throw new \InvalidArgumentException('invalid length for $transaction_limit when calling Year., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($transaction_limit)))) {
            throw new \InvalidArgumentException("invalid value for \$transaction_limit when calling Year., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }

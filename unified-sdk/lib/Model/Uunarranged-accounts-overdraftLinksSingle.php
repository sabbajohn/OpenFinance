 ...
 */
class Uunarranged-accounts-overdraftLinksSingle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinksSingle';
    ...
    */
    ...
    public function setSelf($self)
    {
        ...
        if ((mb_strlen($self) > 4048)) {
            throw new \InvalidArgumentException('invalid length for $self when calling LinksSingle., must be smaller than or equal to 4048.');
        }

<?php
/**
 * POSTResponseCreditPortabilityPaymentMeta
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * POSTResponseCreditPortabilityPaymentMeta Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Ucredit-portabilityPOSTResponseCreditPortabilityPaymentMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'POSTResponseCreditPortabilityPayment_meta';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['request_date_time']) && (mb_strlen($this->container['request_date_time']) > 20)) {
     ...
     *
     * @param \DateTime|null $request_date_time Data e hora da consulta, conforme especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339), formato UTC.
     *
     * @return self
     */
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling POSTResponseCreditPortabilityPaymentMeta., must be smaller than or equal to 20.');
        }

...
/**
 * RejectionReasonGetPix Class Doc Comment
 *
 * @category Class
 * @description Motivo da rejeição do pagamento. Informações complementares sobre o motivo do status [Restrição] Esse motivo deverá ser enviado quando o campo /data/status for igual a RJCT (REJECTED).
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpaymentsRejectionReasonGetPix implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RejectionReasonGetPix';
    ...
    protected static $openAPITypes = [
        'code' => '\OpenAPI\Client\Model\EnumRejectionReasonTypeGetPix',
        'detail' => 'string'
    ];
    ...
    */
     ...
     * Gets code
     *
     * @return \OpenAPI\Client\Model\EnumRejectionReasonTypeGetPix
     */
     ...
     * Sets code
     *
     * @param \OpenAPI\Client\Model\EnumRejectionReasonTypeGetPix $code code
     *
     * @return self
     */
     ...
     * Sets detail
     *
     * @param string $detail Contém informações adicionais ao pagamento rejeitado
     *
     * @return self
     */
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling RejectionReasonGetPix., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling RejectionReasonGetPix., must conform to the pattern /[\\w\\W\\s]*/.");
        }

...
/**
 * EnumProductType Class Doc Comment
 *
 * @category Class
 * @description \&quot;Tipo da modalidade de crédito contratada, conforme  circular 4.015 e descrição do DOC3040 do SCR). (Vide Enum) Financiamentos, Financiamentos rurais  e Financiamentos imobiliários\&quot;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class UfinancingsEnumProductType
{
    /**
     * Possible values of this enum
     */
    public const FINANCIAMENTOS = 'FINANCIAMENTOS';

    public const FINANCIAMENTOS_RURAIS = 'FINANCIAMENTOS_RURAIS';

    public const FINANCIAMENTOS_IMOBILIARIOS = 'FINANCIAMENTOS_IMOBILIARIOS';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::FINANCIAMENTOS,
            self::FINANCIAMENTOS_RURAIS,
            self::FINANCIAMENTOS_IMOBILIARIOS
        ];
    }
}

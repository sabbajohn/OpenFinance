...
/**
 * ResponseVariableIncomesTransactionsCurrent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uvariable-incomesResponseVariableIncomesTransactionsCurrent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseVariableIncomesTransactionsCurrent';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ResponseVariableIncomesTransactionsCurrentData[]',
        'links' => '\OpenAPI\Client\Model\VariableIncomesTransactionsLinks',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ResponseVariableIncomesTransactionsCurrentData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ResponseVariableIncomesTransactionsCurrentData[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseVariableIncomesTransactionsCurrent., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets links
     *
     * @return \OpenAPI\Client\Model\VariableIncomesTransactionsLinks
     */
     ...
     * Sets links
     *
     * @param \OpenAPI\Client\Model\VariableIncomesTransactionsLinks $links links
     *
     * @return self
     */

...
/**
 * ResponseVariableIncomesBalances Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uvariable-incomesResponseVariableIncomesBalances implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseVariableIncomesBalances';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ResponseVariableIncomesBalanceData[]',
        'links' => '\OpenAPI\Client\Model\VariableIncomesLinks',
        'meta' => '\OpenAPI\Client\Model\VariableIncomesMeta'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['data']) > 1)) {
            $invalidProperties[] = "invalid value for 'data', number of items must be less than or equal to 1.";
        }
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ResponseVariableIncomesBalanceData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ResponseVariableIncomesBalanceData[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) > 1)) {
            throw new \InvalidArgumentException('invalid value for $data when calling ResponseVariableIncomesBalances., number of items must be less than or equal to 1.');
        }
        if ((count($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseVariableIncomesBalances., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets links
     *
     * @return \OpenAPI\Client\Model\VariableIncomesLinks
     */
     ...
     * Sets links
     *
     * @param \OpenAPI\Client\Model\VariableIncomesLinks $links links
     *
     * @return self
     */
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\VariableIncomesMeta
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\VariableIncomesMeta $meta meta
     *
     * @return self
     */

...
/**
 * ConsentRevokedReason Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsConsentRevokedReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsentRevokedReason';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Código indicador do motivo de revogação. - REVOGADO_RECEBEDOR - REVOGADO_USUARIO - NAO_INFORMADO
     *
     * @return self
     */
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling ConsentRevokedReason., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling ConsentRevokedReason., must conform to the pattern /[\\w\\W\\s]*/.");
        }

...
/**
 * ConsentEdition Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-paymentsConsentEdition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsentEdition';
    ...
    */
    ...
    public function setCreditors($creditors)
    {
        ...
        if ((count($creditors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $creditors when calling ConsentEdition., number of items must be greater than or equal to 1.');
        }
    ...
    public function setExpirationDateTime($expiration_date_time)
    {
        ...
        if ((mb_strlen($expiration_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date_time when calling ConsentEdition., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($expiration_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$expiration_date_time when calling ConsentEdition., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

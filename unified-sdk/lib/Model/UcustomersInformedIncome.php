...
/**
 * InformedIncome Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UcustomersInformedIncome implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InformedIncome';
    ...
    protected static $openAPITypes = [
        'frequency' => '\OpenAPI\Client\Model\EnumInformedIncomeFrequency',
        'amount' => '\OpenAPI\Client\Model\InformedIncomeAmount',
        'date' => '\DateTime'
    ];
    ...
    */
     ...
     * Gets frequency
     *
     * @return \OpenAPI\Client\Model\EnumInformedIncomeFrequency
     */
     ...
     * Sets frequency
     *
     * @param \OpenAPI\Client\Model\EnumInformedIncomeFrequency $frequency frequency
     *
     * @return self
     */
     ...
     * Gets amount
     *
     * @return \OpenAPI\Client\Model\InformedIncomeAmount
     */
     ...
     * Sets amount
     *
     * @param \OpenAPI\Client\Model\InformedIncomeAmount $amount amount
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime $date Data da renda, conforme especificação RFC-3339.
     *
     * @return self
     */
    public function setDate($date)
    {
        ...
        if ((mb_strlen($date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $date when calling InformedIncome., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($date)))) {
            throw new \InvalidArgumentException("invalid value for \$date when calling InformedIncome., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }

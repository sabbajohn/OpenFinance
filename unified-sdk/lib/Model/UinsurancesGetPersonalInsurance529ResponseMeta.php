...
/**
 * GetPersonalInsurance529ResponseMeta Class Doc Comment
 *
 * @category Class
 ...
 */
class UinsurancesGetPersonalInsurance529ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getPersonalInsurance_529_response_meta';
    ...
    */
    ...
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling GetPersonalInsurance529ResponseMeta., must be smaller than or equal to 20.');
        }

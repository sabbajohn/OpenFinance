...
/**
 * BankFixedIncomesMeta Class Doc Comment
 *
 * @category Class
 ...
 */
class Ubank-fixed-incomesBankFixedIncomesMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankFixedIncomesMeta';
    ...
    */
    ...
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling BankFixedIncomesMeta., must be smaller than or equal to 20.');
        }

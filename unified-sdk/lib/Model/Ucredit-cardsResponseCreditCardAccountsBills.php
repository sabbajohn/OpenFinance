...
/**
 * ResponseCreditCardAccountsBills Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Ucredit-cardsResponseCreditCardAccountsBills implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCreditCardAccountsBills';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\CreditCardAccountsBillsData[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\CreditCardAccountsBillsData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\CreditCardAccountsBillsData[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseCreditCardAccountsBills., number of items must be greater than or equal to 0.');
        }

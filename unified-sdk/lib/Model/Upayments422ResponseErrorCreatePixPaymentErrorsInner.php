<?php
/**
 * 422ResponseErrorCreatePixPaymentErrorsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * 422ResponseErrorCreatePixPaymentErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Upayments422ResponseErrorCreatePixPaymentErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_422ResponseErrorCreatePixPayment_errors_inner';
    ...
    protected static $openAPITypes = [
        'code' => '\OpenAPI\Client\Model\EnumErrorsCreatePixPayment',
        'title' => 'string',
        'detail' => 'string'
    ];
    ...
    */
     ...
     * Gets code
     *
     * @return \OpenAPI\Client\Model\EnumErrorsCreatePixPayment
     */
     ...
     * Sets code
     *
     * @param \OpenAPI\Client\Model\EnumErrorsCreatePixPayment $code code
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title Título específico do erro reportado, de acordo com o código enviado:  • PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento não permite cancelamento
     *
     * @return self
     */
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling 422ResponseErrorCreatePixPaymentErrorsInner., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling 422ResponseErrorCreatePixPaymentErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }
     ...
     * Sets detail
     *
     * @param string $detail Descrição específica do erro de acordo com o código reportado:  • PAGAMENTO_NAO_PERMITE_CANCELAMENTO: Pagamento não permite cancelamento
     *
     * @return self
     */
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling 422ResponseErrorCreatePixPaymentErrorsInner., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling 422ResponseErrorCreatePixPaymentErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }

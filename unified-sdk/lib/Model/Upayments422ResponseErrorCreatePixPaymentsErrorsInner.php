...
/**
 * 422ResponseErrorCreatePixPaymentsErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Upayments422ResponseErrorCreatePixPaymentsErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_422ResponseErrorCreatePixPayments_errors_inner';
    ...
    protected static $openAPITypes = [
        'code' => '\OpenAPI\Client\Model\EnumErrorsCreatePayment',
        'title' => 'string',
        'detail' => 'string'
    ];
    ...
    */
     ...
     * Gets code
     *
     * @return \OpenAPI\Client\Model\EnumErrorsCreatePayment
     */
     ...
     * Sets code
     *
     * @param \OpenAPI\Client\Model\EnumErrorsCreatePayment $code code
     *
     * @return self
     */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling 422ResponseErrorCreatePixPaymentsErrorsInner., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling 422ResponseErrorCreatePixPaymentsErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling 422ResponseErrorCreatePixPaymentsErrorsInner., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling 422ResponseErrorCreatePixPaymentsErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }

<?php
/**
 * ConsentsPostConsents529ResponseMeta
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ConsentsPostConsents529ResponseMeta Class Doc Comment
 *
 * @category Class
 ...
 */
class UconsentsConsentsPostConsents529ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'consentsPostConsents_529_response_meta';
    ...
    */
    ...
    public function setRequestDateTime($request_date_time)
    {
        ...
        if ((mb_strlen($request_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $request_date_time when calling ConsentsPostConsents529ResponseMeta., must be smaller than or equal to 20.');
        }

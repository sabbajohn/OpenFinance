 ...
 */
class UconsentsLinksConsents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinksConsents';
    ...
    */
    ...
    public function setSelf($self)
    {
        ...
        if ((mb_strlen($self) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $self when calling LinksConsents., must be smaller than or equal to 2000.');
        }

...
/**
 * ResponseUnarrangedAccountOverdraftWarranties Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uunarranged-accounts-overdraftResponseUnarrangedAccountOverdraftWarranties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseUnarrangedAccountOverdraftWarranties';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\UnarrangedAccountsOverdraftContractedWarranty[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\UnarrangedAccountsOverdraftContractedWarranty[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\UnarrangedAccountsOverdraftContractedWarranty[] $data Conjunto de informações referentes às garantias que avalizam a operação de crédito de adiantamento a depositantes
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseUnarrangedAccountOverdraftWarranties., number of items must be greater than or equal to 0.');
        }

...
/**
 * ResponseFundsTransactions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UfundsResponseFundsTransactions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseFundsTransactions';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ResponseFundsTransactionsData[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ResponseFundsTransactionsData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ResponseFundsTransactionsData[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseFundsTransactions., number of items must be greater than or equal to 0.');
        }

<?php
/**
 * RiskSignalsConsentEditionGeolocation
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RiskSignalsConsentEditionGeolocation Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsRiskSignalsConsentEditionGeolocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RiskSignalsConsentEdition_geolocation';
    ...
    */
     ...
     * Sets latitude
     *
     * @param float|null $latitude Coordenada latitudial do cliente enquanto logado na iniciadora
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param float|null $longitude Coordenada longitudinal do cliente enquanto logado na iniciadora
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Tipo de mecanismo utilizado na geração da geolocalização
     *
     * @return self
     */

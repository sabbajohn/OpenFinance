...
/**
 * CreateRecurringPixPaymentData Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsCreateRecurringPixPaymentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRecurringPixPaymentData';
    ...
    protected static $openAPITypes = [
        ...
        'creditor_account' => '\OpenAPI\Client\Model\CreateRecurringPixPaymentDataCreditorAccount',
        'remittance_information' => 'string',
        'cnpj_initiator' => 'string',
        'ibge_town_code' => 'string',
        'authorisation_flow' => 'string',
        'risk_signals' => '\OpenAPI\Client\Model\RiskSignalsPayments',
    ...
    */
     ...
     *
     * @param string|null $recurring_consent_id Identificador único do consentimento de longa duração criado para a iniciação de pagamento solicitada. Deverá ser um URN - Uniform Resource Name.  Um URN, conforme definido na [RFC8141](https://tools.ietf.org/html/rfc8141) é um Uniform Resource  Identifier - URI - que é atribuído sob o URI scheme \"urn\" e um namespace URN específico, com a intenção de que o URN  seja um identificador de recurso persistente e independente da localização.  Considerando a string urn:bancoex:C1DD33123 como exemplo para `recurringConsentId` temos: - o namespace(urn) - o identificador associado ao namespace da instituição transmissora (bancoex) - o identificador específico dentro do namespace (C1DD33123). Informações mais detalhadas sobre a construção de namespaces devem ser consultadas na [RFC8141](https://tools.ietf.org/html/rfc8141).  [Restrição] Este campo é de preenchimento obrigatório quando o valor do campo authorisationFlow for igual a FIDO_FLOW.
     *
     * @return self
     */
    public function setRecurringConsentId($recurring_consent_id)
    {
        ...
        if ((mb_strlen($recurring_consent_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $recurring_consent_id when calling CreateRecurringPixPaymentData., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/", ObjectSerializer::toString($recurring_consent_id)))) {
            throw new \InvalidArgumentException("invalid value for \$recurring_consent_id when calling CreateRecurringPixPaymentData., must conform to the pattern /^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/.");
        }
    ...
    public function setEndToEndId($end_to_end_id)
    {
        ...
        if ((mb_strlen($end_to_end_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling CreateRecurringPixPaymentData., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($end_to_end_id) < 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling CreateRecurringPixPaymentData., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/^([E])([0-9]{8})([0-9]{4})(0[1-9]|1[0-2])(0[1-9]|[1-2][0-9]|3[0-1])(2[0-3]|[01][0-9])([0-5][0-9])([a-zA-Z0-9]{11})$/", ObjectSerializer::toString($end_to_end_id)))) {
            throw new \InvalidArgumentException("invalid value for \$end_to_end_id when calling CreateRecurringPixPaymentData., must conform to the pattern /^([E])([0-9]{8})([0-9]{4})(0[1-9]|1[0-2])(0[1-9]|[1-2][0-9]|3[0-1])(2[0-3]|[01][0-9])([0-5][0-9])([a-zA-Z0-9]{11})$/.");
        }
     ...
     * Sets date
     *
     * @param \DateTime $date Data em que o pagamento será realizado. Uma string com a utilização de timezone UTC-3 (UTC time format).
     *
     * @return self
     */
    public function setDate($date)
    {
        ...
        if ((mb_strlen($date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $date when calling CreateRecurringPixPaymentData., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($date)))) {
            throw new \InvalidArgumentException("invalid value for \$date when calling CreateRecurringPixPaymentData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\CreateRecurringPixPaymentDataCreditorAccount
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CreateRecurringPixPaymentDataCreditorAccount $creditor_account creditor_account
     *
     * @return self
     */
    ...
    public function setRemittanceInformation($remittance_information)
    {
        ...
        if ((mb_strlen($remittance_information) > 140)) {
            throw new \InvalidArgumentException('invalid length for $remittance_information when calling CreateRecurringPixPaymentData., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($remittance_information)))) {
            throw new \InvalidArgumentException("invalid value for \$remittance_information when calling CreateRecurringPixPaymentData., must conform to the pattern /[\\w\\W\\s]*/.");
        }
    ...
    public function setCnpjInitiator($cnpj_initiator)
    {
        ...
        if ((mb_strlen($cnpj_initiator) > 14)) {
            throw new \InvalidArgumentException('invalid length for $cnpj_initiator when calling CreateRecurringPixPaymentData., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^\\d{14}$/", ObjectSerializer::toString($cnpj_initiator)))) {
            throw new \InvalidArgumentException("invalid value for \$cnpj_initiator when calling CreateRecurringPixPaymentData., must conform to the pattern /^\\d{14}$/.");
        }
    ...
    public function setIbgeTownCode($ibge_town_code)
    {
        ...
        if ((mb_strlen($ibge_town_code) > 7)) {
            throw new \InvalidArgumentException('invalid length for $ibge_town_code when calling CreateRecurringPixPaymentData., must be smaller than or equal to 7.');
        }
        if ((mb_strlen($ibge_town_code) < 7)) {
            throw new \InvalidArgumentException('invalid length for $ibge_town_code when calling CreateRecurringPixPaymentData., must be bigger than or equal to 7.');
        }
        if ((!preg_match("/^\\d{7}$/", ObjectSerializer::toString($ibge_town_code)))) {
            throw new \InvalidArgumentException("invalid value for \$ibge_town_code when calling CreateRecurringPixPaymentData., must conform to the pattern /^\\d{7}$/.");
        }
     ...
     * Gets risk_signals
     *
     * @return \OpenAPI\Client\Model\RiskSignalsPayments|null
     */
     ...
     * Sets risk_signals
     *
     * @param \OpenAPI\Client\Model\RiskSignalsPayments|null $risk_signals risk_signals
     *
     * @return self
     */
    ...
    public function setProxy($proxy)
    {
        ...
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($proxy)))) {
            throw new \InvalidArgumentException("invalid value for \$proxy when calling CreateRecurringPixPaymentData., must conform to the pattern /[\\w\\W\\s]*/.");
        }
     ...
     *
     * @param string|null $transaction_identification Trata-se de um identificador de transação que deve ser retransmitido intacto pelo PSP do pagador ao gerar a ordem de pagamento.  Essa informação permitirá ao recebedor identificar e correlacionar a transferência, quando recebida, com a apresentação das instruções ao pagador.  Os caracteres permitidos no contexto do Pix para o campo txid (EMV 62-05) são:Letras minúsculas, de 'a' a 'z' Letras maiúsculas, de 'A' a 'z' Dígitos decimais, de '0' a '9'.  [Restrição] Preenchimento condicional de acordo com o conteúdo do campo localInstument: - MANU - O campo transactionIdentification não deve ser preenchido; - DICT - O campo transactionIdentification não deve ser preenchido; - INIC - O campo transactionIdentification deve ser preenchido obrigatoriamente e deve conter até 25 caracteres alfanuméricos ([a-z|A-Z|0-9]).
     *
     * @return self
     */
    public function setTransactionIdentification($transaction_identification)
    {
        ...
        if ((mb_strlen($transaction_identification) > 35)) {
            throw new \InvalidArgumentException('invalid length for $transaction_identification when calling CreateRecurringPixPaymentData., must be smaller than or equal to 35.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]{1,35}$/", ObjectSerializer::toString($transaction_identification)))) {
            throw new \InvalidArgumentException("invalid value for \$transaction_identification when calling CreateRecurringPixPaymentData., must conform to the pattern /^[a-zA-Z0-9]{1,35}$/.");
        }
    ...
    public function setOriginalRecurringPaymentId($original_recurring_payment_id)
    {
        ...
        if ((mb_strlen($original_recurring_payment_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $original_recurring_payment_id when calling CreateRecurringPixPaymentData., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($original_recurring_payment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $original_recurring_payment_id when calling CreateRecurringPixPaymentData., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9][a-zA-Z0-9\\-]{0,99}$/", ObjectSerializer::toString($original_recurring_payment_id)))) {
            throw new \InvalidArgumentException("invalid value for \$original_recurring_payment_id when calling CreateRecurringPixPaymentData., must conform to the pattern /^[a-zA-Z0-9][a-zA-Z0-9\\-]{0,99}$/.");
        }
    ...
    public function setPaymentReference($payment_reference)
    {
        ...
        if ((mb_strlen($payment_reference) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_reference when calling CreateRecurringPixPaymentData., must be smaller than or equal to 10.');
        }

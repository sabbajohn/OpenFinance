...
/**
 * FinancingsContract Class Doc Comment
 *
 * @category Class
 ...
 */
class UfinancingsFinancingsContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancingsContract';
    ...
    protected static $openAPITypes = [
        ...
        'interest_rates' => '\OpenAPI\Client\Model\FinancingsContractInterestRate[]',
        'contracted_fees' => '\OpenAPI\Client\Model\FinancingsContractFee[]',
        'contracted_finance_charges' => '\OpenAPI\Client\Model\FinancingsFinanceCharge[]',
    ...
    public const INSTALMENT_PERIODICITY_OUTROS = 'OUTROS';
    ...
    public function getInstalmentPeriodicityAllowableValues()
    {
        return [
            ...
            self::INSTALMENT_PERIODICITY_OUTROS,
        ];
    }
    ...
    */
    ...
    public function setContractNumber($contract_number)
    {
        ...
        if ((mb_strlen($contract_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $contract_number when calling FinancingsContract., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[\\w\\W]{1,100}$/", ObjectSerializer::toString($contract_number)))) {
            throw new \InvalidArgumentException("invalid value for \$contract_number when calling FinancingsContract., must conform to the pattern /^[\\w\\W]{1,100}$/.");
        }
    ...
    public function setIpocCode($ipoc_code)
    {
        ...
        if ((mb_strlen($ipoc_code) > 67)) {
            throw new \InvalidArgumentException('invalid length for $ipoc_code when calling FinancingsContract., must be smaller than or equal to 67.');
        }
        if ((mb_strlen($ipoc_code) < 22)) {
            throw new \InvalidArgumentException('invalid length for $ipoc_code when calling FinancingsContract., must be bigger than or equal to 22.');
        }
        if ((!preg_match("/^[\\w\\W]{22,67}$/", ObjectSerializer::toString($ipoc_code)))) {
            throw new \InvalidArgumentException("invalid value for \$ipoc_code when calling FinancingsContract., must conform to the pattern /^[\\w\\W]{22,67}$/.");
        }
    ...
    public function setProductName($product_name)
    {
        ...
        if ((mb_strlen($product_name) > 140)) {
            throw new \InvalidArgumentException('invalid length for $product_name when calling FinancingsContract., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($product_name)))) {
            throw new \InvalidArgumentException("invalid value for \$product_name when calling FinancingsContract., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
    ...
    public function setContractDate($contract_date)
    {
        ...
        if ((mb_strlen($contract_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $contract_date when calling FinancingsContract., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($contract_date)))) {
            throw new \InvalidArgumentException("invalid value for \$contract_date when calling FinancingsContract., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
    ...
    public function setDisbursementDates($disbursement_dates)
    {
        ...
        if ((count($disbursement_dates) < 1)) {
            throw new \InvalidArgumentException('invalid length for $disbursement_dates when calling FinancingsContract., number of items must be greater than or equal to 1.');
        }
    ...
    public function setSettlementDate($settlement_date)
    {
        ...
        if ((mb_strlen($settlement_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $settlement_date when calling FinancingsContract., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($settlement_date)))) {
            throw new \InvalidArgumentException("invalid value for \$settlement_date when calling FinancingsContract., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
    ...
    public function setContractAmount($contract_amount)
    {
        ...
        if ((mb_strlen($contract_amount) > 20)) {
            throw new \InvalidArgumentException('invalid length for $contract_amount when calling FinancingsContract., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($contract_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $contract_amount when calling FinancingsContract., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($contract_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$contract_amount when calling FinancingsContract., must conform to the pattern /^\\d{1,15}\\.\\d{2,4}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling FinancingsContract., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^(\\w{3}){1}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling FinancingsContract., must conform to the pattern /^(\\w{3}){1}$/.");
        }
    ...
    public function setDueDate($due_date)
    {
        ...
        if ((mb_strlen($due_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $due_date when calling FinancingsContract., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($due_date)))) {
            throw new \InvalidArgumentException("invalid value for \$due_date when calling FinancingsContract., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
     ...
     *
     * @param string $instalment_periodicity \"Informação relativa à periodicidade regular das parcelas. (Vide Enum) sem periodicidade regular, semanal, quinzenal, mensal, bimestral, trimestral, semestral, anual\"
     *
     * @return self
     */
    ...
    public function setInstalmentPeriodicityAdditionalInfo($instalment_periodicity_additional_info)
    {
        ...
        if ((mb_strlen($instalment_periodicity_additional_info) > 50)) {
            throw new \InvalidArgumentException('invalid length for $instalment_periodicity_additional_info when calling FinancingsContract., must be smaller than or equal to 50.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($instalment_periodicity_additional_info)))) {
            throw new \InvalidArgumentException("invalid value for \$instalment_periodicity_additional_info when calling FinancingsContract., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
    ...
    public function setFirstInstalmentDueDate($first_instalment_due_date)
    {
        ...
        if ((mb_strlen($first_instalment_due_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $first_instalment_due_date when calling FinancingsContract., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($first_instalment_due_date)))) {
            throw new \InvalidArgumentException("invalid value for \$first_instalment_due_date when calling FinancingsContract., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
    ...
    public function setCet($cet)
    {
        ...
        if ((mb_strlen($cet) > 13)) {
            throw new \InvalidArgumentException('invalid length for $cet when calling FinancingsContract., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($cet) < 8)) {
            throw new \InvalidArgumentException('invalid length for $cet when calling FinancingsContract., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d{1,6}\\.\\d{6}$/", ObjectSerializer::toString($cet)))) {
            throw new \InvalidArgumentException("invalid value for \$cet when calling FinancingsContract., must conform to the pattern /^\\d{1,6}\\.\\d{6}$/.");
        }
    ...
    public function setAmortizationScheduledAdditionalInfo($amortization_scheduled_additional_info)
    {
        ...
        if ((mb_strlen($amortization_scheduled_additional_info) > 200)) {
            throw new \InvalidArgumentException('invalid length for $amortization_scheduled_additional_info when calling FinancingsContract., must be smaller than or equal to 200.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($amortization_scheduled_additional_info)))) {
            throw new \InvalidArgumentException("invalid value for \$amortization_scheduled_additional_info when calling FinancingsContract., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
     ...
     * Gets interest_rates
     *
     * @return \OpenAPI\Client\Model\FinancingsContractInterestRate[]
     */
    ...
    public function setInterestRates($interest_rates)
    {
        ...
        if ((count($interest_rates) < 0)) {
            throw new \InvalidArgumentException('invalid length for $interest_rates when calling FinancingsContract., number of items must be greater than or equal to 0.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\FinancingsContractFee[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\FinancingsContractFee[] $contracted_fees Lista que traz as informações das tarifas pactuadas no contrato.
     *
     * @return self
     */
    public function setContractedFees($contracted_fees)
    {
        ...
        if ((count($contracted_fees) < 0)) {
            throw new \InvalidArgumentException('invalid length for $contracted_fees when calling FinancingsContract., number of items must be greater than or equal to 0.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\FinancingsFinanceCharge[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\FinancingsFinanceCharge[] $contracted_finance_charges Lista que traz os encargos pactuados no contrato
     *
     * @return self
     */
    public function setContractedFinanceCharges($contracted_finance_charges)
    {
        ...
        if ((count($contracted_finance_charges) < 0)) {
            throw new \InvalidArgumentException('invalid length for $contracted_finance_charges when calling FinancingsContract., number of items must be greater than or equal to 0.');
        }
     ...
     *
     * @param bool|null $has_insurance_contracted Campo que identifica se existe seguro contratado para o Financiamento, onde seguro contratado é true e não contratado é false. O não envio do campo significa que a instituição não oferece este produto.
     *
     * @return self
     */

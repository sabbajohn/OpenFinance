<?php
/**
 * Model422ResponseErrorRecurringConsents
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * Model422ResponseErrorRecurringConsents Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-paymentsModel422ResponseErrorRecurringConsents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '422ResponseErrorRecurringConsents';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\Model422ResponseErrorRecurringConsentsErrorsInner[]',
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\Model422ResponseErrorRecurringConsentsErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\Model422ResponseErrorRecurringConsentsErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 3)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling Model422ResponseErrorRecurringConsents., number of items must be less than or equal to 3.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling Model422ResponseErrorRecurringConsents., number of items must be greater than or equal to 1.');
        }

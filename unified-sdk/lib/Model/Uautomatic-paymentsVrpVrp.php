 ...
 */
class Uautomatic-paymentsVrpVrp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Vrp_vrp';
    ...
    protected static $openAPITypes = [
        ...
        'global_limits' => '\OpenAPI\Client\Model\VrpVrpGlobalLimits',
        'periodic_limits' => '\OpenAPI\Client\Model\VrpVrpPeriodicLimits'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('global_limits', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $transaction_limit Limite máximo de valor permitido para cada transação de pagamento.
     *
     * @return self
     */
    public function setTransactionLimit($transaction_limit)
    {
        ...
        if ((mb_strlen($transaction_limit) > 19)) {
            throw new \InvalidArgumentException('invalid length for $transaction_limit when calling VrpVrp., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($transaction_limit) < 4)) {
            throw new \InvalidArgumentException('invalid length for $transaction_limit when calling VrpVrp., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($transaction_limit)))) {
            throw new \InvalidArgumentException("invalid value for \$transaction_limit when calling VrpVrp., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }
     ...
     * Gets global_limits
     *
     * @return \OpenAPI\Client\Model\VrpVrpGlobalLimits|null
     */
    public function getGlobalLimits()
    {
        return $this->container['global_limits'];
    }

    /**
     * Sets global_limits
     *
     * @param \OpenAPI\Client\Model\VrpVrpGlobalLimits|null $global_limits global_limits
     *
     * @return self
     */
    public function setGlobalLimits($global_limits)
    {
        if (is_null($global_limits)) {
            throw new \InvalidArgumentException('non-nullable global_limits cannot be null');
        }
        $this->container['global_limits'] = $global_limits;
     ...
     *
     * @return \OpenAPI\Client\Model\VrpVrpPeriodicLimits|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\VrpVrpPeriodicLimits|null $periodic_limits periodic_limits
     *
     * @return self
     */

...
/**
 * EnumContractProductSubTypeInvoiceFinancings Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class Uinvoice-financingsEnumContractProductSubTypeInvoiceFinancings
{
    /**
     * Possible values of this enum
     */
    public const DESCONTO_DUPLICATAS = 'DESCONTO_DUPLICATAS';

    public const DESCONTO_CHEQUES = 'DESCONTO_CHEQUES';

    public const ANTECIPACAO_FATURA_CARTAO_CREDITO = 'ANTECIPACAO_FATURA_CARTAO_CREDITO';

    public const OUTROS_DIREITOS_CREDITORIOS_DESCONTADOS = 'OUTROS_DIREITOS_CREDITORIOS_DESCONTADOS';

    public const OUTROS_TITULOS_DESCONTADOS = 'OUTROS_TITULOS_DESCONTADOS';
    ...
    {
        return [
            self::DESCONTO_DUPLICATAS,
            self::DESCONTO_CHEQUES,
            self::ANTECIPACAO_FATURA_CARTAO_CREDITO,
            self::OUTROS_DIREITOS_CREDITORIOS_DESCONTADOS,
            self::OUTROS_TITULOS_DESCONTADOS
        ];
    }
}

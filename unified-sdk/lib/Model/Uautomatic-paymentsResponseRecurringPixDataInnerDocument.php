<?php
/**
 * ResponseRecurringPixDataInnerDocument
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponseRecurringPixDataInnerDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsResponseRecurringPixDataInnerDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRecurringPixData_inner_document';
    ...
    public const REL_CPF = 'CPF';
    public const REL_CNPJ = 'CNPJ';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['identification']) < 11)) {
            $invalidProperties[] = "invalid value for 'identification', the character length must be bigger than or equal to 11.";
        }

        if (!preg_match("/^(?:\\d{11}|\\d{14})$/", $this->container['identification'])) {
            $invalidProperties[] = "invalid value for 'identification', must be conform to the pattern /^(?:\\d{11}|\\d{14})$/.";
        }
     ...
     * Sets identification
     *
     * @param string $identification Número do documento de identificação oficial do titular pessoa natural ou jurídica.
     *
     * @return self
     */
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 14)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling ResponseRecurringPixDataInnerDocument., must be smaller than or equal to 14.');
        }
        if ((mb_strlen($identification) < 11)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling ResponseRecurringPixDataInnerDocument., must be bigger than or equal to 11.');
        }
        if ((!preg_match("/^(?:\\d{11}|\\d{14})$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling ResponseRecurringPixDataInnerDocument., must conform to the pattern /^(?:\\d{11}|\\d{14})$/.");
        }
     ...
     * Sets rel
     *
     * @param string $rel Tipo do documento de identificação oficial do titular pessoa natural ou jurídica.
     *
     * @return self
     */

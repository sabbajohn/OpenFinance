 ...
 */
class UpaymentsCreditorAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets number
     *
     * @param string $number Deve ser preenchido com o número da conta do usuário recebedor, com dígito verificador (se este existir),   se houver valor alfanumérico, este deve ser convertido para 0.
     *
     * @return self
     */

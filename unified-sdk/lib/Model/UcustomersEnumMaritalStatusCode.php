...
/**
 * EnumMaritalStatusCode Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class UcustomersEnumMaritalStatusCode
{
    /**
     * Possible values of this enum
     */
    public const SOLTEIRO = 'SOLTEIRO';

    public const CASADO = 'CASADO';

    public const VIUVO = 'VIUVO';

    public const SEPARADO_JUDICIALMENTE = 'SEPARADO_JUDICIALMENTE';

    public const DIVORCIADO = 'DIVORCIADO';

    public const UNIAO_ESTAVEL = 'UNIAO_ESTAVEL';

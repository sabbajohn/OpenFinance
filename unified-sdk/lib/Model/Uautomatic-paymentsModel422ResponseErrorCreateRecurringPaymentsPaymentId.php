...
/**
 * Model422ResponseErrorCreateRecurringPaymentsPaymentId Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-paymentsModel422ResponseErrorCreateRecurringPaymentsPaymentId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '422ResponseErrorCreateRecurringPaymentsPaymentId';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrorsInner[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['errors']) > 3)) {
            $invalidProperties[] = "invalid value for 'errors', number of items must be less than or equal to 3.";
        }
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\Model422ResponseErrorCreateRecurringPaymentsPaymentIdErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 3)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling Model422ResponseErrorCreateRecurringPaymentsPaymentId., number of items must be less than or equal to 3.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling Model422ResponseErrorCreateRecurringPaymentsPaymentId., number of items must be greater than or equal to 1.');
        }

<?php
/**
 * RequestCreditPortabilityDataInstitutionProposingContactInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RequestCreditPortabilityDataInstitutionProposingContactInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Ucredit-portabilityRequestCreditPortabilityDataInstitutionProposingContactInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestCreditPortability_data_institution_proposing_contact_inner';
    ...
    public const TYPE_TELEFONE = 'TELEFONE';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['value']) && !preg_match("/^([1-9]{2}(?:[2-8]|9[0-9])[0-9]{3}[0-9]{4})|([a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,})$/", $this->container['value'])) {
            $invalidProperties[] = "invalid value for 'value', must be conform to the pattern /^([1-9]{2}(?:[2-8]|9[0-9])[0-9]{3}[0-9]{4})|([a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,})$/.";
        }
     ...
     * Sets type
     *
     * @param string|null $type Tipo do contato da Instituição Proponente.
     *
     * @return self
     */
    ...
    public function setValue($value)
    {
        ...
        if ((!preg_match("/^([1-9]{2}(?:[2-8]|9[0-9])[0-9]{3}[0-9]{4})|([a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,})$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling RequestCreditPortabilityDataInstitutionProposingContactInner., must conform to the pattern /^([1-9]{2}(?:[2-8]|9[0-9])[0-9]{3}[0-9]{4})|([a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,})$/.");
        }

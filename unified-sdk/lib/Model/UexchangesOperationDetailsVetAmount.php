...
/**
 * OperationDetailsVetAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class UexchangesOperationDetailsVetAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OperationDetails_vetAmount';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 31)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling OperationDetailsVetAmount., must be smaller than or equal to 31.');
        }
        if ((!preg_match("/\\d{1,15}\\.\\d{1,15}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling OperationDetailsVetAmount., must conform to the pattern /\\d{1,15}\\.\\d{1,15}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling OperationDetailsVetAmount., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling OperationDetailsVetAmount., must conform to the pattern /^[A-Z]{3}$/.");
        }

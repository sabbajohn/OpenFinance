...
/**
 * Month Class Doc Comment
 *
 * @category Class
 * @description Configurar limite transacional mensal determinado pelo usuário pagador.  [Restrição] Caso enviado o objeto, ao menos um dos campos (&#x60;quantityLimit&#x60; ou &#x60;transactionLimit&#x60;) devem ser preenchidos
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsMonth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Month';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['quantity_limit']) && ($this->container['quantity_limit'] < 1)) {
            $invalidProperties[] = "invalid value for 'quantity_limit', must be bigger than or equal to 1.";
        }
     ...
     * Sets quantity_limit
     *
     * @param int|null $quantity_limit Quantidade limite de transações permitidas para ocorrer durante um mês.
     *
     * @return self
     */
    public function setQuantityLimit($quantity_limit)
    {
        ...
        if (($quantity_limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity_limit when calling Month., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $transaction_limit Valor máximo a ser transacionado mensalmente.
     *
     * @return self
     */
    public function setTransactionLimit($transaction_limit)
    {
        ...
        if ((mb_strlen($transaction_limit) > 19)) {
            throw new \InvalidArgumentException('invalid length for $transaction_limit when calling Month., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($transaction_limit) < 4)) {
            throw new \InvalidArgumentException('invalid length for $transaction_limit when calling Month., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($transaction_limit)))) {
            throw new \InvalidArgumentException("invalid value for \$transaction_limit when calling Month., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }

...
/**
 * ResponseConsentReadDataRejectionReason Class Doc Comment
 *
 * @category Class
 ...
 */
class UconsentsResponseConsentReadDataRejectionReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseConsentRead_data_rejection_reason';
    ...
    public const CODE_CONSENT_EXPIRED = 'CONSENT_EXPIRED';
    public const CODE_CUSTOMER_MANUALLY_REJECTED = 'CUSTOMER_MANUALLY_REJECTED';
    public const CODE_CUSTOMER_MANUALLY_REVOKED = 'CUSTOMER_MANUALLY_REVOKED';
    public const CODE_CONSENT_MAX_DATE_REACHED = 'CONSENT_MAX_DATE_REACHED';
    public const CODE_CONSENT_TECHNICAL_ISSUE = 'CONSENT_TECHNICAL_ISSUE';
    public const CODE_INTERNAL_SECURITY_REASON = 'INTERNAL_SECURITY_REASON';
    ...
    {
        return [
            self::CODE_CONSENT_EXPIRED,
            self::CODE_CUSTOMER_MANUALLY_REJECTED,
            self::CODE_CUSTOMER_MANUALLY_REVOKED,
            self::CODE_CONSENT_MAX_DATE_REACHED,
            self::CODE_CONSENT_TECHNICAL_ISSUE,
            self::CODE_INTERNAL_SECURITY_REASON,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['additional_information']) && !preg_match("/^[^\\s](.*[^\\s])?$/", $this->container['additional_information'])) {
            $invalidProperties[] = "invalid value for 'additional_information', must be conform to the pattern /^[^\\s](.*[^\\s])?$/.";
        }
     ...
     *
     * @param string|null $additional_information Contém informações adicionais a critério da transmissora.
     *
     * @return self
     */
    public function setAdditionalInformation($additional_information)
    {
        ...
        if ((mb_strlen($additional_information) > 140)) {
            throw new \InvalidArgumentException('invalid length for $additional_information when calling ResponseConsentReadDataRejectionReason., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($additional_information)))) {
            throw new \InvalidArgumentException("invalid value for \$additional_information when calling ResponseConsentReadDataRejectionReason., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }

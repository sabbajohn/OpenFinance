<?php
/**
 * ConsentEditionRecurringConfigurationAutomatic
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ConsentEditionRecurringConfigurationAutomatic Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsConsentEditionRecurringConfigurationAutomatic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsentEdition_recurringConfiguration_automatic';
    ...
    */
    ...
    public function setMaximumVariableAmount($maximum_variable_amount)
    {
        ...
        if ((mb_strlen($maximum_variable_amount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $maximum_variable_amount when calling ConsentEditionRecurringConfigurationAutomatic., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($maximum_variable_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $maximum_variable_amount when calling ConsentEditionRecurringConfigurationAutomatic., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($maximum_variable_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$maximum_variable_amount when calling ConsentEditionRecurringConfigurationAutomatic., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }

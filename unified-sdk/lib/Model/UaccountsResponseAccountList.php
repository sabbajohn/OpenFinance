...
/**
 * ResponseAccountList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UaccountsResponseAccountList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseAccountList';
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\AccountData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\AccountData[] $data Lista de contas depósito à vista, poupança e pagamento pré-pagas mantidas pelo cliente na instituição transmissora e para as quais ele tenha fornecido consentimento
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseAccountList., number of items must be greater than or equal to 0.');
        }
     ...
     * Sets links
     *
     * @param \OpenAPI\Client\Model\Links $links links
     *
     * @return self
     */

...
/**
 * CreditCardsGetAccountsCreditCardAccountIdBillsBillIdTransactions200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Ucredit-cardsCreditCardsGetAccountsCreditCardAccountIdBillsBillIdTransactions200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'creditCardsGetAccountsCreditCardAccountIdBillsBillIdTransactions_200_response';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\CreditCardAccountsBillsTransactions[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\CreditCardAccountsBillsTransactions[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\CreditCardAccountsBillsTransactions[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling CreditCardsGetAccountsCreditCardAccountIdBillsBillIdTransactions200Response., number of items must be greater than or equal to 0.');
        }

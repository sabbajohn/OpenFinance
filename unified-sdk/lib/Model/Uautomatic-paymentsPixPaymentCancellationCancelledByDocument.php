...
/**
 * PixPaymentCancellationCancelledByDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsPixPaymentCancellationCancelledByDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PixPaymentCancellation_cancelledBy_document';
    ...
    */
    ...
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 14)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling PixPaymentCancellationCancelledByDocument., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^(?:\\d{11}|\\d{14})$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling PixPaymentCancellationCancelledByDocument., must conform to the pattern /^(?:\\d{11}|\\d{14})$/.");
        }

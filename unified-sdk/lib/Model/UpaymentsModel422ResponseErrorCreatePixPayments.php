<?php
/**
 * Model422ResponseErrorCreatePixPayments
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * Model422ResponseErrorCreatePixPayments Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpaymentsModel422ResponseErrorCreatePixPayments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '422ResponseErrorCreatePixPayments';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\Model422ResponseErrorCreatePixPaymentsErrorsInner[]',
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\Model422ResponseErrorCreatePixPaymentsErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\Model422ResponseErrorCreatePixPaymentsErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) > 9)) {
            throw new \InvalidArgumentException('invalid value for $errors when calling Model422ResponseErrorCreatePixPayments., number of items must be less than or equal to 9.');
        }
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling Model422ResponseErrorCreatePixPayments., number of items must be greater than or equal to 1.');
        }

...
/**
 * ResponsePostRecurringConsentData Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsResponsePostRecurringConsentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePostRecurringConsent_data';
    ...
    protected static $openAPITypes = [
        ...
        'debtor_account' => '\OpenAPI\Client\Model\ResponsePostRecurringConsentDataDebtorAccount',
    ...
    */
    ...
    public function setRecurringConsentId($recurring_consent_id)
    {
        ...
        if ((mb_strlen($recurring_consent_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $recurring_consent_id when calling ResponsePostRecurringConsentData., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/", ObjectSerializer::toString($recurring_consent_id)))) {
            throw new \InvalidArgumentException("invalid value for \$recurring_consent_id when calling ResponsePostRecurringConsentData., must conform to the pattern /^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/.");
        }
    ...
    public function setStatusUpdateDateTime($status_update_date_time)
    {
        ...
        if ((mb_strlen($status_update_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status_update_date_time when calling ResponsePostRecurringConsentData., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($status_update_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$status_update_date_time when calling ResponsePostRecurringConsentData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
    ...
    public function setCreditors($creditors)
    {
        ...
        if ((count($creditors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $creditors when calling ResponsePostRecurringConsentData., number of items must be greater than or equal to 1.');
        }
    ...
    public function setCreationDateTime($creation_date_time)
    {
        ...
        if ((mb_strlen($creation_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $creation_date_time when calling ResponsePostRecurringConsentData., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($creation_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$creation_date_time when calling ResponsePostRecurringConsentData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
    ...
    public function setExpirationDateTime($expiration_date_time)
    {
        ...
        if ((mb_strlen($expiration_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date_time when calling ResponsePostRecurringConsentData., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($expiration_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$expiration_date_time when calling ResponsePostRecurringConsentData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
    ...
    public function setAdditionalInformation($additional_information)
    {
        ...
        if ((mb_strlen($additional_information) > 140)) {
            throw new \InvalidArgumentException('invalid length for $additional_information when calling ResponsePostRecurringConsentData., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($additional_information)))) {
            throw new \InvalidArgumentException("invalid value for \$additional_information when calling ResponsePostRecurringConsentData., must conform to the pattern /[\\w\\W\\s]*/.");
        }
     ...
     * Gets debtor_account
     *
     * @return \OpenAPI\Client\Model\ResponsePostRecurringConsentDataDebtorAccount|null
     */
     ...
     * Sets debtor_account
     *
     * @param \OpenAPI\Client\Model\ResponsePostRecurringConsentDataDebtorAccount|null $debtor_account debtor_account
     *
     * @return self
     */
    ...
    public function setAuthorisedAtDateTime($authorised_at_date_time)
    {
        ...
        if ((mb_strlen($authorised_at_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $authorised_at_date_time when calling ResponsePostRecurringConsentData., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($authorised_at_date_time) < 20)) {
            throw new \InvalidArgumentException('invalid length for $authorised_at_date_time when calling ResponsePostRecurringConsentData., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($authorised_at_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$authorised_at_date_time when calling ResponsePostRecurringConsentData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
    ...
    public function setUpdatedAtDateTime($updated_at_date_time)
    {
        ...
        if ((mb_strlen($updated_at_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $updated_at_date_time when calling ResponsePostRecurringConsentData., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($updated_at_date_time) < 20)) {
            throw new \InvalidArgumentException('invalid length for $updated_at_date_time when calling ResponsePostRecurringConsentData., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($updated_at_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$updated_at_date_time when calling ResponsePostRecurringConsentData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

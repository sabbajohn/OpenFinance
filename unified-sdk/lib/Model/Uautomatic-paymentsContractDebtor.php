...
/**
 * ContractDebtor Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsContractDebtor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContractDebtor';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'document' => '\OpenAPI\Client\Model\ContractDebtorDocument'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Em caso de pessoa natural deve ser informado o nome completo do titular devedor do contrato.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 120)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContractDebtor., must be smaller than or equal to 120.');
        }
        if ((!preg_match("/^([A-Za-zÀ-ÖØ-öø-ÿ,.@:&*+_<>()!?\/\\\\$%\\d' -]+)$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling ContractDebtor., must conform to the pattern /^([A-Za-zÀ-ÖØ-öø-ÿ,.@:&*+_<>()!?\/\\\\$%\\d' -]+)$/.");
        }
     ...
     * Gets document
     *
     * @return \OpenAPI\Client\Model\ContractDebtorDocument
     */
     ...
     * Sets document
     *
     * @param \OpenAPI\Client\Model\ContractDebtorDocument $document document
     *
     * @return self
     */

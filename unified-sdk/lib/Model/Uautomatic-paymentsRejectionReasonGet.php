...
/**
 * RejectionReasonGet Class Doc Comment
 *
 * @category Class
 * @description Objeto contendo o motivo de rejeição assíncrono
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsRejectionReasonGet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RejectionReasonGet';
    ...
    protected static $openAPITypes = [
        'code' => '\OpenAPI\Client\Model\EnumRejectionReasonCodeGet',
        'detail' => 'string'
    ];
    ...
    */
     ...
     * Gets code
     *
     * @return \OpenAPI\Client\Model\EnumRejectionReasonCodeGet
     */
     ...
     * Sets code
     *
     * @param \OpenAPI\Client\Model\EnumRejectionReasonCodeGet $code code
     *
     * @return self
     */
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling RejectionReasonGet., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling RejectionReasonGet., must conform to the pattern /[\\w\\W\\s]*/.");
        }

...
/**
 * ResponseAccountTransactions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UaccountsResponseAccountTransactions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseAccountTransactions';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\AccountTransactionsData[]',
        'links' => '\OpenAPI\Client\Model\TransactionsLinks',
        'meta' => '\OpenAPI\Client\Model\MetaOnlyRequestDateTime'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\AccountTransactionsData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\AccountTransactionsData[] $data Lista dos lançamentos referentes às transações realizadas e de lançamentos futuros para as contas de: depósito à vista, poupança e de pagamento pré-paga
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseAccountTransactions., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets links
     *
     * @return \OpenAPI\Client\Model\TransactionsLinks
     */
     ...
     * Sets links
     *
     * @param \OpenAPI\Client\Model\TransactionsLinks $links links
     *
     * @return self
     */
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\MetaOnlyRequestDateTime
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\MetaOnlyRequestDateTime $meta meta
     *
     * @return self
     */

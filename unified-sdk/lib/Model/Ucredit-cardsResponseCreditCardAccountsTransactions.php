...
/**
 * ResponseCreditCardAccountsTransactions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Ucredit-cardsResponseCreditCardAccountsTransactions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCreditCardAccountsTransactions';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\CreditCardAccountsTransaction[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\CreditCardAccountsTransaction[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\CreditCardAccountsTransaction[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseCreditCardAccountsTransactions., number of items must be greater than or equal to 0.');
        }

<?php
/**
 * ResponseRecurringConsentPatchData
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponseRecurringConsentPatchData Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsResponseRecurringConsentPatchData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRecurringConsentPatch_data';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\OpenAPI\Client\Model\EnumAuthorisationStatusType',
        'creditors' => '\OpenAPI\Client\Model\CreditorsInner[]',
        'creation_date_time' => '\DateTime',
        'expiration_date_time' => '\DateTime',
        'additional_information' => 'string',
        'debtor_account' => '\OpenAPI\Client\Model\ResponseRecurringConsentPatchDataDebtorAccount',
        'rejection' => '\OpenAPI\Client\Model\ResponseRecurringConsentPatchDataRejection',
        'revocation' => '\OpenAPI\Client\Model\ResponsePostRecurringConsentDataRevocation',
        'recurring_configuration' => '\OpenAPI\Client\Model\RecurringConfiguration',
        'risk_signals' => '\OpenAPI\Client\Model\RiskSignalsConsents',
        'authorised_at_date_time' => '\DateTime',
    ...
    protected static $openAPIFormats = [
        ...
        'rejection' => null,
        'revocation' => null,
        'recurring_configuration' => null,
        'risk_signals' => null,
        'authorised_at_date_time' => 'date-time',
    ...
    protected static array $openAPINullables = [
        ...
        'rejection' => false,
        'revocation' => false,
        'recurring_configuration' => false,
        'risk_signals' => false,
        'authorised_at_date_time' => false,
        'updated_at_date_time' => false,
        'approval_due_date' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'authorised_at_date_time' => 'authorisedAtDateTime',
        'updated_at_date_time' => 'updatedAtDateTime',
    ...
    protected static $setters = [
        ...
        'revocation' => 'setRevocation',
        'recurring_configuration' => 'setRecurringConfiguration',
        'risk_signals' => 'setRiskSignals',
        'authorised_at_date_time' => 'setAuthorisedAtDateTime',
        'updated_at_date_time' => 'setUpdatedAtDateTime',
        'approval_due_date' => 'setApprovalDueDate'
    ];
    ...
    protected static $getters = [
        ...
        'revocation' => 'getRevocation',
        'recurring_configuration' => 'getRecurringConfiguration',
        'risk_signals' => 'getRiskSignals',
        'authorised_at_date_time' => 'getAuthorisedAtDateTime',
        'updated_at_date_time' => 'getUpdatedAtDateTime',
        'approval_due_date' => 'getApprovalDueDate'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('creditors', $data ?? [], null);
        ...
        $this->setIfExists('revocation', $data ?? [], null);
        $this->setIfExists('recurring_configuration', $data ?? [], null);
        $this->setIfExists('risk_signals', $data ?? [], null);
        $this->setIfExists('authorised_at_date_time', $data ?? [], null);
        $this->setIfExists('updated_at_date_time', $data ?? [], null);
        $this->setIfExists('approval_due_date', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recurring_consent_id'] === null) {
            $invalidProperties[] = "'recurring_consent_id' can't be null";
        }
        if ((mb_strlen($this->container['recurring_consent_id']) > 256)) {
            $invalidProperties[] = "invalid value for 'recurring_consent_id', the character length must be smaller than or equal to 256.";
        }

        if (!preg_match("/^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/", $this->container['recurring_consent_id'])) {
        ...
        if ($this->container['creditors'] === null) {
            $invalidProperties[] = "'creditors' can't be null";
        }
        if ((count($this->container['creditors']) < 1)) {
            $invalidProperties[] = "invalid value for 'creditors', number of items must be greater than or equal to 1.";
        }
        ...
        if (!is_null($this->container['additional_information']) && (mb_strlen($this->container['additional_information']) > 140)) {
            $invalidProperties[] = "invalid value for 'additional_information', the character length must be smaller than or equal to 140.";
        }
        ...
        if ($this->container['recurring_configuration'] === null) {
            $invalidProperties[] = "'recurring_configuration' can't be null";
        }
        if (!is_null($this->container['authorised_at_date_time']) && (mb_strlen($this->container['authorised_at_date_time']) > 20)) {
            $invalidProperties[] = "invalid value for 'authorised_at_date_time', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['authorised_at_date_time']) && (mb_strlen($this->container['authorised_at_date_time']) < 20)) {
            $invalidProperties[] = "invalid value for 'authorised_at_date_time', the character length must be bigger than or equal to 20.";
        }

        if (!is_null($this->container['authorised_at_date_time']) && !preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", $this->container['authorised_at_date_time'])) {
            $invalidProperties[] = "invalid value for 'authorised_at_date_time', must be conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.";
        }

        if (!is_null($this->container['updated_at_date_time']) && (mb_strlen($this->container['updated_at_date_time']) > 20)) {
            $invalidProperties[] = "invalid value for 'updated_at_date_time', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['updated_at_date_time']) && (mb_strlen($this->container['updated_at_date_time']) < 20)) {
            $invalidProperties[] = "invalid value for 'updated_at_date_time', the character length must be bigger than or equal to 20.";
        }

        if (!is_null($this->container['updated_at_date_time']) && !preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", $this->container['updated_at_date_time'])) {
            $invalidProperties[] = "invalid value for 'updated_at_date_time', must be conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.";
        }

        if (!is_null($this->container['approval_due_date']) && !preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", $this->container['approval_due_date'])) {
            $invalidProperties[] = "invalid value for 'approval_due_date', must be conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.";
        }
    ...
    public function setRecurringConsentId($recurring_consent_id)
    {
        ...
        if ((mb_strlen($recurring_consent_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $recurring_consent_id when calling ResponseRecurringConsentPatchData., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/", ObjectSerializer::toString($recurring_consent_id)))) {
            throw new \InvalidArgumentException("invalid value for \$recurring_consent_id when calling ResponseRecurringConsentPatchData., must conform to the pattern /^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/.");
        }
     ...
     *
     * @param \DateTime $status_update_date_time Data e hora em que o consentimento teve o status atualizado. Uma string com data e hora conforme especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339), sempre com a utilização de timezone UTC(UTC time format).
     *
     * @return self
     */
    public function setStatusUpdateDateTime($status_update_date_time)
    {
        ...
        if ((mb_strlen($status_update_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status_update_date_time when calling ResponseRecurringConsentPatchData., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($status_update_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$status_update_date_time when calling ResponseRecurringConsentPatchData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
     ...
     * Gets logged_user
     *
     * @return \OpenAPI\Client\Model\LoggedUser|null
     */
     ...
     * Sets logged_user
     *
     * @param \OpenAPI\Client\Model\LoggedUser|null $logged_user logged_user
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\EnumAuthorisationStatusType
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\EnumAuthorisationStatusType $status status
     *
     * @return self
     */
     ...
     * Gets creditors
     *
     * @return \OpenAPI\Client\Model\CreditorsInner[]
     */
    public function getCreditors()
    {
        return $this->container['creditors'];
    }

    /**
     * Sets creditors
     *
     * @param \OpenAPI\Client\Model\CreditorsInner[] $creditors creditors
     *
     * @return self
     */
    public function setCreditors($creditors)
    {
        if (is_null($creditors)) {
            throw new \InvalidArgumentException('non-nullable creditors cannot be null');
        }


        if ((count($creditors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $creditors when calling ResponseRecurringConsentPatchData., number of items must be greater than or equal to 1.');
        }
        $this->container['creditors'] = $creditors;
     ...
     *
     * @param \DateTime $creation_date_time Data e hora em que o consentimento foi criado. Uma string com data e hora conforme especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339), sempre com a utilização de timezone UTC(UTC time format).
     *
     * @return self
     */
    public function setCreationDateTime($creation_date_time)
    {
        ...
        if ((mb_strlen($creation_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $creation_date_time when calling ResponseRecurringConsentPatchData., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($creation_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$creation_date_time when calling ResponseRecurringConsentPatchData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
     ...
     *
     * @param \DateTime|null $expiration_date_time Data e hora em que o consentimento deve deixar de ser válido. Uma string com data e hora conforme especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339), sempre com a utilização de timezone UTC (UTC time format).  [Restrição] Caso o consentimento seja para Pix Automático (\"automatic\" selecionado no oneOf \"/data/recurringConfiguration/\") o horário de expiração do consentimento precisa ser às 23:59:59 (UTC).
     *
     * @return self
     */
    public function setExpirationDateTime($expiration_date_time)
    {
        ...
        if ((mb_strlen($expiration_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date_time when calling ResponseRecurringConsentPatchData., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($expiration_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$expiration_date_time when calling ResponseRecurringConsentPatchData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
     ...
     *
     * @param string|null $additional_information Deve ser preenchido sempre que o usuário pagador inserir alguma informação adicional no consentimento
     *
     * @return self
     */
    public function setAdditionalInformation($additional_information)
    {
        ...
        if ((mb_strlen($additional_information) > 140)) {
            throw new \InvalidArgumentException('invalid length for $additional_information when calling ResponseRecurringConsentPatchData., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($additional_information)))) {
            throw new \InvalidArgumentException("invalid value for \$additional_information when calling ResponseRecurringConsentPatchData., must conform to the pattern /[\\w\\W\\s]*/.");
        }
     ...
     * Gets debtor_account
     *
     * @return \OpenAPI\Client\Model\ResponseRecurringConsentPatchDataDebtorAccount|null
     */
     ...
     * Sets debtor_account
     *
     * @param \OpenAPI\Client\Model\ResponseRecurringConsentPatchDataDebtorAccount|null $debtor_account debtor_account
     *
     * @return self
     */
     ...
     * Gets rejection
     *
     * @return \OpenAPI\Client\Model\ResponseRecurringConsentPatchDataRejection|null
     */
     ...
     * Sets rejection
     *
     * @param \OpenAPI\Client\Model\ResponseRecurringConsentPatchDataRejection|null $rejection rejection
     *
     * @return self
     */
     ...
     * Gets revocation
     *
     * @return \OpenAPI\Client\Model\ResponsePostRecurringConsentDataRevocation|null
     */
    public function getRevocation()
    {
        return $this->container['revocation'];
    }

    /**
     * Sets revocation
     *
     * @param \OpenAPI\Client\Model\ResponsePostRecurringConsentDataRevocation|null $revocation revocation
     *
     * @return self
     */
    public function setRevocation($revocation)
    {
        if (is_null($revocation)) {
            throw new \InvalidArgumentException('non-nullable revocation cannot be null');
        }
        $this->container['revocation'] = $revocation;

        return $this;
    }

    /**
     * Gets recurring_configuration
     *
     * @return \OpenAPI\Client\Model\RecurringConfiguration
     */
    public function getRecurringConfiguration()
    {
        return $this->container['recurring_configuration'];
    }

    /**
     * Sets recurring_configuration
     *
     * @param \OpenAPI\Client\Model\RecurringConfiguration $recurring_configuration recurring_configuration
     *
     * @return self
     */
    public function setRecurringConfiguration($recurring_configuration)
    {
        if (is_null($recurring_configuration)) {
            throw new \InvalidArgumentException('non-nullable recurring_configuration cannot be null');
        }
        $this->container['recurring_configuration'] = $recurring_configuration;
     ...
     * Gets risk_signals
     *
     * @return \OpenAPI\Client\Model\RiskSignalsConsents|null
     */
     ...
     * Sets risk_signals
     *
     * @param \OpenAPI\Client\Model\RiskSignalsConsents|null $risk_signals risk_signals
     *
     * @return self
     */
    ...
    /**
     * Gets authorised_at_date_time
     *
     * @return \DateTime|null
     */
    public function getAuthorisedAtDateTime()
    {
        return $this->container['authorised_at_date_time'];
    }

    /**
     * Sets authorised_at_date_time
     *
     * @param \DateTime|null $authorised_at_date_time Data e hora em que o consentimento foi autorizado.  [Restrição] Campo de envio obrigatório quando consentimento transitar para AUTHORISED.
     *
     * @return self
     */
    public function setAuthorisedAtDateTime($authorised_at_date_time)
    {
        if (is_null($authorised_at_date_time)) {
            throw new \InvalidArgumentException('non-nullable authorised_at_date_time cannot be null');
        }
        if ((mb_strlen($authorised_at_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $authorised_at_date_time when calling ResponseRecurringConsentPatchData., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($authorised_at_date_time) < 20)) {
            throw new \InvalidArgumentException('invalid length for $authorised_at_date_time when calling ResponseRecurringConsentPatchData., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($authorised_at_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$authorised_at_date_time when calling ResponseRecurringConsentPatchData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

        $this->container['authorised_at_date_time'] = $authorised_at_date_time;

        return $this;
    }

    /**
     * Gets updated_at_date_time
     *
     * @return \DateTime|null
     */
    public function getUpdatedAtDateTime()
    {
        return $this->container['updated_at_date_time'];
    }

    /**
     * Sets updated_at_date_time
     *
     * @param \DateTime|null $updated_at_date_time Data e hora em que o consentimento foi atualizado pelo usuário pagador.  O campo deve ser atualizado pelo detentor sempre que o consentimento for editado.  Caso a edição seja realizada a partir do iniciador, o detentor deve preencher com a data e hora (UTC) em que recebeu a solicitação de edição.  A edição só é permitida para o produto Pix automático.
     *
     * @return self
     */
    public function setUpdatedAtDateTime($updated_at_date_time)
    {
        if (is_null($updated_at_date_time)) {
            throw new \InvalidArgumentException('non-nullable updated_at_date_time cannot be null');
        }
        if ((mb_strlen($updated_at_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $updated_at_date_time when calling ResponseRecurringConsentPatchData., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($updated_at_date_time) < 20)) {
            throw new \InvalidArgumentException('invalid length for $updated_at_date_time when calling ResponseRecurringConsentPatchData., must be bigger than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($updated_at_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$updated_at_date_time when calling ResponseRecurringConsentPatchData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

        $this->container['updated_at_date_time'] = $updated_at_date_time;

        return $this;
    }

    /**
     * Gets approval_due_date
     *
     * @return \DateTime|null
     */
    public function getApprovalDueDate()
    {
        return $this->container['approval_due_date'];
    }

    /**
     * Sets approval_due_date
     *
     * @param \DateTime|null $approval_due_date Representa a data máxima para aprovação de um consentimento que encontra-se (ou passou) pelo estado PARTIALLY_ACCEPTED. A aprovação deve ocorrer até as 23:59h do dia informado, caso contrário, consentimento deve ser rejeitado.  [Restrição] Deve ser preenchido pela instituição detentora sempre que um consentimento estiver (ou passado) no estado PARTIALLY_ACCEPTED
     *
     * @return self
     */
    public function setApprovalDueDate($approval_due_date)
    {
        if (is_null($approval_due_date)) {
            throw new \InvalidArgumentException('non-nullable approval_due_date cannot be null');
        }

        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($approval_due_date)))) {
            throw new \InvalidArgumentException("invalid value for \$approval_due_date when calling ResponseRecurringConsentPatchData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }

        $this->container['approval_due_date'] = $approval_due_date;

...
/**
 * ResponseInvoiceFinancingsContractList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uinvoice-financingsResponseInvoiceFinancingsContractList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseInvoiceFinancingsContractList';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\InvoiceFinancingsContractData[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\InvoiceFinancingsContractData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\InvoiceFinancingsContractData[] $data Conjunto de informações  de contratos de direitos creditórios descontados mantidos pelo cliente na instituição transmissora e para os quais ele tenha fornecido consentimento
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseInvoiceFinancingsContractList., number of items must be greater than or equal to 0.');
        }

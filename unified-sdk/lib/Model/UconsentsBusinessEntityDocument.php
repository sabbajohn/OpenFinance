...
/**
 * BusinessEntityDocument Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UconsentsBusinessEntityDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessEntityDocument';
    ...
    */
    ...
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 14)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling BusinessEntityDocument., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^[0-9A-Z]{12}[0-9]{2}$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling BusinessEntityDocument., must conform to the pattern /^[0-9A-Z]{12}[0-9]{2}$/.");
        }
    ...
    public function setRel($rel)
    {
        ...
        if ((mb_strlen($rel) > 4)) {
            throw new \InvalidArgumentException('invalid length for $rel when calling BusinessEntityDocument., must be smaller than or equal to 4.');
        }
        if ((!preg_match("/^[A-Z]{4}$/", ObjectSerializer::toString($rel)))) {
            throw new \InvalidArgumentException("invalid value for \$rel when calling BusinessEntityDocument., must conform to the pattern /^[A-Z]{4}$/.");
        }

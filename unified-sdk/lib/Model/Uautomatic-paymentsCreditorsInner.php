...
class Uautomatic-paymentsCreditorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Creditors_inner';
    ...
    protected static $openAPITypes = [
        'person_type' => '\OpenAPI\Client\Model\EnumPaymentPersonType',
        'cpf_cnpj' => 'string',
        'name' => 'string'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['cpf_cnpj']) > 14)) {
            $invalidProperties[] = "invalid value for 'cpf_cnpj', the character length must be smaller than or equal to 14.";
        }

        if ((mb_strlen($this->container['cpf_cnpj']) < 11)) {
            $invalidProperties[] = "invalid value for 'cpf_cnpj', the character length must be bigger than or equal to 11.";
        }

        if (!preg_match("/^\\d{11}$|^\\d{14}$/", $this->container['cpf_cnpj'])) {
            $invalidProperties[] = "invalid value for 'cpf_cnpj', must be conform to the pattern /^\\d{11}$|^\\d{14}$/.";
        }
        ...
        if (!preg_match("/^([A-Za-zÀ-ÖØ-öø-ÿ,.@:&*+_<>()!?\/\\\\$%\\d' -]+)$/", $this->container['name'])) {
            $invalidProperties[] = "invalid value for 'name', must be conform to the pattern /^([A-Za-zÀ-ÖØ-öø-ÿ,.@:&*+_<>()!?\/\\\\$%\\d' -]+)$/.";
        }
     ...
     * Gets person_type
     *
     * @return \OpenAPI\Client\Model\EnumPaymentPersonType
     */
     ...
     * Sets person_type
     *
     * @param \OpenAPI\Client\Model\EnumPaymentPersonType $person_type person_type
     *
     * @return self
     */
    ...
    public function setCpfCnpj($cpf_cnpj)
    {
        ...
        if ((mb_strlen($cpf_cnpj) > 14)) {
            throw new \InvalidArgumentException('invalid length for $cpf_cnpj when calling CreditorsInner., must be smaller than or equal to 14.');
        }
        if ((mb_strlen($cpf_cnpj) < 11)) {
            throw new \InvalidArgumentException('invalid length for $cpf_cnpj when calling CreditorsInner., must be bigger than or equal to 11.');
        }
        if ((!preg_match("/^\\d{11}$|^\\d{14}$/", ObjectSerializer::toString($cpf_cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$cpf_cnpj when calling CreditorsInner., must conform to the pattern /^\\d{11}$|^\\d{14}$/.");
        }
     ...
     * Sets name
     *
     * @param string $name Em caso de pessoa natural deve ser informado o nome completo do titular da conta do recebedor.   Em caso de pessoa jurídica deve ser informada a razão social ou o nome fantasia da conta do recebedor.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 120)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreditorsInner., must be smaller than or equal to 120.');
        }
        if ((!preg_match("/^([A-Za-zÀ-ÖØ-öø-ÿ,.@:&*+_<>()!?\/\\\\$%\\d' -]+)$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling CreditorsInner., must conform to the pattern /^([A-Za-zÀ-ÖØ-öø-ÿ,.@:&*+_<>()!?\/\\\\$%\\d' -]+)$/.");
        }

...
/**
 * EnrollmentCreateFidoSigningOptionsRequestData Class Doc Comment
 *
 * @category Class
 ...
 */
class UenrollmentsEnrollmentCreateFidoSigningOptionsRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'enrollmentCreateFidoSigningOptions_request_data';
    ...
    */
     ...
     * Sets platform
     *
     * @param string $platform Indica a plataforma em que o usuário criará a nova credencial FIDO2.  Este campo permite que o servidor FIDO inclua extensões de acordo com a plataforma utilizada.
     *
     * @return self
     */
    ...
    public function setConsentId($consent_id)
    {
        ...
        if ((mb_strlen($consent_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $consent_id when calling EnrollmentCreateFidoSigningOptionsRequestData., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/", ObjectSerializer::toString($consent_id)))) {
            throw new \InvalidArgumentException("invalid value for \$consent_id when calling EnrollmentCreateFidoSigningOptionsRequestData., must conform to the pattern /^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/.");
        }

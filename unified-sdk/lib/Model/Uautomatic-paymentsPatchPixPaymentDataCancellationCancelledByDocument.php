 ...
 */
class Uautomatic-paymentsPatchPixPaymentDataCancellationCancelledByDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets identification
     *
     * @param string $identification Número do documento de identificação oficial do pagador ou recebedor, pessoa natural ou jurídica
     *
     * @return self
     */
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 14)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling PatchPixPaymentDataCancellationCancelledByDocument., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^(?:\\d{11}|\\d{14})$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling PatchPixPaymentDataCancellationCancelledByDocument., must conform to the pattern /^(?:\\d{11}|\\d{14})$/.");
        }
     ...
     * Sets rel
     *
     * @param string $rel Tipo de documento de identificação oficial do pagador ou recebedor, pessoa natural ou jurídica.
     *
     * @return self
     */

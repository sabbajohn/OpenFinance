...
/**
 * PersonalContacts Class Doc Comment
 *
 * @category Class
 ...
 */
class UcustomersPersonalContacts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonalContacts';
    ...
    protected static $openAPITypes = [
        'postal_addresses' => '\OpenAPI\Client\Model\PersonalPostalAddress[]',
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\PersonalPostalAddress[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PersonalPostalAddress[] $postal_addresses Lista de endereços da pessoa natural
     *
     * @return self
     */
    public function setPostalAddresses($postal_addresses)
    {
        ...
        if ((count($postal_addresses) < 0)) {
            throw new \InvalidArgumentException('invalid length for $postal_addresses when calling PersonalContacts., number of items must be greater than or equal to 0.');
        }
     ...
     * Sets phones
     *
     * @param \OpenAPI\Client\Model\CustomerPhone[] $phones Lista com telefones de contato da pessoa natural
     *
     * @return self
     */
    public function setPhones($phones)
    {
        ...
        if ((count($phones) < 0)) {
            throw new \InvalidArgumentException('invalid length for $phones when calling PersonalContacts., number of items must be greater than or equal to 0.');
        }
    ...
    public function setEmails($emails)
    {
        ...
        if ((count($emails) < 0)) {
            throw new \InvalidArgumentException('invalid length for $emails when calling PersonalContacts., number of items must be greater than or equal to 0.');
        }

<?php
/**
 * ResponseRecurringConsentPatchDataRejection
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponseRecurringConsentPatchDataRejection Class Doc Comment
 *
 * @category Class
 * @description Objeto contendo as informações de rejeição dos consentimentos.  [Restrição] Campo de preenchimento obrigatório caso status do consentimento igual a \&quot;REJECTED\&quot;.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsResponseRecurringConsentPatchDataRejection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseRecurringConsentPatch_data_rejection';
    ...
    protected static $openAPITypes = [
        ...
        'reason' => '\OpenAPI\Client\Model\ConsentRejectionReason'
    ];
    ...
    public const REJECTED_BY_INICIADORA = 'INICIADORA';
    public const REJECTED_BY_USUARIO = 'USUARIO';
    public const REJECTED_BY_DETENTORA = 'DETENTORA';
    public const REJECTED_FROM_INICIADORA = 'INICIADORA';
    public const REJECTED_FROM_DETENTORA = 'DETENTORA';
     ...
     * @return string[]
     */
    public function getRejectedByAllowableValues()
    {
        return [
            self::REJECTED_BY_INICIADORA,
            self::REJECTED_BY_USUARIO,
            self::REJECTED_BY_DETENTORA,
        ];
    }
     ...
     * @return string[]
     */
    public function getRejectedFromAllowableValues()
    {
        return [
            self::REJECTED_FROM_INICIADORA,
            self::REJECTED_FROM_DETENTORA,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rejected_from', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rejected_by'] === null) {
            $invalidProperties[] = "'rejected_by' can't be null";
        }
        $allowedValues = $this->getRejectedByAllowableValues();
        if (!is_null($this->container['rejected_by']) && !in_array($this->container['rejected_by'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'rejected_by', must be one of '%s'",
                $this->container['rejected_by'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['rejected_from'] === null) {
            $invalidProperties[] = "'rejected_from' can't be null";
        }
        $allowedValues = $this->getRejectedFromAllowableValues();
        if (!is_null($this->container['rejected_from']) && !in_array($this->container['rejected_from'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'rejected_from', must be one of '%s'",
                $this->container['rejected_from'],
                implode("', '", $allowedValues)
            );
        }
        ...
        if ((mb_strlen($this->container['rejected_at']) > 20)) {
            $invalidProperties[] = "invalid value for 'rejected_at', the character length must be smaller than or equal to 20.";
        }

        if (!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", $this->container['rejected_at'])) {
            $invalidProperties[] = "invalid value for 'rejected_at', must be conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.";
        }
     ...
     * Sets rejected_by
     *
     * @param string $rejected_by Quem iniciou a solicitação de rejeição - INICIADORA - USUARIO - DETENTORA
     *
     * @return self
     */
    public function setRejectedBy($rejected_by)
    {
        ...
        $allowedValues = $this->getRejectedByAllowableValues();
        if (!in_array($rejected_by, $allowedValues, true)) {
     ...
     * @return string
     */
    public function getRejectedFrom()
    {
        return $this->container['rejected_from'];
    }

    /**
     * Sets rejected_from
     *
     * @param string $rejected_from Canal onde iniciou-se o processo de rejeição  - INICIADORA - DETENTORA
     *
     * @return self
     */
    public function setRejectedFrom($rejected_from)
    {
        if (is_null($rejected_from)) {
            throw new \InvalidArgumentException('non-nullable rejected_from cannot be null');
        }
        $allowedValues = $this->getRejectedFromAllowableValues();
        if (!in_array($rejected_from, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'rejected_from', must be one of '%s'",
                    $rejected_from,
        ...
        $this->container['rejected_from'] = $rejected_from;
     ...
     * Sets rejected_at
     *
     * @param \DateTime $rejected_at Data e hora em que o consentimento foi rejeitado
     *
     * @return self
     */
    public function setRejectedAt($rejected_at)
    {
        ...
        if ((mb_strlen($rejected_at) > 20)) {
            throw new \InvalidArgumentException('invalid length for $rejected_at when calling ResponseRecurringConsentPatchDataRejection., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($rejected_at)))) {
            throw new \InvalidArgumentException("invalid value for \$rejected_at when calling ResponseRecurringConsentPatchDataRejection., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
     ...
     * Gets reason
     *
     * @return \OpenAPI\Client\Model\ConsentRejectionReason|null
     */
     ...
     * Sets reason
     *
     * @param \OpenAPI\Client\Model\ConsentRejectionReason|null $reason reason
     *
     * @return self
     */

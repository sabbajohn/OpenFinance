<?php
/**
 * Model422ResponseErrorFidoRegistration
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * Model422ResponseErrorFidoRegistration Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UenrollmentsModel422ResponseErrorFidoRegistration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '422ResponseErrorFidoRegistration';
    ...
    protected static $openAPITypes = [
        'errors' => '\OpenAPI\Client\Model\Model422ResponseErrorFidoRegistrationErrorsInner[]',
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\Model422ResponseErrorFidoRegistrationErrorsInner[]
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\Model422ResponseErrorFidoRegistrationErrorsInner[] $errors errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if ((count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling Model422ResponseErrorFidoRegistration., number of items must be greater than or equal to 1.');
        }

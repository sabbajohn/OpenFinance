...
/**
 * LoggedUserDocumentExtensions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UconsentsLoggedUserDocumentExtensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoggedUserDocumentExtensions';
    ...
    */
     ...
     * Sets identification
     *
     * @param string $identification Número do documento de identificação oficial do usuário.
     *
     * @return self
     */
    public function setIdentification($identification)
    {
        ...
        if ((mb_strlen($identification) > 11)) {
            throw new \InvalidArgumentException('invalid length for $identification when calling LoggedUserDocumentExtensions., must be smaller than or equal to 11.');
        }
        if ((!preg_match("/^\\d{11}$/", ObjectSerializer::toString($identification)))) {
            throw new \InvalidArgumentException("invalid value for \$identification when calling LoggedUserDocumentExtensions., must conform to the pattern /^\\d{11}$/.");
        }
     ...
     * Sets rel
     *
     * @param string $rel Tipo do documento de identificação oficial do usuário.
     *
     * @return self
     */
    public function setRel($rel)
    {
        ...
        if ((mb_strlen($rel) > 3)) {
            throw new \InvalidArgumentException('invalid length for $rel when calling LoggedUserDocumentExtensions., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($rel)))) {
            throw new \InvalidArgumentException("invalid value for \$rel when calling LoggedUserDocumentExtensions., must conform to the pattern /^[A-Z]{3}$/.");
        }

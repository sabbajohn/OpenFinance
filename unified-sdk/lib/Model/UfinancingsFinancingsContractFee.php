...
/**
 * FinancingsContractFee Class Doc Comment
 *
 * @category Class
 ...
 */
class UfinancingsFinancingsContractFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancingsContractFee';
    ...
    */
    ...
    public function setFeeName($fee_name)
    {
        ...
        if ((mb_strlen($fee_name) > 140)) {
            throw new \InvalidArgumentException('invalid length for $fee_name when calling FinancingsContractFee., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($fee_name)))) {
            throw new \InvalidArgumentException("invalid value for \$fee_name when calling FinancingsContractFee., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
    ...
    public function setFeeCode($fee_code)
    {
        ...
        if ((mb_strlen($fee_code) > 140)) {
            throw new \InvalidArgumentException('invalid length for $fee_code when calling FinancingsContractFee., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($fee_code)))) {
            throw new \InvalidArgumentException("invalid value for \$fee_code when calling FinancingsContractFee., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
    ...
    public function setFeeAmount($fee_amount)
    {
        ...
        if ((mb_strlen($fee_amount) > 20)) {
            throw new \InvalidArgumentException('invalid length for $fee_amount when calling FinancingsContractFee., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($fee_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $fee_amount when calling FinancingsContractFee., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($fee_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$fee_amount when calling FinancingsContractFee., must conform to the pattern /^\\d{1,15}\\.\\d{2,4}$/.");
        }
    ...
    public function setFeeRate($fee_rate)
    {
        ...
        if ((mb_strlen($fee_rate) > 8)) {
            throw new \InvalidArgumentException('invalid length for $fee_rate when calling FinancingsContractFee., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($fee_rate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $fee_rate when calling FinancingsContractFee., must be bigger than or equal to 8.');
        }
        if ((!preg_match("/^\\d{1}\\.\\d{6}$/", ObjectSerializer::toString($fee_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$fee_rate when calling FinancingsContractFee., must conform to the pattern /^\\d{1}\\.\\d{6}$/.");
        }

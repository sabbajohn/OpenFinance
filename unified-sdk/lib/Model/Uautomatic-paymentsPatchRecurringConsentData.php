...
/**
 * PatchRecurringConsentData Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsPatchRecurringConsentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchRecurringConsent_data';
    ...
    protected static $openAPITypes = [
        'risk_signals' => '\OpenAPI\Client\Model\RiskSignalsConsentEdition',
        'creditors' => '\OpenAPI\Client\Model\ConsentEditionCreditorsInner[]',
        'expiration_date_time' => '\DateTime',
        'recurring_configuration' => '\OpenAPI\Client\Model\ConsentEditionRecurringConfiguration',
        'logged_user' => '\OpenAPI\Client\Model\ConsentEditionLoggedUser',
        'business_entity' => '\OpenAPI\Client\Model\ConsentEditionBusinessEntity',
        'status' => 'string',
        'revocation' => '\OpenAPI\Client\Model\ConsentRevocationRevocation',
        'rejection' => '\OpenAPI\Client\Model\ConsentRejectionRejection'
    ];
    ...
    */
     ...
     * Gets risk_signals
     *
     * @return \OpenAPI\Client\Model\RiskSignalsConsentEdition|null
     */
     ...
     * Sets risk_signals
     *
     * @param \OpenAPI\Client\Model\RiskSignalsConsentEdition|null $risk_signals risk_signals
     *
     * @return self
     */
     ...
     * Gets creditors
     *
     * @return \OpenAPI\Client\Model\ConsentEditionCreditorsInner[]
     */
     ...
     * Sets creditors
     *
     * @param \OpenAPI\Client\Model\ConsentEditionCreditorsInner[] $creditors creditors
     *
     * @return self
     */
    public function setCreditors($creditors)
    {
        ...
        if ((count($creditors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $creditors when calling PatchRecurringConsentData., number of items must be greater than or equal to 1.');
        }
    ...
    public function setExpirationDateTime($expiration_date_time)
    {
        ...
        if ((mb_strlen($expiration_date_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $expiration_date_time when calling PatchRecurringConsentData., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($expiration_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$expiration_date_time when calling PatchRecurringConsentData., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\ConsentEditionRecurringConfiguration|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ConsentEditionRecurringConfiguration|null $recurring_configuration recurring_configuration
     *
     * @return self
     */
     ...
     * Gets logged_user
     *
     * @return \OpenAPI\Client\Model\ConsentEditionLoggedUser|null
     */
     ...
     * Sets logged_user
     *
     * @param \OpenAPI\Client\Model\ConsentEditionLoggedUser|null $logged_user logged_user
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ConsentEditionBusinessEntity|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ConsentEditionBusinessEntity|null $business_entity business_entity
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Estado atual do consentimento de longa duração
     *
     * @return self
     */
     ...
     * Gets revocation
     *
     * @return \OpenAPI\Client\Model\ConsentRevocationRevocation|null
     */
     ...
     * Sets revocation
     *
     * @param \OpenAPI\Client\Model\ConsentRevocationRevocation|null $revocation revocation
     *
     * @return self
     */
     ...
     * Gets rejection
     *
     * @return \OpenAPI\Client\Model\ConsentRejectionRejection|null
     */
     ...
     * Sets rejection
     *
     * @param \OpenAPI\Client\Model\ConsentRejectionRejection|null $rejection rejection
     *
     * @return self
     */

...
/**
 * InvoiceFinancingsChargeOverParcel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uinvoice-financingsInvoiceFinancingsChargeOverParcel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceFinancingsChargeOverParcel';
    ...
    */
    ...
    public function setChargeAdditionalInfo($charge_additional_info)
    {
        ...
        if ((mb_strlen($charge_additional_info) > 140)) {
            throw new \InvalidArgumentException('invalid length for $charge_additional_info when calling InvoiceFinancingsChargeOverParcel., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($charge_additional_info)))) {
            throw new \InvalidArgumentException("invalid value for \$charge_additional_info when calling InvoiceFinancingsChargeOverParcel., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
    ...
    public function setChargeAmount($charge_amount)
    {
        ...
        if ((mb_strlen($charge_amount) > 21)) {
            throw new \InvalidArgumentException('invalid length for $charge_amount when calling InvoiceFinancingsChargeOverParcel., must be smaller than or equal to 21.');
        }
        if ((mb_strlen($charge_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $charge_amount when calling InvoiceFinancingsChargeOverParcel., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^-?\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($charge_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$charge_amount when calling InvoiceFinancingsChargeOverParcel., must conform to the pattern /^-?\\d{1,15}\\.\\d{2,4}$/.");
        }

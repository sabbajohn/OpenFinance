<?php
/**
 * RiskSignalsConsentEditionScreenDimensions
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RiskSignalsConsentEditionScreenDimensions Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsRiskSignalsConsentEditionScreenDimensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RiskSignalsConsentEdition_screenDimensions';
    ...
    */
     ...
     * Sets height
     *
     * @param int $height Altura da tela, em pixels.
     *
     * @return self
     */
     ...
     * Sets width
     *
     * @param int $width Largura da tela, em pixels.
     *
     * @return self
     */

...
/**
 * ScheduleDailyDaily Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpaymentsScheduleDailyDaily implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduleDaily_daily';
    ...
    */
    ...
    public function setStartDate($start_date)
    {
        ...
        if ((mb_strlen($start_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $start_date when calling ScheduleDailyDaily., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($start_date)))) {
            throw new \InvalidArgumentException("invalid value for \$start_date when calling ScheduleDailyDaily., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 60)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ScheduleDailyDaily., must be smaller than or equal to 60.');
        }
        if (($quantity < 2)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ScheduleDailyDaily., must be bigger than or equal to 2.');
        }

 ...
 */
class Upayments422ResponseErrorCreateConsentErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CODE_FORMA_PAGAMENTO_INVALIDA = 'FORMA_PAGAMENTO_INVALIDA';
    ...
    {
        return [
            self::CODE_FORMA_PAGAMENTO_INVALIDA,
    ...
    */
     ...
     * Sets title
     *
     * @param string $title Título específico do erro reportado, de acordo com o código enviado:   • FORMA_PAGAMENTO_INVALIDA: Forma de pagamento inválida.   • DATA_PAGAMENTO_INVALIDA: Data de pagamento inválida.   • DETALHE_PAGAMENTO_INVALIDO: Detalhe do pagamento inválido.   • PARAMETRO_NAO_INFORMADO: Parâmetro não informado.   • PARAMETRO_INVALIDO: Parâmetro inválido.   • ERRO_IDEMPOTENCIA: Erro idempotência.   • NAO_INFORMADO: Não informado.
     *
     * @return self
     */

...
/**
 * ResponseVariableIncomesProductList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uvariable-incomesResponseVariableIncomesProductList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseVariableIncomesProductList';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ResponseVariableIncomesProductListData[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ResponseVariableIncomesProductListData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ResponseVariableIncomesProductListData[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseVariableIncomesProductList., number of items must be greater than or equal to 0.');
        }

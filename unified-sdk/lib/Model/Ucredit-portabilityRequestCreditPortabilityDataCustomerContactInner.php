<?php
/**
 * RequestCreditPortabilityDataCustomerContactInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RequestCreditPortabilityDataCustomerContactInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Ucredit-portabilityRequestCreditPortabilityDataCustomerContactInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestCreditPortability_data_customerContact_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^([1-9]{2}(?:[2-8]|9[0-9])[0-9]{3}[0-9]{4})|([a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,})$/", $this->container['value'])) {
     ...
     * Sets type
     *
     * @param string $type Tipo do contato do cliente.
     *
     * @return self
     */
    ...
    public function setValue($value)
    {
        ...
        if ((!preg_match("/^([1-9]{2}(?:[2-8]|9[0-9])[0-9]{3}[0-9]{4})|([a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,})$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling RequestCreditPortabilityDataCustomerContactInner., must conform to the pattern /^([1-9]{2}(?:[2-8]|9[0-9])[0-9]{3}[0-9]{4})|([a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,})$/.");
        }

...
/**
 * UnarrangedAccountOverdraftContractListData Class Doc Comment
 *
 * @category Class
 ...
 */
class Uunarranged-accounts-overdraftUnarrangedAccountOverdraftContractListData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnarrangedAccountOverdraftContractListData';
    ...
    */
     ...
     * Sets contract_id
     *
     * @param string $contract_id Um identificador único e imutável usado para identificar o contrato de uma operação de crédito. Este identificador não tem significado para o tomador do crédito
     *
     * @return self
     */
    public function setContractId($contract_id)
    {
        ...
        if ((mb_strlen($contract_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $contract_id when calling UnarrangedAccountOverdraftContractListData., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($contract_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contract_id when calling UnarrangedAccountOverdraftContractListData., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9][a-zA-Z0-9-]{0,99}$/", ObjectSerializer::toString($contract_id)))) {
            throw new \InvalidArgumentException("invalid value for \$contract_id when calling UnarrangedAccountOverdraftContractListData., must conform to the pattern /^[a-zA-Z0-9][a-zA-Z0-9-]{0,99}$/.");
        }
    ...
    public function setBrandName($brand_name)
    {
        ...
        if ((mb_strlen($brand_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $brand_name when calling UnarrangedAccountOverdraftContractListData., must be smaller than or equal to 80.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($brand_name)))) {
            throw new \InvalidArgumentException("invalid value for \$brand_name when calling UnarrangedAccountOverdraftContractListData., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
    ...
    public function setCompanyCnpj($company_cnpj)
    {
        ...
        if ((mb_strlen($company_cnpj) > 14)) {
            throw new \InvalidArgumentException('invalid length for $company_cnpj when calling UnarrangedAccountOverdraftContractListData., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^[0-9A-Z]{12}[0-9]{2}$/", ObjectSerializer::toString($company_cnpj)))) {
            throw new \InvalidArgumentException("invalid value for \$company_cnpj when calling UnarrangedAccountOverdraftContractListData., must conform to the pattern /^[0-9A-Z]{12}[0-9]{2}$/.");
        }
    ...
    public function setIpocCode($ipoc_code)
    {
        ...
        if ((mb_strlen($ipoc_code) > 67)) {
            throw new \InvalidArgumentException('invalid length for $ipoc_code when calling UnarrangedAccountOverdraftContractListData., must be smaller than or equal to 67.');
        }
        if ((mb_strlen($ipoc_code) < 22)) {
            throw new \InvalidArgumentException('invalid length for $ipoc_code when calling UnarrangedAccountOverdraftContractListData., must be bigger than or equal to 22.');
        }
        if ((!preg_match("/^[\\w\\W]{22,67}$/", ObjectSerializer::toString($ipoc_code)))) {
            throw new \InvalidArgumentException("invalid value for \$ipoc_code when calling UnarrangedAccountOverdraftContractListData., must conform to the pattern /^[\\w\\W]{22,67}$/.");
        }

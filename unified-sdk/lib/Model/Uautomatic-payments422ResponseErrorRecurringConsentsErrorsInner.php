...
/**
 * 422ResponseErrorRecurringConsentsErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-payments422ResponseErrorRecurringConsentsErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_422ResponseErrorRecurringConsents_errors_inner';
    ...
    public const CODE_CONSENTIMENTO_NAO_PERMITE_CANCELAMENTO = 'CONSENTIMENTO_NAO_PERMITE_CANCELAMENTO';
    public const CODE_CAMPO_NAO_PERMITIDO = 'CAMPO_NAO_PERMITIDO';
    public const CODE_PERMISSAO_INSUFICIENTE = 'PERMISSAO_INSUFICIENTE';
    public const CODE_DETALHE_EDICAO_INVALIDO = 'DETALHE_EDICAO_INVALIDO';
    public const CODE_FALTAM_SINAIS_OBRIGATORIOS_PLATAFORMA = 'FALTAM_SINAIS_OBRIGATORIOS_PLATAFORMA';
    ...
    {
        return [
            self::CODE_CONSENTIMENTO_NAO_PERMITE_CANCELAMENTO,
            self::CODE_CAMPO_NAO_PERMITIDO,
            self::CODE_PERMISSAO_INSUFICIENTE,
            self::CODE_DETALHE_EDICAO_INVALIDO,
            self::CODE_FALTAM_SINAIS_OBRIGATORIOS_PLATAFORMA,
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling 422ResponseErrorRecurringConsentsErrorsInner., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling 422ResponseErrorRecurringConsentsErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling 422ResponseErrorRecurringConsentsErrorsInner., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling 422ResponseErrorRecurringConsentsErrorsInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }

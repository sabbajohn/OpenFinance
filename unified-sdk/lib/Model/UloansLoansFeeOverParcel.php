...
/**
 * LoansFeeOverParcel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UloansLoansFeeOverParcel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoansFeeOverParcel';
    ...
    */
    ...
    public function setFeeName($fee_name)
    {
        ...
        if ((mb_strlen($fee_name) > 140)) {
            throw new \InvalidArgumentException('invalid length for $fee_name when calling LoansFeeOverParcel., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($fee_name)))) {
            throw new \InvalidArgumentException("invalid value for \$fee_name when calling LoansFeeOverParcel., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
    ...
    public function setFeeCode($fee_code)
    {
        ...
        if ((mb_strlen($fee_code) > 140)) {
            throw new \InvalidArgumentException('invalid length for $fee_code when calling LoansFeeOverParcel., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/^[^\\s](.*[^\\s])?$/", ObjectSerializer::toString($fee_code)))) {
            throw new \InvalidArgumentException("invalid value for \$fee_code when calling LoansFeeOverParcel., must conform to the pattern /^[^\\s](.*[^\\s])?$/.");
        }
    ...
    public function setFeeAmount($fee_amount)
    {
        ...
        if ((mb_strlen($fee_amount) > 21)) {
            throw new \InvalidArgumentException('invalid length for $fee_amount when calling LoansFeeOverParcel., must be smaller than or equal to 21.');
        }
        if ((mb_strlen($fee_amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $fee_amount when calling LoansFeeOverParcel., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^-?\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($fee_amount)))) {
            throw new \InvalidArgumentException("invalid value for \$fee_amount when calling LoansFeeOverParcel., must conform to the pattern /^-?\\d{1,15}\\.\\d{2,4}$/.");
        }

 ...
 *
 * @category Class
 * @description Motivo da rejeição do consentimento. Informações complementares sobre o motivo do status.   [Restrição] Esse motivo deverá ser enviado quando o campo /data/status for igual a REJECTED.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpaymentsConsentRejectionReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => '\OpenAPI\Client\Model\EnumConsentRejectionReasonType',
        'detail' => 'string'
    ];
    ...
    */
     ...
     * Gets code
     *
     * @return \OpenAPI\Client\Model\EnumConsentRejectionReasonType
     */
     ...
     * Sets code
     *
     * @param \OpenAPI\Client\Model\EnumConsentRejectionReasonType $code code
     *
     * @return self
     */

 ...
 */
class UpaymentsRejectionReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => '\OpenAPI\Client\Model\EnumRejectionReasonType',
        'detail' => 'string'
    ];
    ...
    */
     ...
     * Gets code
     *
     * @return \OpenAPI\Client\Model\EnumRejectionReasonType
     */
     ...
     * Sets code
     *
     * @param \OpenAPI\Client\Model\EnumRejectionReasonType $code code
     *
     * @return self
     */
    ...
    public function setDetail($detail)
    {
        ...
        if ((mb_strlen($detail) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $detail when calling RejectionReason., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($detail)))) {
            throw new \InvalidArgumentException("invalid value for \$detail when calling RejectionReason., must conform to the pattern /[\\w\\W\\s]*/.");
        }

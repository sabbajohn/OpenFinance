...
/**
 * UnarrangedAccountOverdraftBalloonPayment Class Doc Comment
 *
 * @category Class
 ...
 */
class Uunarranged-accounts-overdraftUnarrangedAccountOverdraftBalloonPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnarrangedAccountOverdraftBalloonPayment';
    ...
    protected static $openAPITypes = [
        'due_date' => '\DateTime',
        'amount' => '\OpenAPI\Client\Model\UnarrangedAccountOverdraftBalloonPaymentAmount'
    ];
    ...
    */
     ...
     * Sets due_date
     *
     * @param \DateTime $due_date Data de vencimento da parcela não regular  a vencer do contrato da modalidade de crédito consultada, conforme especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339). p.ex. 2014-03-19
     *
     * @return self
     */
    public function setDueDate($due_date)
    {
        ...
        if ((mb_strlen($due_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $due_date when calling UnarrangedAccountOverdraftBalloonPayment., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($due_date)))) {
            throw new \InvalidArgumentException("invalid value for \$due_date when calling UnarrangedAccountOverdraftBalloonPayment., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
     ...
     * Gets amount
     *
     * @return \OpenAPI\Client\Model\UnarrangedAccountOverdraftBalloonPaymentAmount
     */
     ...
     * Sets amount
     *
     * @param \OpenAPI\Client\Model\UnarrangedAccountOverdraftBalloonPaymentAmount $amount amount
     *
     * @return self
     */

...
/**
 * PersonalInformedPatrimony Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UcustomersPersonalInformedPatrimony implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonalInformedPatrimony';
    ...
    */
     ...
     * Sets year
     *
     * @param float $year Ano de referência da Renda, conforme especificação RFC-3339.
     *
     * @return self
     */
    public function setYear($year)
    {
        ...
        if (($year > 9999)) {
            throw new \InvalidArgumentException('invalid value for $year when calling PersonalInformedPatrimony., must be smaller than or equal to 9999.');
        }

<?php
/**
 * ResponsePortabilityEligibilityData
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponsePortabilityEligibilityData Class Doc Comment
 *
 * @category Class
 ...
 */
class Ucredit-portabilityResponsePortabilityEligibilityData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsePortabilityEligibility_data';
    ...
    protected static $openAPITypes = [
        'contract_id' => 'string',
        'portability' => '\OpenAPI\Client\Model\ResponsePortabilityEligibilityDataPortability'
    ];
    ...
    */
    ...
    public function setContractId($contract_id)
    {
        ...
        if ((mb_strlen($contract_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $contract_id when calling ResponsePortabilityEligibilityData., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($contract_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contract_id when calling ResponsePortabilityEligibilityData., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9][a-zA-Z0-9-]{0,99}$/", ObjectSerializer::toString($contract_id)))) {
            throw new \InvalidArgumentException("invalid value for \$contract_id when calling ResponsePortabilityEligibilityData., must conform to the pattern /^[a-zA-Z0-9][a-zA-Z0-9-]{0,99}$/.");
        }
     ...
     * Gets portability
     *
     * @return \OpenAPI\Client\Model\ResponsePortabilityEligibilityDataPortability
     */
     ...
     * Sets portability
     *
     * @param \OpenAPI\Client\Model\ResponsePortabilityEligibilityDataPortability $portability portability
     *
     * @return self
     */

<?php
/**
 * ResponseCreatePixPaymentDataInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ResponseCreatePixPaymentDataInner Class Doc Comment
 *
 * @category Class
 ...
 */
class UpaymentsResponseCreatePixPaymentDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCreatePixPayment_data_inner';
    ...
    protected static $openAPITypes = [
        ...
        'payment' => '\OpenAPI\Client\Model\ResponseCreatePixPaymentDataInnerPayment',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['consent_id']) && (mb_strlen($this->container['consent_id']) > 256)) {
            $invalidProperties[] = "invalid value for 'consent_id', the character length must be smaller than or equal to 256.";
        }

        if (!is_null($this->container['consent_id']) && !preg_match("/^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/", $this->container['consent_id'])) {
    ...
    public function setPaymentId($payment_id)
    {
        ...
        if ((mb_strlen($payment_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling ResponseCreatePixPaymentDataInner., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($payment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling ResponseCreatePixPaymentDataInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9][a-zA-Z0-9\\-]{0,99}$/", ObjectSerializer::toString($payment_id)))) {
            throw new \InvalidArgumentException("invalid value for \$payment_id when calling ResponseCreatePixPaymentDataInner., must conform to the pattern /^[a-zA-Z0-9][a-zA-Z0-9\\-]{0,99}$/.");
        }
    ...
    public function setEndToEndId($end_to_end_id)
    {
        ...
        if ((mb_strlen($end_to_end_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling ResponseCreatePixPaymentDataInner., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($end_to_end_id) < 32)) {
            throw new \InvalidArgumentException('invalid length for $end_to_end_id when calling ResponseCreatePixPaymentDataInner., must be bigger than or equal to 32.');
        }
        if ((!preg_match("/^([E])([0-9]{8})([0-9]{4})(0[1-9]|1[0-2])(0[1-9]|[1-2][0-9]|3[0-1])(2[0-3]|[01][0-9])([0-5][0-9])([a-zA-Z0-9]{11})$/", ObjectSerializer::toString($end_to_end_id)))) {
            throw new \InvalidArgumentException("invalid value for \$end_to_end_id when calling ResponseCreatePixPaymentDataInner., must conform to the pattern /^([E])([0-9]{8})([0-9]{4})(0[1-9]|1[0-2])(0[1-9]|[1-2][0-9]|3[0-1])(2[0-3]|[01][0-9])([0-5][0-9])([a-zA-Z0-9]{11})$/.");
        }
    ...
    public function setConsentId($consent_id)
    {
        ...
        if ((mb_strlen($consent_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $consent_id when calling ResponseCreatePixPaymentDataInner., must be smaller than or equal to 256.');
        }
        if ((!preg_match("/^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/", ObjectSerializer::toString($consent_id)))) {
            throw new \InvalidArgumentException("invalid value for \$consent_id when calling ResponseCreatePixPaymentDataInner., must conform to the pattern /^urn:[a-zA-Z0-9][a-zA-Z0-9\\-]{0,31}:[a-zA-Z0-9()+,\\-.:=@;$_!*'%\/?#]+$/.");
        }
    ...
    public function setCreationDateTime($creation_date_time)
    {
        ...
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($creation_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$creation_date_time when calling ResponseCreatePixPaymentDataInner., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
    ...
    public function setStatusUpdateDateTime($status_update_date_time)
    {
        ...
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($status_update_date_time)))) {
            throw new \InvalidArgumentException("invalid value for \$status_update_date_time when calling ResponseCreatePixPaymentDataInner., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
    ...
    public function setProxy($proxy)
    {
        ...
        if ((mb_strlen($proxy) > 77)) {
            throw new \InvalidArgumentException('invalid length for $proxy when calling ResponseCreatePixPaymentDataInner., must be smaller than or equal to 77.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($proxy)))) {
            throw new \InvalidArgumentException("invalid value for \$proxy when calling ResponseCreatePixPaymentDataInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }
    ...
    public function setIbgeTownCode($ibge_town_code)
    {
        ...
        if ((mb_strlen($ibge_town_code) > 7)) {
            throw new \InvalidArgumentException('invalid length for $ibge_town_code when calling ResponseCreatePixPaymentDataInner., must be smaller than or equal to 7.');
        }
        if ((mb_strlen($ibge_town_code) < 7)) {
            throw new \InvalidArgumentException('invalid length for $ibge_town_code when calling ResponseCreatePixPaymentDataInner., must be bigger than or equal to 7.');
        }
        if ((!preg_match("/^\\d{7}$/", ObjectSerializer::toString($ibge_town_code)))) {
            throw new \InvalidArgumentException("invalid value for \$ibge_town_code when calling ResponseCreatePixPaymentDataInner., must conform to the pattern /^\\d{7}$/.");
        }
    ...
    public function setCnpjInitiator($cnpj_initiator)
    {
        ...
        if ((mb_strlen($cnpj_initiator) > 14)) {
            throw new \InvalidArgumentException('invalid length for $cnpj_initiator when calling ResponseCreatePixPaymentDataInner., must be smaller than or equal to 14.');
        }
        if ((!preg_match("/^\\d{14}$/", ObjectSerializer::toString($cnpj_initiator)))) {
            throw new \InvalidArgumentException("invalid value for \$cnpj_initiator when calling ResponseCreatePixPaymentDataInner., must conform to the pattern /^\\d{14}$/.");
        }
     ...
     * Gets payment
     *
     * @return \OpenAPI\Client\Model\ResponseCreatePixPaymentDataInnerPayment
     */
     ...
     * Sets payment
     *
     * @param \OpenAPI\Client\Model\ResponseCreatePixPaymentDataInnerPayment $payment payment
     *
     * @return self
     */
    ...
    public function setTransactionIdentification($transaction_identification)
    {
        ...
        if ((mb_strlen($transaction_identification) > 35)) {
            throw new \InvalidArgumentException('invalid length for $transaction_identification when calling ResponseCreatePixPaymentDataInner., must be smaller than or equal to 35.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]{1,35}$/", ObjectSerializer::toString($transaction_identification)))) {
            throw new \InvalidArgumentException("invalid value for \$transaction_identification when calling ResponseCreatePixPaymentDataInner., must conform to the pattern /^[a-zA-Z0-9]{1,35}$/.");
        }
    ...
    public function setRemittanceInformation($remittance_information)
    {
        ...
        if ((mb_strlen($remittance_information) > 140)) {
            throw new \InvalidArgumentException('invalid length for $remittance_information when calling ResponseCreatePixPaymentDataInner., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($remittance_information)))) {
            throw new \InvalidArgumentException("invalid value for \$remittance_information when calling ResponseCreatePixPaymentDataInner., must conform to the pattern /[\\w\\W\\s]*/.");
        }

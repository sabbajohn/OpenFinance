...
/**
 * CreditCardAccountsLimitsDataCustomizedLimitAmount Class Doc Comment
 *
 * @category Class
 * @description Valor total do limite customizado pelo cliente nos canais eletrônicos da instituição. Esse objeto é de envio obrigatório nos casos em que a instituição permita ao cliente alterar o seu limite.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Ucredit-cardsCreditCardAccountsLimitsDataCustomizedLimitAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditCardAccountsLimitsData_customizedLimitAmount';
    ...
    */
     ...
     * Sets amount
     *
     * @param float $amount Valor total do limite informado expresso em valor monetário com no mínimo 2 casas e no máximo 4 casas decimais.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 20)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling CreditCardAccountsLimitsDataCustomizedLimitAmount., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling CreditCardAccountsLimitsDataCustomizedLimitAmount., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^\\d{1,15}\\.\\d{2,4}$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling CreditCardAccountsLimitsDataCustomizedLimitAmount., must conform to the pattern /^\\d{1,15}\\.\\d{2,4}$/.");
        }
     ...
     * Sets currency
     *
     * @param string $currency Moeda referente ao limite informado, segundo modelo ISO-4217. p.ex. 'BRL.' Todos os limite informados estão representados com a moeda vigente do Brasil.
     *
     * @return self
     */
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreditCardAccountsLimitsDataCustomizedLimitAmount., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling CreditCardAccountsLimitsDataCustomizedLimitAmount., must conform to the pattern /^[A-Z]{3}$/.");
        }

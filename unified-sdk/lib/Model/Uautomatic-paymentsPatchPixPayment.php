...
/**
 * PatchPixPayment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Uautomatic-paymentsPatchPixPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchPixPayment';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\PatchPixPaymentData'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\PatchPixPaymentData
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\PatchPixPaymentData $data data
     *
     * @return self
     */

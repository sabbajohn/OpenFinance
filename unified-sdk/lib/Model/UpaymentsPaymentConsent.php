...
/**
 * PaymentConsent Class Doc Comment
 *
 * @category Class
 ...
 */
class UpaymentsPaymentConsent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentConsent';
    ...
    */
    ...
    public function setDate($date)
    {
        ...
        if ((mb_strlen($date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $date when calling PaymentConsent., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($date)))) {
            throw new \InvalidArgumentException("invalid value for \$date when calling PaymentConsent., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PaymentConsent., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^([A-Z]{3})$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling PaymentConsent., must conform to the pattern /^([A-Z]{3})$/.");
        }
    ...
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling PaymentConsent., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling PaymentConsent., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling PaymentConsent., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }
    ...
    public function setIbgeTownCode($ibge_town_code)
    {
        ...
        if ((mb_strlen($ibge_town_code) > 7)) {
            throw new \InvalidArgumentException('invalid length for $ibge_town_code when calling PaymentConsent., must be smaller than or equal to 7.');
        }
        if ((mb_strlen($ibge_town_code) < 7)) {
            throw new \InvalidArgumentException('invalid length for $ibge_town_code when calling PaymentConsent., must be bigger than or equal to 7.');
        }
        if ((!preg_match("/^\\d{7}$/", ObjectSerializer::toString($ibge_town_code)))) {
            throw new \InvalidArgumentException("invalid value for \$ibge_town_code when calling PaymentConsent., must conform to the pattern /^\\d{7}$/.");
        }

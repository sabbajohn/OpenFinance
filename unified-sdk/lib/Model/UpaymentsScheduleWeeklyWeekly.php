...
/**
 * ScheduleWeeklyWeekly Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpaymentsScheduleWeeklyWeekly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduleWeekly_weekly';
    ...
    public const DAY_OF_WEEK_SEGUNDA_FEIRA = 'SEGUNDA_FEIRA';
    public const DAY_OF_WEEK_TERCA_FEIRA = 'TERCA_FEIRA';
    public const DAY_OF_WEEK_QUARTA_FEIRA = 'QUARTA_FEIRA';
    public const DAY_OF_WEEK_QUINTA_FEIRA = 'QUINTA_FEIRA';
    public const DAY_OF_WEEK_SEXTA_FEIRA = 'SEXTA_FEIRA';
    public const DAY_OF_WEEK_SABADO = 'SABADO';
    public const DAY_OF_WEEK_DOMINGO = 'DOMINGO';
    ...
    {
        return [
            self::DAY_OF_WEEK_SEGUNDA_FEIRA,
            self::DAY_OF_WEEK_TERCA_FEIRA,
            self::DAY_OF_WEEK_QUARTA_FEIRA,
            self::DAY_OF_WEEK_QUINTA_FEIRA,
            self::DAY_OF_WEEK_SEXTA_FEIRA,
            self::DAY_OF_WEEK_SABADO,
            self::DAY_OF_WEEK_DOMINGO,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", $this->container['start_date'])) {
            $invalidProperties[] = "invalid value for 'start_date', must be conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.";
        }

        if ($this->container['quantity'] === null) {
            $invalidProperties[] = "'quantity' can't be null";
        }
        if (($this->container['quantity'] > 60)) {
            $invalidProperties[] = "invalid value for 'quantity', must be smaller than or equal to 60.";
        }
     ...
     * Sets day_of_week
     *
     * @param string $day_of_week Define o dia da semana planejado para a ocorrência das liquidações.
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date Define o início da vigência da recorrência.
     *
     * @return self
     */
    public function setStartDate($start_date)
    {
        ...
        if ((mb_strlen($start_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $start_date when calling ScheduleWeeklyWeekly., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($start_date)))) {
            throw new \InvalidArgumentException("invalid value for \$start_date when calling ScheduleWeeklyWeekly., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
     ...
     * Sets quantity
     *
     * @param int $quantity Define a quantidade de pagamentos que serão enviados para liquidação.
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 60)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ScheduleWeeklyWeekly., must be smaller than or equal to 60.');
        }
        if (($quantity < 2)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ScheduleWeeklyWeekly., must be bigger than or equal to 2.');
        }

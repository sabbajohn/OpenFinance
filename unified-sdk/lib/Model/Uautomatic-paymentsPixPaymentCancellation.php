...
/**
 * PixPaymentCancellation Class Doc Comment
 *
 * @category Class
 * @description Objeto que contém os dados referentes ao usuário pagador que solicitou o cancelamento, o canal utilizado por ele e o motivo.    [Restrição] O objeto cancellation será obrigatório apenas quando o valor do campo status for igual a CANC.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsPixPaymentCancellation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PixPaymentCancellation';
    ...
    protected static $openAPITypes = [
        'reason' => '\OpenAPI\Client\Model\EnumPaymentCancellationReasonType',
        'cancelled_from' => '\OpenAPI\Client\Model\EnumPaymentCancellationFromType',
        'cancelled_at' => '\DateTime',
        'cancelled_by' => '\OpenAPI\Client\Model\PixPaymentCancellationCancelledBy'
    ];
    ...
    protected static $setters = [
        'reason' => 'setReason',
        'cancelled_from' => 'setCancelledFrom',
    ...
    protected static $getters = [
        'reason' => 'getReason',
        'cancelled_from' => 'getCancelledFrom',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cancelled_from', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cancelled_from'] === null) {
            $invalidProperties[] = "'cancelled_from' can't be null";
        }
        if ($this->container['cancelled_at'] === null) {
            $invalidProperties[] = "'cancelled_at' can't be null";
        }
        if ((mb_strlen($this->container['cancelled_at']) > 20)) {
            $invalidProperties[] = "invalid value for 'cancelled_at', the character length must be smaller than or equal to 20.";
        }

        if (!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", $this->container['cancelled_at'])) {
            $invalidProperties[] = "invalid value for 'cancelled_at', must be conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.";
        }
     ...
     * Gets reason
     *
     * @return \OpenAPI\Client\Model\EnumPaymentCancellationReasonType
     */
     ...
     * Sets reason
     *
     * @param \OpenAPI\Client\Model\EnumPaymentCancellationReasonType $reason reason
     *
     * @return self
     */
     ...
     * Gets cancelled_from
     *
     * @return \OpenAPI\Client\Model\EnumPaymentCancellationFromType
     */
    public function getCancelledFrom()
    {
        return $this->container['cancelled_from'];
    }

    /**
     * Sets cancelled_from
     *
     * @param \OpenAPI\Client\Model\EnumPaymentCancellationFromType $cancelled_from cancelled_from
     *
     * @return self
     */
    public function setCancelledFrom($cancelled_from)
    {
        if (is_null($cancelled_from)) {
            throw new \InvalidArgumentException('non-nullable cancelled_from cannot be null');
        }
        $this->container['cancelled_from'] = $cancelled_from;
     ...
     * Sets cancelled_at
     *
     * @param \DateTime $cancelled_at Data e hora que foi realizado o cancelamento, conforme especificação [RFC-3339](https://datatracker.ietf.org/doc/html/rfc3339), formato UTC.
     *
     * @return self
     */
    public function setCancelledAt($cancelled_at)
    {
        ...
        if ((mb_strlen($cancelled_at) > 20)) {
            throw new \InvalidArgumentException('invalid length for $cancelled_at when calling PixPaymentCancellation., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($cancelled_at)))) {
            throw new \InvalidArgumentException("invalid value for \$cancelled_at when calling PixPaymentCancellation., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }
     ...
     * Gets cancelled_by
     *
     * @return \OpenAPI\Client\Model\PixPaymentCancellationCancelledBy
     */
     ...
     * Sets cancelled_by
     *
     * @param \OpenAPI\Client\Model\PixPaymentCancellationCancelledBy $cancelled_by cancelled_by
     *
     * @return self
     */

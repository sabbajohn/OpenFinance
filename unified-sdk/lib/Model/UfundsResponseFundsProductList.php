...
/**
 * ResponseFundsProductList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UfundsResponseFundsProductList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseFundsProductList';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\ResponseFundsProductListData[]',
        'links' => '\OpenAPI\Client\Model\FundsProductListLinks',
        'meta' => '\OpenAPI\Client\Model\FundsMeta'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ResponseFundsProductListData[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ResponseFundsProductListData[] $data data
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseFundsProductList., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets links
     *
     * @return \OpenAPI\Client\Model\FundsProductListLinks
     */
     ...
     * Sets links
     *
     * @param \OpenAPI\Client\Model\FundsProductListLinks $links links
     *
     * @return self
     */
     ...
     * Gets meta
     *
     * @return \OpenAPI\Client\Model\FundsMeta
     */
     ...
     * Sets meta
     *
     * @param \OpenAPI\Client\Model\FundsMeta $meta meta
     *
     * @return self
     */

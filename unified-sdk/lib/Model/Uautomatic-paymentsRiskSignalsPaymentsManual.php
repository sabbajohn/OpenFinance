...
/**
 * RiskSignalsPaymentsManual Class Doc Comment
 *
 * @category Class
 ...
 */
class Uautomatic-paymentsRiskSignalsPaymentsManual implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RiskSignalsPayments_manual';
    ...
    */
     ...
     *
     * @param bool|null $is_rooted_device Indica se o dispositivo atualmente está com permissão de “root”.  [Restrição] Campos de envio obrigatório quando o sistema operacional utilizado pelo usuário durante o pagamento for Android ou iOS.
     *
     * @return self
     */
     ...
     *
     * @param float|null $screen_brightness Indica o nível de brilho da tela do dispositivo.   Em dispositivos Android o valor é um inteiro, entre 0 e 255, inclusive;   Em dispositivos iOS o valor é um ponto flutuante entre 0.0 e 1.0.  [Restrição] Campos de envio obrigatório quando o sistema operacional utilizado pelo usuário durante o pagamento for Android ou iOS.
     *
     * @return self
     */
     ...
     *
     * @param int|null $elapsed_time_since_boot Indica por quanto tempo (em milissegundos) o dispositivo está ligado.  [Restrição] Campos de envio obrigatório quando o sistema operacional utilizado pelo usuário durante o pagamento for Android ou iOS.
     *
     * @return self
     */
    ...
    public function setAccountTenure($account_tenure)
    {
        ...
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($account_tenure)))) {
            throw new \InvalidArgumentException("invalid value for \$account_tenure when calling RiskSignalsPaymentsManual., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }

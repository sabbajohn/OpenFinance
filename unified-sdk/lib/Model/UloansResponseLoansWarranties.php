...
/**
 * ResponseLoansWarranties Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UloansResponseLoansWarranties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseLoansWarranties';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\LoansWarranties[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\LoansWarranties[]
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\LoansWarranties[] $data Conjunto de informações referentes à identificação da operação de crédito de empréstimo
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ((count($data) < 0)) {
            throw new \InvalidArgumentException('invalid length for $data when calling ResponseLoansWarranties., number of items must be greater than or equal to 0.');
        }

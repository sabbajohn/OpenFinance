...
/**
 * FidoRelyingParty Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UenrollmentsFidoRelyingParty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FidoRelyingParty';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Identificador único da Relying Party. Esse campo deve ser preenchido com o valor que é enviado na requisição no campo /data/rp.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Nome amigável da Relying Party para exibição aos usuários. Deve ser obtido através do Software Statement Assertion, atributo software_client_name.
     *
     * @return self
     */

 ...
 */
class Uautomatic-paymentsRejection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Rejection';
    ...
    */
    ...
    public function setRejectedAt($rejected_at)
    {
        ...
        if ((mb_strlen($rejected_at) > 20)) {
            throw new \InvalidArgumentException('invalid length for $rejected_at when calling Rejection., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/", ObjectSerializer::toString($rejected_at)))) {
            throw new \InvalidArgumentException("invalid value for \$rejected_at when calling Rejection., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])T(?:[01]\\d|2[0123]):(?:[012345]\\d):(?:[012345]\\d)Z$/.");
        }

 ...
 */
class UcustomersCustomerEmail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets is_main
     *
     * @param bool $is_main Indica se o email informado é o principal
     *
     * @return self
     */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 320)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CustomerEmail., must be smaller than or equal to 320.');
        }

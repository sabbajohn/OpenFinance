...
/**
 * FirstPayment Class Doc Comment
 *
 * @category Class
 * @description Definições para o primeiro pagamento. É considerado como o pagamento da adesão ao serviço pelo usuário pagador.  [Restrição] Para casos em que conta recebedora e conta pagadora pertencem ao mesmo detentor (/data/debtorAccount/ispb &#x3D; /data/recurringConfiguration/automatic/firstPayment/creditorAccount/ispb), o detentor deve garantir que a conta de crédito informada pertence ao titular do CNPJ enviado no campo “/data/creditors/cpfCnpj”.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Uautomatic-paymentsFirstPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirstPayment';
    ...
    protected static $openAPITypes = [
        ...
        'creditor_account' => '\OpenAPI\Client\Model\CreditorAccountConsent'
    ];
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime $date Define a data alvo da liquidação do pagamento. O fuso horário de Brasília deve ser utilizado para criação e racionalização sobre os dados deste campo.
     *
     * @return self
     */
    public function setDate($date)
    {
        ...
        if ((mb_strlen($date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $date when calling FirstPayment., must be smaller than or equal to 10.');
        }
        if ((!preg_match("/^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/", ObjectSerializer::toString($date)))) {
            throw new \InvalidArgumentException("invalid value for \$date when calling FirstPayment., must conform to the pattern /^(\\d{4})-(1[0-2]|0?[1-9])-(3[01]|[12][0-9]|0?[1-9])$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling FirstPayment., must be smaller than or equal to 3.');
        }
        if ((!preg_match("/^([A-Z]{3})$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling FirstPayment., must conform to the pattern /^([A-Z]{3})$/.");
        }
     ...
     * Sets amount
     *
     * @param string $amount Valor da transação com 2 casas decimais.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if ((mb_strlen($amount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling FirstPayment., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($amount) < 4)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling FirstPayment., must be bigger than or equal to 4.');
        }
        if ((!preg_match("/^((\\d{1,16}\\.\\d{2}))$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling FirstPayment., must conform to the pattern /^((\\d{1,16}\\.\\d{2}))$/.");
        }
    ...
    public function setRemittanceInformation($remittance_information)
    {
        ...
        if ((mb_strlen($remittance_information) > 140)) {
            throw new \InvalidArgumentException('invalid length for $remittance_information when calling FirstPayment., must be smaller than or equal to 140.');
        }
        if ((!preg_match("/[\\w\\W\\s]*/", ObjectSerializer::toString($remittance_information)))) {
            throw new \InvalidArgumentException("invalid value for \$remittance_information when calling FirstPayment., must conform to the pattern /[\\w\\W\\s]*/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\CreditorAccountConsent
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CreditorAccountConsent $creditor_account creditor_account
     *
     * @return self
     */
